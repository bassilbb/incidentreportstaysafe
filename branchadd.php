...
class cbranch_add extends cbranch {
	...
	function AddRow($rsold = NULL) {
		...
		// branch_name
		$this->branch_name->SetDbValueDef($rsnew, $this->branch_name->CurrentValue, NULL, FALSE);
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $branch->branch_name->FldCaption(), $branch->branch_name->ReqErrMsg)) ?>");
...
<?php if ($branch->branch_name->Visible) { // branch_name ?>
	<div id="r_branch_name" class="form-group">
		<label id="elh_branch_branch_name" for="x_branch_name" class="<?php echo $branch_add->LeftColumnClass ?>"><?php echo $branch->branch_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $branch_add->RightColumnClass ?>"><div<?php echo $branch->branch_name->CellAttributes() ?>>
