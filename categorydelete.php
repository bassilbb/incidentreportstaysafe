	...
	function Page_Main() {
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("categorylist.php"); // Return to list
			}
		}
	}
...
fcategorydelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php if ($category->category_id->Visible) { // category_id ?>
		<th class="<?php echo $category->category_id->HeaderCellClass() ?>"><span id="elh_category_category_id" class="category_category_id"><?php echo $category->category_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($category->description->Visible) { // description ?>
		<th class="<?php echo $category->description->HeaderCellClass() ?>"><span id="elh_category_description" class="category_description"><?php echo $category->description->FldCaption() ?></span></th>
<?php } ?>
<?php if ($category->code_id->Visible) { // code_id ?>
		<th class="<?php echo $category->code_id->HeaderCellClass() ?>"><span id="elh_category_code_id" class="category_code_id"><?php echo $category->code_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($category->code_id->Visible) { // code_id ?>
		<td<?php echo $category->code_id->CellAttributes() ?>>
<span id="el<?php echo $category_delete->RowCnt ?>_category_code_id" class="category_code_id">
