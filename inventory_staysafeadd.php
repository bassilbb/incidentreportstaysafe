...
$inventory_staysafe_add = NULL; // Initialize page object first

class cinventory_staysafe_add extends cinventory_staysafe {
	...
	// Page object name
	var $PageObjName = 'inventory_staysafe_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("inventory_staysafelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inventory_staysafeview.php")
...
// Create page object
if (!isset($inventory_staysafe_add)) $inventory_staysafe_add = new cinventory_staysafe_add();

// Page init
$inventory_staysafe_add->Page_Init();

// Page main
$inventory_staysafe_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inventory_staysafe_add->Page_Render();
?>
...
var CurrentForm = finventory_staysafeadd = new ew_Form("finventory_staysafeadd", "add");

// Validate form
finventory_staysafeadd.Validate = function() {
...
finventory_staysafeadd.Form_CustomValidate = 
...
finventory_staysafeadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finventory_staysafeadd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafeadd.Lists["x_staff_id"].Data = "<?php echo $inventory_staysafe_add->staff_id->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafeadd.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_add->staff_id->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_staysafeadd.Lists["x_recieved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafeadd.Lists["x_recieved_by"].Data = "<?php echo $inventory_staysafe_add->recieved_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafeadd.AutoSuggests["x_recieved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_add->recieved_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_staysafeadd.Lists["x_recieved_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_staysafeadd.Lists["x_recieved_action"].Options = <?php echo json_encode($inventory_staysafe_add->recieved_action->Options()) ?>;
finventory_staysafeadd.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_staysafeadd.Lists["x_approver_action"].Options = <?php echo json_encode($inventory_staysafe_add->approver_action->Options()) ?>;
finventory_staysafeadd.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
finventory_staysafeadd.Lists["x_statuss"].Data = "<?php echo $inventory_staysafe_add->statuss->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafeadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafeadd.Lists["x_approved_by"].Data = "<?php echo $inventory_staysafe_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafeadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_staysafeadd.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_staysafeadd.Lists["x_verified_action"].Options = <?php echo json_encode($inventory_staysafe_add->verified_action->Options()) ?>;
finventory_staysafeadd.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafeadd.Lists["x_verified_by"].Data = "<?php echo $inventory_staysafe_add->verified_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafeadd.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_add->verified_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $inventory_staysafe_add->ShowPageHeader(); ?>
<?php
$inventory_staysafe_add->ShowMessage();
?>
<form name="finventory_staysafeadd" id="finventory_staysafeadd" class="<?php echo $inventory_staysafe_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inventory_staysafe_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inventory_staysafe_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inventory_staysafe">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inventory_staysafe_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($inventory_staysafe->date_recieved->Visible) { // date_recieved ?>
	<div id="r_date_recieved" class="form-group">
		<label id="elh_inventory_staysafe_date_recieved" for="x_date_recieved" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->date_recieved->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->date_recieved->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_inventory_staysafe_reference_id" for="x_reference_id" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->reference_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->reference_id->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_inventory_staysafe_staff_id" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->staff_id->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafeadd.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
...
<?php if ($inventory_staysafe->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_inventory_staysafe_material_name" for="x_material_name" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->material_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->material_name->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->type->Visible) { // type ?>
	<div id="r_type" class="form-group">
		<label id="elh_inventory_staysafe_type" for="x_type" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->type->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->capacity->Visible) { // capacity ?>
	<div id="r_capacity" class="form-group">
		<label id="elh_inventory_staysafe_capacity" for="x_capacity" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->capacity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->capacity->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_inventory_staysafe_quantity" for="x_quantity" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->quantity->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->recieved_by->Visible) { // recieved_by ?>
	<div id="r_recieved_by" class="form-group">
		<label id="elh_inventory_staysafe_recieved_by" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->recieved_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->recieved_by->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafeadd.CreateAutoSuggest({"id":"x_recieved_by","forceSelect":false});
</script>
</span>
...
<?php if ($inventory_staysafe->recieved_action->Visible) { // recieved_action ?>
	<div id="r_recieved_action" class="form-group">
		<label id="elh_inventory_staysafe_recieved_action" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->recieved_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->recieved_action->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->recieved_comment->Visible) { // recieved_comment ?>
	<div id="r_recieved_comment" class="form-group">
		<label id="elh_inventory_staysafe_recieved_comment" for="x_recieved_comment" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->recieved_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->recieved_comment->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->date_approved->Visible) { // date_approved ?>
	<div id="r_date_approved" class="form-group">
		<label id="elh_inventory_staysafe_date_approved" for="x_date_approved" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->date_approved->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->date_approved->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_inventory_staysafe_approver_action" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->approver_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->approver_action->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label id="elh_inventory_staysafe_approver_comment" for="x_approver_comment" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->approver_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->approver_comment->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_inventory_staysafe_statuss" for="x_statuss" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->statuss->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->statuss->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_inventory_staysafe_approved_by" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->approved_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->approved_by->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafeadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
...
<?php if ($inventory_staysafe->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label id="elh_inventory_staysafe_verified_date" for="x_verified_date" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->verified_date->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->verified_date->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_inventory_staysafe_verified_action" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->verified_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->verified_action->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_inventory_staysafe_verified_comment" for="x_verified_comment" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->verified_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->verified_comment->CellAttributes() ?>>
...
<?php if ($inventory_staysafe->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_inventory_staysafe_verified_by" class="<?php echo $inventory_staysafe_add->LeftColumnClass ?>"><?php echo $inventory_staysafe->verified_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe->verified_by->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafeadd.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
...
<?php if (!$inventory_staysafe_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inventory_staysafe_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inventory_staysafe_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finventory_staysafeadd.Init();
</script>
<?php
$inventory_staysafe_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inventory_staysafe_add->Page_Terminate();
?>
