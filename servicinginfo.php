...
//
// Table class for servicing
//
class cservicing extends cTable {
	var $id;
	var $date_initiated;
	var $reference_id;
	var $staff_id;
	...
	function __construct() {
		...
		$this->TableVar = 'servicing';
		$this->TableName = 'servicing';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`servicing`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('servicing', 'servicing', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_initiated
		$this->date_initiated = new cField('servicing', 'servicing', 'x_date_initiated', 'date_initiated', '`date_initiated`', ew_CastDateFieldForLike('`date_initiated`', 0, "DB"), 135, 0, FALSE, '`date_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reference_id
		$this->reference_id = new cField('servicing', 'servicing', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// staff_id
		$this->staff_id = new cField('servicing', 'servicing', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 3, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// staff_name
		$this->staff_name = new cField('servicing', 'servicing', 'x_staff_name', 'staff_name', '`staff_name`', '`staff_name`', 3, -1, FALSE, '`staff_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// department
		$this->department = new cField('servicing', 'servicing', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->department->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['department'] = &$this->department;

		// branch
		$this->branch = new cField('servicing', 'servicing', 'x_branch', 'branch', '`branch`', '`branch`', 3, -1, FALSE, '`branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// buildings
		$this->buildings = new cField('servicing', 'servicing', 'x_buildings', 'buildings', '`buildings`', '`buildings`', 3, -1, FALSE, '`buildings`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// floors
		$this->floors = new cField('servicing', 'servicing', 'x_floors', 'floors', '`floors`', '`floors`', 3, -1, FALSE, '`floors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// items
		$this->items = new cField('servicing', 'servicing', 'x_items', 'items', '`items`', '`items`', 3, -1, FALSE, '`items`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->items->Sortable = TRUE; // Allow sort
		$this->items->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->items->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->items->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['items'] = &$this->items;

		// priority
		$this->priority = new cField('servicing', 'servicing', 'x_priority', 'priority', '`priority`', '`priority`', 3, -1, FALSE, '`priority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// description
		$this->description = new cField('servicing', 'servicing', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// status
		$this->status = new cField('servicing', 'servicing', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// date_maintained
		$this->date_maintained = new cField('servicing', 'servicing', 'x_date_maintained', 'date_maintained', '`date_maintained`', ew_CastDateFieldForLike('`date_maintained`', 17, "DB"), 135, 17, FALSE, '`date_maintained`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// initiator_action
		$this->initiator_action = new cField('servicing', 'servicing', 'x_initiator_action', 'initiator_action', '`initiator_action`', '`initiator_action`', 3, -1, FALSE, '`initiator_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// initiator_comment
		$this->initiator_comment = new cField('servicing', 'servicing', 'x_initiator_comment', 'initiator_comment', '`initiator_comment`', '`initiator_comment`', 201, -1, FALSE, '`initiator_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->initiator_comment->Sortable = TRUE; // Allow sort
		$this->fields['initiator_comment'] = &$this->initiator_comment;

		// maintained_by
		$this->maintained_by = new cField('servicing', 'servicing', 'x_maintained_by', 'maintained_by', '`maintained_by`', '`maintained_by`', 3, -1, FALSE, '`maintained_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_date
		$this->reviewed_date = new cField('servicing', 'servicing', 'x_reviewed_date', 'reviewed_date', '`reviewed_date`', ew_CastDateFieldForLike('`reviewed_date`', 17, "DB"), 135, 17, FALSE, '`reviewed_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_action
		$this->reviewed_action = new cField('servicing', 'servicing', 'x_reviewed_action', 'reviewed_action', '`reviewed_action`', '`reviewed_action`', 3, -1, FALSE, '`reviewed_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// reviewed_comment
		$this->reviewed_comment = new cField('servicing', 'servicing', 'x_reviewed_comment', 'reviewed_comment', '`reviewed_comment`', '`reviewed_comment`', 201, -1, FALSE, '`reviewed_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->reviewed_comment->Sortable = TRUE; // Allow sort
		$this->fields['reviewed_comment'] = &$this->reviewed_comment;

		// reviewed_by
		$this->reviewed_by = new cField('servicing', 'servicing', 'x_reviewed_by', 'reviewed_by', '`reviewed_by`', '`reviewed_by`', 3, -1, FALSE, '`reviewed_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// staff_no
		$this->staff_no = new cField('servicing', 'servicing', 'x_staff_no', 'staff_no', '`staff_no`', '`staff_no`', 200, -1, FALSE, '`staff_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_no->Sortable = TRUE; // Allow sort
		$this->fields['staff_no'] = &$this->staff_no;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`servicing`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "servicingedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "servicingadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("servicingview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("servicingview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "servicingadd.php?" . $this->UrlParm($parm);
		else
			$url = "servicingadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("servicingedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("servicingadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("servicingdelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->staff_no->setDbValue($rs->fields('staff_no'));
	}
	...
	function RenderEditRow() {
		...
		$this->date_maintained->EditValue = ew_FormatDateTime($this->date_maintained->CurrentValue, 17);
		...
		$this->reviewed_date->EditValue = ew_FormatDateTime($this->reviewed_date->CurrentValue, 17);
		...
		$this->staff_no->EditValue = $this->staff_no->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->staff_no->Exportable) $Doc->ExportCaption($this->staff_no);
				} else {
					if ($this->id->Exportable) $Doc->ExportCaption($this->id);
					if ($this->date_initiated->Exportable) $Doc->ExportCaption($this->date_initiated);
					if ($this->reference_id->Exportable) $Doc->ExportCaption($this->reference_id);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->staff_no->Exportable) $Doc->ExportField($this->staff_no);
					} else {
						if ($this->id->Exportable) $Doc->ExportField($this->id);
						if ($this->date_initiated->Exportable) $Doc->ExportField($this->date_initiated);
						if ($this->reference_id->Exportable) $Doc->ExportField($this->reference_id);
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		// To cancel, set return value to FALSE
			...
			if ($this->initiator_action->CurrentValue == 1 && $this->status->CurrentValue == 0) {
				...
				$this->setSuccessMessage("&#x25C9; Recharged  sent for Confirmation &#x2714;"); 					
			}
	...
	function Row_Updating($rsold, &$rsnew) {
		...
		// Officer Only
			...
			if ($this->initiator_action->CurrentValue == 1 && $this->status->CurrentValue == 0) {
				$rsnew["status"] = 2;
				$rsnew["initiator_action"] = 1;
				$rsnew["reviewed_action"] = NULL;
				$rsnew["reviewed_comment"] = NULL;
				$this->setSuccessMessage("&#x25C9; Recharged sent for Review And Confirmation &#x2714;"); 					
			}
		...
		if ((CurrentPageID() == "edit" && CurrentUserLevel() == 3) && ($this->staff_id->CurrentValue != $_SESSION['Staff_ID'])) {
			...
			if ((CurrentPageID() == "edit" && CurrentUserLevel() == 3) && $this->staff_id->CurrentValue != $_SESSION['Staff_ID']) {
				...
				if ($this->reviewed_action->CurrentValue == 1 && $this->status->CurrentValue == 2 ) {
					...
					$this->setSuccessMessage("&#x25C9; Record was return for rework &#x2714;");
				}
				...
				if ($this->reviewed_action->CurrentValue == 2 ) {
					...
					$this->setSuccessMessage("&#x25C9; Recharged successfully Confirmed &#x2714;");
				}
		return TRUE;
	}
	...
	function Row_Rendering() {
		...
		if (CurrentPageID() == "add" && (CurrentUserLevel() == 1 || CurrentUserLevel() == 2 || CurrentUserLevel()   == 3 || CurrentUserLevel() == 4)) {
			...
			$this->staff_id->EditValue = $this->staff_id->CurrentValue;
			$this->staff_name->CurrentValue = $_SESSION['Staff_ID'];
			$this->staff_name->EditValue = $this->staff_name->CurrentValue;
			$this->department->CurrentValue = $_SESSION['Department'];
			$this->department->EditValue = $this->department->CurrentValue;
			$this->branch->CurrentValue = $_SESSION['Branch'];
			$this->branch->EditValue = $this->branch->CurrentValue;
			$this->maintained_by->CurrentValue = $_SESSION['Staff_ID'];
			$this->maintained_by->EditValue = $this->maintained_by->CurrentValue;
		}
		if (CurrentPageID() == "add")  {
			$this->reference_id->CurrentValue = $_SESSION['REF_ID'];
			$this->reference_id->EditValue = $this->reference_id->CurrentValue;
		}
	}
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "list") {
			...
			if ($this->status->CurrentValue == 2) {
				...
				$this->date_initiated->CellCssStyle = "color: red; text-align: left;";
				$this->staff_id->CellCssStyle = "color: red; text-align: left;";
				$this->staff_name->CellCssStyle = "color: red; text-align: left;";
				$this->maintained_by->CellCssStyle = "color: red; text-align: left;";
				...
				$this->priority->CellCssStyle = "color: red; text-align: left;";
				$this->buildings->CellCssStyle = "color: red; text-align: left;";
				$this->floors->CellCssStyle = "color: red; text-align: left;";
				$this->items->CellCssStyle = "color: red; text-align: left;";
			}
