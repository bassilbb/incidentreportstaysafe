...
$restock_staysafe_report = NULL;

//
// Table class for restock_staysafe_report
//
class crestock_staysafe_report extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'restock_staysafe_report';
		$this->TableName = 'restock_staysafe_report';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`restock_staysafe_report`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// code
		$this->code = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_code', 'code', '`code`', '`code`', 3, -1, FALSE, '`code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->code->Sortable = TRUE; // Allow sort
		$this->code->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['code'] = &$this->code;

		// date_restocked
		$this->date_restocked = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_date_restocked', 'date_restocked', '`date_restocked`', ew_CastDateFieldForLike('`date_restocked`', 14, "DB"), 133, 14, FALSE, '`date_restocked`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->date_restocked->Sortable = TRUE; // Allow sort
		$this->fields['date_restocked'] = &$this->date_restocked;

		// reference_id
		$this->reference_id = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// material_name
		$this->material_name = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_material_name', 'material_name', '`material_name`', '`material_name`', 3, -1, FALSE, '`material_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// type
		$this->type = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_type', 'type', '`type`', '`type`', 200, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->type->Sortable = TRUE; // Allow sort
		$this->fields['type'] = &$this->type;

		// capacity
		$this->capacity = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_capacity', 'capacity', '`capacity`', '`capacity`', 200, -1, FALSE, '`capacity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->capacity->Sortable = TRUE; // Allow sort
		$this->fields['capacity'] = &$this->capacity;

		// stock_balance
		$this->stock_balance = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_stock_balance', 'stock_balance', '`stock_balance`', '`stock_balance`', 200, -1, FALSE, '`stock_balance`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->stock_balance->Sortable = TRUE; // Allow sort
		$this->fields['stock_balance'] = &$this->stock_balance;

		// quantity
		$this->quantity = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 200, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->fields['quantity'] = &$this->quantity;

		// statuss
		$this->statuss = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_statuss', 'statuss', '`statuss`', '`statuss`', 3, -1, FALSE, '`statuss`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// restocked_action
		$this->restocked_action = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_restocked_action', 'restocked_action', '`restocked_action`', '`restocked_action`', 3, -1, FALSE, '`restocked_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// restocked_comment
		$this->restocked_comment = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_restocked_comment', 'restocked_comment', '`restocked_comment`', '`restocked_comment`', 201, -1, FALSE, '`restocked_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->restocked_comment->Sortable = TRUE; // Allow sort
		$this->fields['restocked_comment'] = &$this->restocked_comment;

		// restocked_by
		$this->restocked_by = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_restocked_by', 'restocked_by', '`restocked_by`', '`restocked_by`', 3, -1, FALSE, '`restocked_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->restocked_by->Sortable = TRUE; // Allow sort
		$this->fields['restocked_by'] = &$this->restocked_by;

		// approver_date
		$this->approver_date = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_approver_date', 'approver_date', '`approver_date`', ew_CastDateFieldForLike('`approver_date`', 14, "DB"), 135, 14, FALSE, '`approver_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->approver_date->Sortable = TRUE; // Allow sort
		$this->fields['approver_date'] = &$this->approver_date;

		// approver_action
		$this->approver_action = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_approver_action', 'approver_action', '`approver_action`', '`approver_action`', 3, -1, FALSE, '`approver_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approver_comment
		$this->approver_comment = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_approver_comment', 'approver_comment', '`approver_comment`', '`approver_comment`', 200, -1, FALSE, '`approver_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->approver_comment->Sortable = TRUE; // Allow sort
		$this->fields['approver_comment'] = &$this->approver_comment;

		// approved_by
		$this->approved_by = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_approved_by', 'approved_by', '`approved_by`', '`approved_by`', 3, -1, FALSE, '`approved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// verified_date
		$this->verified_date = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_verified_date', 'verified_date', '`verified_date`', ew_CastDateFieldForLike('`verified_date`', 14, "DB"), 135, 14, FALSE, '`verified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->verified_date->Sortable = TRUE; // Allow sort
		$this->fields['verified_date'] = &$this->verified_date;

		// verified_action
		$this->verified_action = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_verified_action', 'verified_action', '`verified_action`', '`verified_action`', 3, -1, FALSE, '`verified_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// verified_comment
		$this->verified_comment = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_verified_comment', 'verified_comment', '`verified_comment`', '`verified_comment`', 200, -1, FALSE, '`verified_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->verified_comment->Sortable = TRUE; // Allow sort
		$this->fields['verified_comment'] = &$this->verified_comment;

		// verified_by
		$this->verified_by = new cField('restock_staysafe_report', 'restock_staysafe_report', 'x_verified_by', 'verified_by', '`verified_by`', '`verified_by`', 3, -1, FALSE, '`verified_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`restock_staysafe_report`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "restock_staysafe_reportlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "restock_staysafe_reportedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "restock_staysafe_reportadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("restock_staysafe_reportview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("restock_staysafe_reportview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "restock_staysafe_reportadd.php?" . $this->UrlParm($parm);
		else
			$url = "restock_staysafe_reportadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("restock_staysafe_reportedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("restock_staysafe_reportadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("restock_staysafe_reportdelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->approver_date->EditValue = ew_FormatDateTime($this->approver_date->CurrentValue, 14);
		...
		$this->verified_date->EditValue = ew_FormatDateTime($this->verified_date->CurrentValue, 14);
