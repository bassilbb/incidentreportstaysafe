...
$RootMenu->AddMenuItem(275, "mi_loan_status", $Language->MenuPhrase("275", "MenuText"), "loan_statuslist.php", 33, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}loan_status'), FALSE, FALSE, "fas fa-hourglass-start");
...
$RootMenu->AddMenuItem(429, "mci_Items_Requisition", $Language->MenuPhrase("429", "MenuText"), "", -1, "", TRUE, FALSE, TRUE, "fa-light fa-bars");
$RootMenu->AddMenuItem(345, "mi_requisition_module", $Language->MenuPhrase("345", "MenuText"), "requisition_modulelist.php", 429, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}requisition_module'), FALSE, FALSE, "fas fa-indent");
$RootMenu->AddMenuItem(431, "mi_requisition_report", $Language->MenuPhrase("431", "MenuText"), "requisition_reportlist.php", 429, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}requisition_report'), FALSE, FALSE, "fas fa-indent");
...
$RootMenu->AddMenuItem(433, "mi_system_inventory", $Language->MenuPhrase("433", "MenuText"), "system_inventorylist.php", 256, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}system_inventory'), FALSE, FALSE, "fa fa-cube");
...
$RootMenu->AddMenuItem(434, "mi_system_restock", $Language->MenuPhrase("434", "MenuText"), "system_restocklist.php", 256, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}system_restock'), FALSE, FALSE, "fa fa-cube");
