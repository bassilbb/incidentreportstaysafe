...
$RootMenu->AddMenuItem(145, "mci_Inventory_Store_Module", $Language->MenuPhrase("145", "MenuText"), "", -1, "", TRUE, FALSE, TRUE, "fa fa-cube");
...
$RootMenu->AddMenuItem(268, "mci_Inventory_Issuance_Module", $Language->MenuPhrase("268", "MenuText"), "", -1, "", TRUE, FALSE, TRUE, "fa fa-people-arrows");
$RootMenu->AddMenuItem(102, "mi_inventory_store", $Language->MenuPhrase("102", "MenuText"), "inventory_storelist.php", 268, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}inventory_store'), FALSE, FALSE, "fa fa-people-arrows");
$RootMenu->AddMenuItem(258, "mi_store_reports", $Language->MenuPhrase("258", "MenuText"), "store_reportslist.php", 268, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}store_reports'), FALSE, FALSE, "fas fa-indent");
$RootMenu->AddMenuItem(269, "mi_issuance_records", $Language->MenuPhrase("269", "MenuText"), "issuance_recordslist.php", 268, "", AllowListMenu('{DD9080C0-D1CA-431F-831F-CAC8FA61260C}issuance_records'), FALSE, FALSE, "fa fa-people-arrows");
