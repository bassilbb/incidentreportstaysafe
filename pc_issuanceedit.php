...
fpc_issuanceedit.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"system_inventory"};
fpc_issuanceedit.Lists["x_material_name"].Data = "<?php echo $pc_issuance_edit->material_name->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($pc_issuance->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_pc_issuance_material_name" for="x_material_name" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->material_name->FldCaption() ?></label>
		<div class="<?php echo $pc_issuance_edit->RightColumnClass ?>"><div<?php echo $pc_issuance->material_name->CellAttributes() ?>>
...
<?php if ($pc_issuance->ram->Visible) { // ram ?>
	<div id="r_ram" class="form-group">
		<label id="elh_pc_issuance_ram" for="x_ram" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->ram->FldCaption() ?></label>
...
<?php if ($pc_issuance->hard_disk->Visible) { // hard_disk ?>
	<div id="r_hard_disk" class="form-group">
		<label id="elh_pc_issuance_hard_disk" for="x_hard_disk" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->hard_disk->FldCaption() ?></label>
...
<?php if ($pc_issuance->capacity->Visible) { // capacity ?>
	<div id="r_capacity" class="form-group">
		<label id="elh_pc_issuance_capacity" for="x_capacity" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->capacity->FldCaption() ?></label>
		<div class="<?php echo $pc_issuance_edit->RightColumnClass ?>"><div<?php echo $pc_issuance->capacity->CellAttributes() ?>>
...
<?php if ($pc_issuance->quantity_in->Visible) { // quantity_in ?>
	<div id="r_quantity_in" class="form-group">
		<label id="elh_pc_issuance_quantity_in" for="x_quantity_in" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->quantity_in->FldCaption() ?></label>
		<div class="<?php echo $pc_issuance_edit->RightColumnClass ?>"><div<?php echo $pc_issuance->quantity_in->CellAttributes() ?>>
...
<?php if ($pc_issuance->quantity_out->Visible) { // quantity_out ?>
	<div id="r_quantity_out" class="form-group">
		<label id="elh_pc_issuance_quantity_out" for="x_quantity_out" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->quantity_out->FldCaption() ?></label>
		<div class="<?php echo $pc_issuance_edit->RightColumnClass ?>"><div<?php echo $pc_issuance->quantity_out->CellAttributes() ?>>
...
<?php if ($pc_issuance->total_quantity->Visible) { // total_quantity ?>
	<div id="r_total_quantity" class="form-group">
		<label id="elh_pc_issuance_total_quantity" for="x_total_quantity" class="<?php echo $pc_issuance_edit->LeftColumnClass ?>"><?php echo $pc_issuance->total_quantity->FldCaption() ?></label>
		<div class="<?php echo $pc_issuance_edit->RightColumnClass ?>"><div<?php echo $pc_issuance->total_quantity->CellAttributes() ?>>
