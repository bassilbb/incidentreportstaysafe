...
fissuance_storeadd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
<?php if ($issuance_store->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label id="elh_issuance_store_issued_by" for="x_issued_by" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->issued_by->FldCaption() ?></label>
