...
$issuance_store_add = NULL; // Initialize page object first

class cissuance_store_add extends cissuance_store {
	...
	// Page object name
	var $PageObjName = 'issuance_store_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("issuance_storelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "issuance_storeview.php")
	...
	function LoadDefaultValues() {
		...
		$this->approved_comment->CurrentValue = NULL;
		$this->approved_comment->OldValue = $this->approved_comment->CurrentValue;
	...
	function NewRow() {
		...
		$row['approved_comment'] = $this->approved_comment->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// approved_comment
		$this->approved_comment->SetDbValueDef($rsnew, $this->approved_comment->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($issuance_store_add)) $issuance_store_add = new cissuance_store_add();

// Page init
$issuance_store_add->Page_Init();

// Page main
$issuance_store_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$issuance_store_add->Page_Render();
?>
...
var CurrentForm = fissuance_storeadd = new ew_Form("fissuance_storeadd", "add");

// Validate form
fissuance_storeadd.Validate = function() {
...
fissuance_storeadd.Form_CustomValidate = 
...
fissuance_storeadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fissuance_storeadd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_storeadd.Lists["x_staff_id"].Data = "<?php echo $issuance_store_add->staff_id->LookupFilterQuery(FALSE, "add") ?>";
fissuance_storeadd.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_add->staff_id->LookupFilterQuery(TRUE, "add"))) ?>;
fissuance_storeadd.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory"};
fissuance_storeadd.Lists["x_material_name"].Data = "<?php echo $issuance_store_add->material_name->LookupFilterQuery(FALSE, "add") ?>";
fissuance_storeadd.Lists["x_treated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_storeadd.Lists["x_treated_by"].Data = "<?php echo $issuance_store_add->treated_by->LookupFilterQuery(FALSE, "add") ?>";
fissuance_storeadd.AutoSuggests["x_treated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_add->treated_by->LookupFilterQuery(TRUE, "add"))) ?>;
fissuance_storeadd.Lists["x_issued_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuance_storeadd.Lists["x_issued_action"].Options = <?php echo json_encode($issuance_store_add->issued_action->Options()) ?>;
fissuance_storeadd.Lists["x_issued_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_storeadd.Lists["x_issued_by"].Data = "<?php echo $issuance_store_add->issued_by->LookupFilterQuery(FALSE, "add") ?>";
fissuance_storeadd.AutoSuggests["x_issued_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_add->issued_by->LookupFilterQuery(TRUE, "add"))) ?>;
fissuance_storeadd.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuance_storeadd.Lists["x_approver_action"].Options = <?php echo json_encode($issuance_store_add->approver_action->Options()) ?>;
fissuance_storeadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_storeadd.Lists["x_approved_by"].Data = "<?php echo $issuance_store_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
fissuance_storeadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
fissuance_storeadd.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuance_storeadd.Lists["x_verified_action"].Options = <?php echo json_encode($issuance_store_add->verified_action->Options()) ?>;
fissuance_storeadd.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_storeadd.Lists["x_verified_by"].Data = "<?php echo $issuance_store_add->verified_by->LookupFilterQuery(FALSE, "add") ?>";
fissuance_storeadd.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_add->verified_by->LookupFilterQuery(TRUE, "add"))) ?>;
fissuance_storeadd.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
fissuance_storeadd.Lists["x_statuss"].Data = "<?php echo $issuance_store_add->statuss->LookupFilterQuery(FALSE, "add") ?>";
...
<?php
$issuance_store_add->ShowMessage();
?>
<form name="fissuance_storeadd" id="fissuance_storeadd" class="<?php echo $issuance_store_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($issuance_store_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $issuance_store_add->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo intval($issuance_store_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($issuance_store->date->Visible) { // date ?>
	<div id="r_date" class="form-group">
		<label id="elh_issuance_store_date" for="x_date" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->date->CellAttributes() ?>>
...
<?php if ($issuance_store->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_issuance_store_reference_id" for="x_reference_id" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->reference_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->reference_id->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_issuance_store_staff_id" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->staff_id->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fissuance_storeadd.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_issuance_store_staff_id">
...
<?php if ($issuance_store->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_issuance_store_material_name" for="x_material_name" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->material_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->material_name->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->quantity_in->Visible) { // quantity_in ?>
	<div id="r_quantity_in" class="form-group">
		<label id="elh_issuance_store_quantity_in" for="x_quantity_in" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->quantity_in->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->quantity_in->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->quantity_type->Visible) { // quantity_type ?>
	<div id="r_quantity_type" class="form-group">
		<label id="elh_issuance_store_quantity_type" for="x_quantity_type" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->quantity_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->quantity_type->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->quantity_out->Visible) { // quantity_out ?>
	<div id="r_quantity_out" class="form-group">
		<label id="elh_issuance_store_quantity_out" for="x_quantity_out" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->quantity_out->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->quantity_out->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->total_quantity->Visible) { // total_quantity ?>
	<div id="r_total_quantity" class="form-group">
		<label id="elh_issuance_store_total_quantity" for="x_total_quantity" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->total_quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->total_quantity->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->treated_by->Visible) { // treated_by ?>
	<div id="r_treated_by" class="form-group">
		<label id="elh_issuance_store_treated_by" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->treated_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->treated_by->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fissuance_storeadd.CreateAutoSuggest({"id":"x_treated_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_issuance_store_treated_by">
...
<?php if ($issuance_store->issued_action->Visible) { // issued_action ?>
	<div id="r_issued_action" class="form-group">
		<label id="elh_issuance_store_issued_action" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->issued_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->issued_action->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->issued_comment->Visible) { // issued_comment ?>
	<div id="r_issued_comment" class="form-group">
		<label id="elh_issuance_store_issued_comment" for="x_issued_comment" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->issued_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->issued_comment->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label id="elh_issuance_store_issued_by" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->issued_by->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->issued_by->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fissuance_storeadd.CreateAutoSuggest({"id":"x_issued_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_issuance_store_issued_by">
...
<?php if ($issuance_store->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_issuance_store_approver_date" for="x_approver_date" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->approver_date->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->approver_date->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_issuance_store_approver_action" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->approver_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->approver_action->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->approved_comment->Visible) { // approved_comment ?>
	<div id="r_approved_comment" class="form-group">
		<label id="elh_issuance_store_approved_comment" for="x_approved_comment" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->approved_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->approved_comment->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_issuance_store_approved_by" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->approved_by->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->approved_by->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fissuance_storeadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_issuance_store_approved_by">
...
<?php if ($issuance_store->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label id="elh_issuance_store_verified_date" for="x_verified_date" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->verified_date->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->verified_date->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_issuance_store_verified_action" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->verified_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->verified_action->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_issuance_store_verified_comment" for="x_verified_comment" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->verified_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->verified_comment->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if ($issuance_store->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_issuance_store_verified_by" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->verified_by->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->verified_by->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fissuance_storeadd.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_issuance_store_verified_by">
...
<?php if ($issuance_store->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_issuance_store_statuss" for="x_statuss" class="<?php echo $issuance_store_add->LeftColumnClass ?>"><?php echo $issuance_store->statuss->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_add->RightColumnClass ?>"><div<?php echo $issuance_store->statuss->CellAttributes() ?>>
<?php if ($issuance_store->CurrentAction <> "F") { ?>
...
<?php if (!$issuance_store_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $issuance_store_add->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($issuance_store->CurrentAction <> "F") { // Confirm page ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $issuance_store_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<script type="text/javascript">
fissuance_storeadd.Init();
</script>
<?php
$issuance_store_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$issuance_store_add->Page_Terminate();
?>
