...
$issuance_store_staysafe_edit = NULL; // Initialize page object first

class cissuance_store_staysafe_edit extends cissuance_store_staysafe {
	...
	// Page object name
	var $PageObjName = 'issuance_store_staysafe_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// date
			$this->date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date->CurrentValue, 17), ew_CurrentDate(), $this->date->ReadOnly);
...
// Create page object
if (!isset($issuance_store_staysafe_edit)) $issuance_store_staysafe_edit = new cissuance_store_staysafe_edit();

// Page init
$issuance_store_staysafe_edit->Page_Init();

// Page main
$issuance_store_staysafe_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$issuance_store_staysafe_edit->Page_Render();
?>
...
var CurrentForm = fissuance_store_staysafeedit = new ew_Form("fissuance_store_staysafeedit", "edit");

// Validate form
fissuance_store_staysafeedit.Validate = function() {
...
fissuance_store_staysafeedit.Form_CustomValidate = 
...
fissuance_store_staysafeedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fissuance_store_staysafeedit.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory_staysafe"};
fissuance_store_staysafeedit.Lists["x_material_name"].Data = "<?php echo $issuance_store_staysafe_edit->material_name->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.Lists["x_treated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_store_staysafeedit.Lists["x_treated_by"].Data = "<?php echo $issuance_store_staysafe_edit->treated_by->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.AutoSuggests["x_treated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_staysafe_edit->treated_by->LookupFilterQuery(TRUE, "edit"))) ?>;
fissuance_store_staysafeedit.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_store_staysafeedit.Lists["x_staff_id"].Data = "<?php echo $issuance_store_staysafe_edit->staff_id->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_staysafe_edit->staff_id->LookupFilterQuery(TRUE, "edit"))) ?>;
fissuance_store_staysafeedit.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
fissuance_store_staysafeedit.Lists["x_statuss"].Data = "<?php echo $issuance_store_staysafe_edit->statuss->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.Lists["x_issued_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuance_store_staysafeedit.Lists["x_issued_action"].Options = <?php echo json_encode($issuance_store_staysafe_edit->issued_action->Options()) ?>;
fissuance_store_staysafeedit.Lists["x_issued_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_store_staysafeedit.Lists["x_issued_by"].Data = "<?php echo $issuance_store_staysafe_edit->issued_by->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.AutoSuggests["x_issued_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_staysafe_edit->issued_by->LookupFilterQuery(TRUE, "edit"))) ?>;
fissuance_store_staysafeedit.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuance_store_staysafeedit.Lists["x_approver_action"].Options = <?php echo json_encode($issuance_store_staysafe_edit->approver_action->Options()) ?>;
fissuance_store_staysafeedit.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_store_staysafeedit.Lists["x_approved_by"].Data = "<?php echo $issuance_store_staysafe_edit->approved_by->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_staysafe_edit->approved_by->LookupFilterQuery(TRUE, "edit"))) ?>;
fissuance_store_staysafeedit.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuance_store_staysafeedit.Lists["x_verified_action"].Options = <?php echo json_encode($issuance_store_staysafe_edit->verified_action->Options()) ?>;
fissuance_store_staysafeedit.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_store_staysafeedit.Lists["x_verified_by"].Data = "<?php echo $issuance_store_staysafe_edit->verified_by->LookupFilterQuery(FALSE, "edit") ?>";
fissuance_store_staysafeedit.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_staysafe_edit->verified_by->LookupFilterQuery(TRUE, "edit"))) ?>;
...
<?php
$issuance_store_staysafe_edit->ShowMessage();
?>
<?php if (!$issuance_store_staysafe_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($issuance_store_staysafe_edit->Pager)) $issuance_store_staysafe_edit->Pager = new cPrevNextPager($issuance_store_staysafe_edit->StartRec, $issuance_store_staysafe_edit->DisplayRecs, $issuance_store_staysafe_edit->TotalRecs, $issuance_store_staysafe_edit->AutoHidePager) ?>
<?php if ($issuance_store_staysafe_edit->Pager->RecordCount > 0 && $issuance_store_staysafe_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($issuance_store_staysafe_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $issuance_store_staysafe_edit->PageUrl() ?>start=<?php echo $issuance_store_staysafe_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($issuance_store_staysafe_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $issuance_store_staysafe_edit->PageUrl() ?>start=<?php echo $issuance_store_staysafe_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $issuance_store_staysafe_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($issuance_store_staysafe_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $issuance_store_staysafe_edit->PageUrl() ?>start=<?php echo $issuance_store_staysafe_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($issuance_store_staysafe_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $issuance_store_staysafe_edit->PageUrl() ?>start=<?php echo $issuance_store_staysafe_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $issuance_store_staysafe_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fissuance_store_staysafeedit" id="fissuance_store_staysafeedit" class="<?php echo $issuance_store_staysafe_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($issuance_store_staysafe_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $issuance_store_staysafe_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="issuance_store_staysafe">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($issuance_store_staysafe_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($issuance_store_staysafe->date->Visible) { // date ?>
	<div id="r_date" class="form-group">
		<label id="elh_issuance_store_staysafe_date" for="x_date" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->date->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_issuance_store_staysafe_reference_id" for="x_reference_id" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->reference_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->reference_id->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_issuance_store_staysafe_material_name" for="x_material_name" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->material_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->material_name->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->quantity_in->Visible) { // quantity_in ?>
	<div id="r_quantity_in" class="form-group">
		<label id="elh_issuance_store_staysafe_quantity_in" for="x_quantity_in" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->quantity_in->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->quantity_in->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->treated_by->Visible) { // treated_by ?>
	<div id="r_treated_by" class="form-group">
		<label id="elh_issuance_store_staysafe_treated_by" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->treated_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->treated_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuance_store_staysafeedit.CreateAutoSuggest({"id":"x_treated_by","forceSelect":false});
</script>
</span>
...
<?php if ($issuance_store_staysafe->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_issuance_store_staysafe_staff_id" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->staff_id->CellAttributes() ?>>
...
<script type="text/javascript">
fissuance_store_staysafeedit.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
...
<?php if ($issuance_store_staysafe->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_issuance_store_staysafe_statuss" for="x_statuss" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->statuss->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->statuss->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label id="elh_issuance_store_staysafe_issued_by" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->issued_by->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->issued_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuance_store_staysafeedit.CreateAutoSuggest({"id":"x_issued_by","forceSelect":false});
</script>
</span>
...
<?php if ($issuance_store_staysafe->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_issuance_store_staysafe_approver_date" for="x_approver_date" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->approver_date->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->approver_date->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_issuance_store_staysafe_approved_by" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->approved_by->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->approved_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuance_store_staysafeedit.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
...
<?php if ($issuance_store_staysafe->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label id="elh_issuance_store_staysafe_verified_date" for="x_verified_date" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->verified_date->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->verified_date->CellAttributes() ?>>
...
<?php if ($issuance_store_staysafe->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_issuance_store_staysafe_verified_by" class="<?php echo $issuance_store_staysafe_edit->LeftColumnClass ?>"><?php echo $issuance_store_staysafe->verified_by->FldCaption() ?></label>
		<div class="<?php echo $issuance_store_staysafe_edit->RightColumnClass ?>"><div<?php echo $issuance_store_staysafe->verified_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuance_store_staysafeedit.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
...
<input type="hidden" data-table="issuance_store_staysafe" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($issuance_store_staysafe->id->CurrentValue) ?>">
<?php if (!$issuance_store_staysafe_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $issuance_store_staysafe_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $issuance_store_staysafe_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fissuance_store_staysafeedit.Init();
</script>
<?php
$issuance_store_staysafe_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$issuance_store_staysafe_edit->Page_Terminate();
?>
