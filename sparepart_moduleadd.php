...
$sparepart_module_add = NULL; // Initialize page object first

class csparepart_module_add extends csparepart_module {
	...
	// Page object name
	var $PageObjName = 'sparepart_module_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("sparepart_modulelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "sparepart_moduleview.php")
	...
	function LoadDefaultValues() {
		...
		$this->gen_maintenance->CurrentValue = NULL;
		$this->gen_maintenance->OldValue = $this->gen_maintenance->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['gen_maintenance'] = $this->gen_maintenance->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// gen_maintenance
		$this->gen_maintenance->SetDbValueDef($rsnew, $this->gen_maintenance->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($sparepart_module_add)) $sparepart_module_add = new csparepart_module_add();

// Page init
$sparepart_module_add->Page_Init();

// Page main
$sparepart_module_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sparepart_module_add->Page_Render();
?>
...
var CurrentForm = fsparepart_moduleadd = new ew_Form("fsparepart_moduleadd", "add");

// Validate form
fsparepart_moduleadd.Validate = function() {
...
fsparepart_moduleadd.Form_CustomValidate = 
...
fsparepart_moduleadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $sparepart_module_add->ShowPageHeader(); ?>
<?php
$sparepart_module_add->ShowMessage();
?>
<form name="fsparepart_moduleadd" id="fsparepart_moduleadd" class="<?php echo $sparepart_module_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sparepart_module_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sparepart_module_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="sparepart_module">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($sparepart_module_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($sparepart_module->part_name->Visible) { // part_name ?>
	<div id="r_part_name" class="form-group">
		<label id="elh_sparepart_module_part_name" for="x_part_name" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->part_name->FldCaption() ?></label>
		<div class="<?php echo $sparepart_module_add->RightColumnClass ?>"><div<?php echo $sparepart_module->part_name->CellAttributes() ?>>
...
<?php if ($sparepart_module->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_sparepart_module_quantity" for="x_quantity" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->quantity->FldCaption() ?></label>
		<div class="<?php echo $sparepart_module_add->RightColumnClass ?>"><div<?php echo $sparepart_module->quantity->CellAttributes() ?>>
...
<?php if ($sparepart_module->cost->Visible) { // cost ?>
	<div id="r_cost" class="form-group">
		<label id="elh_sparepart_module_cost" for="x_cost" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->cost->FldCaption() ?></label>
		<div class="<?php echo $sparepart_module_add->RightColumnClass ?>"><div<?php echo $sparepart_module->cost->CellAttributes() ?>>
...
<?php if ($sparepart_module->gen_maintenance->Visible) { // gen_maintenance ?>
	<div id="r_gen_maintenance" class="form-group">
		<label id="elh_sparepart_module_gen_maintenance" for="x_gen_maintenance" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->gen_maintenance->FldCaption() ?></label>
		<div class="<?php echo $sparepart_module_add->RightColumnClass ?>"><div<?php echo $sparepart_module->gen_maintenance->CellAttributes() ?>>
...
<?php if (!$sparepart_module_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $sparepart_module_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $sparepart_module_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fsparepart_moduleadd.Init();
</script>
<?php
$sparepart_module_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sparepart_module_add->Page_Terminate();
?>
