...
<?php if ($sparepart_module->part_name->Visible) { // part_name ?>
	<div id="r_part_name" class="form-group">
		<label id="elh_sparepart_module_part_name" for="x_part_name" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->part_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($sparepart_module->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_sparepart_module_quantity" for="x_quantity" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($sparepart_module->cost->Visible) { // cost ?>
	<div id="r_cost" class="form-group">
		<label id="elh_sparepart_module_cost" for="x_cost" class="<?php echo $sparepart_module_add->LeftColumnClass ?>"><?php echo $sparepart_module->cost->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
