...
$sparepart_module = NULL;

//
// Table class for sparepart_module
//
class csparepart_module extends cTable {
	var $id;
	var $part_name;
	var $quantity;
	var $cost;
	...
	function __construct() {
		...
		$this->TableVar = 'sparepart_module';
		$this->TableName = 'sparepart_module';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`sparepart_module`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('sparepart_module', 'sparepart_module', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// part_name
		$this->part_name = new cField('sparepart_module', 'sparepart_module', 'x_part_name', 'part_name', '`part_name`', '`part_name`', 200, -1, FALSE, '`part_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->part_name->Sortable = TRUE; // Allow sort
		$this->fields['part_name'] = &$this->part_name;

		// quantity
		$this->quantity = new cField('sparepart_module', 'sparepart_module', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 200, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->fields['quantity'] = &$this->quantity;

		// cost
		$this->cost = new cField('sparepart_module', 'sparepart_module', 'x_cost', 'cost', '`cost`', '`cost`', 131, -1, FALSE, '`cost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`sparepart_module`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "sparepart_modulelist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "sparepart_moduleedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "sparepart_moduleadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("sparepart_moduleview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("sparepart_moduleview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "sparepart_moduleadd.php?" . $this->UrlParm($parm);
		else
			$url = "sparepart_moduleadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("sparepart_moduleedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("sparepart_moduleadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("sparepart_moduledelete.php", $this->UrlParm());
	}
