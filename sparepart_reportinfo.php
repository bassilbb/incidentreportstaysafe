...
class csparepart_report extends cTable {
	...
	function __construct() {
		...
		// part_name
		$this->part_name = new cField('sparepart_report', 'sparepart_report', 'x_part_name', 'part_name', '`part_name`', '`part_name`', 200, -1, FALSE, '`part_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// maintenance_id
		$this->maintenance_id = new cField('sparepart_report', 'sparepart_report', 'x_maintenance_id', 'maintenance_id', '`maintenance_id`', '`maintenance_id`', 3, -1, FALSE, '`maintenance_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
