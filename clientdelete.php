...
<?php if ($client->client_id->Visible) { // client_id ?>
		<th class="<?php echo $client->client_id->HeaderCellClass() ?>"><span id="elh_client_client_id" class="client_client_id"><?php echo $client->client_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($client->client_name->Visible) { // client_name ?>
		<th class="<?php echo $client->client_name->HeaderCellClass() ?>"><span id="elh_client_client_name" class="client_client_name"><?php echo $client->client_name->FldCaption() ?></span></th>
<?php } ?>
<?php if ($client->group_id->Visible) { // group_id ?>
		<th class="<?php echo $client->group_id->HeaderCellClass() ?>"><span id="elh_client_group_id" class="client_group_id"><?php echo $client->group_id->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($client->client_id->Visible) { // client_id ?>
		<td<?php echo $client->client_id->CellAttributes() ?>>
<span id="el<?php echo $client_delete->RowCnt ?>_client_client_id" class="client_client_id">
...
<?php } ?>
<?php if ($client->client_name->Visible) { // client_name ?>
		<td<?php echo $client->client_name->CellAttributes() ?>>
<span id="el<?php echo $client_delete->RowCnt ?>_client_client_name" class="client_client_name">
...
<?php } ?>
<?php if ($client->group_id->Visible) { // group_id ?>
		<td<?php echo $client->group_id->CellAttributes() ?>>
<span id="el<?php echo $client_delete->RowCnt ?>_client_group_id" class="client_group_id">
