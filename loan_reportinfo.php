...
//
// Table class for loan_report
//
class cloan_report extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'loan_report';
		$this->TableName = 'loan_report';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`loan_report`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// code
		$this->code = new cField('loan_report', 'loan_report', 'x_code', 'code', '`code`', '`code`', 3, -1, FALSE, '`code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->code->Sortable = TRUE; // Allow sort
		$this->code->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['code'] = &$this->code;

		// date_initiated
		$this->date_initiated = new cField('loan_report', 'loan_report', 'x_date_initiated', 'date_initiated', '`date_initiated`', ew_CastDateFieldForLike('`date_initiated`', 0, "DB"), 133, 0, FALSE, '`date_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// refernce_id
		$this->refernce_id = new cField('loan_report', 'loan_report', 'x_refernce_id', 'refernce_id', '`refernce_id`', '`refernce_id`', 200, -1, FALSE, '`refernce_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->refernce_id->Sortable = TRUE; // Allow sort
		$this->fields['refernce_id'] = &$this->refernce_id;

		// employee_name
		$this->employee_name = new cField('loan_report', 'loan_report', 'x_employee_name', 'employee_name', '`employee_name`', '`employee_name`', 200, -1, FALSE, '`employee_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->employee_name->Sortable = TRUE; // Allow sort
		$this->fields['employee_name'] = &$this->employee_name;

		// address
		$this->address = new cField('loan_report', 'loan_report', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// mobile
		$this->mobile = new cField('loan_report', 'loan_report', 'x_mobile', 'mobile', '`mobile`', '`mobile`', 200, -1, FALSE, '`mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->mobile->Sortable = TRUE; // Allow sort
		$this->fields['mobile'] = &$this->mobile;

		// department
		$this->department = new cField('loan_report', 'loan_report', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// loan_amount
		$this->loan_amount = new cField('loan_report', 'loan_report', 'x_loan_amount', 'loan_amount', '`loan_amount`', '`loan_amount`', 131, -1, FALSE, '`loan_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// amount_inwords
		$this->amount_inwords = new cField('loan_report', 'loan_report', 'x_amount_inwords', 'amount_inwords', '`amount_inwords`', '`amount_inwords`', 200, -1, FALSE, '`amount_inwords`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->amount_inwords->Sortable = TRUE; // Allow sort
		$this->fields['amount_inwords'] = &$this->amount_inwords;

		// purpose
		$this->purpose = new cField('loan_report', 'loan_report', 'x_purpose', 'purpose', '`purpose`', '`purpose`', 201, -1, FALSE, '`purpose`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->purpose->Sortable = TRUE; // Allow sort
		$this->fields['purpose'] = &$this->purpose;

		// repayment_period
		$this->repayment_period = new cField('loan_report', 'loan_report', 'x_repayment_period', 'repayment_period', '`repayment_period`', '`repayment_period`', 200, -1, FALSE, '`repayment_period`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// salary_permonth
		$this->salary_permonth = new cField('loan_report', 'loan_report', 'x_salary_permonth', 'salary_permonth', '`salary_permonth`', '`salary_permonth`', 131, -1, FALSE, '`salary_permonth`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// previous_loan
		$this->previous_loan = new cField('loan_report', 'loan_report', 'x_previous_loan', 'previous_loan', '`previous_loan`', '`previous_loan`', 131, -1, FALSE, '`previous_loan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date_collected
		$this->date_collected = new cField('loan_report', 'loan_report', 'x_date_collected', 'date_collected', '`date_collected`', ew_CastDateFieldForLike('`date_collected`', 0, "DB"), 135, 0, FALSE, '`date_collected`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// date_liquidated
		$this->date_liquidated = new cField('loan_report', 'loan_report', 'x_date_liquidated', 'date_liquidated', '`date_liquidated`', ew_CastDateFieldForLike('`date_liquidated`', 0, "DB"), 135, 0, FALSE, '`date_liquidated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// balance_remaining
		$this->balance_remaining = new cField('loan_report', 'loan_report', 'x_balance_remaining', 'balance_remaining', '`balance_remaining`', '`balance_remaining`', 131, -1, FALSE, '`balance_remaining`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// applicant_date
		$this->applicant_date = new cField('loan_report', 'loan_report', 'x_applicant_date', 'applicant_date', '`applicant_date`', ew_CastDateFieldForLike('`applicant_date`', 14, "DB"), 135, 14, FALSE, '`applicant_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// applicant_passport
		$this->applicant_passport = new cField('loan_report', 'loan_report', 'x_applicant_passport', 'applicant_passport', '`applicant_passport`', '`applicant_passport`', 201, -1, TRUE, '`applicant_passport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->applicant_passport->Sortable = TRUE; // Allow sort
		$this->fields['applicant_passport'] = &$this->applicant_passport;

		// guarantor_name
		$this->guarantor_name = new cField('loan_report', 'loan_report', 'x_guarantor_name', 'guarantor_name', '`guarantor_name`', '`guarantor_name`', 200, -1, FALSE, '`guarantor_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->guarantor_name->Sortable = TRUE; // Allow sort
		$this->fields['guarantor_name'] = &$this->guarantor_name;

		// guarantor_address
		$this->guarantor_address = new cField('loan_report', 'loan_report', 'x_guarantor_address', 'guarantor_address', '`guarantor_address`', '`guarantor_address`', 200, -1, FALSE, '`guarantor_address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->guarantor_address->Sortable = TRUE; // Allow sort
		$this->fields['guarantor_address'] = &$this->guarantor_address;

		// guarantor_mobile
		$this->guarantor_mobile = new cField('loan_report', 'loan_report', 'x_guarantor_mobile', 'guarantor_mobile', '`guarantor_mobile`', '`guarantor_mobile`', 200, -1, FALSE, '`guarantor_mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->guarantor_mobile->Sortable = TRUE; // Allow sort
		$this->fields['guarantor_mobile'] = &$this->guarantor_mobile;

		// guarantor_department
		$this->guarantor_department = new cField('loan_report', 'loan_report', 'x_guarantor_department', 'guarantor_department', '`guarantor_department`', '`guarantor_department`', 3, -1, FALSE, '`guarantor_department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// account_no
		$this->account_no = new cField('loan_report', 'loan_report', 'x_account_no', 'account_no', '`account_no`', '`account_no`', 200, -1, FALSE, '`account_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->account_no->Sortable = TRUE; // Allow sort
		$this->fields['account_no'] = &$this->account_no;

		// bank_name
		$this->bank_name = new cField('loan_report', 'loan_report', 'x_bank_name', 'bank_name', '`bank_name`', '`bank_name`', 3, -1, FALSE, '`bank_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// employers_name
		$this->employers_name = new cField('loan_report', 'loan_report', 'x_employers_name', 'employers_name', '`employers_name`', '`employers_name`', 200, -1, FALSE, '`employers_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->employers_name->Sortable = TRUE; // Allow sort
		$this->fields['employers_name'] = &$this->employers_name;

		// employers_address
		$this->employers_address = new cField('loan_report', 'loan_report', 'x_employers_address', 'employers_address', '`employers_address`', '`employers_address`', 200, -1, FALSE, '`employers_address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->employers_address->Sortable = TRUE; // Allow sort
		$this->fields['employers_address'] = &$this->employers_address;

		// employers_mobile
		$this->employers_mobile = new cField('loan_report', 'loan_report', 'x_employers_mobile', 'employers_mobile', '`employers_mobile`', '`employers_mobile`', 200, -1, FALSE, '`employers_mobile`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->employers_mobile->Sortable = TRUE; // Allow sort
		$this->fields['employers_mobile'] = &$this->employers_mobile;

		// guarantor_date
		$this->guarantor_date = new cField('loan_report', 'loan_report', 'x_guarantor_date', 'guarantor_date', '`guarantor_date`', ew_CastDateFieldForLike('`guarantor_date`', 14, "DB"), 135, 14, FALSE, '`guarantor_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// guarantor_passport
		$this->guarantor_passport = new cField('loan_report', 'loan_report', 'x_guarantor_passport', 'guarantor_passport', '`guarantor_passport`', '`guarantor_passport`', 201, -1, TRUE, '`guarantor_passport`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->guarantor_passport->Sortable = TRUE; // Allow sort
		$this->fields['guarantor_passport'] = &$this->guarantor_passport;

		// status
		$this->status = new cField('loan_report', 'loan_report', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->fields['status'] = &$this->status;

		// initiator_action
		$this->initiator_action = new cField('loan_report', 'loan_report', 'x_initiator_action', 'initiator_action', '`initiator_action`', '`initiator_action`', 3, -1, FALSE, '`initiator_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// initiator_comment
		$this->initiator_comment = new cField('loan_report', 'loan_report', 'x_initiator_comment', 'initiator_comment', '`initiator_comment`', '`initiator_comment`', 200, -1, FALSE, '`initiator_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->initiator_comment->Sortable = TRUE; // Allow sort
		$this->fields['initiator_comment'] = &$this->initiator_comment;

		// recommended_date
		$this->recommended_date = new cField('loan_report', 'loan_report', 'x_recommended_date', 'recommended_date', '`recommended_date`', ew_CastDateFieldForLike('`recommended_date`', 14, "DB"), 135, 14, FALSE, '`recommended_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// document_checklist
		$this->document_checklist = new cField('loan_report', 'loan_report', 'x_document_checklist', 'document_checklist', '`document_checklist`', '`document_checklist`', 200, -1, FALSE, '`document_checklist`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->document_checklist->Sortable = TRUE; // Allow sort
		$this->fields['document_checklist'] = &$this->document_checklist;

		// recommender_action
		$this->recommender_action = new cField('loan_report', 'loan_report', 'x_recommender_action', 'recommender_action', '`recommender_action`', '`recommender_action`', 3, -1, FALSE, '`recommender_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// recommender_comment
		$this->recommender_comment = new cField('loan_report', 'loan_report', 'x_recommender_comment', 'recommender_comment', '`recommender_comment`', '`recommender_comment`', 200, -1, FALSE, '`recommender_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->recommender_comment->Sortable = TRUE; // Allow sort
		$this->fields['recommender_comment'] = &$this->recommender_comment;

		// recommended_by
		$this->recommended_by = new cField('loan_report', 'loan_report', 'x_recommended_by', 'recommended_by', '`recommended_by`', '`recommended_by`', 3, -1, FALSE, '`recommended_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->recommended_by->Sortable = TRUE; // Allow sort
		$this->fields['recommended_by'] = &$this->recommended_by;

		// application_status
		$this->application_status = new cField('loan_report', 'loan_report', 'x_application_status', 'application_status', '`application_status`', '`application_status`', 200, -1, FALSE, '`application_status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approved_amount
		$this->approved_amount = new cField('loan_report', 'loan_report', 'x_approved_amount', 'approved_amount', '`approved_amount`', '`approved_amount`', 131, -1, FALSE, '`approved_amount`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// duration_approved
		$this->duration_approved = new cField('loan_report', 'loan_report', 'x_duration_approved', 'duration_approved', '`duration_approved`', ew_CastDateFieldForLike('`duration_approved`', 0, "DB"), 133, 0, FALSE, '`duration_approved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// approval_date
		$this->approval_date = new cField('loan_report', 'loan_report', 'x_approval_date', 'approval_date', '`approval_date`', ew_CastDateFieldForLike('`approval_date`', 17, "DB"), 135, 17, FALSE, '`approval_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// approval_action
		$this->approval_action = new cField('loan_report', 'loan_report', 'x_approval_action', 'approval_action', '`approval_action`', '`approval_action`', 3, -1, FALSE, '`approval_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approval_comment
		$this->approval_comment = new cField('loan_report', 'loan_report', 'x_approval_comment', 'approval_comment', '`approval_comment`', '`approval_comment`', 200, -1, FALSE, '`approval_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->approval_comment->Sortable = TRUE; // Allow sort
		$this->fields['approval_comment'] = &$this->approval_comment;

		// approved_by
		$this->approved_by = new cField('loan_report', 'loan_report', 'x_approved_by', 'approved_by', '`approved_by`', '`approved_by`', 3, -1, FALSE, '`approved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`loan_report`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "loan_reportedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "loan_reportadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("loan_reportview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("loan_reportview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "loan_reportadd.php?" . $this->UrlParm($parm);
		else
			$url = "loan_reportadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("loan_reportedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("loan_reportadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("loan_reportdelete.php", $this->UrlParm());
	}
