...
class ccategory_add extends ccategory {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "categoryview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// code_id
		$this->code_id->SetDbValueDef($rsnew, $this->code_id->CurrentValue, NULL, FALSE);
...
fcategoryadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($category_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($category->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_category_description" for="x_description" class="<?php echo $category_add->LeftColumnClass ?>"><?php echo $category->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($category->code_id->Visible) { // code_id ?>
	<div id="r_code_id" class="form-group">
		<label id="elh_category_code_id" for="x_code_id" class="<?php echo $category_add->LeftColumnClass ?>"><?php echo $category->code_id->FldCaption() ?></label>
		<div class="<?php echo $category_add->RightColumnClass ?>"><div<?php echo $category->code_id->CellAttributes() ?>>
