...
<?php if ($inventory_store->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_inventory_store_approver_action" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->approver_action->FldCaption() ?></label>
...
<?php if ($inventory_store->approved_comment->Visible) { // approved_comment ?>
	<div id="r_approved_comment" class="form-group">
		<label id="elh_inventory_store_approved_comment" for="x_approved_comment" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->approved_comment->FldCaption() ?></label>
...
<?php if ($inventory_store->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_inventory_store_verified_action" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->verified_action->FldCaption() ?></label>
...
<?php if ($inventory_store->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_inventory_store_verified_comment" for="x_verified_comment" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->verified_comment->FldCaption() ?></label>
