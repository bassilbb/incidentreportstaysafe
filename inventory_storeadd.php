...
finventory_storeadd.Lists["x_treated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
finventory_storeadd.Lists["x_issued_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_storeadd.Lists["x_issued_action"].Options = <?php echo json_encode($inventory_store_add->issued_action->Options()) ?>;
finventory_storeadd.Lists["x_issued_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_storeadd.Lists["x_issued_by"].Data = "<?php echo $inventory_store_add->issued_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_storeadd.AutoSuggests["x_issued_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_store_add->issued_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_storeadd.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_storeadd.Lists["x_approver_action"].Options = <?php echo json_encode($inventory_store_add->approver_action->Options()) ?>;
finventory_storeadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_storeadd.Lists["x_approved_by"].Data = "<?php echo $inventory_store_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_storeadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_store_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_storeadd.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_storeadd.Lists["x_verified_action"].Options = <?php echo json_encode($inventory_store_add->verified_action->Options()) ?>;
finventory_storeadd.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_storeadd.Lists["x_verified_by"].Data = "<?php echo $inventory_store_add->verified_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_storeadd.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_store_add->verified_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_storeadd.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
finventory_storeadd.Lists["x_statuss"].Data = "<?php echo $inventory_store_add->statuss->LookupFilterQuery(FALSE, "add") ?>";
...
<?php if ($inventory_store->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label id="elh_inventory_store_issued_by" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->issued_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->issued_by->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
finventory_storeadd.CreateAutoSuggest({"id":"x_issued_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_inventory_store_issued_by">
...
<?php if ($inventory_store->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_inventory_store_approver_date" for="x_approver_date" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->approver_date->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->approver_date->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<?php if ($inventory_store->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_inventory_store_approver_action" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->approver_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->approver_action->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<?php if ($inventory_store->approved_comment->Visible) { // approved_comment ?>
	<div id="r_approved_comment" class="form-group">
		<label id="elh_inventory_store_approved_comment" for="x_approved_comment" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->approved_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->approved_comment->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<?php if ($inventory_store->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_inventory_store_approved_by" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->approved_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->approved_by->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
finventory_storeadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_inventory_store_approved_by">
...
<?php if ($inventory_store->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label id="elh_inventory_store_verified_date" for="x_verified_date" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->verified_date->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->verified_date->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<?php if ($inventory_store->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_inventory_store_verified_action" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->verified_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->verified_action->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<?php if ($inventory_store->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_inventory_store_verified_comment" for="x_verified_comment" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->verified_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->verified_comment->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<?php if ($inventory_store->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_inventory_store_verified_by" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->verified_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->verified_by->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
finventory_storeadd.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_inventory_store_verified_by">
...
<?php } ?>
<?php if ($inventory_store->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_inventory_store_statuss" for="x_statuss" class="<?php echo $inventory_store_add->LeftColumnClass ?>"><?php echo $inventory_store->statuss->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_add->RightColumnClass ?>"><div<?php echo $inventory_store->statuss->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
<span id="el_inventory_store_statuss">
<select data-table="inventory_store" data-field="x_statuss" data-page="1" data-value-separator="<?php echo $inventory_store->statuss->DisplayValueSeparatorAttribute() ?>" id="x_statuss" name="x_statuss"<?php echo $inventory_store->statuss->EditAttributes() ?>>
<?php echo $inventory_store->statuss->SelectOptionListHtml("x_statuss") ?>
</select>
</span>
<?php } else { ?>
<span id="el_inventory_store_statuss">
<span<?php echo $inventory_store->statuss->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $inventory_store->statuss->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="inventory_store" data-field="x_statuss" data-page="1" name="x_statuss" id="x_statuss" value="<?php echo ew_HtmlEncode($inventory_store->statuss->FormValue) ?>">
<?php } ?>
<?php echo $inventory_store->statuss->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
