...
$gen_maintenance_view = NULL; // Initialize page object first

class cgen_maintenance_view extends cgen_maintenance {
	...
	// Page object name
	var $PageObjName = 'gen_maintenance_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "gen_maintenancelist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "gen_maintenancelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($gen_maintenance_view)) $gen_maintenance_view = new cgen_maintenance_view();

// Page init
$gen_maintenance_view->Page_Init();

// Page main
$gen_maintenance_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$gen_maintenance_view->Page_Render();
?>
...
var CurrentForm = fgen_maintenanceview = new ew_Form("fgen_maintenanceview", "view");

// Form_CustomValidate event
fgen_maintenanceview.Form_CustomValidate = 
...
fgen_maintenanceview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fgen_maintenanceview.Lists["x_gen_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","x_kva",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fgen_maintenanceview.Lists["x_gen_name"].Data = "<?php echo $gen_maintenance_view->gen_name->LookupFilterQuery(FALSE, "view") ?>";
fgen_maintenanceview.Lists["x_maintenance_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"maintenance_type"};
fgen_maintenanceview.Lists["x_maintenance_type"].Data = "<?php echo $gen_maintenance_view->maintenance_type->LookupFilterQuery(FALSE, "view") ?>";
fgen_maintenanceview.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgen_maintenanceview.Lists["x_staff_id"].Data = "<?php echo $gen_maintenance_view->staff_id->LookupFilterQuery(FALSE, "view") ?>";
fgen_maintenanceview.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_status"};
fgen_maintenanceview.Lists["x_status"].Data = "<?php echo $gen_maintenance_view->status->LookupFilterQuery(FALSE, "view") ?>";
fgen_maintenanceview.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgen_maintenanceview.Lists["x_initiator_action"].Options = <?php echo json_encode($gen_maintenance_view->initiator_action->Options()) ?>;
fgen_maintenanceview.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgen_maintenanceview.Lists["x_approver_action"].Options = <?php echo json_encode($gen_maintenance_view->approver_action->Options()) ?>;
fgen_maintenanceview.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgen_maintenanceview.Lists["x_approved_by"].Data = "<?php echo $gen_maintenance_view->approved_by->LookupFilterQuery(FALSE, "view") ?>";
fgen_maintenanceview.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $gen_maintenance_view->approved_by->LookupFilterQuery(TRUE, "view"))) ?>;
...
<?php if ($gen_maintenance->Export == "") { ?>
<div class="ewToolbar">
<?php $gen_maintenance_view->ExportOptions->Render("body") ?>
<?php
	foreach ($gen_maintenance_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $gen_maintenance_view->ShowPageHeader(); ?>
<?php
$gen_maintenance_view->ShowMessage();
?>
<?php if (!$gen_maintenance_view->IsModal) { ?>
<?php if ($gen_maintenance->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($gen_maintenance_view->Pager)) $gen_maintenance_view->Pager = new cPrevNextPager($gen_maintenance_view->StartRec, $gen_maintenance_view->DisplayRecs, $gen_maintenance_view->TotalRecs, $gen_maintenance_view->AutoHidePager) ?>
<?php if ($gen_maintenance_view->Pager->RecordCount > 0 && $gen_maintenance_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($gen_maintenance_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $gen_maintenance_view->PageUrl() ?>start=<?php echo $gen_maintenance_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($gen_maintenance_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $gen_maintenance_view->PageUrl() ?>start=<?php echo $gen_maintenance_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $gen_maintenance_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($gen_maintenance_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $gen_maintenance_view->PageUrl() ?>start=<?php echo $gen_maintenance_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($gen_maintenance_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $gen_maintenance_view->PageUrl() ?>start=<?php echo $gen_maintenance_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $gen_maintenance_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fgen_maintenanceview" id="fgen_maintenanceview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($gen_maintenance_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $gen_maintenance_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="gen_maintenance">
<input type="hidden" name="modal" value="<?php echo intval($gen_maintenance_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($gen_maintenance->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_gen_maintenance_id"><?php echo $gen_maintenance->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $gen_maintenance->id->CellAttributes() ?>>
<span id="el_gen_maintenance_id" data-page="1">
<span<?php echo $gen_maintenance->id->ViewAttributes() ?>>
<?php echo $gen_maintenance->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->datetime->Visible) { // datetime ?>
	<tr id="r_datetime">
		<td class="col-sm-2"><span id="elh_gen_maintenance_datetime"><?php echo $gen_maintenance->datetime->FldCaption() ?></span></td>
		<td data-name="datetime"<?php echo $gen_maintenance->datetime->CellAttributes() ?>>
<span id="el_gen_maintenance_datetime" data-page="1">
<span<?php echo $gen_maintenance->datetime->ViewAttributes() ?>>
<?php echo $gen_maintenance->datetime->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<span id="el_gen_maintenance_gen_name" data-page="1">
<span<?php echo $gen_maintenance->gen_name->ViewAttributes() ?>>
<?php echo $gen_maintenance->gen_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->maintenance_type->Visible) { // maintenance_type ?>
	<tr id="r_maintenance_type">
		<td class="col-sm-2"><span id="elh_gen_maintenance_maintenance_type"><?php echo $gen_maintenance->maintenance_type->FldCaption() ?></span></td>
		<td data-name="maintenance_type"<?php echo $gen_maintenance->maintenance_type->CellAttributes() ?>>
<span id="el_gen_maintenance_maintenance_type" data-page="1">
<span<?php echo $gen_maintenance->maintenance_type->ViewAttributes() ?>>
<?php echo $gen_maintenance->maintenance_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->running_hours->Visible) { // running_hours ?>
	<tr id="r_running_hours">
		<td class="col-sm-2"><span id="elh_gen_maintenance_running_hours"><?php echo $gen_maintenance->running_hours->FldCaption() ?></span></td>
		<td data-name="running_hours"<?php echo $gen_maintenance->running_hours->CellAttributes() ?>>
<span id="el_gen_maintenance_running_hours" data-page="1">
<span<?php echo $gen_maintenance->running_hours->ViewAttributes() ?>>
<?php echo $gen_maintenance->running_hours->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->cost->Visible) { // cost ?>
	<tr id="r_cost">
		<td class="col-sm-2"><span id="elh_gen_maintenance_cost"><?php echo $gen_maintenance->cost->FldCaption() ?></span></td>
		<td data-name="cost"<?php echo $gen_maintenance->cost->CellAttributes() ?>>
<span id="el_gen_maintenance_cost" data-page="1">
<span<?php echo $gen_maintenance->cost->ViewAttributes() ?>>
<?php echo $gen_maintenance->cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->labour_fee->Visible) { // labour_fee ?>
	<tr id="r_labour_fee">
		<td class="col-sm-2"><span id="elh_gen_maintenance_labour_fee"><?php echo $gen_maintenance->labour_fee->FldCaption() ?></span></td>
		<td data-name="labour_fee"<?php echo $gen_maintenance->labour_fee->CellAttributes() ?>>
<span id="el_gen_maintenance_labour_fee" data-page="1">
<span<?php echo $gen_maintenance->labour_fee->ViewAttributes() ?>>
<?php echo $gen_maintenance->labour_fee->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->total->Visible) { // total ?>
	<tr id="r_total">
		<td class="col-sm-2"><span id="elh_gen_maintenance_total"><?php echo $gen_maintenance->total->FldCaption() ?></span></td>
		<td data-name="total"<?php echo $gen_maintenance->total->CellAttributes() ?>>
<span id="el_gen_maintenance_total" data-page="1">
<span<?php echo $gen_maintenance->total->ViewAttributes() ?>>
<?php echo $gen_maintenance->total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->staff_id->Visible) { // staff_id ?>
	<tr id="r_staff_id">
		<td class="col-sm-2"><span id="elh_gen_maintenance_staff_id"><?php echo $gen_maintenance->staff_id->FldCaption() ?></span></td>
		<td data-name="staff_id"<?php echo $gen_maintenance->staff_id->CellAttributes() ?>>
<span id="el_gen_maintenance_staff_id" data-page="1">
<span<?php echo $gen_maintenance->staff_id->ViewAttributes() ?>>
<?php echo $gen_maintenance->staff_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_gen_maintenance_status"><?php echo $gen_maintenance->status->FldCaption() ?></span></td>
		<td data-name="status"<?php echo $gen_maintenance->status->CellAttributes() ?>>
<span id="el_gen_maintenance_status" data-page="1">
<span<?php echo $gen_maintenance->status->ViewAttributes() ?>>
<?php echo $gen_maintenance->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->initiator_action->Visible) { // initiator_action ?>
	<tr id="r_initiator_action">
		<td class="col-sm-2"><span id="elh_gen_maintenance_initiator_action"><?php echo $gen_maintenance->initiator_action->FldCaption() ?></span></td>
		<td data-name="initiator_action"<?php echo $gen_maintenance->initiator_action->CellAttributes() ?>>
<span id="el_gen_maintenance_initiator_action" data-page="1">
<span<?php echo $gen_maintenance->initiator_action->ViewAttributes() ?>>
<?php echo $gen_maintenance->initiator_action->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->initiator_comment->Visible) { // initiator_comment ?>
	<tr id="r_initiator_comment">
		<td class="col-sm-2"><span id="elh_gen_maintenance_initiator_comment"><?php echo $gen_maintenance->initiator_comment->FldCaption() ?></span></td>
		<td data-name="initiator_comment"<?php echo $gen_maintenance->initiator_comment->CellAttributes() ?>>
<span id="el_gen_maintenance_initiator_comment" data-page="1">
<span<?php echo $gen_maintenance->initiator_comment->ViewAttributes() ?>>
<?php echo $gen_maintenance->initiator_comment->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->approver_date->Visible) { // approver_date ?>
	<tr id="r_approver_date">
		<td class="col-sm-2"><span id="elh_gen_maintenance_approver_date"><?php echo $gen_maintenance->approver_date->FldCaption() ?></span></td>
		<td data-name="approver_date"<?php echo $gen_maintenance->approver_date->CellAttributes() ?>>
<span id="el_gen_maintenance_approver_date" data-page="1">
<span<?php echo $gen_maintenance->approver_date->ViewAttributes() ?>>
<?php echo $gen_maintenance->approver_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->approver_action->Visible) { // approver_action ?>
	<tr id="r_approver_action">
		<td class="col-sm-2"><span id="elh_gen_maintenance_approver_action"><?php echo $gen_maintenance->approver_action->FldCaption() ?></span></td>
		<td data-name="approver_action"<?php echo $gen_maintenance->approver_action->CellAttributes() ?>>
<span id="el_gen_maintenance_approver_action" data-page="1">
<span<?php echo $gen_maintenance->approver_action->ViewAttributes() ?>>
<?php echo $gen_maintenance->approver_action->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->approver_comment->Visible) { // approver_comment ?>
	<tr id="r_approver_comment">
		<td class="col-sm-2"><span id="elh_gen_maintenance_approver_comment"><?php echo $gen_maintenance->approver_comment->FldCaption() ?></span></td>
		<td data-name="approver_comment"<?php echo $gen_maintenance->approver_comment->CellAttributes() ?>>
<span id="el_gen_maintenance_approver_comment" data-page="1">
<span<?php echo $gen_maintenance->approver_comment->ViewAttributes() ?>>
<?php echo $gen_maintenance->approver_comment->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gen_maintenance->approved_by->Visible) { // approved_by ?>
	<tr id="r_approved_by">
		<td class="col-sm-2"><span id="elh_gen_maintenance_approved_by"><?php echo $gen_maintenance->approved_by->FldCaption() ?></span></td>
		<td data-name="approved_by"<?php echo $gen_maintenance->approved_by->CellAttributes() ?>>
<span id="el_gen_maintenance_approved_by" data-page="1">
<span<?php echo $gen_maintenance->approved_by->ViewAttributes() ?>>
<?php echo $gen_maintenance->approved_by->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($gen_maintenance->Export == "") { ?>
<script type="text/javascript">
fgen_maintenanceview.Init();
</script>
<?php } ?>
<?php
$gen_maintenance_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($gen_maintenance->Export == "") { ?>
...
<?php
$gen_maintenance_view->Page_Terminate();
?>
