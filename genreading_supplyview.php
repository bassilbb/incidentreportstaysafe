...
$genreading_supply_view = NULL; // Initialize page object first

class cgenreading_supply_view extends cgenreading_supply {
	...
	// Page object name
	var $PageObjName = 'genreading_supply_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "genreading_supplylist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "genreading_supplylist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($genreading_supply_view)) $genreading_supply_view = new cgenreading_supply_view();

// Page init
$genreading_supply_view->Page_Init();

// Page main
$genreading_supply_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$genreading_supply_view->Page_Render();
?>
...
var CurrentForm = fgenreading_supplyview = new ew_Form("fgenreading_supplyview", "view");

// Form_CustomValidate event
fgenreading_supplyview.Form_CustomValidate = 
...
fgenreading_supplyview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fgenreading_supplyview.Lists["x_gen_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fgenreading_supplyview.Lists["x_gen_type"].Data = "<?php echo $genreading_supply_view->gen_type->LookupFilterQuery(FALSE, "view") ?>";
fgenreading_supplyview.Lists["x_category"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_category"};
fgenreading_supplyview.Lists["x_category"].Data = "<?php echo $genreading_supply_view->category->LookupFilterQuery(FALSE, "view") ?>";
fgenreading_supplyview.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"supply_status"};
fgenreading_supplyview.Lists["x_status"].Data = "<?php echo $genreading_supply_view->status->LookupFilterQuery(FALSE, "view") ?>";
fgenreading_supplyview.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgenreading_supplyview.Lists["x_initiator_action"].Options = <?php echo json_encode($genreading_supply_view->initiator_action->Options()) ?>;
fgenreading_supplyview.Lists["x_initiated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgenreading_supplyview.Lists["x_initiated_by"].Data = "<?php echo $genreading_supply_view->initiated_by->LookupFilterQuery(FALSE, "view") ?>";
fgenreading_supplyview.AutoSuggests["x_initiated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $genreading_supply_view->initiated_by->LookupFilterQuery(TRUE, "view"))) ?>;
...
<?php if ($genreading_supply->Export == "") { ?>
<div class="ewToolbar">
<?php $genreading_supply_view->ExportOptions->Render("body") ?>
<?php
	foreach ($genreading_supply_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $genreading_supply_view->ShowPageHeader(); ?>
<?php
$genreading_supply_view->ShowMessage();
?>
<?php if (!$genreading_supply_view->IsModal) { ?>
<?php if ($genreading_supply->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($genreading_supply_view->Pager)) $genreading_supply_view->Pager = new cPrevNextPager($genreading_supply_view->StartRec, $genreading_supply_view->DisplayRecs, $genreading_supply_view->TotalRecs, $genreading_supply_view->AutoHidePager) ?>
<?php if ($genreading_supply_view->Pager->RecordCount > 0 && $genreading_supply_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($genreading_supply_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $genreading_supply_view->PageUrl() ?>start=<?php echo $genreading_supply_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($genreading_supply_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $genreading_supply_view->PageUrl() ?>start=<?php echo $genreading_supply_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $genreading_supply_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($genreading_supply_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $genreading_supply_view->PageUrl() ?>start=<?php echo $genreading_supply_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($genreading_supply_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $genreading_supply_view->PageUrl() ?>start=<?php echo $genreading_supply_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $genreading_supply_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fgenreading_supplyview" id="fgenreading_supplyview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($genreading_supply_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $genreading_supply_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="genreading_supply">
<input type="hidden" name="modal" value="<?php echo intval($genreading_supply_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($genreading_supply->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_genreading_supply_id"><?php echo $genreading_supply->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $genreading_supply->id->CellAttributes() ?>>
<span id="el_genreading_supply_id">
<span<?php echo $genreading_supply->id->ViewAttributes() ?>>
<?php echo $genreading_supply->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->date_initiated->Visible) { // date_initiated ?>
	<tr id="r_date_initiated">
		<td class="col-sm-2"><span id="elh_genreading_supply_date_initiated"><?php echo $genreading_supply->date_initiated->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->date_initiated->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->gen_type->Visible) { // gen_type ?>
	<tr id="r_gen_type">
		<td class="col-sm-2"><span id="elh_genreading_supply_gen_type"><?php echo $genreading_supply->gen_type->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->gen_type->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->category->Visible) { // category ?>
	<tr id="r_category">
		<td class="col-sm-2"><span id="elh_genreading_supply_category"><?php echo $genreading_supply->category->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->category->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->gen_reading->Visible) { // gen_reading ?>
	<tr id="r_gen_reading">
		<td class="col-sm-2"><span id="elh_genreading_supply_gen_reading"><?php echo $genreading_supply->gen_reading->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->gen_reading->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->diesel_initia_qty->Visible) { // diesel_initia_qty ?>
	<tr id="r_diesel_initia_qty">
		<td class="col-sm-2"><span id="elh_genreading_supply_diesel_initia_qty"><?php echo $genreading_supply->diesel_initia_qty->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->diesel_initia_qty->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->diesel_new_qty->Visible) { // diesel_new_qty ?>
	<tr id="r_diesel_new_qty">
		<td class="col-sm-2"><span id="elh_genreading_supply_diesel_new_qty"><?php echo $genreading_supply->diesel_new_qty->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->diesel_new_qty->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->total->Visible) { // total ?>
	<tr id="r_total">
		<td class="col-sm-2"><span id="elh_genreading_supply_total"><?php echo $genreading_supply->total->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_genreading_supply_status"><?php echo $genreading_supply->status->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->initiator_action->Visible) { // initiator_action ?>
	<tr id="r_initiator_action">
		<td class="col-sm-2"><span id="elh_genreading_supply_initiator_action"><?php echo $genreading_supply->initiator_action->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->initiator_action->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->initiator_comment->Visible) { // initiator_comment ?>
	<tr id="r_initiator_comment">
		<td class="col-sm-2"><span id="elh_genreading_supply_initiator_comment"><?php echo $genreading_supply->initiator_comment->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->initiator_comment->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($genreading_supply->initiated_by->Visible) { // initiated_by ?>
	<tr id="r_initiated_by">
		<td class="col-sm-2"><span id="elh_genreading_supply_initiated_by"><?php echo $genreading_supply->initiated_by->FldCaption() ?></span></td>
...
<?php echo $genreading_supply->initiated_by->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($genreading_supply->Export == "") { ?>
<script type="text/javascript">
fgenreading_supplyview.Init();
</script>
<?php } ?>
<?php
$genreading_supply_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($genreading_supply->Export == "") { ?>
...
<?php
$genreading_supply_view->Page_Terminate();
?>
