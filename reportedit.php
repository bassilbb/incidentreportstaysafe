...
class creport_edit extends creport {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// datetime_initiated
			$this->datetime_initiated->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->datetime_initiated->CurrentValue, 7), ew_CurrentDate(), $this->datetime_initiated->ReadOnly);
