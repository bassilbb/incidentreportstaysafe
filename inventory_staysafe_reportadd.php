...
$inventory_staysafe_report_add = NULL; // Initialize page object first

class cinventory_staysafe_report_add extends cinventory_staysafe_report {
	...
	// Page object name
	var $PageObjName = 'inventory_staysafe_report_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("inventory_staysafe_reportlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "inventory_staysafe_reportview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// date_recieved
		$this->date_recieved->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_recieved->CurrentValue, 0), NULL, FALSE);
		...
		// date_approved
		$this->date_approved->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_approved->CurrentValue, 0), NULL, FALSE);
...
// Create page object
if (!isset($inventory_staysafe_report_add)) $inventory_staysafe_report_add = new cinventory_staysafe_report_add();

// Page init
$inventory_staysafe_report_add->Page_Init();

// Page main
$inventory_staysafe_report_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$inventory_staysafe_report_add->Page_Render();
?>
...
var CurrentForm = finventory_staysafe_reportadd = new ew_Form("finventory_staysafe_reportadd", "add");

// Validate form
finventory_staysafe_reportadd.Validate = function() {
...
finventory_staysafe_reportadd.Form_CustomValidate = 
...
finventory_staysafe_reportadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
finventory_staysafe_reportadd.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory_staysafe"};
finventory_staysafe_reportadd.Lists["x_material_name"].Data = "<?php echo $inventory_staysafe_report_add->material_name->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafe_reportadd.AutoSuggests["x_material_name"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_report_add->material_name->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_staysafe_reportadd.Lists["x_recieved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafe_reportadd.Lists["x_recieved_by"].Data = "<?php echo $inventory_staysafe_report_add->recieved_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafe_reportadd.AutoSuggests["x_recieved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_report_add->recieved_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_staysafe_reportadd.Lists["x_recieved_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_staysafe_reportadd.Lists["x_recieved_action"].Options = <?php echo json_encode($inventory_staysafe_report_add->recieved_action->Options()) ?>;
finventory_staysafe_reportadd.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_staysafe_reportadd.Lists["x_approver_action"].Options = <?php echo json_encode($inventory_staysafe_report_add->approver_action->Options()) ?>;
finventory_staysafe_reportadd.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
finventory_staysafe_reportadd.Lists["x_statuss"].Data = "<?php echo $inventory_staysafe_report_add->statuss->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafe_reportadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafe_reportadd.Lists["x_approved_by"].Data = "<?php echo $inventory_staysafe_report_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafe_reportadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_report_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
finventory_staysafe_reportadd.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
finventory_staysafe_reportadd.Lists["x_verified_action"].Options = <?php echo json_encode($inventory_staysafe_report_add->verified_action->Options()) ?>;
finventory_staysafe_reportadd.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
finventory_staysafe_reportadd.Lists["x_verified_by"].Data = "<?php echo $inventory_staysafe_report_add->verified_by->LookupFilterQuery(FALSE, "add") ?>";
finventory_staysafe_reportadd.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $inventory_staysafe_report_add->verified_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $inventory_staysafe_report_add->ShowPageHeader(); ?>
<?php
$inventory_staysafe_report_add->ShowMessage();
?>
<form name="finventory_staysafe_reportadd" id="finventory_staysafe_reportadd" class="<?php echo $inventory_staysafe_report_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($inventory_staysafe_report_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $inventory_staysafe_report_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="inventory_staysafe_report">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($inventory_staysafe_report_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($inventory_staysafe_report->date_recieved->Visible) { // date_recieved ?>
	<div id="r_date_recieved" class="form-group">
		<label id="elh_inventory_staysafe_report_date_recieved" for="x_date_recieved" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->date_recieved->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->date_recieved->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("finventory_staysafe_reportadd", "x_date_recieved", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($inventory_staysafe_report->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_inventory_staysafe_report_reference_id" for="x_reference_id" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->reference_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->reference_id->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_inventory_staysafe_report_material_name" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->material_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->material_name->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafe_reportadd.CreateAutoSuggest({"id":"x_material_name","forceSelect":false});
</script>
</span>
...
<?php if ($inventory_staysafe_report->type->Visible) { // type ?>
	<div id="r_type" class="form-group">
		<label id="elh_inventory_staysafe_report_type" for="x_type" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->type->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->capacity->Visible) { // capacity ?>
	<div id="r_capacity" class="form-group">
		<label id="elh_inventory_staysafe_report_capacity" for="x_capacity" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->capacity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->capacity->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_inventory_staysafe_report_quantity" for="x_quantity" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->quantity->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->recieved_by->Visible) { // recieved_by ?>
	<div id="r_recieved_by" class="form-group">
		<label id="elh_inventory_staysafe_report_recieved_by" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->recieved_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->recieved_by->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafe_reportadd.CreateAutoSuggest({"id":"x_recieved_by","forceSelect":false});
</script>
...
<?php if ($inventory_staysafe_report->recieved_action->Visible) { // recieved_action ?>
	<div id="r_recieved_action" class="form-group">
		<label id="elh_inventory_staysafe_report_recieved_action" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->recieved_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->recieved_action->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->recieved_comment->Visible) { // recieved_comment ?>
	<div id="r_recieved_comment" class="form-group">
		<label id="elh_inventory_staysafe_report_recieved_comment" for="x_recieved_comment" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->recieved_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->recieved_comment->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->date_approved->Visible) { // date_approved ?>
	<div id="r_date_approved" class="form-group">
		<label id="elh_inventory_staysafe_report_date_approved" for="x_date_approved" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->date_approved->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->date_approved->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_inventory_staysafe_report_approver_action" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->approver_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->approver_action->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label id="elh_inventory_staysafe_report_approver_comment" for="x_approver_comment" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->approver_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->approver_comment->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_inventory_staysafe_report_statuss" for="x_statuss" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->statuss->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->statuss->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_inventory_staysafe_report_approved_by" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->approved_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->approved_by->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafe_reportadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
...
<?php if ($inventory_staysafe_report->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label id="elh_inventory_staysafe_report_verified_date" for="x_verified_date" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->verified_date->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->verified_date->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_inventory_staysafe_report_verified_action" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->verified_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->verified_action->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_inventory_staysafe_report_verified_comment" for="x_verified_comment" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->verified_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->verified_comment->CellAttributes() ?>>
...
<?php if ($inventory_staysafe_report->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_inventory_staysafe_report_verified_by" class="<?php echo $inventory_staysafe_report_add->LeftColumnClass ?>"><?php echo $inventory_staysafe_report->verified_by->FldCaption() ?></label>
		<div class="<?php echo $inventory_staysafe_report_add->RightColumnClass ?>"><div<?php echo $inventory_staysafe_report->verified_by->CellAttributes() ?>>
...
<script type="text/javascript">
finventory_staysafe_reportadd.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
...
<?php if (!$inventory_staysafe_report_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $inventory_staysafe_report_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $inventory_staysafe_report_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
finventory_staysafe_reportadd.Init();
</script>
<?php
$inventory_staysafe_report_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$inventory_staysafe_report_add->Page_Terminate();
?>
