...
class cloan_application extends cTable {
	...
	function __construct() {
		...
		// employee_name
		$this->employee_name = new cField('loan_application', 'loan_application', 'x_employee_name', 'employee_name', '`employee_name`', '`employee_name`', 200, -1, FALSE, '`employee_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->employee_name->Sortable = TRUE; // Allow sort
		$this->fields['employee_name'] = &$this->employee_name;

		// address
		$this->address = new cField('loan_application', 'loan_application', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// applicant_date
		$this->applicant_date = new cField('loan_application', 'loan_application', 'x_applicant_date', 'applicant_date', '`applicant_date`', ew_CastDateFieldForLike('`applicant_date`', 14, "DB"), 135, 14, FALSE, '`applicant_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// guarantor_date
		$this->guarantor_date = new cField('loan_application', 'loan_application', 'x_guarantor_date', 'guarantor_date', '`guarantor_date`', ew_CastDateFieldForLike('`guarantor_date`', 14, "DB"), 135, 14, FALSE, '`guarantor_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
