...
$report_add = NULL; // Initialize page object first

class creport_add extends creport {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("reportlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "reportview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// last_updated_date
		$this->last_updated_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->last_updated_date->CurrentValue, 0), ew_CurrentDate(), FALSE);
		...
		// verified_datetime
		$this->verified_datetime->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->verified_datetime->CurrentValue, 0), NULL, FALSE);
...
// Create page object
if (!isset($report_add)) $report_add = new creport_add();

// Page init
$report_add->Page_Init();

// Page main
$report_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$report_add->Page_Render();
?>
...
var CurrentForm = freportadd = new ew_Form("freportadd", "add");
...
freportadd.Form_CustomValidate = 
...
freportadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
freportadd.Lists["x_staffid"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_staffid"].Data = "<?php echo $report_add->staffid->LookupFilterQuery(FALSE, "add") ?>";
freportadd.AutoSuggests["x_staffid"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_add->staffid->LookupFilterQuery(TRUE, "add"))) ?>;
freportadd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_staff_id"].Data = "<?php echo $report_add->staff_id->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_department"] = {"LinkField":"x_department_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_department_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"depertment"};
freportadd.Lists["x_department"].Data = "<?php echo $report_add->department->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_branch"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_branch_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"branch"};
freportadd.Lists["x_branch"].Data = "<?php echo $report_add->branch->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_departments"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_category"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"departments"};
freportadd.Lists["x_departments"].Data = "<?php echo $report_add->departments->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_category"] = {"LinkField":"x_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_departments"],"ChildFields":["x_sub_category"],"FilterFields":["x_code_id"],"Options":[],"Template":"","LinkTable":"category"};
freportadd.Lists["x_category"].Data = "<?php echo $report_add->category->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":["x_category"],"ChildFields":["x_sub_sub_category[]"],"FilterFields":["x_category_id"],"Options":[],"Template":"","LinkTable":"sub_category"};
freportadd.Lists["x_sub_category"].Data = "<?php echo $report_add->sub_category->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_sub_sub_category[]"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_sub_category"],"ChildFields":[],"FilterFields":["x_sub_category_id"],"Options":[],"Template":"","LinkTable":"sub_sub_category"};
freportadd.Lists["x_sub_sub_category[]"].Data = "<?php echo $report_add->sub_sub_category->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_incident_type"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"type_of_incident"};
freportadd.Lists["x_incident_type"].Data = "<?php echo $report_add->incident_type->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_incident_category"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_category"};
freportadd.Lists["x_incident_category"].Data = "<?php echo $report_add->incident_category->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_incident_location"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_incident_sub_location"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
freportadd.Lists["x_incident_location"].Data = "<?php echo $report_add->incident_location->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_incident_sub_location"] = {"LinkField":"x_code_sub","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_incident_location"],"ChildFields":["x_incident_venue"],"FilterFields":["x_code_id"],"Options":[],"Template":"","LinkTable":"incident_sub_location"};
freportadd.Lists["x_incident_sub_location"].Data = "<?php echo $report_add->incident_sub_location->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_incident_venue"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_incident_sub_location"],"ChildFields":[],"FilterFields":["x_code_sub"],"Options":[],"Template":"","LinkTable":"incident_venue"};
freportadd.Lists["x_incident_venue"].Data = "<?php echo $report_add->incident_venue->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_status"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"status"};
freportadd.Lists["x_status"].Data = "<?php echo $report_add->status->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freportadd.Lists["x_initiator_action"].Options = <?php echo json_encode($report_add->initiator_action->Options()) ?>;
freportadd.Lists["x_report_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_report_by"].Data = "<?php echo $report_add->report_by->LookupFilterQuery(FALSE, "add") ?>";
freportadd.AutoSuggests["x_report_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_add->report_by->LookupFilterQuery(TRUE, "add"))) ?>;
freportadd.Lists["x_assign_task"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_assign_task"].Data = "<?php echo $report_add->assign_task->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_approval_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freportadd.Lists["x_approval_action"].Options = <?php echo json_encode($report_add->approval_action->Options()) ?>;
freportadd.Lists["x_reason"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"reason"};
freportadd.Lists["x_reason"].Data = "<?php echo $report_add->reason->LookupFilterQuery(FALSE, "add") ?>";
freportadd.Lists["x_resolved_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freportadd.Lists["x_resolved_action"].Options = <?php echo json_encode($report_add->resolved_action->Options()) ?>;
freportadd.Lists["x_resolved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_resolved_by"].Data = "<?php echo $report_add->resolved_by->LookupFilterQuery(FALSE, "add") ?>";
freportadd.AutoSuggests["x_resolved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_add->resolved_by->LookupFilterQuery(TRUE, "add"))) ?>;
freportadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_approved_by"].Data = "<?php echo $report_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
freportadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
freportadd.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freportadd.Lists["x_last_updated_by"].Data = "<?php echo $report_add->last_updated_by->LookupFilterQuery(FALSE, "add") ?>";
freportadd.AutoSuggests["x_last_updated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_add->last_updated_by->LookupFilterQuery(TRUE, "add"))) ?>;
freportadd.Lists["x_job_assessment"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freportadd.Lists["x_job_assessment"].Options = <?php echo json_encode($report_add->job_assessment->Options()) ?>;
...
<?php $report_add->ShowPageHeader(); ?>
<?php
$report_add->ShowMessage();
?>
<form name="freportadd" id="freportadd" class="<?php echo $report_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($report_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $report_add->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo intval($report_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($report->datetime_initiated->Visible) { // datetime_initiated ?>
	<div id="r_datetime_initiated" class="form-group">
		<label id="elh_report_datetime_initiated" for="x_datetime_initiated" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->datetime_initiated->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->datetime_initiated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freportadd", "x_datetime_initiated", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($report->incident_id->Visible) { // incident_id ?>
	<div id="r_incident_id" class="form-group">
		<label id="elh_report_incident_id" for="x_incident_id" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_id->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->staffid->Visible) { // staffid ?>
	<div id="r_staffid" class="form-group">
		<label id="elh_report_staffid" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->staffid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->staffid->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
freportadd.CreateAutoSuggest({"id":"x_staffid","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_report_staffid">
...
<?php if ($report->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_report_staff_id" for="x_staff_id" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->staff_id->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label id="elh_report_department" for="x_department" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->department->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->department->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->branch->Visible) { // branch ?>
	<div id="r_branch" class="form-group">
		<label id="elh_report_branch" for="x_branch" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->branch->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->branch->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->departments->Visible) { // departments ?>
	<div id="r_departments" class="form-group">
		<label id="elh_report_departments" for="x_departments" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->departments->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->departments->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->category->Visible) { // category ?>
	<div id="r_category" class="form-group">
		<label id="elh_report_category" for="x_category" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->category->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->category->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->sub_category->Visible) { // sub_category ?>
	<div id="r_sub_category" class="form-group">
		<label id="elh_report_sub_category" for="x_sub_category" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->sub_category->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->sub_category->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->sub_sub_category->Visible) { // sub_sub_category ?>
	<div id="r_sub_sub_category" class="form-group">
		<label id="elh_report_sub_sub_category" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->sub_sub_category->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->sub_sub_category->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->start_date->Visible) { // start_date ?>
	<div id="r_start_date" class="form-group">
		<label id="elh_report_start_date" for="x_start_date" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->start_date->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->start_date->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freportadd", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":2});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($report->end_date->Visible) { // end_date ?>
	<div id="r_end_date" class="form-group">
		<label id="elh_report_end_date" for="x_end_date" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->end_date->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->end_date->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freportadd", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":2});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($report->duration->Visible) { // duration ?>
	<div id="r_duration" class="form-group">
		<label id="elh_report_duration" for="x_duration" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->duration->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->duration->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->amount_paid->Visible) { // amount_paid ?>
	<div id="r_amount_paid" class="form-group">
		<label id="elh_report_amount_paid" for="x_amount_paid" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->amount_paid->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->amount_paid->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->no_of_people_involved->Visible) { // no_of_people_involved ?>
	<div id="r_no_of_people_involved" class="form-group">
		<label id="elh_report_no_of_people_involved" for="x_no_of_people_involved" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->no_of_people_involved->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->no_of_people_involved->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->incident_type->Visible) { // incident_type ?>
	<div id="r_incident_type" class="form-group">
		<label id="elh_report_incident_type" for="x_incident_type" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_type->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_type->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->incident_category->Visible) { // incident-category ?>
	<div id="r_incident_category" class="form-group">
		<label id="elh_report_incident_category" for="x_incident_category" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_category->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_category->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->incident_location->Visible) { // incident_location ?>
	<div id="r_incident_location" class="form-group">
		<label id="elh_report_incident_location" for="x_incident_location" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_location->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_location->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->incident_sub_location->Visible) { // incident_sub_location ?>
	<div id="r_incident_sub_location" class="form-group">
		<label id="elh_report_incident_sub_location" for="x_incident_sub_location" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_sub_location->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_sub_location->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->incident_venue->Visible) { // incident_venue ?>
	<div id="r_incident_venue" class="form-group">
		<label id="elh_report_incident_venue" for="x_incident_venue" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_venue->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_venue->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->incident_description->Visible) { // incident_description ?>
	<div id="r_incident_description" class="form-group">
		<label id="elh_report_incident_description" for="x_incident_description" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->incident_description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->incident_description->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->_upload->Visible) { // upload ?>
	<div id="r__upload" class="form-group">
		<label id="elh_report__upload" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->_upload->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->_upload->CellAttributes() ?>>
...
<?php if ($report->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_report_status" for="x_status" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->status->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_report_initiator_action" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->initiator_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->initiator_action->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_report_initiator_comment" for="x_initiator_comment" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->initiator_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->initiator_comment->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->report_by->Visible) { // report_by ?>
	<div id="r_report_by" class="form-group">
		<label id="elh_report_report_by" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->report_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->report_by->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
freportadd.CreateAutoSuggest({"id":"x_report_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_report_report_by">
...
<?php if ($report->datetime_resolved->Visible) { // datetime_resolved ?>
	<div id="r_datetime_resolved" class="form-group">
		<label id="elh_report_datetime_resolved" for="x_datetime_resolved" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->datetime_resolved->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->datetime_resolved->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->assign_task->Visible) { // assign_task ?>
	<div id="r_assign_task" class="form-group">
		<label id="elh_report_assign_task" for="x_assign_task" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->assign_task->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->assign_task->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->approval_action->Visible) { // approval_action ?>
	<div id="r_approval_action" class="form-group">
		<label id="elh_report_approval_action" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->approval_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->approval_action->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->approval_comment->Visible) { // approval_comment ?>
	<div id="r_approval_comment" class="form-group">
		<label id="elh_report_approval_comment" for="x_approval_comment" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->approval_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->approval_comment->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->reason->Visible) { // reason ?>
	<div id="r_reason" class="form-group">
		<label id="elh_report_reason" for="x_reason" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->reason->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->reason->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->resolved_action->Visible) { // resolved_action ?>
	<div id="r_resolved_action" class="form-group">
		<label id="elh_report_resolved_action" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->resolved_action->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->resolved_action->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->resolved_comment->Visible) { // resolved_comment ?>
	<div id="r_resolved_comment" class="form-group">
		<label id="elh_report_resolved_comment" for="x_resolved_comment" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->resolved_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->resolved_comment->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->resolved_by->Visible) { // resolved_by ?>
	<div id="r_resolved_by" class="form-group">
		<label id="elh_report_resolved_by" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->resolved_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->resolved_by->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
freportadd.CreateAutoSuggest({"id":"x_resolved_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_report_resolved_by">
...
<?php if ($report->datetime_approved->Visible) { // datetime_approved ?>
	<div id="r_datetime_approved" class="form-group">
		<label id="elh_report_datetime_approved" for="x_datetime_approved" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->datetime_approved->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->datetime_approved->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_report_approved_by" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->approved_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->approved_by->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
freportadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_report_approved_by">
...
<?php if ($report->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_report_verified_by" for="x_verified_by" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->verified_by->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->verified_by->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->last_updated_date->Visible) { // last_updated_date ?>
	<div id="r_last_updated_date" class="form-group">
		<label id="elh_report_last_updated_date" for="x_last_updated_date" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->last_updated_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->last_updated_date->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freportadd", "x_last_updated_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($report->last_updated_by->Visible) { // last_updated_by ?>
	<div id="r_last_updated_by" class="form-group">
		<label id="elh_report_last_updated_by" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->last_updated_by->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->last_updated_by->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
freportadd.CreateAutoSuggest({"id":"x_last_updated_by","forceSelect":false});
</script>
...
<?php if ($report->selection_sub_category->Visible) { // selection_sub_category ?>
	<div id="r_selection_sub_category" class="form-group">
		<label id="elh_report_selection_sub_category" for="x_selection_sub_category" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->selection_sub_category->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->selection_sub_category->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->verified_datetime->Visible) { // verified_datetime ?>
	<div id="r_verified_datetime" class="form-group">
		<label id="elh_report_verified_datetime" for="x_verified_datetime" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->verified_datetime->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->verified_datetime->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_report_verified_action" for="x_verified_action" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->verified_action->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->verified_action->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_report_verified_comment" for="x_verified_comment" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->verified_comment->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->verified_comment->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if ($report->job_assessment->Visible) { // job_assessment ?>
	<div id="r_job_assessment" class="form-group">
		<label id="elh_report_job_assessment" class="<?php echo $report_add->LeftColumnClass ?>"><?php echo $report->job_assessment->FldCaption() ?></label>
		<div class="<?php echo $report_add->RightColumnClass ?>"><div<?php echo $report->job_assessment->CellAttributes() ?>>
<?php if ($report->CurrentAction <> "F") { ?>
...
<?php if (!$report_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $report_add->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($report->CurrentAction <> "F") { // Confirm page ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $report_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
