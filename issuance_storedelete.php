...
$issuance_store_delete = NULL; // Initialize page object first

class cissuance_store_delete extends cissuance_store {
	...
	// Page object name
	var $PageObjName = 'issuance_store_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("issuance_storelist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in issuance_store class, issuance_storeinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("issuance_storelist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($issuance_store_delete)) $issuance_store_delete = new cissuance_store_delete();

// Page init
$issuance_store_delete->Page_Init();

// Page main
$issuance_store_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$issuance_store_delete->Page_Render();
?>
...
var CurrentForm = fissuance_storedelete = new ew_Form("fissuance_storedelete", "delete");

// Form_CustomValidate event
fissuance_storedelete.Form_CustomValidate = 
...
fissuance_storedelete.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_storedelete.Lists["x_verified_by"].Data = "<?php echo $issuance_store_delete->verified_by->LookupFilterQuery(FALSE, "delete") ?>";
fissuance_storedelete.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_store_delete->verified_by->LookupFilterQuery(TRUE, "delete"))) ?>;
fissuance_storedelete.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
fissuance_storedelete.Lists["x_statuss"].Data = "<?php echo $issuance_store_delete->statuss->LookupFilterQuery(FALSE, "delete") ?>";
...
<?php $issuance_store_delete->ShowPageHeader(); ?>
<?php
$issuance_store_delete->ShowMessage();
?>
<form name="fissuance_storedelete" id="fissuance_storedelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($issuance_store_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $issuance_store_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="issuance_store">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($issuance_store_delete->RecKeys as $key) { ?>
...
<?php if ($issuance_store->date->Visible) { // date ?>
		<th class="<?php echo $issuance_store->date->HeaderCellClass() ?>"><span id="elh_issuance_store_date" class="issuance_store_date"><?php echo $issuance_store->date->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($issuance_store->quantity_in->Visible) { // quantity_in ?>
		<th class="<?php echo $issuance_store->quantity_in->HeaderCellClass() ?>"><span id="elh_issuance_store_quantity_in" class="issuance_store_quantity_in"><?php echo $issuance_store->quantity_in->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->quantity_type->Visible) { // quantity_type ?>
		<th class="<?php echo $issuance_store->quantity_type->HeaderCellClass() ?>"><span id="elh_issuance_store_quantity_type" class="issuance_store_quantity_type"><?php echo $issuance_store->quantity_type->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->quantity_out->Visible) { // quantity_out ?>
		<th class="<?php echo $issuance_store->quantity_out->HeaderCellClass() ?>"><span id="elh_issuance_store_quantity_out" class="issuance_store_quantity_out"><?php echo $issuance_store->quantity_out->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->total_quantity->Visible) { // total_quantity ?>
		<th class="<?php echo $issuance_store->total_quantity->HeaderCellClass() ?>"><span id="elh_issuance_store_total_quantity" class="issuance_store_total_quantity"><?php echo $issuance_store->total_quantity->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->issued_comment->Visible) { // issued_comment ?>
		<th class="<?php echo $issuance_store->issued_comment->HeaderCellClass() ?>"><span id="elh_issuance_store_issued_comment" class="issuance_store_issued_comment"><?php echo $issuance_store->issued_comment->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->issued_by->Visible) { // issued_by ?>
		<th class="<?php echo $issuance_store->issued_by->HeaderCellClass() ?>"><span id="elh_issuance_store_issued_by" class="issuance_store_issued_by"><?php echo $issuance_store->issued_by->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->approved_comment->Visible) { // approved_comment ?>
		<th class="<?php echo $issuance_store->approved_comment->HeaderCellClass() ?>"><span id="elh_issuance_store_approved_comment" class="issuance_store_approved_comment"><?php echo $issuance_store->approved_comment->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->approved_by->Visible) { // approved_by ?>
		<th class="<?php echo $issuance_store->approved_by->HeaderCellClass() ?>"><span id="elh_issuance_store_approved_by" class="issuance_store_approved_by"><?php echo $issuance_store->approved_by->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->verified_comment->Visible) { // verified_comment ?>
		<th class="<?php echo $issuance_store->verified_comment->HeaderCellClass() ?>"><span id="elh_issuance_store_verified_comment" class="issuance_store_verified_comment"><?php echo $issuance_store->verified_comment->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->verified_by->Visible) { // verified_by ?>
		<th class="<?php echo $issuance_store->verified_by->HeaderCellClass() ?>"><span id="elh_issuance_store_verified_by" class="issuance_store_verified_by"><?php echo $issuance_store->verified_by->FldCaption() ?></span></th>
<?php } ?>
<?php if ($issuance_store->statuss->Visible) { // statuss ?>
		<th class="<?php echo $issuance_store->statuss->HeaderCellClass() ?>"><span id="elh_issuance_store_statuss" class="issuance_store_statuss"><?php echo $issuance_store->statuss->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$issuance_store_delete->RecCnt = 0;
$i = 0;
while (!$issuance_store_delete->Recordset->EOF) {
	$issuance_store_delete->RecCnt++;
	$issuance_store_delete->RowCnt++;

	// Set row properties
	$issuance_store->ResetAttrs();
	$issuance_store->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$issuance_store_delete->LoadRowValues($issuance_store_delete->Recordset);

	// Render row
	$issuance_store_delete->RenderRow();
?>
	<tr<?php echo $issuance_store->RowAttributes() ?>>
<?php if ($issuance_store->date->Visible) { // date ?>
		<td<?php echo $issuance_store->date->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_date" class="issuance_store_date">
...
<?php } ?>
<?php if ($issuance_store->reference_id->Visible) { // reference_id ?>
		<td<?php echo $issuance_store->reference_id->CellAttributes() ?>>
...
<?php } ?>
<?php if ($issuance_store->material_name->Visible) { // material_name ?>
		<td<?php echo $issuance_store->material_name->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_material_name" class="issuance_store_material_name">
...
<?php } ?>
<?php if ($issuance_store->quantity_in->Visible) { // quantity_in ?>
		<td<?php echo $issuance_store->quantity_in->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_quantity_in" class="issuance_store_quantity_in">
...
<?php } ?>
<?php if ($issuance_store->quantity_type->Visible) { // quantity_type ?>
		<td<?php echo $issuance_store->quantity_type->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_quantity_type" class="issuance_store_quantity_type">
...
<?php } ?>
<?php if ($issuance_store->quantity_out->Visible) { // quantity_out ?>
		<td<?php echo $issuance_store->quantity_out->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_quantity_out" class="issuance_store_quantity_out">
...
<?php } ?>
<?php if ($issuance_store->total_quantity->Visible) { // total_quantity ?>
		<td<?php echo $issuance_store->total_quantity->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_total_quantity" class="issuance_store_total_quantity">
...
<?php } ?>
<?php if ($issuance_store->issued_comment->Visible) { // issued_comment ?>
		<td<?php echo $issuance_store->issued_comment->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_issued_comment" class="issuance_store_issued_comment">
...
<?php } ?>
<?php if ($issuance_store->issued_by->Visible) { // issued_by ?>
		<td<?php echo $issuance_store->issued_by->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_issued_by" class="issuance_store_issued_by">
...
<?php } ?>
<?php if ($issuance_store->approved_comment->Visible) { // approved_comment ?>
		<td<?php echo $issuance_store->approved_comment->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_approved_comment" class="issuance_store_approved_comment">
...
<?php } ?>
<?php if ($issuance_store->approved_by->Visible) { // approved_by ?>
		<td<?php echo $issuance_store->approved_by->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_approved_by" class="issuance_store_approved_by">
...
<?php } ?>
<?php if ($issuance_store->verified_comment->Visible) { // verified_comment ?>
		<td<?php echo $issuance_store->verified_comment->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_verified_comment" class="issuance_store_verified_comment">
...
<?php } ?>
<?php if ($issuance_store->verified_by->Visible) { // verified_by ?>
		<td<?php echo $issuance_store->verified_by->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_verified_by" class="issuance_store_verified_by">
...
<?php } ?>
<?php if ($issuance_store->statuss->Visible) { // statuss ?>
		<td<?php echo $issuance_store->statuss->CellAttributes() ?>>
<span id="el<?php echo $issuance_store_delete->RowCnt ?>_issuance_store_statuss" class="issuance_store_statuss">
...
<?php
	$issuance_store_delete->Recordset->MoveNext();
}
$issuance_store_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $issuance_store_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fissuance_storedelete.Init();
</script>
<?php
$issuance_store_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$issuance_store_delete->Page_Terminate();
?>
