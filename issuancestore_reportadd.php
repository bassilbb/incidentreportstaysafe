...
$issuancestore_report_add = NULL; // Initialize page object first

class cissuancestore_report_add extends cissuancestore_report {
	...
	// Page object name
	var $PageObjName = 'issuancestore_report_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("issuancestore_reportlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "issuancestore_reportview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// date
		$this->date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date->CurrentValue, 14), NULL, FALSE);
...
// Create page object
if (!isset($issuancestore_report_add)) $issuancestore_report_add = new cissuancestore_report_add();

// Page init
$issuancestore_report_add->Page_Init();

// Page main
$issuancestore_report_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$issuancestore_report_add->Page_Render();
?>
...
var CurrentForm = fissuancestore_reportadd = new ew_Form("fissuancestore_reportadd", "add");

// Validate form
fissuancestore_reportadd.Validate = function() {
...
fissuancestore_reportadd.Form_CustomValidate = 
...
fissuancestore_reportadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fissuancestore_reportadd.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory_staysafe"};
fissuancestore_reportadd.Lists["x_material_name"].Data = "<?php echo $issuancestore_report_add->material_name->LookupFilterQuery(FALSE, "add") ?>";
fissuancestore_reportadd.Lists["x_treated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportadd.Lists["x_treated_by"].Data = "<?php echo $issuancestore_report_add->treated_by->LookupFilterQuery(FALSE, "add") ?>";
fissuancestore_reportadd.AutoSuggests["x_treated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_add->treated_by->LookupFilterQuery(TRUE, "add"))) ?>;
fissuancestore_reportadd.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
fissuancestore_reportadd.Lists["x_statuss"].Data = "<?php echo $issuancestore_report_add->statuss->LookupFilterQuery(FALSE, "add") ?>";
fissuancestore_reportadd.Lists["x_issued_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuancestore_reportadd.Lists["x_issued_action"].Options = <?php echo json_encode($issuancestore_report_add->issued_action->Options()) ?>;
fissuancestore_reportadd.Lists["x_issued_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportadd.Lists["x_issued_by"].Data = "<?php echo $issuancestore_report_add->issued_by->LookupFilterQuery(FALSE, "add") ?>";
fissuancestore_reportadd.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuancestore_reportadd.Lists["x_approver_action"].Options = <?php echo json_encode($issuancestore_report_add->approver_action->Options()) ?>;
fissuancestore_reportadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportadd.Lists["x_approved_by"].Data = "<?php echo $issuancestore_report_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
fissuancestore_reportadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
fissuancestore_reportadd.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuancestore_reportadd.Lists["x_verified_action"].Options = <?php echo json_encode($issuancestore_report_add->verified_action->Options()) ?>;
fissuancestore_reportadd.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportadd.Lists["x_verified_by"].Data = "<?php echo $issuancestore_report_add->verified_by->LookupFilterQuery(FALSE, "add") ?>";
fissuancestore_reportadd.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_add->verified_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $issuancestore_report_add->ShowPageHeader(); ?>
<?php
$issuancestore_report_add->ShowMessage();
?>
<form name="fissuancestore_reportadd" id="fissuancestore_reportadd" class="<?php echo $issuancestore_report_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($issuancestore_report_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $issuancestore_report_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="issuancestore_report">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($issuancestore_report_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($issuancestore_report->date->Visible) { // date ?>
	<div id="r_date" class="form-group">
		<label id="elh_issuancestore_report_date" for="x_date" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->date->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fissuancestore_reportadd", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":14});
</script>
<?php } ?>
</span>
...
<?php if ($issuancestore_report->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_issuancestore_report_reference_id" for="x_reference_id" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->reference_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->reference_id->CellAttributes() ?>>
...
<?php if ($issuancestore_report->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_issuancestore_report_material_name" for="x_material_name" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->material_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->material_name->CellAttributes() ?>>
...
<?php if ($issuancestore_report->quantity_in->Visible) { // quantity_in ?>
	<div id="r_quantity_in" class="form-group">
		<label id="elh_issuancestore_report_quantity_in" for="x_quantity_in" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->quantity_in->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->quantity_in->CellAttributes() ?>>
...
<?php if ($issuancestore_report->quantity_out->Visible) { // quantity_out ?>
	<div id="r_quantity_out" class="form-group">
		<label id="elh_issuancestore_report_quantity_out" for="x_quantity_out" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->quantity_out->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->quantity_out->CellAttributes() ?>>
...
<?php if ($issuancestore_report->total_quantity->Visible) { // total_quantity ?>
	<div id="r_total_quantity" class="form-group">
		<label id="elh_issuancestore_report_total_quantity" for="x_total_quantity" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->total_quantity->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->total_quantity->CellAttributes() ?>>
...
<?php if ($issuancestore_report->quantity_type->Visible) { // quantity_type ?>
	<div id="r_quantity_type" class="form-group">
		<label id="elh_issuancestore_report_quantity_type" for="x_quantity_type" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->quantity_type->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->quantity_type->CellAttributes() ?>>
...
<?php if ($issuancestore_report->treated_by->Visible) { // treated_by ?>
	<div id="r_treated_by" class="form-group">
		<label id="elh_issuancestore_report_treated_by" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->treated_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->treated_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuancestore_reportadd.CreateAutoSuggest({"id":"x_treated_by","forceSelect":false});
</script>
</span>
...
<?php if ($issuancestore_report->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_issuancestore_report_statuss" for="x_statuss" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->statuss->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->statuss->CellAttributes() ?>>
...
<?php if ($issuancestore_report->issued_action->Visible) { // issued_action ?>
	<div id="r_issued_action" class="form-group">
		<label id="elh_issuancestore_report_issued_action" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->issued_action->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->issued_action->CellAttributes() ?>>
...
<?php if ($issuancestore_report->issued_comment->Visible) { // issued_comment ?>
	<div id="r_issued_comment" class="form-group">
		<label id="elh_issuancestore_report_issued_comment" for="x_issued_comment" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->issued_comment->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->issued_comment->CellAttributes() ?>>
...
<?php if ($issuancestore_report->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label id="elh_issuancestore_report_issued_by" for="x_issued_by" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->issued_by->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->issued_by->CellAttributes() ?>>
...
<?php if ($issuancestore_report->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_issuancestore_report_approver_date" for="x_approver_date" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->approver_date->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->approver_date->CellAttributes() ?>>
...
<?php if ($issuancestore_report->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_issuancestore_report_approver_action" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->approver_action->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->approver_action->CellAttributes() ?>>
...
<?php if ($issuancestore_report->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label id="elh_issuancestore_report_approver_comment" for="x_approver_comment" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->approver_comment->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->approver_comment->CellAttributes() ?>>
...
<?php if ($issuancestore_report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_issuancestore_report_approved_by" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->approved_by->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->approved_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuancestore_reportadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
...
<?php if ($issuancestore_report->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label id="elh_issuancestore_report_verified_date" for="x_verified_date" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->verified_date->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_date->CellAttributes() ?>>
...
<?php if ($issuancestore_report->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_issuancestore_report_verified_action" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->verified_action->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_action->CellAttributes() ?>>
...
<?php if ($issuancestore_report->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_issuancestore_report_verified_comment" for="x_verified_comment" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->verified_comment->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_comment->CellAttributes() ?>>
...
<?php if ($issuancestore_report->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_issuancestore_report_verified_by" class="<?php echo $issuancestore_report_add->LeftColumnClass ?>"><?php echo $issuancestore_report->verified_by->FldCaption() ?></label>
		<div class="<?php echo $issuancestore_report_add->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_by->CellAttributes() ?>>
...
<script type="text/javascript">
fissuancestore_reportadd.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
...
<?php if (!$issuancestore_report_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $issuancestore_report_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $issuancestore_report_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fissuancestore_reportadd.Init();
</script>
<?php
$issuancestore_report_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$issuancestore_report_add->Page_Terminate();
?>
