...
$store_report_search = NULL; // Initialize page object first

class cstore_report_search extends cstore_report {
	...
	// Page object name
	var $PageObjName = 'store_report_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "store_reportlist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($store_report_search)) $store_report_search = new cstore_report_search();

// Page init
$store_report_search->Page_Init();

// Page main
$store_report_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$store_report_search->Page_Render();
?>
...
<?php if ($store_report_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fstore_reportsearch = new ew_Form("fstore_reportsearch", "search");
<?php } else { ?>
var CurrentForm = fstore_reportsearch = new ew_Form("fstore_reportsearch", "search");
<?php } ?>

// Form_CustomValidate event
fstore_reportsearch.Form_CustomValidate = 
...
fstore_reportsearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fstore_reportsearch.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fstore_reportsearch.Lists["x_staff_id"].Data = "<?php echo $store_report_search->staff_id->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $store_report_search->staff_id->LookupFilterQuery(TRUE, "search"))) ?>;
fstore_reportsearch.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory"};
fstore_reportsearch.Lists["x_material_name"].Data = "<?php echo $store_report_search->material_name->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.Lists["x_treated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fstore_reportsearch.Lists["x_treated_by"].Data = "<?php echo $store_report_search->treated_by->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.AutoSuggests["x_treated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $store_report_search->treated_by->LookupFilterQuery(TRUE, "search"))) ?>;
fstore_reportsearch.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
fstore_reportsearch.Lists["x_status"].Data = "<?php echo $store_report_search->status->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.AutoSuggests["x_status"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $store_report_search->status->LookupFilterQuery(TRUE, "search"))) ?>;
fstore_reportsearch.Lists["x_issued_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstore_reportsearch.Lists["x_issued_action"].Options = <?php echo json_encode($store_report_search->issued_action->Options()) ?>;
fstore_reportsearch.Lists["x_issued_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fstore_reportsearch.Lists["x_issued_by"].Data = "<?php echo $store_report_search->issued_by->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstore_reportsearch.Lists["x_approver_action"].Options = <?php echo json_encode($store_report_search->approver_action->Options()) ?>;
fstore_reportsearch.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fstore_reportsearch.Lists["x_approved_by"].Data = "<?php echo $store_report_search->approved_by->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $store_report_search->approved_by->LookupFilterQuery(TRUE, "search"))) ?>;
fstore_reportsearch.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fstore_reportsearch.Lists["x_verified_action"].Options = <?php echo json_encode($store_report_search->verified_action->Options()) ?>;
fstore_reportsearch.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fstore_reportsearch.Lists["x_verified_by"].Data = "<?php echo $store_report_search->verified_by->LookupFilterQuery(FALSE, "search") ?>";
fstore_reportsearch.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $store_report_search->verified_by->LookupFilterQuery(TRUE, "search"))) ?>;

// Form object for search
// Validate function for search

fstore_reportsearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->id->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_staff_id");
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->staff_id->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_treated_by");
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->treated_by->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_approver_date");
	if (elm && !ew_CheckDateDef(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->approver_date->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_approved_by");
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->approved_by->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_verified_date");
	if (elm && !ew_CheckDateDef(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->verified_date->FldErrMsg()) ?>");
	elm = this.GetElements("x" + infix + "_verified_by");
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($store_report->verified_by->FldErrMsg()) ?>");
...
<?php $store_report_search->ShowPageHeader(); ?>
<?php
$store_report_search->ShowMessage();
?>
<form name="fstore_reportsearch" id="fstore_reportsearch" class="<?php echo $store_report_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($store_report_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $store_report_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="store_report">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($store_report_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($store_report->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label for="x_id" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_id"><?php echo $store_report->id->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_id" id="z_id" value="="></p>
		</label>
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->id->CellAttributes() ?>>
			<span id="el_store_report_id">
<input type="text" data-table="store_report" data-field="x_id" name="x_id" id="x_id" placeholder="<?php echo ew_HtmlEncode($store_report->id->getPlaceHolder()) ?>" value="<?php echo $store_report->id->EditValue ?>"<?php echo $store_report->id->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->date->Visible) { // date ?>
	<div id="r_date" class="form-group">
		<label for="x_date" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_date"><?php echo $store_report->date->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->date->CellAttributes() ?>>
			<span id="el_store_report_date">
...
<script type="text/javascript">
ew_CreateDateTimePicker("fstore_reportsearch", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
			<span class="ewSearchCond btw1_date">&nbsp;<?php echo $Language->Phrase("AND") ?>&nbsp;</span>
			<span id="e2_store_report_date" class="btw1_date">
...
<?php if (!$store_report->date->ReadOnly && !$store_report->date->Disabled && !isset($store_report->date->EditAttrs["readonly"]) && !isset($store_report->date->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("fstore_reportsearch", "y_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
		</div></div>
...
<?php if ($store_report->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label for="x_reference_id" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_reference_id"><?php echo $store_report->reference_id->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->reference_id->CellAttributes() ?>>
			<span id="el_store_report_reference_id">
...
<?php if ($store_report->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_staff_id"><?php echo $store_report->staff_id->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->staff_id->CellAttributes() ?>>
			<span id="el_store_report_staff_id">
<?php
$wrkonchange = trim(" " . @$store_report->staff_id->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$store_report->staff_id->EditAttrs["onchange"] = "";
?>
<span id="as_x_staff_id" style="white-space: nowrap; z-index: 8960">
	<input type="text" name="sv_x_staff_id" id="sv_x_staff_id" value="<?php echo $store_report->staff_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($store_report->staff_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($store_report->staff_id->getPlaceHolder()) ?>"<?php echo $store_report->staff_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="store_report" data-field="x_staff_id" data-value-separator="<?php echo $store_report->staff_id->DisplayValueSeparatorAttribute() ?>" name="x_staff_id" id="x_staff_id" value="<?php echo ew_HtmlEncode($store_report->staff_id->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fstore_reportsearch.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label for="x_material_name" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_material_name"><?php echo $store_report->material_name->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->material_name->CellAttributes() ?>>
			<span id="el_store_report_material_name">
...
<?php if ($store_report->quantity_in->Visible) { // quantity_in ?>
	<div id="r_quantity_in" class="form-group">
		<label for="x_quantity_in" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_quantity_in"><?php echo $store_report->quantity_in->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->quantity_in->CellAttributes() ?>>
			<span id="el_store_report_quantity_in">
<input type="text" data-table="store_report" data-field="x_quantity_in" name="x_quantity_in" id="x_quantity_in" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($store_report->quantity_in->getPlaceHolder()) ?>" value="<?php echo $store_report->quantity_in->EditValue ?>"<?php echo $store_report->quantity_in->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->quantity_type->Visible) { // quantity_type ?>
	<div id="r_quantity_type" class="form-group">
		<label for="x_quantity_type" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_quantity_type"><?php echo $store_report->quantity_type->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->quantity_type->CellAttributes() ?>>
			<span id="el_store_report_quantity_type">
<input type="text" data-table="store_report" data-field="x_quantity_type" name="x_quantity_type" id="x_quantity_type" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($store_report->quantity_type->getPlaceHolder()) ?>" value="<?php echo $store_report->quantity_type->EditValue ?>"<?php echo $store_report->quantity_type->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->quantity_out->Visible) { // quantity_out ?>
	<div id="r_quantity_out" class="form-group">
		<label for="x_quantity_out" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_quantity_out"><?php echo $store_report->quantity_out->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->quantity_out->CellAttributes() ?>>
			<span id="el_store_report_quantity_out">
<input type="text" data-table="store_report" data-field="x_quantity_out" name="x_quantity_out" id="x_quantity_out" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($store_report->quantity_out->getPlaceHolder()) ?>" value="<?php echo $store_report->quantity_out->EditValue ?>"<?php echo $store_report->quantity_out->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->total_quantity->Visible) { // total_quantity ?>
	<div id="r_total_quantity" class="form-group">
		<label for="x_total_quantity" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_total_quantity"><?php echo $store_report->total_quantity->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->total_quantity->CellAttributes() ?>>
			<span id="el_store_report_total_quantity">
<input type="text" data-table="store_report" data-field="x_total_quantity" name="x_total_quantity" id="x_total_quantity" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($store_report->total_quantity->getPlaceHolder()) ?>" value="<?php echo $store_report->total_quantity->EditValue ?>"<?php echo $store_report->total_quantity->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->treated_by->Visible) { // treated_by ?>
	<div id="r_treated_by" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_treated_by"><?php echo $store_report->treated_by->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->treated_by->CellAttributes() ?>>
			<span id="el_store_report_treated_by">
<?php
$wrkonchange = trim(" " . @$store_report->treated_by->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$store_report->treated_by->EditAttrs["onchange"] = "";
?>
<span id="as_x_treated_by" style="white-space: nowrap; z-index: 8900">
	<input type="text" name="sv_x_treated_by" id="sv_x_treated_by" value="<?php echo $store_report->treated_by->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($store_report->treated_by->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($store_report->treated_by->getPlaceHolder()) ?>"<?php echo $store_report->treated_by->EditAttributes() ?>>
</span>
<input type="hidden" data-table="store_report" data-field="x_treated_by" data-value-separator="<?php echo $store_report->treated_by->DisplayValueSeparatorAttribute() ?>" name="x_treated_by" id="x_treated_by" value="<?php echo ew_HtmlEncode($store_report->treated_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fstore_reportsearch.CreateAutoSuggest({"id":"x_treated_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_status"><?php echo $store_report->status->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->status->CellAttributes() ?>>
			<span id="el_store_report_status">
<?php
$wrkonchange = trim(" " . @$store_report->status->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$store_report->status->EditAttrs["onchange"] = "";
?>
<span id="as_x_status" style="white-space: nowrap; z-index: 8890">
	<input type="text" name="sv_x_status" id="sv_x_status" value="<?php echo $store_report->status->EditValue ?>" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($store_report->status->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($store_report->status->getPlaceHolder()) ?>"<?php echo $store_report->status->EditAttributes() ?>>
</span>
<input type="hidden" data-table="store_report" data-field="x_status" data-value-separator="<?php echo $store_report->status->DisplayValueSeparatorAttribute() ?>" name="x_status" id="x_status" value="<?php echo ew_HtmlEncode($store_report->status->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fstore_reportsearch.CreateAutoSuggest({"id":"x_status","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->issued_action->Visible) { // issued_action ?>
	<div id="r_issued_action" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_issued_action"><?php echo $store_report->issued_action->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->issued_action->CellAttributes() ?>>
			<span id="el_store_report_issued_action">
<div id="tp_x_issued_action" class="ewTemplate"><input type="radio" data-table="store_report" data-field="x_issued_action" data-value-separator="<?php echo $store_report->issued_action->DisplayValueSeparatorAttribute() ?>" name="x_issued_action" id="x_issued_action" value="{value}"<?php echo $store_report->issued_action->EditAttributes() ?>></div>
<div id="dsl_x_issued_action" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $store_report->issued_action->RadioButtonListHtml(FALSE, "x_issued_action") ?>
</div></div>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->issued_comment->Visible) { // issued_comment ?>
	<div id="r_issued_comment" class="form-group">
		<label for="x_issued_comment" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_issued_comment"><?php echo $store_report->issued_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->issued_comment->CellAttributes() ?>>
			<span id="el_store_report_issued_comment">
<input type="text" data-table="store_report" data-field="x_issued_comment" name="x_issued_comment" id="x_issued_comment" size="35" maxlength="25" placeholder="<?php echo ew_HtmlEncode($store_report->issued_comment->getPlaceHolder()) ?>" value="<?php echo $store_report->issued_comment->EditValue ?>"<?php echo $store_report->issued_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label for="x_issued_by" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_issued_by"><?php echo $store_report->issued_by->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->issued_by->CellAttributes() ?>>
			<span id="el_store_report_issued_by">
<span class="ewLookupList">
...
<?php if ($store_report->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label for="x_approver_date" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_approver_date"><?php echo $store_report->approver_date->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->approver_date->CellAttributes() ?>>
			<span id="el_store_report_approver_date">
<input type="text" data-table="store_report" data-field="x_approver_date" name="x_approver_date" id="x_approver_date" size="30" placeholder="<?php echo ew_HtmlEncode($store_report->approver_date->getPlaceHolder()) ?>" value="<?php echo $store_report->approver_date->EditValue ?>"<?php echo $store_report->approver_date->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_approver_action"><?php echo $store_report->approver_action->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->approver_action->CellAttributes() ?>>
			<span id="el_store_report_approver_action">
<div id="tp_x_approver_action" class="ewTemplate"><input type="radio" data-table="store_report" data-field="x_approver_action" data-value-separator="<?php echo $store_report->approver_action->DisplayValueSeparatorAttribute() ?>" name="x_approver_action" id="x_approver_action" value="{value}"<?php echo $store_report->approver_action->EditAttributes() ?>></div>
<div id="dsl_x_approver_action" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $store_report->approver_action->RadioButtonListHtml(FALSE, "x_approver_action") ?>
</div></div>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->approved_comment->Visible) { // approved_comment ?>
	<div id="r_approved_comment" class="form-group">
		<label for="x_approved_comment" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_approved_comment"><?php echo $store_report->approved_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->approved_comment->CellAttributes() ?>>
			<span id="el_store_report_approved_comment">
<input type="text" data-table="store_report" data-field="x_approved_comment" name="x_approved_comment" id="x_approved_comment" size="35" maxlength="50" placeholder="<?php echo ew_HtmlEncode($store_report->approved_comment->getPlaceHolder()) ?>" value="<?php echo $store_report->approved_comment->EditValue ?>"<?php echo $store_report->approved_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_approved_by"><?php echo $store_report->approved_by->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->approved_by->CellAttributes() ?>>
			<span id="el_store_report_approved_by">
<?php
$wrkonchange = trim(" " . @$store_report->approved_by->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$store_report->approved_by->EditAttrs["onchange"] = "";
?>
<span id="as_x_approved_by" style="white-space: nowrap; z-index: 8820">
	<input type="text" name="sv_x_approved_by" id="sv_x_approved_by" value="<?php echo $store_report->approved_by->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($store_report->approved_by->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($store_report->approved_by->getPlaceHolder()) ?>"<?php echo $store_report->approved_by->EditAttributes() ?>>
</span>
<input type="hidden" data-table="store_report" data-field="x_approved_by" data-value-separator="<?php echo $store_report->approved_by->DisplayValueSeparatorAttribute() ?>" name="x_approved_by" id="x_approved_by" value="<?php echo ew_HtmlEncode($store_report->approved_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fstore_reportsearch.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label for="x_verified_date" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_verified_date"><?php echo $store_report->verified_date->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->verified_date->CellAttributes() ?>>
			<span id="el_store_report_verified_date">
<input type="text" data-table="store_report" data-field="x_verified_date" name="x_verified_date" id="x_verified_date" placeholder="<?php echo ew_HtmlEncode($store_report->verified_date->getPlaceHolder()) ?>" value="<?php echo $store_report->verified_date->EditValue ?>"<?php echo $store_report->verified_date->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_verified_action"><?php echo $store_report->verified_action->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->verified_action->CellAttributes() ?>>
			<span id="el_store_report_verified_action">
<div id="tp_x_verified_action" class="ewTemplate"><input type="radio" data-table="store_report" data-field="x_verified_action" data-value-separator="<?php echo $store_report->verified_action->DisplayValueSeparatorAttribute() ?>" name="x_verified_action" id="x_verified_action" value="{value}"<?php echo $store_report->verified_action->EditAttributes() ?>></div>
<div id="dsl_x_verified_action" data-repeatcolumn="5" class="ewItemList" style="display: none;"><div>
<?php echo $store_report->verified_action->RadioButtonListHtml(FALSE, "x_verified_action") ?>
</div></div>
</span>
		</div></div>
	</div>
...
<?php if ($store_report->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label for="x_verified_comment" class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_verified_comment"><?php echo $store_report->verified_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->verified_comment->CellAttributes() ?>>
			<span id="el_store_report_verified_comment">
<input type="text" data-table="store_report" data-field="x_verified_comment" name="x_verified_comment" id="x_verified_comment" size="35" maxlength="25" placeholder="<?php echo ew_HtmlEncode($store_report->verified_comment->getPlaceHolder()) ?>" value="<?php echo $store_report->verified_comment->EditValue ?>"<?php echo $store_report->verified_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($store_report->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label class="<?php echo $store_report_search->LeftColumnClass ?>"><span id="elh_store_report_verified_by"><?php echo $store_report->verified_by->FldCaption() ?></span>
		...
		<div class="<?php echo $store_report_search->RightColumnClass ?>"><div<?php echo $store_report->verified_by->CellAttributes() ?>>
			<span id="el_store_report_verified_by">
<?php
$wrkonchange = trim(" " . @$store_report->verified_by->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$store_report->verified_by->EditAttrs["onchange"] = "";
?>
<span id="as_x_verified_by" style="white-space: nowrap; z-index: 8780">
	<input type="text" name="sv_x_verified_by" id="sv_x_verified_by" value="<?php echo $store_report->verified_by->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($store_report->verified_by->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($store_report->verified_by->getPlaceHolder()) ?>"<?php echo $store_report->verified_by->EditAttributes() ?>>
</span>
<input type="hidden" data-table="store_report" data-field="x_verified_by" data-value-separator="<?php echo $store_report->verified_by->DisplayValueSeparatorAttribute() ?>" name="x_verified_by" id="x_verified_by" value="<?php echo ew_HtmlEncode($store_report->verified_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fstore_reportsearch.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $store_report_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fstore_reportsearch.Init();
</script>
<?php
$store_report_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$store_report_search->Page_Terminate();
?>
