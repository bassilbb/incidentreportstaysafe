...
$inventory_tracking_statysafe = NULL;

//
// Table class for inventory_tracking_statysafe
//
class cinventory_tracking_statysafe extends cTable {
	var $id;
	var $date_recieved;
	var $reference_id;
	var $staff_id;
	...
	function __construct() {
		...
		$this->TableVar = 'inventory_tracking_statysafe';
		$this->TableName = 'inventory_tracking_statysafe';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`inventory_tracking_statysafe`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_recieved
		$this->date_recieved = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_date_recieved', 'date_recieved', '`date_recieved`', ew_CastDateFieldForLike('`date_recieved`', 0, "DB"), 135, 0, FALSE, '`date_recieved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reference_id
		$this->reference_id = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// staff_id
		$this->staff_id = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 200, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// material_name
		$this->material_name = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_material_name', 'material_name', '`material_name`', '`material_name`', 200, -1, FALSE, '`material_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->material_name->Sortable = TRUE; // Allow sort
		$this->fields['material_name'] = &$this->material_name;

		// type
		$this->type = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_type', 'type', '`type`', '`type`', 200, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->type->Sortable = TRUE; // Allow sort
		$this->fields['type'] = &$this->type;

		// capacity
		$this->capacity = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_capacity', 'capacity', '`capacity`', '`capacity`', 200, -1, FALSE, '`capacity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->capacity->Sortable = TRUE; // Allow sort
		$this->fields['capacity'] = &$this->capacity;

		// quantity
		$this->quantity = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 200, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->fields['quantity'] = &$this->quantity;

		// recieved_by
		$this->recieved_by = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_recieved_by', 'recieved_by', '`recieved_by`', '`recieved_by`', 3, -1, FALSE, '`recieved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->recieved_by->Sortable = TRUE; // Allow sort
		$this->fields['recieved_by'] = &$this->recieved_by;

		// recieved_action
		$this->recieved_action = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_recieved_action', 'recieved_action', '`recieved_action`', '`recieved_action`', 3, -1, FALSE, '`recieved_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->recieved_action->Sortable = TRUE; // Allow sort
		$this->recieved_action->OptionCount = 2;
		$this->recieved_action->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['recieved_action'] = &$this->recieved_action;

		// recieved_comment
		$this->recieved_comment = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_recieved_comment', 'recieved_comment', '`recieved_comment`', '`recieved_comment`', 200, -1, FALSE, '`recieved_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->recieved_comment->Sortable = TRUE; // Allow sort
		$this->fields['recieved_comment'] = &$this->recieved_comment;

		// date_approved
		$this->date_approved = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_date_approved', 'date_approved', '`date_approved`', ew_CastDateFieldForLike('`date_approved`', 0, "DB"), 135, 0, FALSE, '`date_approved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->date_approved->Sortable = TRUE; // Allow sort
		$this->date_approved->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['date_approved'] = &$this->date_approved;

		// approver_action
		$this->approver_action = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_approver_action', 'approver_action', '`approver_action`', '`approver_action`', 3, -1, FALSE, '`approver_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approver_comment
		$this->approver_comment = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_approver_comment', 'approver_comment', '`approver_comment`', '`approver_comment`', 200, -1, FALSE, '`approver_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->approver_comment->Sortable = TRUE; // Allow sort
		$this->fields['approver_comment'] = &$this->approver_comment;

		// statuss
		$this->statuss = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_statuss', 'statuss', '`statuss`', '`statuss`', 3, -1, FALSE, '`statuss`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// approved_by
		$this->approved_by = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_approved_by', 'approved_by', '`approved_by`', '`approved_by`', 3, -1, FALSE, '`approved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->approved_by->Sortable = TRUE; // Allow sort
		$this->fields['approved_by'] = &$this->approved_by;

		// verified_date
		$this->verified_date = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_verified_date', 'verified_date', '`verified_date`', ew_CastDateFieldForLike('`verified_date`', 0, "DB"), 135, 0, FALSE, '`verified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// verified_action
		$this->verified_action = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_verified_action', 'verified_action', '`verified_action`', '`verified_action`', 3, -1, FALSE, '`verified_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// verified_comment
		$this->verified_comment = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_verified_comment', 'verified_comment', '`verified_comment`', '`verified_comment`', 200, -1, FALSE, '`verified_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->verified_comment->Sortable = TRUE; // Allow sort
		$this->fields['verified_comment'] = &$this->verified_comment;

		// verified_by
		$this->verified_by = new cField('inventory_tracking_statysafe', 'inventory_tracking_statysafe', 'x_verified_by', 'verified_by', '`verified_by`', '`verified_by`', 3, -1, FALSE, '`verified_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`inventory_tracking_statysafe`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "inventory_tracking_statysafelist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "inventory_tracking_statysafeview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "inventory_tracking_statysafeedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "inventory_tracking_statysafeadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("inventory_tracking_statysafeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("inventory_tracking_statysafeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "inventory_tracking_statysafeadd.php?" . $this->UrlParm($parm);
		else
			$url = "inventory_tracking_statysafeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("inventory_tracking_statysafeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("inventory_tracking_statysafeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("inventory_tracking_statysafedelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->date_approved->EditValue = ew_FormatDateTime($this->date_approved->CurrentValue, 8);
