...
$requisition_module_search = NULL; // Initialize page object first

class crequisition_module_search extends crequisition_module {
	...
	// Page object name
	var $PageObjName = 'requisition_module_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "requisition_modulelist.php" . "?" . $sSrchStr;
	...
	function RenderRow() {
		...
		$this->rep_comment->ViewCustomAttributes = "";
			...
			if (strval($this->name->AdvancedSearch->SearchValue) <> "") {
			...
			if (strval($this->department->AdvancedSearch->SearchValue) <> "") {
			...
			$this->authorizer_name->EditValue = ew_HtmlEncode($this->authorizer_name->AdvancedSearch->SearchValue);
			if (strval($this->authorizer_name->AdvancedSearch->SearchValue) <> "") {
	...
	function ValidateSearch() {
		...
		if (!ew_CheckShortEuroDate($this->rep_date->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->rep_date->FldErrMsg());
		}
		if (!ew_CheckShortEuroDate($this->outward_datetime->AdvancedSearch->SearchValue)) {
			ew_AddMessage($gsSearchError, $this->outward_datetime->FldErrMsg());
		}
...
// Create page object
if (!isset($requisition_module_search)) $requisition_module_search = new crequisition_module_search();

// Page init
$requisition_module_search->Page_Init();

// Page main
$requisition_module_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$requisition_module_search->Page_Render();
?>
...
<?php if ($requisition_module_search->IsModal) { ?>
var CurrentAdvancedSearchForm = frequisition_modulesearch = new ew_Form("frequisition_modulesearch", "search");
<?php } else { ?>
var CurrentForm = frequisition_modulesearch = new ew_Form("frequisition_modulesearch", "search");
<?php } ?>

// Form_CustomValidate event
frequisition_modulesearch.Form_CustomValidate = 
...
frequisition_modulesearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
frequisition_modulesearch.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
frequisition_modulesearch.Lists["x_staff_id"].Data = "<?php echo $requisition_module_search->staff_id->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->staff_id->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
frequisition_modulesearch.Lists["x_name"].Data = "<?php echo $requisition_module_search->name->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_name"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->name->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_organization"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_branch_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"branch"};
frequisition_modulesearch.Lists["x_organization"].Data = "<?php echo $requisition_module_search->organization->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_organization"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->organization->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_designation"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"designation"};
frequisition_modulesearch.Lists["x_designation"].Data = "<?php echo $requisition_module_search->designation->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_designation"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->designation->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_department"] = {"LinkField":"x_department_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_department_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"depertment"};
frequisition_modulesearch.Lists["x_department"].Data = "<?php echo $requisition_module_search->department->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_department"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->department->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_requester_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frequisition_modulesearch.Lists["x_requester_action"].Options = <?php echo json_encode($requisition_module_search->requester_action->Options()) ?>;
frequisition_modulesearch.Lists["x_authorizer_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
frequisition_modulesearch.Lists["x_authorizer_name"].Data = "<?php echo $requisition_module_search->authorizer_name->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_authorizer_name"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->authorizer_name->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_authorizer_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frequisition_modulesearch.Lists["x_authorizer_action"].Options = <?php echo json_encode($requisition_module_search->authorizer_action->Options()) ?>;
frequisition_modulesearch.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"status_ssf"};
frequisition_modulesearch.Lists["x_status"].Data = "<?php echo $requisition_module_search->status->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.Lists["x_rep_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
frequisition_modulesearch.Lists["x_rep_name"].Data = "<?php echo $requisition_module_search->rep_name->LookupFilterQuery(FALSE, "search") ?>";
frequisition_modulesearch.AutoSuggests["x_rep_name"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $requisition_module_search->rep_name->LookupFilterQuery(TRUE, "search"))) ?>;
frequisition_modulesearch.Lists["x_rep_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
frequisition_modulesearch.Lists["x_rep_action"].Options = <?php echo json_encode($requisition_module_search->rep_action->Options()) ?>;

// Form object for search
// Validate function for search

frequisition_modulesearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($requisition_module->code->FldErrMsg()) ?>");
...
<?php $requisition_module_search->ShowPageHeader(); ?>
<?php
$requisition_module_search->ShowMessage();
?>
<form name="frequisition_modulesearch" id="frequisition_modulesearch" class="<?php echo $requisition_module_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($requisition_module_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $requisition_module_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="requisition_module">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($requisition_module_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($requisition_module->code->Visible) { // code ?>
	<div id="r_code" class="form-group">
		<label for="x_code" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_code"><?php echo $requisition_module->code->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_code" id="z_code" value="="></p>
		</label>
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->code->CellAttributes() ?>>
			<span id="el_requisition_module_code">
<input type="text" data-table="requisition_module" data-field="x_code" name="x_code" id="x_code" size="30" placeholder="<?php echo ew_HtmlEncode($requisition_module->code->getPlaceHolder()) ?>" value="<?php echo $requisition_module->code->EditValue ?>"<?php echo $requisition_module->code->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->date->Visible) { // date ?>
	<div id="r_date" class="form-group">
		<label for="x_date" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_date"><?php echo $requisition_module->date->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_date" id="z_date" value="="></p>
		</label>
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->date->CellAttributes() ?>>
			<span id="el_requisition_module_date">
<input type="text" data-table="requisition_module" data-field="x_date" data-format="17" name="x_date" id="x_date" size="30" placeholder="<?php echo ew_HtmlEncode($requisition_module->date->getPlaceHolder()) ?>" value="<?php echo $requisition_module->date->EditValue ?>"<?php echo $requisition_module->date->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->reference->Visible) { // reference ?>
	<div id="r_reference" class="form-group">
		<label for="x_reference" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_reference"><?php echo $requisition_module->reference->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->reference->CellAttributes() ?>>
			<span id="el_requisition_module_reference">
<input type="text" data-table="requisition_module" data-field="x_reference" name="x_reference" id="x_reference" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->reference->getPlaceHolder()) ?>" value="<?php echo $requisition_module->reference->EditValue ?>"<?php echo $requisition_module->reference->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_staff_id"><?php echo $requisition_module->staff_id->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->staff_id->CellAttributes() ?>>
...
<input type="hidden" data-table="requisition_module" data-field="x_staff_id" data-value-separator="<?php echo $requisition_module->staff_id->DisplayValueSeparatorAttribute() ?>" name="x_staff_id" id="x_staff_id" value="<?php echo ew_HtmlEncode($requisition_module->staff_id->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
frequisition_modulesearch.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($requisition_module->outward_location->Visible) { // outward_location ?>
	<div id="r_outward_location" class="form-group">
		<label for="x_outward_location" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_outward_location"><?php echo $requisition_module->outward_location->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->outward_location->CellAttributes() ?>>
			<span id="el_requisition_module_outward_location">
<input type="text" data-table="requisition_module" data-field="x_outward_location" name="x_outward_location" id="x_outward_location" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->outward_location->getPlaceHolder()) ?>" value="<?php echo $requisition_module->outward_location->EditValue ?>"<?php echo $requisition_module->outward_location->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->delivery_point->Visible) { // delivery_point ?>
	<div id="r_delivery_point" class="form-group">
		<label for="x_delivery_point" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_delivery_point"><?php echo $requisition_module->delivery_point->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->delivery_point->CellAttributes() ?>>
			<span id="el_requisition_module_delivery_point">
<input type="text" data-table="requisition_module" data-field="x_delivery_point" name="x_delivery_point" id="x_delivery_point" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->delivery_point->getPlaceHolder()) ?>" value="<?php echo $requisition_module->delivery_point->EditValue ?>"<?php echo $requisition_module->delivery_point->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_name"><?php echo $requisition_module->name->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->name->CellAttributes() ?>>
...
<input type="hidden" data-table="requisition_module" data-field="x_name" data-value-separator="<?php echo $requisition_module->name->DisplayValueSeparatorAttribute() ?>" name="x_name" id="x_name" value="<?php echo ew_HtmlEncode($requisition_module->name->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
frequisition_modulesearch.CreateAutoSuggest({"id":"x_name","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($requisition_module->organization->Visible) { // organization ?>
	<div id="r_organization" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_organization"><?php echo $requisition_module->organization->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->organization->CellAttributes() ?>>
...
<?php if ($requisition_module->designation->Visible) { // designation ?>
	<div id="r_designation" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_designation"><?php echo $requisition_module->designation->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->designation->CellAttributes() ?>>
...
<?php if ($requisition_module->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_department"><?php echo $requisition_module->department->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->department->CellAttributes() ?>>
...
<input type="hidden" data-table="requisition_module" data-field="x_department" data-value-separator="<?php echo $requisition_module->department->DisplayValueSeparatorAttribute() ?>" name="x_department" id="x_department" value="<?php echo ew_HtmlEncode($requisition_module->department->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
frequisition_modulesearch.CreateAutoSuggest({"id":"x_department","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($requisition_module->item_description->Visible) { // item_description ?>
	<div id="r_item_description" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_item_description"><?php echo $requisition_module->item_description->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->item_description->CellAttributes() ?>>
			<span id="el_requisition_module_item_description">
<input type="text" data-table="requisition_module" data-field="x_item_description" name="x_item_description" id="x_item_description" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($requisition_module->item_description->getPlaceHolder()) ?>" value="<?php echo $requisition_module->item_description->EditValue ?>"<?php echo $requisition_module->item_description->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->driver_name->Visible) { // driver_name ?>
	<div id="r_driver_name" class="form-group">
		<label for="x_driver_name" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_driver_name"><?php echo $requisition_module->driver_name->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->driver_name->CellAttributes() ?>>
			<span id="el_requisition_module_driver_name">
<input type="text" data-table="requisition_module" data-field="x_driver_name" name="x_driver_name" id="x_driver_name" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->driver_name->getPlaceHolder()) ?>" value="<?php echo $requisition_module->driver_name->EditValue ?>"<?php echo $requisition_module->driver_name->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->vehicle_no->Visible) { // vehicle_no ?>
	<div id="r_vehicle_no" class="form-group">
		<label for="x_vehicle_no" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_vehicle_no"><?php echo $requisition_module->vehicle_no->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->vehicle_no->CellAttributes() ?>>
			<span id="el_requisition_module_vehicle_no">
<input type="text" data-table="requisition_module" data-field="x_vehicle_no" name="x_vehicle_no" id="x_vehicle_no" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->vehicle_no->getPlaceHolder()) ?>" value="<?php echo $requisition_module->vehicle_no->EditValue ?>"<?php echo $requisition_module->vehicle_no->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->requester_action->Visible) { // requester_action ?>
	<div id="r_requester_action" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_requester_action"><?php echo $requisition_module->requester_action->FldCaption() ?></span>
...
<?php if ($requisition_module->requester_comment->Visible) { // requester_comment ?>
	<div id="r_requester_comment" class="form-group">
		<label for="x_requester_comment" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_requester_comment"><?php echo $requisition_module->requester_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->requester_comment->CellAttributes() ?>>
			<span id="el_requisition_module_requester_comment">
<input type="text" data-table="requisition_module" data-field="x_requester_comment" name="x_requester_comment" id="x_requester_comment" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->requester_comment->getPlaceHolder()) ?>" value="<?php echo $requisition_module->requester_comment->EditValue ?>"<?php echo $requisition_module->requester_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->date_authorized->Visible) { // date_authorized ?>
	<div id="r_date_authorized" class="form-group">
		<label for="x_date_authorized" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_date_authorized"><?php echo $requisition_module->date_authorized->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->date_authorized->CellAttributes() ?>>
...
<?php if ($requisition_module->authorizer_name->Visible) { // authorizer_name ?>
	<div id="r_authorizer_name" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_authorizer_name"><?php echo $requisition_module->authorizer_name->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->authorizer_name->CellAttributes() ?>>
...
<input type="hidden" data-table="requisition_module" data-field="x_authorizer_name" data-value-separator="<?php echo $requisition_module->authorizer_name->DisplayValueSeparatorAttribute() ?>" name="x_authorizer_name" id="x_authorizer_name" value="<?php echo ew_HtmlEncode($requisition_module->authorizer_name->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
frequisition_modulesearch.CreateAutoSuggest({"id":"x_authorizer_name","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($requisition_module->authorizer_action->Visible) { // authorizer_action ?>
	<div id="r_authorizer_action" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_authorizer_action"><?php echo $requisition_module->authorizer_action->FldCaption() ?></span>
...
<?php if ($requisition_module->authorizer_comment->Visible) { // authorizer_comment ?>
	<div id="r_authorizer_comment" class="form-group">
		<label for="x_authorizer_comment" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_authorizer_comment"><?php echo $requisition_module->authorizer_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->authorizer_comment->CellAttributes() ?>>
			<span id="el_requisition_module_authorizer_comment">
<input type="text" data-table="requisition_module" data-field="x_authorizer_comment" name="x_authorizer_comment" id="x_authorizer_comment" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->authorizer_comment->getPlaceHolder()) ?>" value="<?php echo $requisition_module->authorizer_comment->EditValue ?>"<?php echo $requisition_module->authorizer_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label for="x_status" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_status"><?php echo $requisition_module->status->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->status->CellAttributes() ?>>
			<span id="el_requisition_module_status">
<select data-table="requisition_module" data-field="x_status" data-value-separator="<?php echo $requisition_module->status->DisplayValueSeparatorAttribute() ?>" id="x_status" name="x_status"<?php echo $requisition_module->status->EditAttributes() ?>>
...
<?php if ($requisition_module->rep_date->Visible) { // rep_date ?>
	<div id="r_rep_date" class="form-group">
		<label for="x_rep_date" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_rep_date"><?php echo $requisition_module->rep_date->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->rep_date->CellAttributes() ?>>
			<span id="el_requisition_module_rep_date">
<input type="text" data-table="requisition_module" data-field="x_rep_date" data-format="17" name="x_rep_date" id="x_rep_date" size="30" placeholder="<?php echo ew_HtmlEncode($requisition_module->rep_date->getPlaceHolder()) ?>" value="<?php echo $requisition_module->rep_date->EditValue ?>"<?php echo $requisition_module->rep_date->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($requisition_module->rep_name->Visible) { // rep_name ?>
	<div id="r_rep_name" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_rep_name"><?php echo $requisition_module->rep_name->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->rep_name->CellAttributes() ?>>
...
<input type="hidden" data-table="requisition_module" data-field="x_rep_name" data-value-separator="<?php echo $requisition_module->rep_name->DisplayValueSeparatorAttribute() ?>" name="x_rep_name" id="x_rep_name" value="<?php echo ew_HtmlEncode($requisition_module->rep_name->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
frequisition_modulesearch.CreateAutoSuggest({"id":"x_rep_name","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($requisition_module->outward_datetime->Visible) { // outward_datetime ?>
	<div id="r_outward_datetime" class="form-group">
		<label for="x_outward_datetime" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_outward_datetime"><?php echo $requisition_module->outward_datetime->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->outward_datetime->CellAttributes() ?>>
			<span id="el_requisition_module_outward_datetime">
<input type="text" data-table="requisition_module" data-field="x_outward_datetime" data-format="17" name="x_outward_datetime" id="x_outward_datetime" placeholder="<?php echo ew_HtmlEncode($requisition_module->outward_datetime->getPlaceHolder()) ?>" value="<?php echo $requisition_module->outward_datetime->EditValue ?>"<?php echo $requisition_module->outward_datetime->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("frequisition_modulesearch", "x_outward_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":17});
</script>
<?php } ?>
</span>
		</div></div>
...
<?php if ($requisition_module->rep_action->Visible) { // rep_action ?>
	<div id="r_rep_action" class="form-group">
		<label class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_rep_action"><?php echo $requisition_module->rep_action->FldCaption() ?></span>
...
<?php if ($requisition_module->rep_comment->Visible) { // rep_comment ?>
	<div id="r_rep_comment" class="form-group">
		<label for="x_rep_comment" class="<?php echo $requisition_module_search->LeftColumnClass ?>"><span id="elh_requisition_module_rep_comment"><?php echo $requisition_module->rep_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $requisition_module_search->RightColumnClass ?>"><div<?php echo $requisition_module->rep_comment->CellAttributes() ?>>
			<span id="el_requisition_module_rep_comment">
<input type="text" data-table="requisition_module" data-field="x_rep_comment" name="x_rep_comment" id="x_rep_comment" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($requisition_module->rep_comment->getPlaceHolder()) ?>" value="<?php echo $requisition_module->rep_comment->EditValue ?>"<?php echo $requisition_module->rep_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $requisition_module_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
frequisition_modulesearch.Init();
</script>
<?php
$requisition_module_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$requisition_module_search->Page_Terminate();
?>
