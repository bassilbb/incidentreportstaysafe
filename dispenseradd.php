...
$dispenser_add = NULL; // Initialize page object first

class cdispenser_add extends cdispenser {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("dispenserlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "dispenserview.php")
	...
	function LoadDefaultValues() {
		...
		$this->referrence_id->CurrentValue = NULL;
		$this->referrence_id->OldValue = $this->referrence_id->CurrentValue;
		...
		$this->sub_location->CurrentValue = NULL;
		$this->sub_location->OldValue = $this->sub_location->CurrentValue;
	...
	function NewRow() {
		...
		$row['referrence_id'] = $this->referrence_id->CurrentValue;
		...
		$row['sub_location'] = $this->sub_location->CurrentValue;
		$row['venue'] = $this->venue->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// date_initiated
		$this->date_initiated->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_initiated->CurrentValue, 0), ew_CurrentDate(), FALSE);

		// referrence_id
		$this->referrence_id->SetDbValueDef($rsnew, $this->referrence_id->CurrentValue, NULL, FALSE);
		...
		// sub_location
		$this->sub_location->SetDbValueDef($rsnew, $this->sub_location->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($dispenser_add)) $dispenser_add = new cdispenser_add();

// Page init
$dispenser_add->Page_Init();

// Page main
$dispenser_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$dispenser_add->Page_Render();
?>
...
var CurrentForm = fdispenseradd = new ew_Form("fdispenseradd", "add");

// Validate form
fdispenseradd.Validate = function() {
...
fdispenseradd.Form_CustomValidate = 
...
fdispenseradd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fdispenseradd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fdispenseradd.Lists["x_staff_id"].Data = "<?php echo $dispenser_add->staff_id->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $dispenser_add->staff_id->LookupFilterQuery(TRUE, "add"))) ?>;
fdispenseradd.Lists["x_fullname"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fdispenseradd.Lists["x_fullname"].Data = "<?php echo $dispenser_add->fullname->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.AutoSuggests["x_fullname"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $dispenser_add->fullname->LookupFilterQuery(TRUE, "add"))) ?>;
fdispenseradd.Lists["x_department"] = {"LinkField":"x_department_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_department_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"depertment"};
fdispenseradd.Lists["x_department"].Data = "<?php echo $dispenser_add->department->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.AutoSuggests["x_department"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $dispenser_add->department->LookupFilterQuery(TRUE, "add"))) ?>;
fdispenseradd.Lists["x_location"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_sub_location"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
fdispenseradd.Lists["x_location"].Data = "<?php echo $dispenser_add->location->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.Lists["x_sub_location"] = {"LinkField":"x_code_sub","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_location"],"ChildFields":["x_venue"],"FilterFields":["x_code_id"],"Options":[],"Template":"","LinkTable":"incident_sub_location"};
fdispenseradd.Lists["x_sub_location"].Data = "<?php echo $dispenser_add->sub_location->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.Lists["x_venue"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_sub_location"],"ChildFields":[],"FilterFields":["x_code_sub"],"Options":[],"Template":"","LinkTable":"incident_venue"};
fdispenseradd.Lists["x_venue"].Data = "<?php echo $dispenser_add->venue->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.Lists["x_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","x_serial_no","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"dispenser_type"};
fdispenseradd.Lists["x_type"].Data = "<?php echo $dispenser_add->type->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.Lists["x_action_taken"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"action_taken"};
fdispenseradd.Lists["x_action_taken"].Data = "<?php echo $dispenser_add->action_taken->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdispenseradd.Lists["x_initiator_action"].Options = <?php echo json_encode($dispenser_add->initiator_action->Options()) ?>;
fdispenseradd.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"dispenser_status"};
fdispenseradd.Lists["x_status"].Data = "<?php echo $dispenser_add->status->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.AutoSuggests["x_status"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $dispenser_add->status->LookupFilterQuery(TRUE, "add"))) ?>;
fdispenseradd.Lists["x_initiated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fdispenseradd.Lists["x_initiated_by"].Data = "<?php echo $dispenser_add->initiated_by->LookupFilterQuery(FALSE, "add") ?>";
fdispenseradd.AutoSuggests["x_initiated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $dispenser_add->initiated_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $dispenser_add->ShowPageHeader(); ?>
<?php
$dispenser_add->ShowMessage();
?>
<form name="fdispenseradd" id="fdispenseradd" class="<?php echo $dispenser_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($dispenser_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $dispenser_add->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo intval($dispenser_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($dispenser->date_initiated->Visible) { // date_initiated ?>
	<div id="r_date_initiated" class="form-group">
		<label id="elh_dispenser_date_initiated" for="x_date_initiated" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->date_initiated->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->date_initiated->CellAttributes() ?>>
...
<?php if ($dispenser->referrence_id->Visible) { // referrence_id ?>
	<div id="r_referrence_id" class="form-group">
		<label id="elh_dispenser_referrence_id" for="x_referrence_id" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->referrence_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->referrence_id->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_dispenser_staff_id" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->staff_id->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fdispenseradd.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_dispenser_staff_id">
...
<?php if ($dispenser->fullname->Visible) { // fullname ?>
	<div id="r_fullname" class="form-group">
		<label id="elh_dispenser_fullname" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->fullname->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->fullname->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fdispenseradd.CreateAutoSuggest({"id":"x_fullname","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_dispenser_fullname">
...
<?php if ($dispenser->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label id="elh_dispenser_department" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->department->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->department->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fdispenseradd.CreateAutoSuggest({"id":"x_department","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_dispenser_department">
...
<?php if ($dispenser->location->Visible) { // location ?>
	<div id="r_location" class="form-group">
		<label id="elh_dispenser_location" for="x_location" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->location->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->sub_location->Visible) { // sub_location ?>
	<div id="r_sub_location" class="form-group">
		<label id="elh_dispenser_sub_location" for="x_sub_location" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->sub_location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->sub_location->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->venue->Visible) { // venue ?>
	<div id="r_venue" class="form-group">
		<label id="elh_dispenser_venue" for="x_venue" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->venue->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->venue->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->type->Visible) { // type ?>
	<div id="r_type" class="form-group">
		<label id="elh_dispenser_type" for="x_type" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->type->FldCaption() ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->type->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->action_taken->Visible) { // action_taken ?>
	<div id="r_action_taken" class="form-group">
		<label id="elh_dispenser_action_taken" for="x_action_taken" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->action_taken->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->action_taken->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_dispenser_initiator_action" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->initiator_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->initiator_action->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_dispenser_initiator_comment" for="x_initiator_comment" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->initiator_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->initiator_comment->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<?php if ($dispenser->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_dispenser_status" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->status->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fdispenseradd.CreateAutoSuggest({"id":"x_status","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_dispenser_status">
...
<?php if ($dispenser->initiated_by->Visible) { // initiated_by ?>
	<div id="r_initiated_by" class="form-group">
		<label id="elh_dispenser_initiated_by" class="<?php echo $dispenser_add->LeftColumnClass ?>"><?php echo $dispenser->initiated_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $dispenser_add->RightColumnClass ?>"><div<?php echo $dispenser->initiated_by->CellAttributes() ?>>
<?php if ($dispenser->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fdispenseradd.CreateAutoSuggest({"id":"x_initiated_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_dispenser_initiated_by">
...
<?php if (!$dispenser_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $dispenser_add->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($dispenser->CurrentAction <> "F") { // Confirm page ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $dispenser_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
