...
$requisition_module = NULL;

//
// Table class for requisition_module
//
class crequisition_module extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'requisition_module';
		$this->TableName = 'requisition_module';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`requisition_module`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// code
		$this->code = new cField('requisition_module', 'requisition_module', 'x_code', 'code', '`code`', '`code`', 3, -1, FALSE, '`code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->code->Sortable = TRUE; // Allow sort
		$this->code->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['code'] = &$this->code;

		// date
		$this->date = new cField('requisition_module', 'requisition_module', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 17, "DB"), 135, 17, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->date->Sortable = TRUE; // Allow sort
		$this->fields['date'] = &$this->date;

		// reference
		$this->reference = new cField('requisition_module', 'requisition_module', 'x_reference', 'reference', '`reference`', '`reference`', 200, -1, FALSE, '`reference`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference->Sortable = TRUE; // Allow sort
		$this->fields['reference'] = &$this->reference;

		// staff_id
		$this->staff_id = new cField('requisition_module', 'requisition_module', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 3, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// outward_location
		$this->outward_location = new cField('requisition_module', 'requisition_module', 'x_outward_location', 'outward_location', '`outward_location`', '`outward_location`', 200, -1, FALSE, '`outward_location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->outward_location->Sortable = TRUE; // Allow sort
		$this->fields['outward_location'] = &$this->outward_location;

		// delivery_point
		$this->delivery_point = new cField('requisition_module', 'requisition_module', 'x_delivery_point', 'delivery_point', '`delivery_point`', '`delivery_point`', 200, -1, FALSE, '`delivery_point`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->delivery_point->Sortable = TRUE; // Allow sort
		$this->fields['delivery_point'] = &$this->delivery_point;

		// name
		$this->name = new cField('requisition_module', 'requisition_module', 'x_name', 'name', '`name`', '`name`', 200, -1, FALSE, '`name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->name->Sortable = TRUE; // Allow sort
		$this->fields['name'] = &$this->name;

		// organization
		$this->organization = new cField('requisition_module', 'requisition_module', 'x_organization', 'organization', '`organization`', '`organization`', 200, -1, FALSE, '`organization`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->organization->Sortable = TRUE; // Allow sort
		$this->fields['organization'] = &$this->organization;

		// designation
		$this->designation = new cField('requisition_module', 'requisition_module', 'x_designation', 'designation', '`designation`', '`designation`', 200, -1, FALSE, '`designation`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->designation->Sortable = TRUE; // Allow sort
		$this->fields['designation'] = &$this->designation;

		// department
		$this->department = new cField('requisition_module', 'requisition_module', 'x_department', 'department', '`department`', '`department`', 200, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->fields['department'] = &$this->department;

		// item_description
		$this->item_description = new cField('requisition_module', 'requisition_module', 'x_item_description', 'item_description', '`item_description`', '`item_description`', 200, -1, FALSE, '`item_description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->item_description->Sortable = TRUE; // Allow sort
		$this->fields['item_description'] = &$this->item_description;

		// driver_name
		$this->driver_name = new cField('requisition_module', 'requisition_module', 'x_driver_name', 'driver_name', '`driver_name`', '`driver_name`', 200, -1, FALSE, '`driver_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->driver_name->Sortable = TRUE; // Allow sort
		$this->fields['driver_name'] = &$this->driver_name;

		// vehicle_no
		$this->vehicle_no = new cField('requisition_module', 'requisition_module', 'x_vehicle_no', 'vehicle_no', '`vehicle_no`', '`vehicle_no`', 200, -1, FALSE, '`vehicle_no`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->vehicle_no->Sortable = TRUE; // Allow sort
		$this->fields['vehicle_no'] = &$this->vehicle_no;

		// requester_action
		$this->requester_action = new cField('requisition_module', 'requisition_module', 'x_requester_action', 'requester_action', '`requester_action`', '`requester_action`', 3, -1, FALSE, '`requester_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// requester_comment
		$this->requester_comment = new cField('requisition_module', 'requisition_module', 'x_requester_comment', 'requester_comment', '`requester_comment`', '`requester_comment`', 200, -1, FALSE, '`requester_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->requester_comment->Sortable = TRUE; // Allow sort
		$this->fields['requester_comment'] = &$this->requester_comment;

		// date_authorized
		$this->date_authorized = new cField('requisition_module', 'requisition_module', 'x_date_authorized', 'date_authorized', '`date_authorized`', ew_CastDateFieldForLike('`date_authorized`', 17, "DB"), 135, 17, FALSE, '`date_authorized`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->date_authorized->Sortable = TRUE; // Allow sort
		$this->fields['date_authorized'] = &$this->date_authorized;

		// authorizer_name
		$this->authorizer_name = new cField('requisition_module', 'requisition_module', 'x_authorizer_name', 'authorizer_name', '`authorizer_name`', '`authorizer_name`', 200, -1, FALSE, '`authorizer_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->authorizer_name->Sortable = TRUE; // Allow sort
		$this->fields['authorizer_name'] = &$this->authorizer_name;

		// authorizer_action
		$this->authorizer_action = new cField('requisition_module', 'requisition_module', 'x_authorizer_action', 'authorizer_action', '`authorizer_action`', '`authorizer_action`', 3, -1, FALSE, '`authorizer_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// authorizer_comment
		$this->authorizer_comment = new cField('requisition_module', 'requisition_module', 'x_authorizer_comment', 'authorizer_comment', '`authorizer_comment`', '`authorizer_comment`', 200, -1, FALSE, '`authorizer_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->authorizer_comment->Sortable = TRUE; // Allow sort
		$this->fields['authorizer_comment'] = &$this->authorizer_comment;

		// status
		$this->status = new cField('requisition_module', 'requisition_module', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// rep_date
		$this->rep_date = new cField('requisition_module', 'requisition_module', 'x_rep_date', 'rep_date', '`rep_date`', ew_CastDateFieldForLike('`rep_date`', 17, "DB"), 133, 17, FALSE, '`rep_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rep_name
		$this->rep_name = new cField('requisition_module', 'requisition_module', 'x_rep_name', 'rep_name', '`rep_name`', '`rep_name`', 200, -1, FALSE, '`rep_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rep_name->Sortable = TRUE; // Allow sort
		$this->fields['rep_name'] = &$this->rep_name;

		// outward_datetime
		$this->outward_datetime = new cField('requisition_module', 'requisition_module', 'x_outward_datetime', 'outward_datetime', '`outward_datetime`', ew_CastDateFieldForLike('`outward_datetime`', 17, "DB"), 135, 17, FALSE, '`outward_datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// rep_action
		$this->rep_action = new cField('requisition_module', 'requisition_module', 'x_rep_action', 'rep_action', '`rep_action`', '`rep_action`', 3, -1, FALSE, '`rep_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// rep_comment
		$this->rep_comment = new cField('requisition_module', 'requisition_module', 'x_rep_comment', 'rep_comment', '`rep_comment`', '`rep_comment`', 200, -1, FALSE, '`rep_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`requisition_module`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "requisition_modulelist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "requisition_moduleedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "requisition_moduleadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("requisition_moduleview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("requisition_moduleview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "requisition_moduleadd.php?" . $this->UrlParm($parm);
		else
			$url = "requisition_moduleadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("requisition_moduleedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("requisition_moduleadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("requisition_moduledelete.php", $this->UrlParm());
	}
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		if (CurrentPageID() == "add" && CurrentUserLevel() == 12) {

			// Save and forward
			if ($this->requester_action->CurrentValue == 1) {
				$rsnew["status"] = 1;
				$rsnew["requester_action"] = 1;
			...
			// Saved only
			if ($this->requester_action->CurrentValue == 0) {
				$rsnew["status"] = 0;			
				$rsnew["requester_action"] = 0; 
	...
	function Row_Updating($rsold, &$rsnew) {
		...
		// Officer Only
			if (CurrentPageID() == "edit" && CurrentUserLevel() == 12) {

			// Save and forward
			if ($this->requester_action->CurrentValue == 1 && $this->status->CurrentValue == 0) {
				$rsnew["status"] = 1;
				$rsnew["requester_action"] = 1;
				$rsnew["authorizer_action"] = NULL;
				$rsnew["authorizer_comment"] = NULL;
				$this->setSuccessMessage("&#x25C9; Requisition sent for Review and Approval &#x2714;"); 					
			}
		...
		if ((CurrentPageID() == "edit" && CurrentUserLevel() == 12 || CurrentUserLevel() == 14)) {
			...
			$rsnew["outward_location"] = $rsold["outward_location"];
			$rsnew["delivery_point"] = $rsold["delivery_point"];
			$rsnew["name"] = $rsold["name"];
			$rsnew["organization"] = $rsold["organization"];
			$rsnew["department"] = $rsold["department"];
			$rsnew["designation"] = $rsold["designation"];
			$rsnew["item_description"] = $rsold["item_description"];
			$rsnew["driver_name"] = $rsold["driver_name"];
			$rsnew["vehicle_no"] = $rsold["vehicle_no"];

			//$rsnew["status"] = $rsold["status"];
			$rsnew["requester_action"] = $rsold["requester_action"];
			$rsnew["requester_comment"] = $rsold["requester_comment"];
		...
		// Warehouse Rep Area
		   if ((CurrentPageID() == "edit" && CurrentUserLevel() == 13 || CurrentUserLevel() == 14)) {
			...
			$rsnew["rep_name"] = $_SESSION['Staff_ID'];
		}
		...
		if ((CurrentPageID() == "edit" && CurrentUserLevel() == 13 || CurrentUserLevel() == 14)) {
			...
			$rsnew["requester_action"] = $rsold["requester_action"];
			$rsnew["requester_comment"] = $rsold["requester_comment"];
			$rsnew["authorizer_action"] = $rsold["authorizer_action"];
			$rsnew["authorizer_comment"] = $rsold["authorizer_comment"];
			...
			if ((CurrentPageID() == "edit" && CurrentUserLevel() == 13 || CurrentUserLevel() == 14) && $this->staff_id->CurrentValue != $_SESSION['Staff_ID']) {
				...
				$rsnew["authorizer_name"] = $_SESSION['Staff_ID'];
			   	...
			   	// Approved by Authorizer
				if ($this->authorizer_action->CurrentValue == 0) {

					// New
					if ($this->status->CurrentValue == 1) {
						$rsnew["status"] = 2;					
						$rsnew["authorizer_action"] = 0;
					}
					$this->setSuccessMessage("&#x25CE;  Requisition Successfully Declined &#x2718;");

					//$this->setSuccessMessage("&#x25C9; Requisition Declined &#x2714;");
				}

				// Approved by Authorizer
				if ($this->authorizer_action->CurrentValue == 1 ) {

					// New
					if ($this->status->CurrentValue == 1) {
						$rsnew["status"] = 3;					
						$rsnew["authorizer_action"] = 1;
					}
					$this->setSuccessMessage("&#x25C9; Requisition successfully Authorized and Sent for Issuance &#x2714;");
				}
			}
			...
			if (CurrentPageID() == "edit" && CurrentUserLevel() == 9) {
				...
				$rsnew["rep_name"] = $_SESSION['Staff_ID'];
			   	...
			   	// Verified by Guard
				if ($this->rep_action->CurrentValue == 0) {
				...
				// Verified by Guard
				if ($this->rep_action->CurrentValue == 1) {
					...
					$this->setSuccessMessage("&#x25C9; Items Requisition Successfully Issued &#x2714;");
				}
			}
		return TRUE;
	}
	...
	function Row_Rendering() {
		...
		if (CurrentPageID() == "add" && (CurrentUserLevel() == 12 || CurrentUserLevel()   == 13 || CurrentUserLevel() == 14)) {
			$this->staff_id->CurrentValue = $_SESSION['Staff_ID'];
			$this->staff_id->EditValue = $this->staff_id->CurrentValue;
			$this->name->CurrentValue = $_SESSION['Staff_ID'];
			$this->name->EditValue = $this->name->CurrentValue;
			$this->organization->CurrentValue = $_SESSION['Branch'];
			$this->organization->EditValue = $this->organization->CurrentValue;
			$this->designation->CurrentValue = $_SESSION['Designation'];
			$this->designation->EditValue = $this->designation->CurrentValue;
			$this->department->CurrentValue = $_SESSION['Department'];
			$this->department->EditValue = $this->department->CurrentValue;
		}
		if (CurrentPageID() == "add")  {
			$this->reference->CurrentValue = $_SESSION['REQ_ID'];
			$this->reference->EditValue = $this->reference->CurrentValue;
		}
		if (CurrentPageID() == "edit" && CurrentUserLevel() == 13 ) {
			date_default_timezone_set('Africa/Lagos');
			$now = new DateTime();
		...
		if (CurrentPageID() == "edit" && CurrentUserLevel() == 9 ) {
			date_default_timezone_set('Africa/Lagos');
			$now = new DateTime();
			$this->rep_date->CurrentValue = $now->Format('Y-m-d H:i:s');
			$this->rep_date->EditValue = $this->rep_date->CurrentValue;
			$this->rep_name->CurrentValue = $_SESSION['Staff_ID'];
			$this->rep_name->EditValue = $this->rep_name->CurrentValue;
		}
	}
		...
		// Edit Page
		 if (CurrentPageID() == "edit") {
			...
			if (CurrentUserLevel() == 9) {
			  ...
			  $this->requester_comment->ReadOnly = TRUE;
			  $this->date_authorized->ReadOnly = TRUE;
			  $this->authorizer_action->ReadOnly = TRUE;
			  $this->authorizer_name->ReadOnly = TRUE;
			  $this->authorizer_comment->ReadOnly = TRUE;
			  $this->rep_date->ReadOnly = TRUE;
			  $this->rep_action->Visible = TRUE;
