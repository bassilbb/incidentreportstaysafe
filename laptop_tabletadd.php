...
$laptop_tablet_add = NULL; // Initialize page object first

class claptop_tablet_add extends claptop_tablet {
	...
	// Page object name
	var $PageObjName = 'laptop_tablet_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("laptop_tabletlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "laptop_tabletview.php")
...
// Create page object
if (!isset($laptop_tablet_add)) $laptop_tablet_add = new claptop_tablet_add();

// Page init
$laptop_tablet_add->Page_Init();

// Page main
$laptop_tablet_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$laptop_tablet_add->Page_Render();
?>
...
var CurrentForm = flaptop_tabletadd = new ew_Form("flaptop_tabletadd", "add");

// Validate form
flaptop_tabletadd.Validate = function() {
...
flaptop_tabletadd.Form_CustomValidate = 
...
flaptop_tabletadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $laptop_tablet_add->ShowPageHeader(); ?>
<?php
$laptop_tablet_add->ShowMessage();
?>
<form name="flaptop_tabletadd" id="flaptop_tabletadd" class="<?php echo $laptop_tablet_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($laptop_tablet_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $laptop_tablet_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="laptop_tablet">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($laptop_tablet_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($laptop_tablet->asset_tag->Visible) { // asset_tag ?>
	<div id="r_asset_tag" class="form-group">
		<label id="elh_laptop_tablet_asset_tag" for="x_asset_tag" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->asset_tag->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->asset_tag->CellAttributes() ?>>
...
<?php if ($laptop_tablet->start_sate->Visible) { // start_sate ?>
	<div id="r_start_sate" class="form-group">
		<label id="elh_laptop_tablet_start_sate" for="x_start_sate" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->start_sate->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->start_sate->CellAttributes() ?>>
...
<?php if ($laptop_tablet->end_date->Visible) { // end_date ?>
	<div id="r_end_date" class="form-group">
		<label id="elh_laptop_tablet_end_date" for="x_end_date" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->end_date->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->end_date->CellAttributes() ?>>
...
<?php if ($laptop_tablet->cost_for_repair->Visible) { // cost_for_repair ?>
	<div id="r_cost_for_repair" class="form-group">
		<label id="elh_laptop_tablet_cost_for_repair" for="x_cost_for_repair" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->cost_for_repair->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->cost_for_repair->CellAttributes() ?>>
...
<?php if ($laptop_tablet->service_provider->Visible) { // service_provider ?>
	<div id="r_service_provider" class="form-group">
		<label id="elh_laptop_tablet_service_provider" for="x_service_provider" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->service_provider->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->service_provider->CellAttributes() ?>>
...
<?php if ($laptop_tablet->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_laptop_tablet_address" for="x_address" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->address->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->address->CellAttributes() ?>>
...
<?php if ($laptop_tablet->type_of_repair->Visible) { // type_of_repair ?>
	<div id="r_type_of_repair" class="form-group">
		<label id="elh_laptop_tablet_type_of_repair" for="x_type_of_repair" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->type_of_repair->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->type_of_repair->CellAttributes() ?>>
...
<?php if ($laptop_tablet->note->Visible) { // note ?>
	<div id="r_note" class="form-group">
		<label id="elh_laptop_tablet_note" for="x_note" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->note->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->note->CellAttributes() ?>>
...
<?php if ($laptop_tablet->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_laptop_tablet_status" for="x_status" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->status->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->status->CellAttributes() ?>>
...
<?php if ($laptop_tablet->asset_category->Visible) { // asset_category ?>
	<div id="r_asset_category" class="form-group">
		<label id="elh_laptop_tablet_asset_category" for="x_asset_category" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->asset_category->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->asset_category->CellAttributes() ?>>
...
<?php if ($laptop_tablet->asset_sub_category->Visible) { // asset_sub_category ?>
	<div id="r_asset_sub_category" class="form-group">
		<label id="elh_laptop_tablet_asset_sub_category" for="x_asset_sub_category" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->asset_sub_category->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->asset_sub_category->CellAttributes() ?>>
...
<?php if ($laptop_tablet->serial_number->Visible) { // serial_number ?>
	<div id="r_serial_number" class="form-group">
		<label id="elh_laptop_tablet_serial_number" for="x_serial_number" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->serial_number->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->serial_number->CellAttributes() ?>>
...
<?php if ($laptop_tablet->programe_area->Visible) { // programe_area ?>
	<div id="r_programe_area" class="form-group">
		<label id="elh_laptop_tablet_programe_area" for="x_programe_area" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->programe_area->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->programe_area->CellAttributes() ?>>
...
<?php if ($laptop_tablet->division->Visible) { // division ?>
	<div id="r_division" class="form-group">
		<label id="elh_laptop_tablet_division" for="x_division" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->division->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->division->CellAttributes() ?>>
...
<?php if ($laptop_tablet->branch->Visible) { // branch ?>
	<div id="r_branch" class="form-group">
		<label id="elh_laptop_tablet_branch" for="x_branch" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->branch->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->branch->CellAttributes() ?>>
...
<?php if ($laptop_tablet->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label id="elh_laptop_tablet_department" for="x_department" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->department->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->department->CellAttributes() ?>>
...
<?php if ($laptop_tablet->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_laptop_tablet_staff_id" for="x_staff_id" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->staff_id->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->staff_id->CellAttributes() ?>>
...
<?php if ($laptop_tablet->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_laptop_tablet_created_by" for="x_created_by" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->created_by->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->created_by->CellAttributes() ?>>
...
<?php if ($laptop_tablet->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_laptop_tablet_created_date" for="x_created_date" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->created_date->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->created_date->CellAttributes() ?>>
...
<?php if ($laptop_tablet->device_number->Visible) { // device_number ?>
	<div id="r_device_number" class="form-group">
		<label id="elh_laptop_tablet_device_number" for="x_device_number" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->device_number->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->device_number->CellAttributes() ?>>
...
<?php if ($laptop_tablet->tablet_imie_number->Visible) { // tablet_imie_number ?>
	<div id="r_tablet_imie_number" class="form-group">
		<label id="elh_laptop_tablet_tablet_imie_number" for="x_tablet_imie_number" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->tablet_imie_number->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->tablet_imie_number->CellAttributes() ?>>
...
<?php if ($laptop_tablet->model->Visible) { // model ?>
	<div id="r_model" class="form-group">
		<label id="elh_laptop_tablet_model" for="x_model" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->model->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->model->CellAttributes() ?>>
...
<?php if ($laptop_tablet->flag->Visible) { // flag ?>
	<div id="r_flag" class="form-group">
		<label id="elh_laptop_tablet_flag" for="x_flag" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->flag->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->flag->CellAttributes() ?>>
...
<?php if ($laptop_tablet->area->Visible) { // area ?>
	<div id="r_area" class="form-group">
		<label id="elh_laptop_tablet_area" for="x_area" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->area->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->area->CellAttributes() ?>>
...
<?php if ($laptop_tablet->updated_date->Visible) { // updated_date ?>
	<div id="r_updated_date" class="form-group">
		<label id="elh_laptop_tablet_updated_date" for="x_updated_date" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->updated_date->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->updated_date->CellAttributes() ?>>
...
<?php if ($laptop_tablet->updated_by->Visible) { // updated_by ?>
	<div id="r_updated_by" class="form-group">
		<label id="elh_laptop_tablet_updated_by" for="x_updated_by" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->updated_by->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->updated_by->CellAttributes() ?>>
...
<?php if ($laptop_tablet->received_date->Visible) { // received_date ?>
	<div id="r_received_date" class="form-group">
		<label id="elh_laptop_tablet_received_date" for="x_received_date" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->received_date->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->received_date->CellAttributes() ?>>
...
<?php if ($laptop_tablet->received_by->Visible) { // received_by ?>
	<div id="r_received_by" class="form-group">
		<label id="elh_laptop_tablet_received_by" for="x_received_by" class="<?php echo $laptop_tablet_add->LeftColumnClass ?>"><?php echo $laptop_tablet->received_by->FldCaption() ?></label>
		<div class="<?php echo $laptop_tablet_add->RightColumnClass ?>"><div<?php echo $laptop_tablet->received_by->CellAttributes() ?>>
...
<?php if (!$laptop_tablet_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $laptop_tablet_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $laptop_tablet_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
flaptop_tabletadd.Init();
</script>
<?php
$laptop_tablet_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$laptop_tablet_add->Page_Terminate();
?>
