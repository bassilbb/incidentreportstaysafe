...
class cloan_application_add extends cloan_application {
	...
	function LoadDefaultValues() {
		...
		$this->correction_action->CurrentValue = NULL;
		$this->correction_action->OldValue = $this->correction_action->CurrentValue;
		$this->correction_comment->CurrentValue = NULL;
		$this->correction_comment->OldValue = $this->correction_comment->CurrentValue;
		$this->corrected_by->CurrentValue = NULL;
		$this->corrected_by->OldValue = $this->corrected_by->CurrentValue;
	}
	...
	function NewRow() {
		...
		$row['correction_action'] = $this->correction_action->CurrentValue;
		$row['correction_comment'] = $this->correction_comment->CurrentValue;
		$row['corrected_by'] = $this->corrected_by->CurrentValue;
		return $row;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// duration_approved
		$this->duration_approved->SetDbValueDef($rsnew, $this->duration_approved->CurrentValue, NULL, FALSE);
		...
		// correction_date
		$this->correction_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->correction_date->CurrentValue, 0), NULL, FALSE);

		// correction_action
		$this->correction_action->SetDbValueDef($rsnew, $this->correction_action->CurrentValue, NULL, FALSE);

		// correction_comment
		$this->correction_comment->SetDbValueDef($rsnew, $this->correction_comment->CurrentValue, NULL, FALSE);

		// corrected_by
		$this->corrected_by->SetDbValueDef($rsnew, $this->corrected_by->CurrentValue, NULL, FALSE);
		if ($this->applicant_passport->Visible && !$this->applicant_passport->Upload->KeepFile) {
...
floan_applicationadd.Lists["x_correction_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
floan_applicationadd.Lists["x_correction_action"].Options = <?php echo json_encode($loan_application_add->correction_action->Options()) ?>;
floan_applicationadd.Lists["x_corrected_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
floan_applicationadd.Lists["x_corrected_by"].Data = "<?php echo $loan_application_add->corrected_by->LookupFilterQuery(FALSE, "add") ?>";
floan_applicationadd.AutoSuggests["x_corrected_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $loan_application_add->corrected_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php if ($loan_application->correction_date->Visible) { // correction_date ?>
	<div id="r_correction_date" class="form-group">
		<label id="elh_loan_application_correction_date" for="x_correction_date" class="<?php echo $loan_application_add->LeftColumnClass ?>"><?php echo $loan_application->correction_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $loan_application_add->RightColumnClass ?>"><div<?php echo $loan_application->correction_date->CellAttributes() ?>>
...
<?php if ($loan_application->correction_action->Visible) { // correction_action ?>
	<div id="r_correction_action" class="form-group">
		<label id="elh_loan_application_correction_action" class="<?php echo $loan_application_add->LeftColumnClass ?>"><?php echo $loan_application->correction_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $loan_application_add->RightColumnClass ?>"><div<?php echo $loan_application->correction_action->CellAttributes() ?>>
...
<?php if ($loan_application->correction_comment->Visible) { // correction_comment ?>
	<div id="r_correction_comment" class="form-group">
		<label id="elh_loan_application_correction_comment" for="x_correction_comment" class="<?php echo $loan_application_add->LeftColumnClass ?>"><?php echo $loan_application->correction_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $loan_application_add->RightColumnClass ?>"><div<?php echo $loan_application->correction_comment->CellAttributes() ?>>
...
<?php if ($loan_application->corrected_by->Visible) { // corrected_by ?>
	<div id="r_corrected_by" class="form-group">
		<label id="elh_loan_application_corrected_by" class="<?php echo $loan_application_add->LeftColumnClass ?>"><?php echo $loan_application->corrected_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $loan_application_add->RightColumnClass ?>"><div<?php echo $loan_application->corrected_by->CellAttributes() ?>>
...
<script type="text/javascript">
floan_applicationadd.CreateAutoSuggest({"id":"x_corrected_by","forceSelect":false});
</script>
</span>
