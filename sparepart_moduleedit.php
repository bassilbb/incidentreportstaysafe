...
$sparepart_module_edit = NULL; // Initialize page object first

class csparepart_module_edit extends csparepart_module {
	...
	// Page object name
	var $PageObjName = 'sparepart_module_edit';
	...
	function Page_Main() {
		...
		switch ($this->CurrentAction) {
			...
			Case "U": // Update
				...
				if (ew_GetPageName($sReturnUrl) == "sparepart_modulelist.php")
	...
	function RenderRow() {
		...
		$this->gen_maintenance->ViewCustomAttributes = "";
			...
			$this->part_name->EditValue = ew_HtmlEncode($this->part_name->CurrentValue);
...
// Create page object
if (!isset($sparepart_module_edit)) $sparepart_module_edit = new csparepart_module_edit();

// Page init
$sparepart_module_edit->Page_Init();

// Page main
$sparepart_module_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sparepart_module_edit->Page_Render();
?>
...
var CurrentForm = fsparepart_moduleedit = new ew_Form("fsparepart_moduleedit", "edit");

// Validate form
fsparepart_moduleedit.Validate = function() {
...
fsparepart_moduleedit.Form_CustomValidate = 
...
fsparepart_moduleedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $sparepart_module_edit->ShowPageHeader(); ?>
<?php
$sparepart_module_edit->ShowMessage();
?>
<?php if (!$sparepart_module_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($sparepart_module_edit->Pager)) $sparepart_module_edit->Pager = new cPrevNextPager($sparepart_module_edit->StartRec, $sparepart_module_edit->DisplayRecs, $sparepart_module_edit->TotalRecs, $sparepart_module_edit->AutoHidePager) ?>
<?php if ($sparepart_module_edit->Pager->RecordCount > 0 && $sparepart_module_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($sparepart_module_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $sparepart_module_edit->PageUrl() ?>start=<?php echo $sparepart_module_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($sparepart_module_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $sparepart_module_edit->PageUrl() ?>start=<?php echo $sparepart_module_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $sparepart_module_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($sparepart_module_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $sparepart_module_edit->PageUrl() ?>start=<?php echo $sparepart_module_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($sparepart_module_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $sparepart_module_edit->PageUrl() ?>start=<?php echo $sparepart_module_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $sparepart_module_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fsparepart_moduleedit" id="fsparepart_moduleedit" class="<?php echo $sparepart_module_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sparepart_module_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sparepart_module_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="sparepart_module">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($sparepart_module_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($sparepart_module->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_sparepart_module_id" class="<?php echo $sparepart_module_edit->LeftColumnClass ?>"><?php echo $sparepart_module->id->FldCaption() ?></label>
		<div class="<?php echo $sparepart_module_edit->RightColumnClass ?>"><div<?php echo $sparepart_module->id->CellAttributes() ?>>
<span id="el_sparepart_module_id">
<span<?php echo $sparepart_module->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $sparepart_module->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="sparepart_module" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($sparepart_module->id->CurrentValue) ?>">
<?php echo $sparepart_module->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php echo $sparepart_module->part_name->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php echo $sparepart_module->quantity->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $sparepart_module_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $sparepart_module_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fsparepart_moduleedit.Init();
</script>
<?php
$sparepart_module_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$sparepart_module_edit->Page_Terminate();
?>
