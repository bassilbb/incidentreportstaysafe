...
$issunacestore_view = NULL;

//
// Table class for issunacestore_view
//
class cissunacestore_view extends cTable {
	var $id;
	var $date;
	var $reference_id;
	var $material_name;
	...
	function __construct() {
		...
		$this->TableVar = 'issunacestore_view';
		$this->TableName = 'issunacestore_view';
		$this->TableType = 'VIEW';
		...
		// id
		$this->id = new cField('issunacestore_view', 'issunacestore_view', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date
		$this->date = new cField('issunacestore_view', 'issunacestore_view', 'x_date', 'date', '`date`', ew_CastDateFieldForLike('`date`', 17, "DB"), 135, 17, FALSE, '`date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reference_id
		$this->reference_id = new cField('issunacestore_view', 'issunacestore_view', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// material_name
		$this->material_name = new cField('issunacestore_view', 'issunacestore_view', 'x_material_name', 'material_name', '`material_name`', '`material_name`', 200, -1, FALSE, '`material_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// quantity_in
		$this->quantity_in = new cField('issunacestore_view', 'issunacestore_view', 'x_quantity_in', 'quantity_in', '`quantity_in`', '`quantity_in`', 200, -1, FALSE, '`quantity_in`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity_in->Sortable = TRUE; // Allow sort
		$this->fields['quantity_in'] = &$this->quantity_in;

		// quantity_out
		$this->quantity_out = new cField('issunacestore_view', 'issunacestore_view', 'x_quantity_out', 'quantity_out', '`quantity_out`', '`quantity_out`', 200, -1, FALSE, '`quantity_out`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity_out->Sortable = TRUE; // Allow sort
		$this->fields['quantity_out'] = &$this->quantity_out;

		// total_quantity
		$this->total_quantity = new cField('issunacestore_view', 'issunacestore_view', 'x_total_quantity', 'total_quantity', '`total_quantity`', '`total_quantity`', 200, -1, FALSE, '`total_quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total_quantity->Sortable = TRUE; // Allow sort
		$this->fields['total_quantity'] = &$this->total_quantity;

		// quantity_type
		$this->quantity_type = new cField('issunacestore_view', 'issunacestore_view', 'x_quantity_type', 'quantity_type', '`quantity_type`', '`quantity_type`', 200, -1, FALSE, '`quantity_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity_type->Sortable = TRUE; // Allow sort
		$this->fields['quantity_type'] = &$this->quantity_type;

		// treated_by
		$this->treated_by = new cField('issunacestore_view', 'issunacestore_view', 'x_treated_by', 'treated_by', '`treated_by`', '`treated_by`', 3, -1, FALSE, '`treated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->treated_by->Sortable = TRUE; // Allow sort
		$this->fields['treated_by'] = &$this->treated_by;

		// staff_id
		$this->staff_id = new cField('issunacestore_view', 'issunacestore_view', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 3, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// statuss
		$this->statuss = new cField('issunacestore_view', 'issunacestore_view', 'x_statuss', 'statuss', '`statuss`', '`statuss`', 3, -1, FALSE, '`statuss`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// issued_action
		$this->issued_action = new cField('issunacestore_view', 'issunacestore_view', 'x_issued_action', 'issued_action', '`issued_action`', '`issued_action`', 3, -1, FALSE, '`issued_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// issued_comment
		$this->issued_comment = new cField('issunacestore_view', 'issunacestore_view', 'x_issued_comment', 'issued_comment', '`issued_comment`', '`issued_comment`', 200, -1, FALSE, '`issued_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->issued_comment->Sortable = TRUE; // Allow sort
		$this->fields['issued_comment'] = &$this->issued_comment;

		// issued_by
		$this->issued_by = new cField('issunacestore_view', 'issunacestore_view', 'x_issued_by', 'issued_by', '`issued_by`', '`issued_by`', 3, -1, FALSE, '`issued_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->issued_by->Sortable = TRUE; // Allow sort
		$this->fields['issued_by'] = &$this->issued_by;

		// approver_date
		$this->approver_date = new cField('issunacestore_view', 'issunacestore_view', 'x_approver_date', 'approver_date', '`approver_date`', ew_CastDateFieldForLike('`approver_date`', 0, "DB"), 135, 0, FALSE, '`approver_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// approver_action
		$this->approver_action = new cField('issunacestore_view', 'issunacestore_view', 'x_approver_action', 'approver_action', '`approver_action`', '`approver_action`', 3, -1, FALSE, '`approver_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approver_comment
		$this->approver_comment = new cField('issunacestore_view', 'issunacestore_view', 'x_approver_comment', 'approver_comment', '`approver_comment`', '`approver_comment`', 200, -1, FALSE, '`approver_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->approver_comment->Sortable = TRUE; // Allow sort
		$this->fields['approver_comment'] = &$this->approver_comment;

		// approved_by
		$this->approved_by = new cField('issunacestore_view', 'issunacestore_view', 'x_approved_by', 'approved_by', '`approved_by`', '`approved_by`', 3, -1, FALSE, '`approved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->approved_by->Sortable = TRUE; // Allow sort
		$this->fields['approved_by'] = &$this->approved_by;

		// verified_date
		$this->verified_date = new cField('issunacestore_view', 'issunacestore_view', 'x_verified_date', 'verified_date', '`verified_date`', ew_CastDateFieldForLike('`verified_date`', 0, "DB"), 135, 0, FALSE, '`verified_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// verified_action
		$this->verified_action = new cField('issunacestore_view', 'issunacestore_view', 'x_verified_action', 'verified_action', '`verified_action`', '`verified_action`', 3, -1, FALSE, '`verified_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// verified_comment
		$this->verified_comment = new cField('issunacestore_view', 'issunacestore_view', 'x_verified_comment', 'verified_comment', '`verified_comment`', '`verified_comment`', 200, -1, FALSE, '`verified_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->verified_comment->Sortable = TRUE; // Allow sort
		$this->fields['verified_comment'] = &$this->verified_comment;

		// verified_by
		$this->verified_by = new cField('issunacestore_view', 'issunacestore_view', 'x_verified_by', 'verified_by', '`verified_by`', '`verified_by`', 3, -1, FALSE, '`verified_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`issunacestore_view`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "issunacestore_viewlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "issunacestore_viewview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "issunacestore_viewedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "issunacestore_viewadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("issunacestore_viewview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("issunacestore_viewview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "issunacestore_viewadd.php?" . $this->UrlParm($parm);
		else
			$url = "issunacestore_viewadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("issunacestore_viewedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("issunacestore_viewadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("issunacestore_viewdelete.php", $this->UrlParm());
	}
