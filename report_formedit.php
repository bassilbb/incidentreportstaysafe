...
class creport_form_edit extends creport_form {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// end_date
			$this->end_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->end_date->CurrentValue, 7), NULL, $this->end_date->ReadOnly);
			...
			// rejection_reasons
			$this->rejection_reasons->SetDbValueDef($rsnew, $this->rejection_reasons->CurrentValue, NULL, $this->rejection_reasons->ReadOnly);
			...
			// assign
			$this->assign->SetDbValueDef($rsnew, $this->assign->CurrentValue, NULL, $this->assign->ReadOnly);
			...
			// quantity_issued
			$this->quantity_issued->SetDbValueDef($rsnew, $this->quantity_issued->CurrentValue, NULL, $this->quantity_issued->ReadOnly);
			...
			// last_updated_date
			$this->last_updated_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->last_updated_date->CurrentValue, 17), ew_CurrentDate(), $this->last_updated_date->ReadOnly);

			// last_updated_by
			$this->last_updated_by->SetDbValueDef($rsnew, $this->last_updated_by->CurrentValue, NULL, $this->last_updated_by->ReadOnly);

			// verified_datetime
			$this->verified_datetime->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->verified_datetime->CurrentValue, 17), NULL, $this->verified_datetime->ReadOnly);
	...
	function Page_Load() {
		...
		//echo "Page Load";
			ew_SetClientVar("GetStock_item", ew_Encrypt("SELECT `quantity`,`material_name` FROM `inventory` WHERE `id`= {query_value}"));
	}
	...
	function Form_CustomValidate(&$CustomError) {
		...
		if(CurrentUserLevel() == 2 && $rs["resolved_action"] == '') {
			$CustomError = "Please enter required field - Resolved Action!";
			return FALSE;
		}	
		if(CurrentUserLevel() == 2 && $rs["resolved_comment"] == '') {
			$CustomError = "Please enter required field - Resolved Comment!";
			return FALSE;
		}
		if(CurrentUserLevel() == 3 && $rs["status"] == 3 && $rs["assign_task"] != '' && $rs["approval_action"] == '') {
			$CustomError = "Please enter required field - Approval Action!";
			return FALSE;
		}	
		if(CurrentUserLevel() == 3 && $rs["status"] == 3 && $rs["assign_task"] != '' && $rs["approval_comment"] == '') {
...
freport_formedit.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_form_edit->staff_id->LookupFilterQuery(TRUE, "edit"))) ?>;
...
freport_formedit.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":["x_category"],"ChildFields":["x_sub_sub_category[]"],"FilterFields":["x_category_id"],"Options":[],"Template":"","LinkTable":"sub_category"};
freport_formedit.Lists["x_sub_category"].Data = "<?php echo $report_form_edit->sub_category->LookupFilterQuery(FALSE, "edit") ?>";
freport_formedit.Lists["x_sub_sub_category[]"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_sub_category"],"ChildFields":["x_selection_sub_category[]"],"FilterFields":["x_sub_category_id"],"Options":[],"Template":"","LinkTable":"sub_sub_category"};
freport_formedit.Lists["x_sub_sub_category[]"].Data = "<?php echo $report_form_edit->sub_sub_category->LookupFilterQuery(FALSE, "edit") ?>";
freport_formedit.Lists["x_selection_sub_category[]"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_sub_sub_category[]"],"ChildFields":[],"FilterFields":["x_code"],"Options":[],"Template":"","LinkTable":"selection_sub_category"};
freport_formedit.Lists["x_selection_sub_category[]"].Data = "<?php echo $report_form_edit->selection_sub_category->LookupFilterQuery(FALSE, "edit") ?>";
...
freport_formedit.Lists["x_incident_location"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_incident_sub_location"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
freport_formedit.Lists["x_incident_location"].Data = "<?php echo $report_form_edit->incident_location->LookupFilterQuery(FALSE, "edit") ?>";
freport_formedit.Lists["x_incident_sub_location"] = {"LinkField":"x_code_sub","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_incident_location"],"ChildFields":["x_incident_venue"],"FilterFields":["x_code_id"],"Options":[],"Template":"","LinkTable":"incident_sub_location"};
freport_formedit.Lists["x_incident_sub_location"].Data = "<?php echo $report_form_edit->incident_sub_location->LookupFilterQuery(FALSE, "edit") ?>";
freport_formedit.Lists["x_incident_venue"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_incident_sub_location"],"ChildFields":[],"FilterFields":["x_code_sub"],"Options":[],"Template":"","LinkTable":"incident_venue"};
freport_formedit.Lists["x_incident_venue"].Data = "<?php echo $report_form_edit->incident_venue->LookupFilterQuery(FALSE, "edit") ?>";
...
freport_formedit.Lists["x_assign"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freport_formedit.Lists["x_assign"].Data = "<?php echo $report_form_edit->assign->LookupFilterQuery(FALSE, "edit") ?>";
...
freport_formedit.Lists["x_item_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory"};
freport_formedit.Lists["x_item_name"].Data = "<?php echo $report_form_edit->item_name->LookupFilterQuery(FALSE, "edit") ?>";
freport_formedit.Lists["x_reason"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"reason"};
freport_formedit.Lists["x_reason"].Data = "<?php echo $report_form_edit->reason->LookupFilterQuery(FALSE, "edit") ?>";
...
freport_formedit.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
freport_formedit.Lists["x_job_assessment"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freport_formedit.Lists["x_job_assessment"].Options = <?php echo json_encode($report_form_edit->job_assessment->Options()) ?>;
freport_formedit.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freport_formedit.Lists["x_verified_action"].Options = <?php echo json_encode($report_form_edit->verified_action->Options()) ?>;
freport_formedit.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freport_formedit.Lists["x_verified_by"].Data = "<?php echo $report_form_edit->verified_by->LookupFilterQuery(FALSE, "edit") ?>";
freport_formedit.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_form_edit->verified_by->LookupFilterQuery(TRUE, "edit"))) ?>;
freport_formedit.Lists["x_remainder"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
freport_formedit.Lists["x_remainder"].Data = "<?php echo $report_form_edit->remainder->LookupFilterQuery(FALSE, "edit") ?>";
...
var departments = $("#x_departments").val()
	...
	if(departments == 13){
		$("#r_item_name").show();
		$("#r_quantity_issued").show();
		$("#r_remainder").show();
 }else{
	 $("#r_item_name").hide();
	 $("#r_quantity_issued").hide();
	 $("#x_item_name").val('');
	 $("#x_quantity_issued").val('');
	 $("#r_remainder").hide();
	 $("#r_remainder").val('');
 }

	//=================================
	if(currlevel == 3 && status == 6 && $("#x_resolved_action_1").val() == 1){

		//alert($("#x_resolved_action_1").val())
		$("#x_resolved_action_0").attr('disabled',true);
		$("#x_resolved_comment").attr('disabled',true);

		//$("#r_resolved_action").attr('readonly',true);
		//$("#r_resolved_comment").attr('readonly',true);

	}

	//================================
	if(currlevel == 3 && status == 7){

	//alert('yes');
	//alert($("#x_resolved_action_1").val())

	$('#x_resolved_action_0').attr('disabled',true);
	$('#x_resolved_action_1').attr('disabled',true);
...
//============MY NEWEST CODES=======================
$("#x_item_name").on("change", function() {
	var item_name = this.value;
	var quantity_issued = parseInt($("#x_quantity_issued").val())

	//alert(item_name);
	var resultSearchModel = ew_Ajax(ewVar.GetStock_item, item_name);
	if(resultSearchModel !='' ){

		//resultSearchModel;
	   storeQty = parseInt(resultSearchModel[0]);

		 /* if(storeQty > quantity_issued){
			  var newQuantity = storeQty - quantity_issued;
			   $("#x_remainder").val(parseInt(newQuantity));
		  }else{
			 alert('Quantity requested is higher than Stock!');
			 $("#x_quantity_issued").val('');
			  newQuantity = '';
			  $("#x_remainder").val('');
		  }
	   ...
	   //alert(storeQty)*/
	  $('#lnmessage').html('The total quantity in store is: ' + storeQty);
	  }else{
			storeQty='';
	  } 
});
...
//====================================================//
$("#x_quantity_issued").on("change", function() {
   var quantity_issued = parseInt(this.value);
   if((quantity_issued !="") && (storeQty > quantity_issued) ){
		  var newQuantity = storeQty - quantity_issued;

		   //$("#x_remainder").val(parseInt(newQuantity));
	 }else{

			 //alertify.alert('You Do Not and Savings Plan In-Progress .').set('title', 'Duplicate Savings Plan!');
			 alert('Quantity requested can not be zero and can not be higher than stock!');
			 $("#x_quantity_issued").val('');
			  newQuantity = '';
			  $("#x_remainder").val('');
		}
...
<?php if ($report_form->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_report_form_staff_id" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
freport_formedit.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_report_form_staff_id">
...
<?php if ($report_form->sub_sub_category->Visible) { // sub_sub_category ?>
	<div id="r_sub_sub_category" class="form-group">
		<label id="elh_report_form_sub_sub_category" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->sub_sub_category->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->sub_sub_category->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->selection_sub_category->Visible) { // selection_sub_category ?>
	<div id="r_selection_sub_category" class="form-group">
		<label id="elh_report_form_selection_sub_category" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->selection_sub_category->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->selection_sub_category->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freport_formedit", "x_start_date", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("freport_formedit", "x_end_date", {"ignoreReadonly":true,"useCurrent":false,"format":7});
</script>
<?php } ?>
</span>
<?php } else { ?>
...
<?php if ($report_form->incident_location->Visible) { // incident_location ?>
	<div id="r_incident_location" class="form-group">
		<label id="elh_report_form_incident_location" for="x_incident_location" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->incident_location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($report_form->incident_sub_location->Visible) { // incident_sub_location ?>
	<div id="r_incident_sub_location" class="form-group">
		<label id="elh_report_form_incident_sub_location" for="x_incident_sub_location" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->incident_sub_location->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->incident_sub_location->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->incident_venue->Visible) { // incident_venue ?>
	<div id="r_incident_venue" class="form-group">
		<label id="elh_report_form_incident_venue" for="x_incident_venue" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->incident_venue->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->incident_venue->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->incident_description->Visible) { // incident_description ?>
	<div id="r_incident_description" class="form-group">
		<label id="elh_report_form_incident_description" for="x_incident_description" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->incident_description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($report_form->rejection_reasons->Visible) { // rejection_reasons ?>
	<div id="r_rejection_reasons" class="form-group">
		<label id="elh_report_form_rejection_reasons" for="x_rejection_reasons" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->rejection_reasons->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->rejection_reasons->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->assign->Visible) { // assign ?>
	<div id="r_assign" class="form-group">
		<label id="elh_report_form_assign" for="x_assign" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->assign->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->assign->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->approval_action->Visible) { // approval_action ?>
	<div id="r_approval_action" class="form-group">
		<label id="elh_report_form_approval_action" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->approval_action->FldCaption() ?></label>
...
<?php if ($report_form->approval_comment->Visible) { // approval_comment ?>
	<div id="r_approval_comment" class="form-group">
		<label id="elh_report_form_approval_comment" for="x_approval_comment" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->approval_comment->FldCaption() ?></label>
...
<?php if ($report_form->item_name->Visible) { // item_name ?>
	<div id="r_item_name" class="form-group">
		<label id="elh_report_form_item_name" for="x_item_name" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->item_name->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->item_name->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->quantity_issued->Visible) { // quantity_issued ?>
	<div id="r_quantity_issued" class="form-group">
		<label id="elh_report_form_quantity_issued" for="x_quantity_issued" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->quantity_issued->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->quantity_issued->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->reason->Visible) { // reason ?>
	<div id="r_reason" class="form-group">
		<label id="elh_report_form_reason" for="x_reason" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->reason->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->reason->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->resolved_action->Visible) { // resolved_action ?>
	<div id="r_resolved_action" class="form-group">
		<label id="elh_report_form_resolved_action" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->resolved_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($report_form->last_updated_date->Visible) { // last_updated_date ?>
	<div id="r_last_updated_date" class="form-group">
		<label id="elh_report_form_last_updated_date" for="x_last_updated_date" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->last_updated_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($report_form->verified_datetime->Visible) { // verified_datetime ?>
	<div id="r_verified_datetime" class="form-group">
		<label id="elh_report_form_verified_datetime" for="x_verified_datetime" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->verified_datetime->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->verified_datetime->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->job_assessment->Visible) { // job_assessment ?>
	<div id="r_job_assessment" class="form-group">
		<label id="elh_report_form_job_assessment" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->job_assessment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->job_assessment->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label id="elh_report_form_verified_action" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->verified_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->verified_action->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label id="elh_report_form_verified_comment" for="x_verified_comment" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->verified_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->verified_comment->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<?php if ($report_form->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label id="elh_report_form_verified_by" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->verified_by->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->verified_by->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
freport_formedit.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_report_form_verified_by">
...
<?php if ($report_form->remainder->Visible) { // remainder ?>
	<div id="r_remainder" class="form-group">
		<label id="elh_report_form_remainder" for="x_remainder" class="<?php echo $report_form_edit->LeftColumnClass ?>"><?php echo $report_form->remainder->FldCaption() ?></label>
		<div class="<?php echo $report_form_edit->RightColumnClass ?>"><div<?php echo $report_form->remainder->CellAttributes() ?>>
<?php if ($report_form->CurrentAction <> "F") { ?>
...
var departments = $("#x_departments").val()
var currlevel = "<?php echo CurrentUserLevel() ?>";
var stat = parseInt($('#x_status').val());
if (stat == 1) {
	$("#r_rejection_reasons").show();
	$('#x_rejection_reasons').attr('readonly',true);
} else {
	$("#r_rejection_reasons").hide();
}

//$('#x_departments').attr('readonly',true);
//$('#r_assign_task').attr('readonly',true);
