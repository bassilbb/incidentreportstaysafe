...
//
// Table class for system_inventory
//
class csystem_inventory extends cTable {
	var $id;
	var $date_recieved;
	var $reference_id;
	var $material_name;
	...
	function __construct() {
		...
		$this->TableVar = 'system_inventory';
		$this->TableName = 'system_inventory';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`system_inventory`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('system_inventory', 'system_inventory', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_recieved
		$this->date_recieved = new cField('system_inventory', 'system_inventory', 'x_date_recieved', 'date_recieved', '`date_recieved`', ew_CastDateFieldForLike('`date_recieved`', 17, "DB"), 135, 17, FALSE, '`date_recieved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reference_id
		$this->reference_id = new cField('system_inventory', 'system_inventory', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// material_name
		$this->material_name = new cField('system_inventory', 'system_inventory', 'x_material_name', 'material_name', '`material_name`', '`material_name`', 200, -1, FALSE, '`material_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->material_name->Sortable = TRUE; // Allow sort
		$this->fields['material_name'] = &$this->material_name;

		// make
		$this->make = new cField('system_inventory', 'system_inventory', 'x_make', 'make', '`make`', '`make`', 200, -1, FALSE, '`make`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->make->Sortable = TRUE; // Allow sort
		$this->fields['make'] = &$this->make;

		// pc_ram
		$this->pc_ram = new cField('system_inventory', 'system_inventory', 'x_pc_ram', 'pc_ram', '`pc_ram`', '`pc_ram`', 200, -1, FALSE, '`pc_ram`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pc_ram->Sortable = TRUE; // Allow sort
		$this->fields['pc_ram'] = &$this->pc_ram;

		// pc_harddisk
		$this->pc_harddisk = new cField('system_inventory', 'system_inventory', 'x_pc_harddisk', 'pc_harddisk', '`pc_harddisk`', '`pc_harddisk`', 200, -1, FALSE, '`pc_harddisk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pc_harddisk->Sortable = TRUE; // Allow sort
		$this->fields['pc_harddisk'] = &$this->pc_harddisk;

		// color
		$this->color = new cField('system_inventory', 'system_inventory', 'x_color', 'color', '`color`', '`color`', 200, -1, FALSE, '`color`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->color->Sortable = TRUE; // Allow sort
		$this->fields['color'] = &$this->color;

		// capacity
		$this->capacity = new cField('system_inventory', 'system_inventory', 'x_capacity', 'capacity', '`capacity`', '`capacity`', 200, -1, FALSE, '`capacity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->capacity->Sortable = TRUE; // Allow sort
		$this->fields['capacity'] = &$this->capacity;

		// quantity
		$this->quantity = new cField('system_inventory', 'system_inventory', 'x_quantity', 'quantity', '`quantity`', '`quantity`', 200, -1, FALSE, '`quantity`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->quantity->Sortable = TRUE; // Allow sort
		$this->fields['quantity'] = &$this->quantity;

		// description
		$this->description = new cField('system_inventory', 'system_inventory', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->fields['description'] = &$this->description;

		// recieved_by
		$this->recieved_by = new cField('system_inventory', 'system_inventory', 'x_recieved_by', 'recieved_by', '`recieved_by`', '`recieved_by`', 3, -1, FALSE, '`recieved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->recieved_by->Sortable = TRUE; // Allow sort
		$this->fields['recieved_by'] = &$this->recieved_by;

		// status
		$this->status = new cField('system_inventory', 'system_inventory', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`system_inventory`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "system_inventorylist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "system_inventoryedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "system_inventoryadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("system_inventoryview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("system_inventoryview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "system_inventoryadd.php?" . $this->UrlParm($parm);
		else
			$url = "system_inventoryadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("system_inventoryedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("system_inventoryadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("system_inventorydelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->pc_ram->setDbValue($rs->fields('pc_ram'));
		$this->pc_harddisk->setDbValue($rs->fields('pc_harddisk'));
	...
	function RenderEditRow() {
		...
		$this->pc_ram->EditValue = $this->pc_ram->CurrentValue;
		...
		$this->pc_harddisk->EditValue = $this->pc_harddisk->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->pc_ram->Exportable) $Doc->ExportCaption($this->pc_ram);
					if ($this->pc_harddisk->Exportable) $Doc->ExportCaption($this->pc_harddisk);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->pc_ram->Exportable) $Doc->ExportField($this->pc_ram);
						if ($this->pc_harddisk->Exportable) $Doc->ExportField($this->pc_harddisk);
	...
	function Row_Rendering() {
		...
		if (CurrentPageID() == "add")  {
			...
			$this->reference_id->CurrentValue = $_SESSION['REFI_NO'];
			$this->reference_id->EditValue = $this->reference_id->CurrentValue;
