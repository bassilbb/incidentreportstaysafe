...
$dispenser_report = NULL;

//
// Table class for dispenser_report
//
class cdispenser_report extends cTable {
	var $id;
	var $date_initiated;
	var $referrence_id;
	var $staff_id;
	...
	function __construct() {
		...
		$this->TableVar = 'dispenser_report';
		$this->TableName = 'dispenser_report';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`dispenser_report`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('dispenser_report', 'dispenser_report', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_initiated
		$this->date_initiated = new cField('dispenser_report', 'dispenser_report', 'x_date_initiated', 'date_initiated', '`date_initiated`', ew_CastDateFieldForLike('`date_initiated`', 7, "DB"), 133, 7, FALSE, '`date_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->date_initiated->Sortable = TRUE; // Allow sort
		$this->fields['date_initiated'] = &$this->date_initiated;

		// referrence_id
		$this->referrence_id = new cField('dispenser_report', 'dispenser_report', 'x_referrence_id', 'referrence_id', '`referrence_id`', '`referrence_id`', 200, -1, FALSE, '`referrence_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->referrence_id->Sortable = TRUE; // Allow sort
		$this->fields['referrence_id'] = &$this->referrence_id;

		// staff_id
		$this->staff_id = new cField('dispenser_report', 'dispenser_report', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 3, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// fullname
		$this->fullname = new cField('dispenser_report', 'dispenser_report', 'x_fullname', 'fullname', '`fullname`', '`fullname`', 200, -1, FALSE, '`fullname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->fullname->Sortable = TRUE; // Allow sort
		$this->fullname->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->fullname->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['fullname'] = &$this->fullname;

		// department
		$this->department = new cField('dispenser_report', 'dispenser_report', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->department->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['department'] = &$this->department;

		// location
		$this->location = new cField('dispenser_report', 'dispenser_report', 'x_location', 'location', '`location`', '`location`', 3, -1, FALSE, '`location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sub_location
		$this->sub_location = new cField('dispenser_report', 'dispenser_report', 'x_sub_location', 'sub_location', '`sub_location`', '`sub_location`', 3, -1, FALSE, '`sub_location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// venue
		$this->venue = new cField('dispenser_report', 'dispenser_report', 'x_venue', 'venue', '`venue`', '`venue`', 3, -1, FALSE, '`venue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// type
		$this->type = new cField('dispenser_report', 'dispenser_report', 'x_type', 'type', '`type`', '`type`', 3, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// action_taken
		$this->action_taken = new cField('dispenser_report', 'dispenser_report', 'x_action_taken', 'action_taken', '`action_taken`', '`action_taken`', 3, -1, FALSE, '`action_taken`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// initiator_action
		$this->initiator_action = new cField('dispenser_report', 'dispenser_report', 'x_initiator_action', 'initiator_action', '`initiator_action`', '`initiator_action`', 3, -1, FALSE, '`initiator_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// initiator_comment
		$this->initiator_comment = new cField('dispenser_report', 'dispenser_report', 'x_initiator_comment', 'initiator_comment', '`initiator_comment`', '`initiator_comment`', 201, -1, FALSE, '`initiator_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->initiator_comment->Sortable = TRUE; // Allow sort
		$this->fields['initiator_comment'] = &$this->initiator_comment;

		// status
		$this->status = new cField('dispenser_report', 'dispenser_report', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// initiated_by
		$this->initiated_by = new cField('dispenser_report', 'dispenser_report', 'x_initiated_by', 'initiated_by', '`initiated_by`', '`initiated_by`', 3, -1, FALSE, '`initiated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->initiated_by->Sortable = TRUE; // Allow sort
		$this->initiated_by->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`dispenser_report`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "dispenser_reportlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "dispenser_reportedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "dispenser_reportadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("dispenser_reportview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("dispenser_reportview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "dispenser_reportadd.php?" . $this->UrlParm($parm);
		else
			$url = "dispenser_reportadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("dispenser_reportedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("dispenser_reportadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("dispenser_reportdelete.php", $this->UrlParm());
	}
