...
$sparepart_report_view = NULL; // Initialize page object first

class csparepart_report_view extends csparepart_report {
	...
	// Page object name
	var $PageObjName = 'sparepart_report_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("sparepart_reportlist.php"); // Return to list page
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "sparepart_reportlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "sparepart_reportlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($sparepart_report_view)) $sparepart_report_view = new csparepart_report_view();

// Page init
$sparepart_report_view->Page_Init();

// Page main
$sparepart_report_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$sparepart_report_view->Page_Render();
?>
...
var CurrentForm = fsparepart_reportview = new ew_Form("fsparepart_reportview", "view");

// Form_CustomValidate event
fsparepart_reportview.Form_CustomValidate = 
...
fsparepart_reportview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsparepart_reportview.Lists["x_part_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_part_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_module"};
fsparepart_reportview.Lists["x_part_name"].Data = "<?php echo $sparepart_report_view->part_name->LookupFilterQuery(FALSE, "view") ?>";
fsparepart_reportview.Lists["x_maintenance_id"] = {"LinkField":"x_maintenance_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_generator_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_view"};
fsparepart_reportview.Lists["x_maintenance_id"].Data = "<?php echo $sparepart_report_view->maintenance_id->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($sparepart_report->Export == "") { ?>
<div class="ewToolbar">
<?php $sparepart_report_view->ExportOptions->Render("body") ?>
<?php
	foreach ($sparepart_report_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $sparepart_report_view->ShowPageHeader(); ?>
<?php
$sparepart_report_view->ShowMessage();
?>
<?php if (!$sparepart_report_view->IsModal) { ?>
<?php if ($sparepart_report->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($sparepart_report_view->Pager)) $sparepart_report_view->Pager = new cPrevNextPager($sparepart_report_view->StartRec, $sparepart_report_view->DisplayRecs, $sparepart_report_view->TotalRecs, $sparepart_report_view->AutoHidePager) ?>
<?php if ($sparepart_report_view->Pager->RecordCount > 0 && $sparepart_report_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($sparepart_report_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $sparepart_report_view->PageUrl() ?>start=<?php echo $sparepart_report_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($sparepart_report_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $sparepart_report_view->PageUrl() ?>start=<?php echo $sparepart_report_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $sparepart_report_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($sparepart_report_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $sparepart_report_view->PageUrl() ?>start=<?php echo $sparepart_report_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($sparepart_report_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $sparepart_report_view->PageUrl() ?>start=<?php echo $sparepart_report_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $sparepart_report_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fsparepart_reportview" id="fsparepart_reportview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($sparepart_report_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $sparepart_report_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="sparepart_report">
<input type="hidden" name="modal" value="<?php echo intval($sparepart_report_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($sparepart_report->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_sparepart_report_id"><?php echo $sparepart_report->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $sparepart_report->id->CellAttributes() ?>>
<span id="el_sparepart_report_id" data-page="1">
<span<?php echo $sparepart_report->id->ViewAttributes() ?>>
<?php echo $sparepart_report->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_sparepart_report_date"><?php echo $sparepart_report->date->FldCaption() ?></span></td>
		<td data-name="date"<?php echo $sparepart_report->date->CellAttributes() ?>>
<span id="el_sparepart_report_date" data-page="1">
<span<?php echo $sparepart_report->date->ViewAttributes() ?>>
<?php echo $sparepart_report->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->part_name->Visible) { // part_name ?>
	<tr id="r_part_name">
		<td class="col-sm-2"><span id="elh_sparepart_report_part_name"><?php echo $sparepart_report->part_name->FldCaption() ?></span></td>
		<td data-name="part_name"<?php echo $sparepart_report->part_name->CellAttributes() ?>>
<span id="el_sparepart_report_part_name" data-page="1">
<span<?php echo $sparepart_report->part_name->ViewAttributes() ?>>
<?php echo $sparepart_report->part_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->maintenance_id->Visible) { // maintenance_id ?>
	<tr id="r_maintenance_id">
		<td class="col-sm-2"><span id="elh_sparepart_report_maintenance_id"><?php echo $sparepart_report->maintenance_id->FldCaption() ?></span></td>
		<td data-name="maintenance_id"<?php echo $sparepart_report->maintenance_id->CellAttributes() ?>>
<span id="el_sparepart_report_maintenance_id" data-page="1">
<span<?php echo $sparepart_report->maintenance_id->ViewAttributes() ?>>
<?php echo $sparepart_report->maintenance_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->quantity_in->Visible) { // quantity_in ?>
	<tr id="r_quantity_in">
		<td class="col-sm-2"><span id="elh_sparepart_report_quantity_in"><?php echo $sparepart_report->quantity_in->FldCaption() ?></span></td>
		<td data-name="quantity_in"<?php echo $sparepart_report->quantity_in->CellAttributes() ?>>
<span id="el_sparepart_report_quantity_in" data-page="1">
<span<?php echo $sparepart_report->quantity_in->ViewAttributes() ?>>
<?php echo $sparepart_report->quantity_in->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->quantity_used->Visible) { // quantity_used ?>
	<tr id="r_quantity_used">
		<td class="col-sm-2"><span id="elh_sparepart_report_quantity_used"><?php echo $sparepart_report->quantity_used->FldCaption() ?></span></td>
		<td data-name="quantity_used"<?php echo $sparepart_report->quantity_used->CellAttributes() ?>>
<span id="el_sparepart_report_quantity_used" data-page="1">
<span<?php echo $sparepart_report->quantity_used->ViewAttributes() ?>>
<?php echo $sparepart_report->quantity_used->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->cost->Visible) { // cost ?>
	<tr id="r_cost">
		<td class="col-sm-2"><span id="elh_sparepart_report_cost"><?php echo $sparepart_report->cost->FldCaption() ?></span></td>
		<td data-name="cost"<?php echo $sparepart_report->cost->CellAttributes() ?>>
<span id="el_sparepart_report_cost" data-page="1">
<span<?php echo $sparepart_report->cost->ViewAttributes() ?>>
<?php echo $sparepart_report->cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->total_quantity->Visible) { // total_quantity ?>
	<tr id="r_total_quantity">
		<td class="col-sm-2"><span id="elh_sparepart_report_total_quantity"><?php echo $sparepart_report->total_quantity->FldCaption() ?></span></td>
		<td data-name="total_quantity"<?php echo $sparepart_report->total_quantity->CellAttributes() ?>>
<span id="el_sparepart_report_total_quantity" data-page="1">
<span<?php echo $sparepart_report->total_quantity->ViewAttributes() ?>>
<?php echo $sparepart_report->total_quantity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->total_cost->Visible) { // total_cost ?>
	<tr id="r_total_cost">
		<td class="col-sm-2"><span id="elh_sparepart_report_total_cost"><?php echo $sparepart_report->total_cost->FldCaption() ?></span></td>
		<td data-name="total_cost"<?php echo $sparepart_report->total_cost->CellAttributes() ?>>
<span id="el_sparepart_report_total_cost" data-page="1">
<span<?php echo $sparepart_report->total_cost->ViewAttributes() ?>>
<?php echo $sparepart_report->total_cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($sparepart_report->maintenance_total_cost->Visible) { // maintenance_total_cost ?>
	<tr id="r_maintenance_total_cost">
		<td class="col-sm-2"><span id="elh_sparepart_report_maintenance_total_cost"><?php echo $sparepart_report->maintenance_total_cost->FldCaption() ?></span></td>
		<td data-name="maintenance_total_cost"<?php echo $sparepart_report->maintenance_total_cost->CellAttributes() ?>>
<span id="el_sparepart_report_maintenance_total_cost" data-page="1">
<span<?php echo $sparepart_report->maintenance_total_cost->ViewAttributes() ?>>
<?php echo $sparepart_report->maintenance_total_cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($sparepart_report->Export == "") { ?>
<script type="text/javascript">
fsparepart_reportview.Init();
</script>
<?php } ?>
<?php
$sparepart_report_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($sparepart_report->Export == "") { ?>
...
<?php
$sparepart_report_view->Page_Terminate();
?>
