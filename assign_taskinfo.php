...
//
// Table class for assign_task
//
class cassign_task extends cTable {
	var $id;
	...
	function __construct() {
		...
		$this->TableVar = 'assign_task';
		$this->TableName = 'assign_task';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`assign_task`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('assign_task', 'assign_task', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// datetime_initiated
		$this->datetime_initiated = new cField('assign_task', 'assign_task', 'x_datetime_initiated', 'datetime_initiated', '`datetime_initiated`', ew_CastDateFieldForLike('`datetime_initiated`', 11, "DB"), 135, 11, FALSE, '`datetime_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// incident_id
		$this->incident_id = new cField('assign_task', 'assign_task', 'x_incident_id', 'incident_id', '`incident_id`', '`incident_id`', 200, -1, FALSE, '`incident_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->incident_id->Sortable = TRUE; // Allow sort
		$this->fields['incident_id'] = &$this->incident_id;

		// staffid
		$this->staffid = new cField('assign_task', 'assign_task', 'x_staffid', 'staffid', '`staffid`', '`staffid`', 200, -1, FALSE, '`staffid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staffid->Sortable = TRUE; // Allow sort
		$this->fields['staffid'] = &$this->staffid;

		// staff_id
		$this->staff_id = new cField('assign_task', 'assign_task', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 3, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// department
		$this->department = new cField('assign_task', 'assign_task', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// branch
		$this->branch = new cField('assign_task', 'assign_task', 'x_branch', 'branch', '`branch`', '`branch`', 3, -1, FALSE, '`branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// departments
		$this->departments = new cField('assign_task', 'assign_task', 'x_departments', 'departments', '`departments`', '`departments`', 3, -1, FALSE, '`departments`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// category
		$this->category = new cField('assign_task', 'assign_task', 'x_category', 'category', '`category`', '`category`', 3, -1, FALSE, '`category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sub_category
		$this->sub_category = new cField('assign_task', 'assign_task', 'x_sub_category', 'sub_category', '`sub_category`', '`sub_category`', 3, -1, FALSE, '`sub_category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sub_sub_category
		$this->sub_sub_category = new cField('assign_task', 'assign_task', 'x_sub_sub_category', 'sub_sub_category', '`sub_sub_category`', '`sub_sub_category`', 200, -1, FALSE, '`sub_sub_category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		$this->selection_sub_category = new cField('assign_task', 'assign_task', 'x_selection_sub_category', 'selection_sub_category', '`selection_sub_category`', '`selection_sub_category`', 200, -1, FALSE, '`selection_sub_category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->selection_sub_category->Sortable = TRUE; // Allow sort
		$this->fields['selection_sub_category'] = &$this->selection_sub_category;

		// start_date
		$this->start_date = new cField('assign_task', 'assign_task', 'x_start_date', 'start_date', '`start_date`', ew_CastDateFieldForLike('`start_date`', 7, "DB"), 133, 7, FALSE, '`start_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end_date
		$this->end_date = new cField('assign_task', 'assign_task', 'x_end_date', 'end_date', '`end_date`', ew_CastDateFieldForLike('`end_date`', 7, "DB"), 133, 7, FALSE, '`end_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// duration
		$this->duration = new cField('assign_task', 'assign_task', 'x_duration', 'duration', '`duration`', '`duration`', 3, -1, FALSE, '`duration`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// amount_paid
		$this->amount_paid = new cField('assign_task', 'assign_task', 'x_amount_paid', 'amount_paid', '`amount_paid`', '`amount_paid`', 131, -1, FALSE, '`amount_paid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->no_of_people_involved = new cField('assign_task', 'assign_task', 'x_no_of_people_involved', 'no_of_people_involved', '`no_of_people_involved`', '`no_of_people_involved`', 3, -1, FALSE, '`no_of_people_involved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_of_people_involved->Sortable = TRUE; // Allow sort
		$this->fields['no_of_people_involved'] = &$this->no_of_people_involved;

		// incident_type
		$this->incident_type = new cField('assign_task', 'assign_task', 'x_incident_type', 'incident_type', '`incident_type`', '`incident_type`', 3, -1, FALSE, '`incident_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// incident-category
		$this->incident_category = new cField('assign_task', 'assign_task', 'x_incident_category', 'incident-category', '`incident-category`', '`incident-category`', 3, -1, FALSE, '`incident-category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// incident_location
		$this->incident_location = new cField('assign_task', 'assign_task', 'x_incident_location', 'incident_location', '`incident_location`', '`incident_location`', 3, -1, FALSE, '`incident_location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->incident_sub_location = new cField('assign_task', 'assign_task', 'x_incident_sub_location', 'incident_sub_location', '`incident_sub_location`', '`incident_sub_location`', 3, -1, FALSE, '`incident_sub_location`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// incident_venue
		$this->incident_venue = new cField('assign_task', 'assign_task', 'x_incident_venue', 'incident_venue', '`incident_venue`', '`incident_venue`', 3, -1, FALSE, '`incident_venue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->incident_description = new cField('assign_task', 'assign_task', 'x_incident_description', 'incident_description', '`incident_description`', '`incident_description`', 201, -1, FALSE, '`incident_description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->incident_description->Sortable = TRUE; // Allow sort
		$this->fields['incident_description'] = &$this->incident_description;

		// upload
		$this->_upload = new cField('assign_task', 'assign_task', 'x__upload', 'upload', '`upload`', '`upload`', 200, -1, TRUE, '`upload`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		...
		// status
		$this->status = new cField('assign_task', 'assign_task', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// initiator_action
		$this->initiator_action = new cField('assign_task', 'assign_task', 'x_initiator_action', 'initiator_action', '`initiator_action`', '`initiator_action`', 3, -1, FALSE, '`initiator_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// initiator_comment
		$this->initiator_comment = new cField('assign_task', 'assign_task', 'x_initiator_comment', 'initiator_comment', '`initiator_comment`', '`initiator_comment`', 201, -1, FALSE, '`initiator_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->initiator_comment->Sortable = TRUE; // Allow sort
		$this->fields['initiator_comment'] = &$this->initiator_comment;

		// report_by
		$this->report_by = new cField('assign_task', 'assign_task', 'x_report_by', 'report_by', '`report_by`', '`report_by`', 3, -1, FALSE, '`report_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// datetime_resolved
		$this->datetime_resolved = new cField('assign_task', 'assign_task', 'x_datetime_resolved', 'datetime_resolved', '`datetime_resolved`', ew_CastDateFieldForLike('`datetime_resolved`', 11, "DB"), 135, 11, FALSE, '`datetime_resolved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// assign_task
		$this->assign_task = new cField('assign_task', 'assign_task', 'x_assign_task', 'assign_task', '`assign_task`', '`assign_task`', 3, -1, FALSE, '`assign_task`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// approval_action
		$this->approval_action = new cField('assign_task', 'assign_task', 'x_approval_action', 'approval_action', '`approval_action`', '`approval_action`', 3, -1, FALSE, '`approval_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approval_comment
		$this->approval_comment = new cField('assign_task', 'assign_task', 'x_approval_comment', 'approval_comment', '`approval_comment`', '`approval_comment`', 201, -1, FALSE, '`approval_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->approval_comment->Sortable = TRUE; // Allow sort
		$this->fields['approval_comment'] = &$this->approval_comment;

		// reason
		$this->reason = new cField('assign_task', 'assign_task', 'x_reason', 'reason', '`reason`', '`reason`', 3, -1, FALSE, '`reason`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// resolved_action
		$this->resolved_action = new cField('assign_task', 'assign_task', 'x_resolved_action', 'resolved_action', '`resolved_action`', '`resolved_action`', 3, -1, FALSE, '`resolved_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// resolved_comment
		$this->resolved_comment = new cField('assign_task', 'assign_task', 'x_resolved_comment', 'resolved_comment', '`resolved_comment`', '`resolved_comment`', 201, -1, FALSE, '`resolved_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->resolved_comment->Sortable = TRUE; // Allow sort
		$this->fields['resolved_comment'] = &$this->resolved_comment;

		// resolved_by
		$this->resolved_by = new cField('assign_task', 'assign_task', 'x_resolved_by', 'resolved_by', '`resolved_by`', '`resolved_by`', 3, -1, FALSE, '`resolved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// datetime_approved
		$this->datetime_approved = new cField('assign_task', 'assign_task', 'x_datetime_approved', 'datetime_approved', '`datetime_approved`', ew_CastDateFieldForLike('`datetime_approved`', 11, "DB"), 135, 11, FALSE, '`datetime_approved`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// approved_by
		$this->approved_by = new cField('assign_task', 'assign_task', 'x_approved_by', 'approved_by', '`approved_by`', '`approved_by`', 3, -1, FALSE, '`approved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// last_updated_date
		$this->last_updated_date = new cField('assign_task', 'assign_task', 'x_last_updated_date', 'last_updated_date', '`last_updated_date`', ew_CastDateFieldForLike('`last_updated_date`', 17, "DB"), 135, 17, FALSE, '`last_updated_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// last_updated_by
		$this->last_updated_by = new cField('assign_task', 'assign_task', 'x_last_updated_by', 'last_updated_by', '`last_updated_by`', '`last_updated_by`', 3, -1, FALSE, '`last_updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// job_assessment
		$this->job_assessment = new cField('assign_task', 'assign_task', 'x_job_assessment', 'job_assessment', '`job_assessment`', '`job_assessment`', 200, -1, FALSE, '`job_assessment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// verified_datetime
		$this->verified_datetime = new cField('assign_task', 'assign_task', 'x_verified_datetime', 'verified_datetime', '`verified_datetime`', ew_CastDateFieldForLike('`verified_datetime`', 17, "DB"), 135, 17, FALSE, '`verified_datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// verified_action
		$this->verified_action = new cField('assign_task', 'assign_task', 'x_verified_action', 'verified_action', '`verified_action`', '`verified_action`', 3, -1, FALSE, '`verified_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// verified_comment
		$this->verified_comment = new cField('assign_task', 'assign_task', 'x_verified_comment', 'verified_comment', '`verified_comment`', '`verified_comment`', 200, -1, FALSE, '`verified_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->verified_comment->Sortable = TRUE; // Allow sort
		$this->fields['verified_comment'] = &$this->verified_comment;

		// verified_by
		$this->verified_by = new cField('assign_task', 'assign_task', 'x_verified_by', 'verified_by', '`verified_by`', '`verified_by`', 3, -1, FALSE, '`verified_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`assign_task`";
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "assign_taskview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "assign_taskedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "assign_taskadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("assign_taskview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("assign_taskview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "assign_taskadd.php?" . $this->UrlParm($parm);
		else
			$url = "assign_taskadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("assign_taskedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("assign_taskadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("assign_taskdelete.php", $this->UrlParm());
	}
	...
	// Common render codes
		...
		if ($this->_upload->UseColorbox) {
			...
			$this->_upload->LinkAttrs["data-rel"] = "assign_task_x__upload";
