...
//
// Table class for maintenance_report
//
class cmaintenance_report extends cTable {
	var $id;
	var $date_initiated;
	var $reference_id;
	var $staff_id;
	...
	function __construct() {
		...
		$this->TableVar = 'maintenance_report';
		$this->TableName = 'maintenance_report';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`maintenance_report`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('maintenance_report', 'maintenance_report', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_initiated
		$this->date_initiated = new cField('maintenance_report', 'maintenance_report', 'x_date_initiated', 'date_initiated', '`date_initiated`', ew_CastDateFieldForLike('`date_initiated`', 7, "DB"), 133, 7, FALSE, '`date_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->date_initiated->Sortable = TRUE; // Allow sort
		$this->date_initiated->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['date_initiated'] = &$this->date_initiated;

		// reference_id
		$this->reference_id = new cField('maintenance_report', 'maintenance_report', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// staff_id
		$this->staff_id = new cField('maintenance_report', 'maintenance_report', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 200, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// staff_name
		$this->staff_name = new cField('maintenance_report', 'maintenance_report', 'x_staff_name', 'staff_name', '`staff_name`', '`staff_name`', 3, -1, FALSE, '`staff_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// department
		$this->department = new cField('maintenance_report', 'maintenance_report', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->fields['department'] = &$this->department;

		// branch
		$this->branch = new cField('maintenance_report', 'maintenance_report', 'x_branch', 'branch', '`branch`', '`branch`', 3, -1, FALSE, '`branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->branch->Sortable = TRUE; // Allow sort
		$this->fields['branch'] = &$this->branch;

		// buildings
		$this->buildings = new cField('maintenance_report', 'maintenance_report', 'x_buildings', 'buildings', '`buildings`', '`buildings`', 3, -1, FALSE, '`buildings`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// floors
		$this->floors = new cField('maintenance_report', 'maintenance_report', 'x_floors', 'floors', '`floors`', '`floors`', 3, -1, FALSE, '`floors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// items
		$this->items = new cField('maintenance_report', 'maintenance_report', 'x_items', 'items', '`items`', '`items`', 3, -1, FALSE, '`items`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// priority
		$this->priority = new cField('maintenance_report', 'maintenance_report', 'x_priority', 'priority', '`priority`', '`priority`', 3, -1, FALSE, '`priority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// description
		$this->description = new cField('maintenance_report', 'maintenance_report', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->description->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['description'] = &$this->description;

		// status
		$this->status = new cField('maintenance_report', 'maintenance_report', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// date_maintained
		$this->date_maintained = new cField('maintenance_report', 'maintenance_report', 'x_date_maintained', 'date_maintained', '`date_maintained`', ew_CastDateFieldForLike('`date_maintained`', 17, "DB"), 135, 17, FALSE, '`date_maintained`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// maintenance_action
		$this->maintenance_action = new cField('maintenance_report', 'maintenance_report', 'x_maintenance_action', 'maintenance_action', '`maintenance_action`', '`maintenance_action`', 3, -1, FALSE, '`maintenance_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// maintenance_comment
		$this->maintenance_comment = new cField('maintenance_report', 'maintenance_report', 'x_maintenance_comment', 'maintenance_comment', '`maintenance_comment`', '`maintenance_comment`', 201, -1, FALSE, '`maintenance_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->maintenance_comment->Sortable = TRUE; // Allow sort
		$this->fields['maintenance_comment'] = &$this->maintenance_comment;

		// maintained_by
		$this->maintained_by = new cField('maintenance_report', 'maintenance_report', 'x_maintained_by', 'maintained_by', '`maintained_by`', '`maintained_by`', 3, -1, FALSE, '`maintained_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_date
		$this->reviewed_date = new cField('maintenance_report', 'maintenance_report', 'x_reviewed_date', 'reviewed_date', '`reviewed_date`', ew_CastDateFieldForLike('`reviewed_date`', 11, "DB"), 135, 11, FALSE, '`reviewed_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_action
		$this->reviewed_action = new cField('maintenance_report', 'maintenance_report', 'x_reviewed_action', 'reviewed_action', '`reviewed_action`', '`reviewed_action`', 3, -1, FALSE, '`reviewed_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// reviewed_comment
		$this->reviewed_comment = new cField('maintenance_report', 'maintenance_report', 'x_reviewed_comment', 'reviewed_comment', '`reviewed_comment`', '`reviewed_comment`', 200, -1, FALSE, '`reviewed_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->reviewed_comment->Sortable = TRUE; // Allow sort
		$this->fields['reviewed_comment'] = &$this->reviewed_comment;

		// reviewed_by
		$this->reviewed_by = new cField('maintenance_report', 'maintenance_report', 'x_reviewed_by', 'reviewed_by', '`reviewed_by`', '`reviewed_by`', 3, -1, FALSE, '`reviewed_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`maintenance_report`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "maintenance_reportlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "maintenance_reportedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "maintenance_reportadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("maintenance_reportview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("maintenance_reportview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "maintenance_reportadd.php?" . $this->UrlParm($parm);
		else
			$url = "maintenance_reportadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("maintenance_reportedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("maintenance_reportadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("maintenance_reportdelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->date_initiated->EditValue = ew_FormatDateTime($this->date_initiated->CurrentValue, 7);
