...
$servicing_history = NULL;

//
// Table class for servicing_history
//
class cservicing_history extends cTable {
	var $id;
	var $date_initiated;
	var $reference_id;
	var $staff_id;
	...
	function __construct() {
		...
		$this->TableVar = 'servicing_history';
		$this->TableName = 'servicing_history';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`servicing_history`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('servicing_history', 'servicing_history', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_initiated
		$this->date_initiated = new cField('servicing_history', 'servicing_history', 'x_date_initiated', 'date_initiated', '`date_initiated`', ew_CastDateFieldForLike('`date_initiated`', 0, "DB"), 135, 0, FALSE, '`date_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reference_id
		$this->reference_id = new cField('servicing_history', 'servicing_history', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// staff_id
		$this->staff_id = new cField('servicing_history', 'servicing_history', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 200, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// staff_name
		$this->staff_name = new cField('servicing_history', 'servicing_history', 'x_staff_name', 'staff_name', '`staff_name`', '`staff_name`', 3, -1, FALSE, '`staff_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// department
		$this->department = new cField('servicing_history', 'servicing_history', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->fields['department'] = &$this->department;

		// branch
		$this->branch = new cField('servicing_history', 'servicing_history', 'x_branch', 'branch', '`branch`', '`branch`', 3, -1, FALSE, '`branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->branch->Sortable = TRUE; // Allow sort
		$this->fields['branch'] = &$this->branch;

		// buildings
		$this->buildings = new cField('servicing_history', 'servicing_history', 'x_buildings', 'buildings', '`buildings`', '`buildings`', 3, -1, FALSE, '`buildings`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// floors
		$this->floors = new cField('servicing_history', 'servicing_history', 'x_floors', 'floors', '`floors`', '`floors`', 3, -1, FALSE, '`floors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// items
		$this->items = new cField('servicing_history', 'servicing_history', 'x_items', 'items', '`items`', '`items`', 3, -1, FALSE, '`items`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// priority
		$this->priority = new cField('servicing_history', 'servicing_history', 'x_priority', 'priority', '`priority`', '`priority`', 3, -1, FALSE, '`priority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// description
		$this->description = new cField('servicing_history', 'servicing_history', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->description->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['description'] = &$this->description;

		// status
		$this->status = new cField('servicing_history', 'servicing_history', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// date_maintained
		$this->date_maintained = new cField('servicing_history', 'servicing_history', 'x_date_maintained', 'date_maintained', '`date_maintained`', ew_CastDateFieldForLike('`date_maintained`', 17, "DB"), 135, 17, FALSE, '`date_maintained`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// maintenance_action
		$this->maintenance_action = new cField('servicing_history', 'servicing_history', 'x_maintenance_action', 'maintenance_action', '`maintenance_action`', '`maintenance_action`', 3, -1, FALSE, '`maintenance_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// maintenance_comment
		$this->maintenance_comment = new cField('servicing_history', 'servicing_history', 'x_maintenance_comment', 'maintenance_comment', '`maintenance_comment`', '`maintenance_comment`', 201, -1, FALSE, '`maintenance_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->maintenance_comment->Sortable = TRUE; // Allow sort
		$this->fields['maintenance_comment'] = &$this->maintenance_comment;

		// maintained_by
		$this->maintained_by = new cField('servicing_history', 'servicing_history', 'x_maintained_by', 'maintained_by', '`maintained_by`', '`maintained_by`', 3, -1, FALSE, '`maintained_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_date
		$this->reviewed_date = new cField('servicing_history', 'servicing_history', 'x_reviewed_date', 'reviewed_date', '`reviewed_date`', ew_CastDateFieldForLike('`reviewed_date`', 11, "DB"), 135, 11, FALSE, '`reviewed_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_action
		$this->reviewed_action = new cField('servicing_history', 'servicing_history', 'x_reviewed_action', 'reviewed_action', '`reviewed_action`', '`reviewed_action`', 3, -1, FALSE, '`reviewed_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// reviewed_comment
		$this->reviewed_comment = new cField('servicing_history', 'servicing_history', 'x_reviewed_comment', 'reviewed_comment', '`reviewed_comment`', '`reviewed_comment`', 200, -1, FALSE, '`reviewed_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->reviewed_comment->Sortable = TRUE; // Allow sort
		$this->fields['reviewed_comment'] = &$this->reviewed_comment;

		// reviewed_by
		$this->reviewed_by = new cField('servicing_history', 'servicing_history', 'x_reviewed_by', 'reviewed_by', '`reviewed_by`', '`reviewed_by`', 3, -1, FALSE, '`reviewed_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`servicing_history`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "servicing_historylist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "servicing_historyedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "servicing_historyadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("servicing_historyview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("servicing_historyview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "servicing_historyadd.php?" . $this->UrlParm($parm);
		else
			$url = "servicing_historyadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("servicing_historyedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("servicing_historyadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("servicing_historydelete.php", $this->UrlParm());
	}
