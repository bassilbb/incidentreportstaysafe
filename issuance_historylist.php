...
fissuance_historylist.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuance_historylist.Lists["x_staff_id"].Data = "<?php echo $issuance_history_list->staff_id->LookupFilterQuery(FALSE, "list") ?>";
fissuance_historylist.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuance_history_list->staff_id->LookupFilterQuery(TRUE, "list"))) ?>;
...
<?php if ($issuance_history->staff_id->Visible) { // staff_id ?>
	<?php if ($issuance_history->SortUrl($issuance_history->staff_id) == "") { ?>
		<th data-name="staff_id" class="<?php echo $issuance_history->staff_id->HeaderCellClass() ?>"><div id="elh_issuance_history_staff_id" class="issuance_history_staff_id"><div class="ewTableHeaderCaption"><?php echo $issuance_history->staff_id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="staff_id" class="<?php echo $issuance_history->staff_id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $issuance_history->SortUrl($issuance_history->staff_id) ?>',1);"><div id="elh_issuance_history_staff_id" class="issuance_history_staff_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $issuance_history->staff_id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($issuance_history->staff_id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($issuance_history->staff_id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($issuance_history->material_name->Visible) { // material_name ?>
...
<span id="el<?php echo $issuance_history_list->RowCnt ?>_issuance_history_staff_id" class="issuance_history_staff_id">
<span<?php echo $issuance_history->staff_id->ViewAttributes() ?>>
<?php echo $issuance_history->staff_id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($issuance_history->material_name->Visible) { // material_name ?>
