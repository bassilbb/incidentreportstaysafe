...
$gen_maintenance_edit = NULL; // Initialize page object first

class cgen_maintenance_edit extends cgen_maintenance {
	...
	// Page object name
	var $PageObjName = 'gen_maintenance_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("gen_maintenancelist.php"); // Return to list page
...
// Create page object
if (!isset($gen_maintenance_edit)) $gen_maintenance_edit = new cgen_maintenance_edit();

// Page init
$gen_maintenance_edit->Page_Init();

// Page main
$gen_maintenance_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$gen_maintenance_edit->Page_Render();
?>
...
var CurrentForm = fgen_maintenanceedit = new ew_Form("fgen_maintenanceedit", "edit");

// Validate form
fgen_maintenanceedit.Validate = function() {
...
fgen_maintenanceedit.Form_CustomValidate = 
...
fgen_maintenanceedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fgen_maintenanceedit.Lists["x_gen_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","x_kva",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fgen_maintenanceedit.Lists["x_gen_name"].Data = "<?php echo $gen_maintenance_edit->gen_name->LookupFilterQuery(FALSE, "edit") ?>";
fgen_maintenanceedit.Lists["x_maintenance_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"maintenance_type"};
fgen_maintenanceedit.Lists["x_maintenance_type"].Data = "<?php echo $gen_maintenance_edit->maintenance_type->LookupFilterQuery(FALSE, "edit") ?>";
fgen_maintenanceedit.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgen_maintenanceedit.Lists["x_staff_id"].Data = "<?php echo $gen_maintenance_edit->staff_id->LookupFilterQuery(FALSE, "edit") ?>";
fgen_maintenanceedit.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_status"};
fgen_maintenanceedit.Lists["x_status"].Data = "<?php echo $gen_maintenance_edit->status->LookupFilterQuery(FALSE, "edit") ?>";
fgen_maintenanceedit.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgen_maintenanceedit.Lists["x_initiator_action"].Options = <?php echo json_encode($gen_maintenance_edit->initiator_action->Options()) ?>;
fgen_maintenanceedit.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgen_maintenanceedit.Lists["x_approver_action"].Options = <?php echo json_encode($gen_maintenance_edit->approver_action->Options()) ?>;
fgen_maintenanceedit.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgen_maintenanceedit.Lists["x_approved_by"].Data = "<?php echo $gen_maintenance_edit->approved_by->LookupFilterQuery(FALSE, "edit") ?>";
fgen_maintenanceedit.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $gen_maintenance_edit->approved_by->LookupFilterQuery(TRUE, "edit"))) ?>;
...
$(document).ready(function() {
	$("#x_labour_fee").on("blur input", function() {
		var labour_fee_raw = this.value.trim();
		var cost = parseFloat($('#x_cost').val()) || 0;
		if(labour_fee_raw === '') {
			...
			var labour_fee = parseFloat(labour_fee_raw) || 0;
			var total = cost + labour_fee;
...
/*$(document).ready(function() {
	...
	// When labour fee changes
	$("#x_labour_fee").on("change input", function() { 
		var labour_fee = parseFloat($(this).val()) || 0;   // convert to number
		var cost = parseFloat($('#x_cost').val()) || 0; // convert to number
		if(labour_fee !== 0 || cost !== 0){
			var total = cost + labour_fee;                 // add numbers
			$('#x_total').val(total.toFixed(2));          // keep 2 decimal places
		} else {
			$('#x_total').val('');
			$('#x_labour_fee').val('');
		}
...
<?php $gen_maintenance_edit->ShowPageHeader(); ?>
<?php
$gen_maintenance_edit->ShowMessage();
?>
<?php if (!$gen_maintenance_edit->IsModal) { ?>
<?php if ($gen_maintenance->CurrentAction <> "F") { // Confirm page ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($gen_maintenance_edit->Pager)) $gen_maintenance_edit->Pager = new cPrevNextPager($gen_maintenance_edit->StartRec, $gen_maintenance_edit->DisplayRecs, $gen_maintenance_edit->TotalRecs, $gen_maintenance_edit->AutoHidePager) ?>
<?php if ($gen_maintenance_edit->Pager->RecordCount > 0 && $gen_maintenance_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($gen_maintenance_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $gen_maintenance_edit->PageUrl() ?>start=<?php echo $gen_maintenance_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($gen_maintenance_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $gen_maintenance_edit->PageUrl() ?>start=<?php echo $gen_maintenance_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $gen_maintenance_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($gen_maintenance_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $gen_maintenance_edit->PageUrl() ?>start=<?php echo $gen_maintenance_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($gen_maintenance_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $gen_maintenance_edit->PageUrl() ?>start=<?php echo $gen_maintenance_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $gen_maintenance_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
...
<?php } ?>
<?php } ?>
<form name="fgen_maintenanceedit" id="fgen_maintenanceedit" class="<?php echo $gen_maintenance_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($gen_maintenance_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $gen_maintenance_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo intval($gen_maintenance_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($gen_maintenance->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label id="elh_gen_maintenance_datetime" for="x_datetime" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->datetime->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->datetime->CellAttributes() ?>>
...
<?php if ($gen_maintenance->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_gen_maintenance_reference_id" for="x_reference_id" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->reference_id->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->reference_id->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<input type="hidden" data-table="gen_maintenance" data-field="x_reference_id" data-page="1" name="x_reference_id" id="x_reference_id" value="<?php echo ew_HtmlEncode($gen_maintenance->reference_id->FormValue) ?>">
<?php } ?>
...
<?php if ($gen_maintenance->gen_name->Visible) { // gen_name ?>
	<div id="r_gen_name" class="form-group">
		<label id="elh_gen_maintenance_gen_name" for="x_gen_name" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->gen_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->gen_name->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->maintenance_type->Visible) { // maintenance_type ?>
	<div id="r_maintenance_type" class="form-group">
		<label id="elh_gen_maintenance_maintenance_type" for="x_maintenance_type" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->maintenance_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->maintenance_type->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->running_hours->Visible) { // running_hours ?>
	<div id="r_running_hours" class="form-group">
		<label id="elh_gen_maintenance_running_hours" for="x_running_hours" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->running_hours->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->running_hours->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->cost->Visible) { // cost ?>
	<div id="r_cost" class="form-group">
		<label id="elh_gen_maintenance_cost" for="x_cost" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->cost->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->cost->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->labour_fee->Visible) { // labour_fee ?>
	<div id="r_labour_fee" class="form-group">
		<label id="elh_gen_maintenance_labour_fee" for="x_labour_fee" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->labour_fee->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->labour_fee->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->total->Visible) { // total ?>
	<div id="r_total" class="form-group">
		<label id="elh_gen_maintenance_total" for="x_total" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->total->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->total->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_gen_maintenance_staff_id" for="x_staff_id" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->staff_id->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->staff_id->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_gen_maintenance_status" for="x_status" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->status->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->status->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_gen_maintenance_initiator_action" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->initiator_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->initiator_action->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_gen_maintenance_initiator_comment" for="x_initiator_comment" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->initiator_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->initiator_comment->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_gen_maintenance_approver_date" for="x_approver_date" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->approver_date->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->approver_date->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_gen_maintenance_approver_action" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->approver_action->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->approver_action->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label id="elh_gen_maintenance_approver_comment" for="x_approver_comment" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->approver_comment->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->approver_comment->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<?php if ($gen_maintenance->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_gen_maintenance_approved_by" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->approved_by->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->approved_by->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fgen_maintenanceedit.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_gen_maintenance_approved_by">
...
<?php if ($gen_maintenance->flag->Visible) { // flag ?>
	<div id="r_flag" class="form-group">
		<label id="elh_gen_maintenance_flag" for="x_flag" class="<?php echo $gen_maintenance_edit->LeftColumnClass ?>"><?php echo $gen_maintenance->flag->FldCaption() ?></label>
		<div class="<?php echo $gen_maintenance_edit->RightColumnClass ?>"><div<?php echo $gen_maintenance->flag->CellAttributes() ?>>
<?php if ($gen_maintenance->CurrentAction <> "F") { ?>
...
<input type="hidden" data-table="gen_maintenance" data-field="x_flag" data-page="1" name="x_flag" id="x_flag" value="<?php echo ew_HtmlEncode($gen_maintenance->flag->FormValue) ?>">
<?php } ?>
<?php echo $gen_maintenance->flag->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<input type="hidden" data-table="gen_maintenance" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($gen_maintenance->id->CurrentValue) ?>">
<?php if (!$gen_maintenance_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $gen_maintenance_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($gen_maintenance->CurrentAction <> "F") { // Confirm page ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $gen_maintenance_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<script type="text/javascript">
fgen_maintenanceedit.Init();
</script>
<?php
$gen_maintenance_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$gen_maintenance_edit->Page_Terminate();
?>
