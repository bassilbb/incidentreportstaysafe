...
$diesel_supply_add = NULL; // Initialize page object first

class cdiesel_supply_add extends cdiesel_supply {
	...
	// Page object name
	var $PageObjName = 'diesel_supply_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("diesel_supplylist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "diesel_supplyview.php")
	...
	function AddRow($rsold = NULL) {
		...
		// date_initiated
		$this->date_initiated->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_initiated->CurrentValue, 14), NULL, FALSE);
...
// Create page object
if (!isset($diesel_supply_add)) $diesel_supply_add = new cdiesel_supply_add();

// Page init
$diesel_supply_add->Page_Init();

// Page main
$diesel_supply_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$diesel_supply_add->Page_Render();
?>
...
var CurrentForm = fdiesel_supplyadd = new ew_Form("fdiesel_supplyadd", "add");

// Validate form
fdiesel_supplyadd.Validate = function() {
...
fdiesel_supplyadd.Form_CustomValidate = 
...
fdiesel_supplyadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fdiesel_supplyadd.Lists["x_gen_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fdiesel_supplyadd.Lists["x_gen_type"].Data = "<?php echo $diesel_supply_add->gen_type->LookupFilterQuery(FALSE, "add") ?>";
fdiesel_supplyadd.Lists["x_category"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_category"};
fdiesel_supplyadd.Lists["x_category"].Data = "<?php echo $diesel_supply_add->category->LookupFilterQuery(FALSE, "add") ?>";
fdiesel_supplyadd.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"supply_status"};
fdiesel_supplyadd.Lists["x_status"].Data = "<?php echo $diesel_supply_add->status->LookupFilterQuery(FALSE, "add") ?>";
fdiesel_supplyadd.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdiesel_supplyadd.Lists["x_initiator_action"].Options = <?php echo json_encode($diesel_supply_add->initiator_action->Options()) ?>;
fdiesel_supplyadd.Lists["x_initiated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fdiesel_supplyadd.Lists["x_initiated_by"].Data = "<?php echo $diesel_supply_add->initiated_by->LookupFilterQuery(FALSE, "add") ?>";
fdiesel_supplyadd.AutoSuggests["x_initiated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $diesel_supply_add->initiated_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $diesel_supply_add->ShowPageHeader(); ?>
<?php
$diesel_supply_add->ShowMessage();
?>
<form name="fdiesel_supplyadd" id="fdiesel_supplyadd" class="<?php echo $diesel_supply_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($diesel_supply_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $diesel_supply_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="diesel_supply">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($diesel_supply_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($diesel_supply->date_initiated->Visible) { // date_initiated ?>
	<div id="r_date_initiated" class="form-group">
		<label id="elh_diesel_supply_date_initiated" for="x_date_initiated" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->date_initiated->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->date_initiated->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fdiesel_supplyadd", "x_date_initiated", {"ignoreReadonly":true,"useCurrent":false,"format":14});
</script>
<?php } ?>
</span>
...
<?php if ($diesel_supply->gen_type->Visible) { // gen_type ?>
	<div id="r_gen_type" class="form-group">
		<label id="elh_diesel_supply_gen_type" for="x_gen_type" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->gen_type->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->gen_type->CellAttributes() ?>>
...
<?php if ($diesel_supply->category->Visible) { // category ?>
	<div id="r_category" class="form-group">
		<label id="elh_diesel_supply_category" for="x_category" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->category->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->category->CellAttributes() ?>>
...
<?php if ($diesel_supply->diesel_initia_qty->Visible) { // diesel_initia_qty ?>
	<div id="r_diesel_initia_qty" class="form-group">
		<label id="elh_diesel_supply_diesel_initia_qty" for="x_diesel_initia_qty" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->diesel_initia_qty->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->diesel_initia_qty->CellAttributes() ?>>
...
<?php if ($diesel_supply->diesel_new_qty->Visible) { // diesel_new_qty ?>
	<div id="r_diesel_new_qty" class="form-group">
		<label id="elh_diesel_supply_diesel_new_qty" for="x_diesel_new_qty" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->diesel_new_qty->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->diesel_new_qty->CellAttributes() ?>>
...
<?php if ($diesel_supply->total->Visible) { // total ?>
	<div id="r_total" class="form-group">
		<label id="elh_diesel_supply_total" for="x_total" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->total->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->total->CellAttributes() ?>>
...
<?php if ($diesel_supply->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_diesel_supply_status" for="x_status" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->status->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->status->CellAttributes() ?>>
...
<?php if ($diesel_supply->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_diesel_supply_initiator_action" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->initiator_action->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->initiator_action->CellAttributes() ?>>
...
<?php if ($diesel_supply->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_diesel_supply_initiator_comment" for="x_initiator_comment" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->initiator_comment->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->initiator_comment->CellAttributes() ?>>
...
<?php if ($diesel_supply->initiated_by->Visible) { // initiated_by ?>
	<div id="r_initiated_by" class="form-group">
		<label id="elh_diesel_supply_initiated_by" class="<?php echo $diesel_supply_add->LeftColumnClass ?>"><?php echo $diesel_supply->initiated_by->FldCaption() ?></label>
		<div class="<?php echo $diesel_supply_add->RightColumnClass ?>"><div<?php echo $diesel_supply->initiated_by->CellAttributes() ?>>
...
<script type="text/javascript">
fdiesel_supplyadd.CreateAutoSuggest({"id":"x_initiated_by","forceSelect":false});
</script>
</span>
...
<?php if (!$diesel_supply_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $diesel_supply_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $diesel_supply_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fdiesel_supplyadd.Init();
</script>
<?php
$diesel_supply_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$diesel_supply_add->Page_Terminate();
?>
