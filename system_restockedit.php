...
$system_restock_edit = NULL; // Initialize page object first

class csystem_restock_edit extends csystem_restock {
	...
	// Page object name
	var $PageObjName = 'system_restock_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// date_restocked
			$this->date_restocked->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_restocked->CurrentValue, 0), NULL, $this->date_restocked->ReadOnly);
...
// Create page object
if (!isset($system_restock_edit)) $system_restock_edit = new csystem_restock_edit();

// Page init
$system_restock_edit->Page_Init();

// Page main
$system_restock_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$system_restock_edit->Page_Render();
?>
...
var CurrentForm = fsystem_restockedit = new ew_Form("fsystem_restockedit", "edit");

// Validate form
fsystem_restockedit.Validate = function() {
...
fsystem_restockedit.Form_CustomValidate = 
...
fsystem_restockedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $system_restock_edit->ShowPageHeader(); ?>
<?php
$system_restock_edit->ShowMessage();
?>
<?php if (!$system_restock_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($system_restock_edit->Pager)) $system_restock_edit->Pager = new cPrevNextPager($system_restock_edit->StartRec, $system_restock_edit->DisplayRecs, $system_restock_edit->TotalRecs, $system_restock_edit->AutoHidePager) ?>
<?php if ($system_restock_edit->Pager->RecordCount > 0 && $system_restock_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($system_restock_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $system_restock_edit->PageUrl() ?>start=<?php echo $system_restock_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($system_restock_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $system_restock_edit->PageUrl() ?>start=<?php echo $system_restock_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $system_restock_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($system_restock_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $system_restock_edit->PageUrl() ?>start=<?php echo $system_restock_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($system_restock_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $system_restock_edit->PageUrl() ?>start=<?php echo $system_restock_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $system_restock_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fsystem_restockedit" id="fsystem_restockedit" class="<?php echo $system_restock_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($system_restock_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $system_restock_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="system_restock">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($system_restock_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($system_restock->code->Visible) { // code ?>
	<div id="r_code" class="form-group">
		<label id="elh_system_restock_code" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->code->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->code->CellAttributes() ?>>
<span id="el_system_restock_code">
<span<?php echo $system_restock->code->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $system_restock->code->EditValue ?></p></span>
</span>
<input type="hidden" data-table="system_restock" data-field="x_code" name="x_code" id="x_code" value="<?php echo ew_HtmlEncode($system_restock->code->CurrentValue) ?>">
<?php echo $system_restock->code->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($system_restock->date_restocked->Visible) { // date_restocked ?>
	<div id="r_date_restocked" class="form-group">
		<label id="elh_system_restock_date_restocked" for="x_date_restocked" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->date_restocked->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->date_restocked->CellAttributes() ?>>
...
<?php if ($system_restock->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_system_restock_reference_id" for="x_reference_id" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->reference_id->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->reference_id->CellAttributes() ?>>
...
<?php if ($system_restock->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_system_restock_material_name" for="x_material_name" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->material_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->material_name->CellAttributes() ?>>
...
<?php if ($system_restock->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_system_restock_quantity" for="x_quantity" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->quantity->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->quantity->CellAttributes() ?>>
...
<?php if ($system_restock->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_system_restock_statuss" for="x_statuss" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->statuss->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->statuss->CellAttributes() ?>>
...
<?php if ($system_restock->restocked_action->Visible) { // restocked_action ?>
	<div id="r_restocked_action" class="form-group">
		<label id="elh_system_restock_restocked_action" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->restocked_action->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->restocked_action->CellAttributes() ?>>
...
<?php if ($system_restock->restocked_comment->Visible) { // restocked_comment ?>
	<div id="r_restocked_comment" class="form-group">
		<label id="elh_system_restock_restocked_comment" for="x_restocked_comment" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->restocked_comment->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->restocked_comment->CellAttributes() ?>>
...
<?php if ($system_restock->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_system_restock_approver_date" for="x_approver_date" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->approver_date->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->approver_date->CellAttributes() ?>>
...
<?php if ($system_restock->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_system_restock_approver_action" for="x_approver_action" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->approver_action->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->approver_action->CellAttributes() ?>>
...
<?php if ($system_restock->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label id="elh_system_restock_approver_comment" for="x_approver_comment" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->approver_comment->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->approver_comment->CellAttributes() ?>>
...
<?php if ($system_restock->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_system_restock_approved_by" for="x_approved_by" class="<?php echo $system_restock_edit->LeftColumnClass ?>"><?php echo $system_restock->approved_by->FldCaption() ?></label>
		<div class="<?php echo $system_restock_edit->RightColumnClass ?>"><div<?php echo $system_restock->approved_by->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $system_restock_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $system_restock_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fsystem_restockedit.Init();
</script>
<?php
$system_restock_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$system_restock_edit->Page_Terminate();
?>
