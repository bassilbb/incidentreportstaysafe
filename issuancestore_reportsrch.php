...
$issuancestore_report_search = NULL; // Initialize page object first

class cissuancestore_report_search extends cissuancestore_report {
	...
	// Page object name
	var $PageObjName = 'issuancestore_report_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "issuancestore_reportlist.php" . "?" . $sSrchStr;
...
// Create page object
if (!isset($issuancestore_report_search)) $issuancestore_report_search = new cissuancestore_report_search();

// Page init
$issuancestore_report_search->Page_Init();

// Page main
$issuancestore_report_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$issuancestore_report_search->Page_Render();
?>
...
<?php if ($issuancestore_report_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fissuancestore_reportsearch = new ew_Form("fissuancestore_reportsearch", "search");
<?php } else { ?>
var CurrentForm = fissuancestore_reportsearch = new ew_Form("fissuancestore_reportsearch", "search");
<?php } ?>

// Form_CustomValidate event
fissuancestore_reportsearch.Form_CustomValidate = 
...
fissuancestore_reportsearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fissuancestore_reportsearch.Lists["x_material_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_material_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"inventory_staysafe"};
fissuancestore_reportsearch.Lists["x_material_name"].Data = "<?php echo $issuancestore_report_search->material_name->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.Lists["x_treated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportsearch.Lists["x_treated_by"].Data = "<?php echo $issuancestore_report_search->treated_by->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.AutoSuggests["x_treated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_search->treated_by->LookupFilterQuery(TRUE, "search"))) ?>;
fissuancestore_reportsearch.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportsearch.Lists["x_staff_id"].Data = "<?php echo $issuancestore_report_search->staff_id->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_search->staff_id->LookupFilterQuery(TRUE, "search"))) ?>;
fissuancestore_reportsearch.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
fissuancestore_reportsearch.Lists["x_statuss"].Data = "<?php echo $issuancestore_report_search->statuss->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.Lists["x_issued_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuancestore_reportsearch.Lists["x_issued_action"].Options = <?php echo json_encode($issuancestore_report_search->issued_action->Options()) ?>;
fissuancestore_reportsearch.Lists["x_issued_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportsearch.Lists["x_issued_by"].Data = "<?php echo $issuancestore_report_search->issued_by->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuancestore_reportsearch.Lists["x_approver_action"].Options = <?php echo json_encode($issuancestore_report_search->approver_action->Options()) ?>;
fissuancestore_reportsearch.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportsearch.Lists["x_approved_by"].Data = "<?php echo $issuancestore_report_search->approved_by->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_search->approved_by->LookupFilterQuery(TRUE, "search"))) ?>;
fissuancestore_reportsearch.Lists["x_verified_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fissuancestore_reportsearch.Lists["x_verified_action"].Options = <?php echo json_encode($issuancestore_report_search->verified_action->Options()) ?>;
fissuancestore_reportsearch.Lists["x_verified_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fissuancestore_reportsearch.Lists["x_verified_by"].Data = "<?php echo $issuancestore_report_search->verified_by->LookupFilterQuery(FALSE, "search") ?>";
fissuancestore_reportsearch.AutoSuggests["x_verified_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $issuancestore_report_search->verified_by->LookupFilterQuery(TRUE, "search"))) ?>;

// Form object for search
// Validate function for search

fissuancestore_reportsearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($issuancestore_report->id->FldErrMsg()) ?>");
...
<?php $issuancestore_report_search->ShowPageHeader(); ?>
<?php
$issuancestore_report_search->ShowMessage();
?>
<form name="fissuancestore_reportsearch" id="fissuancestore_reportsearch" class="<?php echo $issuancestore_report_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($issuancestore_report_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $issuancestore_report_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="issuancestore_report">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($issuancestore_report_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($issuancestore_report->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label for="x_id" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_id"><?php echo $issuancestore_report->id->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_id" id="z_id" value="="></p>
		</label>
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->id->CellAttributes() ?>>
			<span id="el_issuancestore_report_id">
<input type="text" data-table="issuancestore_report" data-field="x_id" name="x_id" id="x_id" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->id->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->id->EditValue ?>"<?php echo $issuancestore_report->id->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->date->Visible) { // date ?>
	<div id="r_date" class="form-group">
		<label for="x_date" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_date"><?php echo $issuancestore_report->date->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fissuancestore_reportsearch", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":14});
</script>
<?php } ?>
</span>
			<span class="ewSearchCond btw1_date">&nbsp;<?php echo $Language->Phrase("AND") ?>&nbsp;</span>
			<span id="e2_issuancestore_report_date" class="btw1_date">
...
<?php if (!$issuancestore_report->date->ReadOnly && !$issuancestore_report->date->Disabled && !isset($issuancestore_report->date->EditAttrs["readonly"]) && !isset($issuancestore_report->date->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("fissuancestore_reportsearch", "y_date", {"ignoreReadonly":true,"useCurrent":false,"format":14});
</script>
<?php } ?>
</span>
		</div></div>
...
<?php if ($issuancestore_report->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label for="x_reference_id" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_reference_id"><?php echo $issuancestore_report->reference_id->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->reference_id->CellAttributes() ?>>
...
<?php if ($issuancestore_report->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label for="x_material_name" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_material_name"><?php echo $issuancestore_report->material_name->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->material_name->CellAttributes() ?>>
...
<?php if ($issuancestore_report->quantity_in->Visible) { // quantity_in ?>
	<div id="r_quantity_in" class="form-group">
		<label for="x_quantity_in" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_quantity_in"><?php echo $issuancestore_report->quantity_in->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->quantity_in->CellAttributes() ?>>
...
<?php if ($issuancestore_report->quantity_out->Visible) { // quantity_out ?>
	<div id="r_quantity_out" class="form-group">
		<label for="x_quantity_out" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_quantity_out"><?php echo $issuancestore_report->quantity_out->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->quantity_out->CellAttributes() ?>>
			<span id="el_issuancestore_report_quantity_out">
<input type="text" data-table="issuancestore_report" data-field="x_quantity_out" name="x_quantity_out" id="x_quantity_out" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->quantity_out->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->quantity_out->EditValue ?>"<?php echo $issuancestore_report->quantity_out->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->total_quantity->Visible) { // total_quantity ?>
	<div id="r_total_quantity" class="form-group">
		<label for="x_total_quantity" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_total_quantity"><?php echo $issuancestore_report->total_quantity->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->total_quantity->CellAttributes() ?>>
...
<?php if ($issuancestore_report->quantity_type->Visible) { // quantity_type ?>
	<div id="r_quantity_type" class="form-group">
		<label for="x_quantity_type" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_quantity_type"><?php echo $issuancestore_report->quantity_type->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->quantity_type->CellAttributes() ?>>
...
<?php if ($issuancestore_report->treated_by->Visible) { // treated_by ?>
	<div id="r_treated_by" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_treated_by"><?php echo $issuancestore_report->treated_by->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->treated_by->CellAttributes() ?>>
...
<input type="hidden" data-table="issuancestore_report" data-field="x_treated_by" data-value-separator="<?php echo $issuancestore_report->treated_by->DisplayValueSeparatorAttribute() ?>" name="x_treated_by" id="x_treated_by" value="<?php echo ew_HtmlEncode($issuancestore_report->treated_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fissuancestore_reportsearch.CreateAutoSuggest({"id":"x_treated_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_staff_id"><?php echo $issuancestore_report->staff_id->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->staff_id->CellAttributes() ?>>
			<span id="el_issuancestore_report_staff_id">
<?php
$wrkonchange = trim(" " . @$issuancestore_report->staff_id->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$issuancestore_report->staff_id->EditAttrs["onchange"] = "";
?>
<span id="as_x_staff_id" style="white-space: nowrap; z-index: 8900">
	<input type="text" name="sv_x_staff_id" id="sv_x_staff_id" value="<?php echo $issuancestore_report->staff_id->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->staff_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($issuancestore_report->staff_id->getPlaceHolder()) ?>"<?php echo $issuancestore_report->staff_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="issuancestore_report" data-field="x_staff_id" data-value-separator="<?php echo $issuancestore_report->staff_id->DisplayValueSeparatorAttribute() ?>" name="x_staff_id" id="x_staff_id" value="<?php echo ew_HtmlEncode($issuancestore_report->staff_id->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fissuancestore_reportsearch.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($issuancestore_report->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label for="x_statuss" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_statuss"><?php echo $issuancestore_report->statuss->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->statuss->CellAttributes() ?>>
...
<?php if ($issuancestore_report->issued_action->Visible) { // issued_action ?>
	<div id="r_issued_action" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_issued_action"><?php echo $issuancestore_report->issued_action->FldCaption() ?></span>
...
<?php if ($issuancestore_report->issued_comment->Visible) { // issued_comment ?>
	<div id="r_issued_comment" class="form-group">
		<label for="x_issued_comment" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_issued_comment"><?php echo $issuancestore_report->issued_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->issued_comment->CellAttributes() ?>>
			<span id="el_issuancestore_report_issued_comment">
<input type="text" data-table="issuancestore_report" data-field="x_issued_comment" name="x_issued_comment" id="x_issued_comment" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->issued_comment->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->issued_comment->EditValue ?>"<?php echo $issuancestore_report->issued_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->issued_by->Visible) { // issued_by ?>
	<div id="r_issued_by" class="form-group">
		<label for="x_issued_by" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_issued_by"><?php echo $issuancestore_report->issued_by->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->issued_by->CellAttributes() ?>>
...
<?php if ($issuancestore_report->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label for="x_approver_date" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_approver_date"><?php echo $issuancestore_report->approver_date->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->approver_date->CellAttributes() ?>>
			<span id="el_issuancestore_report_approver_date">
<input type="text" data-table="issuancestore_report" data-field="x_approver_date" name="x_approver_date" id="x_approver_date" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->approver_date->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->approver_date->EditValue ?>"<?php echo $issuancestore_report->approver_date->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_approver_action"><?php echo $issuancestore_report->approver_action->FldCaption() ?></span>
...
<?php if ($issuancestore_report->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label for="x_approver_comment" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_approver_comment"><?php echo $issuancestore_report->approver_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->approver_comment->CellAttributes() ?>>
			<span id="el_issuancestore_report_approver_comment">
<input type="text" data-table="issuancestore_report" data-field="x_approver_comment" name="x_approver_comment" id="x_approver_comment" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->approver_comment->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->approver_comment->EditValue ?>"<?php echo $issuancestore_report->approver_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_approved_by"><?php echo $issuancestore_report->approved_by->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->approved_by->CellAttributes() ?>>
...
<input type="hidden" data-table="issuancestore_report" data-field="x_approved_by" data-value-separator="<?php echo $issuancestore_report->approved_by->DisplayValueSeparatorAttribute() ?>" name="x_approved_by" id="x_approved_by" value="<?php echo ew_HtmlEncode($issuancestore_report->approved_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fissuancestore_reportsearch.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<?php if ($issuancestore_report->verified_date->Visible) { // verified_date ?>
	<div id="r_verified_date" class="form-group">
		<label for="x_verified_date" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_verified_date"><?php echo $issuancestore_report->verified_date->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_date->CellAttributes() ?>>
			<span id="el_issuancestore_report_verified_date">
<input type="text" data-table="issuancestore_report" data-field="x_verified_date" name="x_verified_date" id="x_verified_date" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->verified_date->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->verified_date->EditValue ?>"<?php echo $issuancestore_report->verified_date->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->verified_action->Visible) { // verified_action ?>
	<div id="r_verified_action" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_verified_action"><?php echo $issuancestore_report->verified_action->FldCaption() ?></span>
...
<?php if ($issuancestore_report->verified_comment->Visible) { // verified_comment ?>
	<div id="r_verified_comment" class="form-group">
		<label for="x_verified_comment" class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_verified_comment"><?php echo $issuancestore_report->verified_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_comment->CellAttributes() ?>>
			<span id="el_issuancestore_report_verified_comment">
<input type="text" data-table="issuancestore_report" data-field="x_verified_comment" name="x_verified_comment" id="x_verified_comment" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($issuancestore_report->verified_comment->getPlaceHolder()) ?>" value="<?php echo $issuancestore_report->verified_comment->EditValue ?>"<?php echo $issuancestore_report->verified_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($issuancestore_report->verified_by->Visible) { // verified_by ?>
	<div id="r_verified_by" class="form-group">
		<label class="<?php echo $issuancestore_report_search->LeftColumnClass ?>"><span id="elh_issuancestore_report_verified_by"><?php echo $issuancestore_report->verified_by->FldCaption() ?></span>
		...
		<div class="<?php echo $issuancestore_report_search->RightColumnClass ?>"><div<?php echo $issuancestore_report->verified_by->CellAttributes() ?>>
...
<input type="hidden" data-table="issuancestore_report" data-field="x_verified_by" data-value-separator="<?php echo $issuancestore_report->verified_by->DisplayValueSeparatorAttribute() ?>" name="x_verified_by" id="x_verified_by" value="<?php echo ew_HtmlEncode($issuancestore_report->verified_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fissuancestore_reportsearch.CreateAutoSuggest({"id":"x_verified_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $issuancestore_report_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fissuancestore_reportsearch.Init();
</script>
<?php
$issuancestore_report_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$issuancestore_report_search->Page_Terminate();
?>
