...
$genreading_supply_edit = NULL; // Initialize page object first

class cgenreading_supply_edit extends cgenreading_supply {
	...
	// Page object name
	var $PageObjName = 'genreading_supply_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("genreading_supplylist.php"); // Return to list page
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// date_initiated
			$this->date_initiated->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_initiated->CurrentValue, 17), NULL, $this->date_initiated->ReadOnly);
			...
			// gen_reading
			$this->gen_reading->SetDbValueDef($rsnew, $this->gen_reading->CurrentValue, NULL, $this->gen_reading->ReadOnly);
...
// Create page object
if (!isset($genreading_supply_edit)) $genreading_supply_edit = new cgenreading_supply_edit();

// Page init
$genreading_supply_edit->Page_Init();

// Page main
$genreading_supply_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$genreading_supply_edit->Page_Render();
?>
...
var CurrentForm = fgenreading_supplyedit = new ew_Form("fgenreading_supplyedit", "edit");

// Validate form
fgenreading_supplyedit.Validate = function() {
...
fgenreading_supplyedit.Form_CustomValidate = 
...
fgenreading_supplyedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fgenreading_supplyedit.Lists["x_gen_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fgenreading_supplyedit.Lists["x_gen_type"].Data = "<?php echo $genreading_supply_edit->gen_type->LookupFilterQuery(FALSE, "edit") ?>";
fgenreading_supplyedit.Lists["x_category"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_category"};
fgenreading_supplyedit.Lists["x_category"].Data = "<?php echo $genreading_supply_edit->category->LookupFilterQuery(FALSE, "edit") ?>";
fgenreading_supplyedit.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"supply_status"};
fgenreading_supplyedit.Lists["x_status"].Data = "<?php echo $genreading_supply_edit->status->LookupFilterQuery(FALSE, "edit") ?>";
fgenreading_supplyedit.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgenreading_supplyedit.Lists["x_initiator_action"].Options = <?php echo json_encode($genreading_supply_edit->initiator_action->Options()) ?>;
fgenreading_supplyedit.Lists["x_initiated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgenreading_supplyedit.Lists["x_initiated_by"].Data = "<?php echo $genreading_supply_edit->initiated_by->LookupFilterQuery(FALSE, "edit") ?>";
fgenreading_supplyedit.AutoSuggests["x_initiated_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $genreading_supply_edit->initiated_by->LookupFilterQuery(TRUE, "edit"))) ?>;
...
<?php $genreading_supply_edit->ShowPageHeader(); ?>
<?php
$genreading_supply_edit->ShowMessage();
?>
<?php if (!$genreading_supply_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($genreading_supply_edit->Pager)) $genreading_supply_edit->Pager = new cPrevNextPager($genreading_supply_edit->StartRec, $genreading_supply_edit->DisplayRecs, $genreading_supply_edit->TotalRecs, $genreading_supply_edit->AutoHidePager) ?>
<?php if ($genreading_supply_edit->Pager->RecordCount > 0 && $genreading_supply_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($genreading_supply_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $genreading_supply_edit->PageUrl() ?>start=<?php echo $genreading_supply_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($genreading_supply_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $genreading_supply_edit->PageUrl() ?>start=<?php echo $genreading_supply_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $genreading_supply_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($genreading_supply_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $genreading_supply_edit->PageUrl() ?>start=<?php echo $genreading_supply_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($genreading_supply_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $genreading_supply_edit->PageUrl() ?>start=<?php echo $genreading_supply_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $genreading_supply_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fgenreading_supplyedit" id="fgenreading_supplyedit" class="<?php echo $genreading_supply_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($genreading_supply_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $genreading_supply_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="genreading_supply">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($genreading_supply_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($genreading_supply->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_genreading_supply_id" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->id->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->id->CellAttributes() ?>>
<span id="el_genreading_supply_id">
<span<?php echo $genreading_supply->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $genreading_supply->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="genreading_supply" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($genreading_supply->id->CurrentValue) ?>">
<?php echo $genreading_supply->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($genreading_supply->date_initiated->Visible) { // date_initiated ?>
	<div id="r_date_initiated" class="form-group">
		<label id="elh_genreading_supply_date_initiated" for="x_date_initiated" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->date_initiated->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->date_initiated->CellAttributes() ?>>
...
<?php if ($genreading_supply->gen_type->Visible) { // gen_type ?>
	<div id="r_gen_type" class="form-group">
		<label id="elh_genreading_supply_gen_type" for="x_gen_type" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->gen_type->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->gen_type->CellAttributes() ?>>
...
<?php if ($genreading_supply->category->Visible) { // category ?>
	<div id="r_category" class="form-group">
		<label id="elh_genreading_supply_category" for="x_category" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->category->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->category->CellAttributes() ?>>
...
<?php if ($genreading_supply->gen_reading->Visible) { // gen_reading ?>
	<div id="r_gen_reading" class="form-group">
		<label id="elh_genreading_supply_gen_reading" for="x_gen_reading" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->gen_reading->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->gen_reading->CellAttributes() ?>>
...
<?php if ($genreading_supply->diesel_initia_qty->Visible) { // diesel_initia_qty ?>
	<div id="r_diesel_initia_qty" class="form-group">
		<label id="elh_genreading_supply_diesel_initia_qty" for="x_diesel_initia_qty" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->diesel_initia_qty->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->diesel_initia_qty->CellAttributes() ?>>
...
<?php if ($genreading_supply->diesel_new_qty->Visible) { // diesel_new_qty ?>
	<div id="r_diesel_new_qty" class="form-group">
		<label id="elh_genreading_supply_diesel_new_qty" for="x_diesel_new_qty" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->diesel_new_qty->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->diesel_new_qty->CellAttributes() ?>>
...
<?php if ($genreading_supply->total->Visible) { // total ?>
	<div id="r_total" class="form-group">
		<label id="elh_genreading_supply_total" for="x_total" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->total->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->total->CellAttributes() ?>>
...
<?php if ($genreading_supply->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_genreading_supply_status" for="x_status" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->status->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->status->CellAttributes() ?>>
...
<?php if ($genreading_supply->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_genreading_supply_initiator_action" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->initiator_action->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->initiator_action->CellAttributes() ?>>
...
<?php if ($genreading_supply->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_genreading_supply_initiator_comment" for="x_initiator_comment" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->initiator_comment->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->initiator_comment->CellAttributes() ?>>
...
<?php if ($genreading_supply->initiated_by->Visible) { // initiated_by ?>
	<div id="r_initiated_by" class="form-group">
		<label id="elh_genreading_supply_initiated_by" class="<?php echo $genreading_supply_edit->LeftColumnClass ?>"><?php echo $genreading_supply->initiated_by->FldCaption() ?></label>
		<div class="<?php echo $genreading_supply_edit->RightColumnClass ?>"><div<?php echo $genreading_supply->initiated_by->CellAttributes() ?>>
...
<script type="text/javascript">
fgenreading_supplyedit.CreateAutoSuggest({"id":"x_initiated_by","forceSelect":false});
</script>
</span>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $genreading_supply_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $genreading_supply_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fgenreading_supplyedit.Init();
</script>
<?php
$genreading_supply_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$genreading_supply_edit->Page_Terminate();
?>
