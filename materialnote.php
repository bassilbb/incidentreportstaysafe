...
$materialnote_php = NULL; // Initialize page object first

class cmaterialnote_php {
	...
	// Table name
	var $TableName = 'materialnote.php';

	// Page object name
	var $PageObjName = 'materialnote_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'materialnote.php');
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "materialnote_php", $url, "", "materialnote_php", TRUE);
		$this->Heading = $Language->TablePhrase("materialnote_php", "TblCaption"); 
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($materialnote_php)) $materialnote_php = new cmaterialnote_php();

// Page init
$materialnote_php->Page_Init();

// Page main
$materialnote_php->Page_Main();
