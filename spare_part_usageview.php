...
$spare_part_usage_view = NULL; // Initialize page object first

class cspare_part_usage_view extends cspare_part_usage {
	...
	// Page object name
	var $PageObjName = 'spare_part_usage_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "spare_part_usagelist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "spare_part_usagelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($spare_part_usage_view)) $spare_part_usage_view = new cspare_part_usage_view();

// Page init
$spare_part_usage_view->Page_Init();

// Page main
$spare_part_usage_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$spare_part_usage_view->Page_Render();
?>
...
var CurrentForm = fspare_part_usageview = new ew_Form("fspare_part_usageview", "view");

// Form_CustomValidate event
fspare_part_usageview.Form_CustomValidate = 
...
fspare_part_usageview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fspare_part_usageview.Lists["x_reference_id"] = {"LinkField":"x_reference_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_reference_id","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_maintenance"};
fspare_part_usageview.Lists["x_reference_id"].Data = "<?php echo $spare_part_usage_view->reference_id->LookupFilterQuery(FALSE, "view") ?>";
fspare_part_usageview.Lists["x_part_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_part_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_module"};
fspare_part_usageview.Lists["x_part_name"].Data = "<?php echo $spare_part_usage_view->part_name->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($spare_part_usage->Export == "") { ?>
<div class="ewToolbar">
<?php $spare_part_usage_view->ExportOptions->Render("body") ?>
<?php
	foreach ($spare_part_usage_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $spare_part_usage_view->ShowPageHeader(); ?>
<?php
$spare_part_usage_view->ShowMessage();
?>
<?php if (!$spare_part_usage_view->IsModal) { ?>
<?php if ($spare_part_usage->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($spare_part_usage_view->Pager)) $spare_part_usage_view->Pager = new cPrevNextPager($spare_part_usage_view->StartRec, $spare_part_usage_view->DisplayRecs, $spare_part_usage_view->TotalRecs, $spare_part_usage_view->AutoHidePager) ?>
<?php if ($spare_part_usage_view->Pager->RecordCount > 0 && $spare_part_usage_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($spare_part_usage_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $spare_part_usage_view->PageUrl() ?>start=<?php echo $spare_part_usage_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($spare_part_usage_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $spare_part_usage_view->PageUrl() ?>start=<?php echo $spare_part_usage_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $spare_part_usage_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($spare_part_usage_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $spare_part_usage_view->PageUrl() ?>start=<?php echo $spare_part_usage_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($spare_part_usage_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $spare_part_usage_view->PageUrl() ?>start=<?php echo $spare_part_usage_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $spare_part_usage_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fspare_part_usageview" id="fspare_part_usageview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($spare_part_usage_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $spare_part_usage_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="spare_part_usage">
<input type="hidden" name="modal" value="<?php echo intval($spare_part_usage_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($spare_part_usage->id->Visible) { // id ?>
	<tr id="r_id">
		<td class="col-sm-2"><span id="elh_spare_part_usage_id"><?php echo $spare_part_usage->id->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->date->Visible) { // date ?>
	<tr id="r_date">
		<td class="col-sm-2"><span id="elh_spare_part_usage_date"><?php echo $spare_part_usage->date->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->reference_id->Visible) { // reference_id ?>
	<tr id="r_reference_id">
		<td class="col-sm-2"><span id="elh_spare_part_usage_reference_id"><?php echo $spare_part_usage->reference_id->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->reference_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->part_name->Visible) { // part_name ?>
	<tr id="r_part_name">
		<td class="col-sm-2"><span id="elh_spare_part_usage_part_name"><?php echo $spare_part_usage->part_name->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->part_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->gen_name->Visible) { // gen_name ?>
	<tr id="r_gen_name">
		<td class="col-sm-2"><span id="elh_spare_part_usage_gen_name"><?php echo $spare_part_usage->gen_name->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->gen_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->quantity_in->Visible) { // quantity_in ?>
	<tr id="r_quantity_in">
		<td class="col-sm-2"><span id="elh_spare_part_usage_quantity_in"><?php echo $spare_part_usage->quantity_in->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->quantity_in->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->quantity_used->Visible) { // quantity_used ?>
	<tr id="r_quantity_used">
		<td class="col-sm-2"><span id="elh_spare_part_usage_quantity_used"><?php echo $spare_part_usage->quantity_used->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->quantity_used->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->cost->Visible) { // cost ?>
	<tr id="r_cost">
		<td class="col-sm-2"><span id="elh_spare_part_usage_cost"><?php echo $spare_part_usage->cost->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->total_quantity->Visible) { // total_quantity ?>
	<tr id="r_total_quantity">
		<td class="col-sm-2"><span id="elh_spare_part_usage_total_quantity"><?php echo $spare_part_usage->total_quantity->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->total_quantity->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->total_cost->Visible) { // total_cost ?>
	<tr id="r_total_cost">
		<td class="col-sm-2"><span id="elh_spare_part_usage_total_cost"><?php echo $spare_part_usage->total_cost->FldCaption() ?></span></td>
...
<?php if ($spare_part_usage->maintenance_total_cost->Visible) { // maintenance_total_cost ?>
	<tr id="r_maintenance_total_cost">
		<td class="col-sm-2"><span id="elh_spare_part_usage_maintenance_total_cost"><?php echo $spare_part_usage->maintenance_total_cost->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->maintenance_total_cost->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($spare_part_usage->maintenance_id->Visible) { // maintenance_id ?>
	<tr id="r_maintenance_id">
		<td class="col-sm-2"><span id="elh_spare_part_usage_maintenance_id"><?php echo $spare_part_usage->maintenance_id->FldCaption() ?></span></td>
...
<?php echo $spare_part_usage->maintenance_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($spare_part_usage->Export == "") { ?>
<script type="text/javascript">
fspare_part_usageview.Init();
</script>
<?php } ?>
<?php
$spare_part_usage_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($spare_part_usage->Export == "") { ?>
...
<?php
$spare_part_usage_view->Page_Terminate();
?>
