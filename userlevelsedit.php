...
<?php if (!isset($userlevels_edit->Pager)) $userlevels_edit->Pager = new cPrevNextPager($userlevels_edit->StartRec, $userlevels_edit->DisplayRecs, $userlevels_edit->TotalRecs, $userlevels_edit->AutoHidePager) ?>
