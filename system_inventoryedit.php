...
$system_inventory_edit = NULL; // Initialize page object first

class csystem_inventory_edit extends csystem_inventory {
	...
	// Page object name
	var $PageObjName = 'system_inventory_edit';
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("system_inventorylist.php"); // Return to list page
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// date_recieved
			$this->date_recieved->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_recieved->CurrentValue, 17), NULL, $this->date_recieved->ReadOnly);
			...
			// pc_ram
			$this->pc_ram->SetDbValueDef($rsnew, $this->pc_ram->CurrentValue, NULL, $this->pc_ram->ReadOnly);

			// pc_harddisk
			$this->pc_harddisk->SetDbValueDef($rsnew, $this->pc_harddisk->CurrentValue, NULL, $this->pc_harddisk->ReadOnly);
			...
			// recieved_by
			$this->recieved_by->SetDbValueDef($rsnew, $this->recieved_by->CurrentValue, NULL, $this->recieved_by->ReadOnly);
...
// Create page object
if (!isset($system_inventory_edit)) $system_inventory_edit = new csystem_inventory_edit();

// Page init
$system_inventory_edit->Page_Init();

// Page main
$system_inventory_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$system_inventory_edit->Page_Render();
?>
...
var CurrentForm = fsystem_inventoryedit = new ew_Form("fsystem_inventoryedit", "edit");

// Validate form
fsystem_inventoryedit.Validate = function() {
...
fsystem_inventoryedit.Form_CustomValidate = 
...
fsystem_inventoryedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsystem_inventoryedit.Lists["x_recieved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fsystem_inventoryedit.Lists["x_recieved_by"].Data = "<?php echo $system_inventory_edit->recieved_by->LookupFilterQuery(FALSE, "edit") ?>";
fsystem_inventoryedit.AutoSuggests["x_recieved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $system_inventory_edit->recieved_by->LookupFilterQuery(TRUE, "edit"))) ?>;
...
<?php $system_inventory_edit->ShowPageHeader(); ?>
<?php
$system_inventory_edit->ShowMessage();
?>
<?php if (!$system_inventory_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($system_inventory_edit->Pager)) $system_inventory_edit->Pager = new cPrevNextPager($system_inventory_edit->StartRec, $system_inventory_edit->DisplayRecs, $system_inventory_edit->TotalRecs, $system_inventory_edit->AutoHidePager) ?>
<?php if ($system_inventory_edit->Pager->RecordCount > 0 && $system_inventory_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($system_inventory_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $system_inventory_edit->PageUrl() ?>start=<?php echo $system_inventory_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($system_inventory_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $system_inventory_edit->PageUrl() ?>start=<?php echo $system_inventory_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $system_inventory_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($system_inventory_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $system_inventory_edit->PageUrl() ?>start=<?php echo $system_inventory_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($system_inventory_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $system_inventory_edit->PageUrl() ?>start=<?php echo $system_inventory_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $system_inventory_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fsystem_inventoryedit" id="fsystem_inventoryedit" class="<?php echo $system_inventory_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($system_inventory_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $system_inventory_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="system_inventory">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($system_inventory_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($system_inventory->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_system_inventory_id" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->id->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->id->CellAttributes() ?>>
<span id="el_system_inventory_id">
<span<?php echo $system_inventory->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $system_inventory->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="system_inventory" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($system_inventory->id->CurrentValue) ?>">
<?php echo $system_inventory->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($system_inventory->date_recieved->Visible) { // date_recieved ?>
	<div id="r_date_recieved" class="form-group">
		<label id="elh_system_inventory_date_recieved" for="x_date_recieved" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->date_recieved->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->date_recieved->CellAttributes() ?>>
...
<?php if ($system_inventory->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_system_inventory_reference_id" for="x_reference_id" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->reference_id->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->reference_id->CellAttributes() ?>>
...
<?php if ($system_inventory->material_name->Visible) { // material_name ?>
	<div id="r_material_name" class="form-group">
		<label id="elh_system_inventory_material_name" for="x_material_name" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->material_name->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->material_name->CellAttributes() ?>>
...
<?php if ($system_inventory->make->Visible) { // make ?>
	<div id="r_make" class="form-group">
		<label id="elh_system_inventory_make" for="x_make" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->make->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->make->CellAttributes() ?>>
...
<?php if ($system_inventory->pc_ram->Visible) { // pc_ram ?>
	<div id="r_pc_ram" class="form-group">
		<label id="elh_system_inventory_pc_ram" for="x_pc_ram" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->pc_ram->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->pc_ram->CellAttributes() ?>>
...
<?php if ($system_inventory->pc_harddisk->Visible) { // pc_harddisk ?>
	<div id="r_pc_harddisk" class="form-group">
		<label id="elh_system_inventory_pc_harddisk" for="x_pc_harddisk" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->pc_harddisk->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->pc_harddisk->CellAttributes() ?>>
...
<?php if ($system_inventory->color->Visible) { // color ?>
	<div id="r_color" class="form-group">
		<label id="elh_system_inventory_color" for="x_color" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->color->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->color->CellAttributes() ?>>
...
<?php if ($system_inventory->capacity->Visible) { // capacity ?>
	<div id="r_capacity" class="form-group">
		<label id="elh_system_inventory_capacity" for="x_capacity" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->capacity->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->capacity->CellAttributes() ?>>
...
<?php if ($system_inventory->quantity->Visible) { // quantity ?>
	<div id="r_quantity" class="form-group">
		<label id="elh_system_inventory_quantity" for="x_quantity" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->quantity->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->quantity->CellAttributes() ?>>
...
<?php if ($system_inventory->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_system_inventory_description" for="x_description" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->description->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->description->CellAttributes() ?>>
...
<?php if ($system_inventory->recieved_by->Visible) { // recieved_by ?>
	<div id="r_recieved_by" class="form-group">
		<label id="elh_system_inventory_recieved_by" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->recieved_by->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->recieved_by->CellAttributes() ?>>
...
<script type="text/javascript">
fsystem_inventoryedit.CreateAutoSuggest({"id":"x_recieved_by","forceSelect":false});
</script>
</span>
...
<?php if ($system_inventory->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_system_inventory_status" for="x_status" class="<?php echo $system_inventory_edit->LeftColumnClass ?>"><?php echo $system_inventory->status->FldCaption() ?></label>
		<div class="<?php echo $system_inventory_edit->RightColumnClass ?>"><div<?php echo $system_inventory->status->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $system_inventory_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $system_inventory_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fsystem_inventoryedit.Init();
</script>
<?php
$system_inventory_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$system_inventory_edit->Page_Terminate();
?>
