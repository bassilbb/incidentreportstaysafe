...
//
// Table class for maintenance
//
class cmaintenance extends cTable {
	var $id;
	var $date_initiated;
	var $reference_id;
	var $staff_id;
	...
	function __construct() {
		...
		$this->TableVar = 'maintenance';
		$this->TableName = 'maintenance';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`maintenance`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('maintenance', 'maintenance', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// date_initiated
		$this->date_initiated = new cField('maintenance', 'maintenance', 'x_date_initiated', 'date_initiated', '`date_initiated`', ew_CastDateFieldForLike('`date_initiated`', 0, "DB"), 135, 0, FALSE, '`date_initiated`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reference_id
		$this->reference_id = new cField('maintenance', 'maintenance', 'x_reference_id', 'reference_id', '`reference_id`', '`reference_id`', 200, -1, FALSE, '`reference_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reference_id->Sortable = TRUE; // Allow sort
		$this->fields['reference_id'] = &$this->reference_id;

		// staff_id
		$this->staff_id = new cField('maintenance', 'maintenance', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 200, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// staff_name
		$this->staff_name = new cField('maintenance', 'maintenance', 'x_staff_name', 'staff_name', '`staff_name`', '`staff_name`', 3, -1, FALSE, '`staff_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// department
		$this->department = new cField('maintenance', 'maintenance', 'x_department', 'department', '`department`', '`department`', 3, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->fields['department'] = &$this->department;

		// branch
		$this->branch = new cField('maintenance', 'maintenance', 'x_branch', 'branch', '`branch`', '`branch`', 3, -1, FALSE, '`branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->branch->Sortable = TRUE; // Allow sort
		$this->fields['branch'] = &$this->branch;

		// buildings
		$this->buildings = new cField('maintenance', 'maintenance', 'x_buildings', 'buildings', '`buildings`', '`buildings`', 3, -1, FALSE, '`buildings`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// floors
		$this->floors = new cField('maintenance', 'maintenance', 'x_floors', 'floors', '`floors`', '`floors`', 3, -1, FALSE, '`floors`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// items
		$this->items = new cField('maintenance', 'maintenance', 'x_items', 'items', '`items`', '`items`', 3, -1, FALSE, '`items`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// priority
		$this->priority = new cField('maintenance', 'maintenance', 'x_priority', 'priority', '`priority`', '`priority`', 3, -1, FALSE, '`priority`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// description
		$this->description = new cField('maintenance', 'maintenance', 'x_description', 'description', '`description`', '`description`', 201, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->description->Sortable = TRUE; // Allow sort
		$this->description->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['description'] = &$this->description;

		// status
		$this->status = new cField('maintenance', 'maintenance', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// date_maintained
		$this->date_maintained = new cField('maintenance', 'maintenance', 'x_date_maintained', 'date_maintained', '`date_maintained`', ew_CastDateFieldForLike('`date_maintained`', 17, "DB"), 135, 17, FALSE, '`date_maintained`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// maintenance_action
		$this->maintenance_action = new cField('maintenance', 'maintenance', 'x_maintenance_action', 'maintenance_action', '`maintenance_action`', '`maintenance_action`', 3, -1, FALSE, '`maintenance_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// maintenance_comment
		$this->maintenance_comment = new cField('maintenance', 'maintenance', 'x_maintenance_comment', 'maintenance_comment', '`maintenance_comment`', '`maintenance_comment`', 201, -1, FALSE, '`maintenance_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->maintenance_comment->Sortable = TRUE; // Allow sort
		$this->fields['maintenance_comment'] = &$this->maintenance_comment;

		// maintained_by
		$this->maintained_by = new cField('maintenance', 'maintenance', 'x_maintained_by', 'maintained_by', '`maintained_by`', '`maintained_by`', 3, -1, FALSE, '`maintained_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// reviewed_date
		$this->reviewed_date = new cField('maintenance', 'maintenance', 'x_reviewed_date', 'reviewed_date', '`reviewed_date`', ew_CastDateFieldForLike('`reviewed_date`', 11, "DB"), 135, 11, FALSE, '`reviewed_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->reviewed_date->Sortable = TRUE; // Allow sort
		$this->reviewed_date->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['reviewed_date'] = &$this->reviewed_date;

		// reviewed_action
		$this->reviewed_action = new cField('maintenance', 'maintenance', 'x_reviewed_action', 'reviewed_action', '`reviewed_action`', '`reviewed_action`', 3, -1, FALSE, '`reviewed_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// reviewed_comment
		$this->reviewed_comment = new cField('maintenance', 'maintenance', 'x_reviewed_comment', 'reviewed_comment', '`reviewed_comment`', '`reviewed_comment`', 200, -1, FALSE, '`reviewed_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->reviewed_comment->Sortable = TRUE; // Allow sort
		$this->fields['reviewed_comment'] = &$this->reviewed_comment;

		// reviewed_by
		$this->reviewed_by = new cField('maintenance', 'maintenance', 'x_reviewed_by', 'reviewed_by', '`reviewed_by`', '`reviewed_by`', 3, -1, FALSE, '`reviewed_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`maintenance`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "maintenanceedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "maintenanceadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("maintenanceview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("maintenanceview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "maintenanceadd.php?" . $this->UrlParm($parm);
		else
			$url = "maintenanceadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("maintenanceedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("maintenanceadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("maintenancedelete.php", $this->UrlParm());
	}
	...
	function RenderEditRow() {
		...
		$this->reviewed_date->EditValue = ew_FormatDateTime($this->reviewed_date->CurrentValue, 11);
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		// To cancel, set return value to FALSE
			...
			// Save and forward
			if ($this->maintenance_action->CurrentValue == 1 && $this->status->CurrentValue == 0) {
				$rsnew["status"] = 2;
	...
	function Row_Updating($rsold, &$rsnew) {
		...
		$rsnew["maintained_by"] = $_SESSION['Staff_ID'];
		date_default_timezone_set('Africa/Lagos');
		$now = new DateTime();
		$rsnew["reviewed_date"] = $now->format('Y-m-d H:i:s');
		$rsnew["date_maintained"] = $now->format('Y-m-d H:i:s');

		//$rsnew["confirm_by"] = $_SESSION['User_id'];
		...
		// Officer Only
			...
			if ($this->maintenance_action->CurrentValue == 1 && ($this->status->CurrentValue == 0 || $this->status->CurrentValue == 1)) {
				$rsnew["status"] = 2;
				$rsnew["maintenance_action"] = 1;
				$rsnew["reviewed_action"] = NULL;
				$rsnew["reviewed_comment"] = NULL;
				$this->setSuccessMessage("&#x25C9; Ticket sent for Review &#x2714;"); 					
			}

			// Saved only
			if ($this->maintenance_action->CurrentValue == 0 && $this->status->CurrentValue == 0) {
				$rsnew["status"] = 0;			
				$rsnew["maintenance_action"] = 0; 
				$this->setSuccessMessage("&#x25C9; Ticket has been saved &#x2714;");
			}
		}
	...
	function Row_Rendering() {
		...
		if (CurrentPageID() == "edit" && (CurrentUserLevel() == 2 )) {
			$this->reviewed_by->CurrentValue = $_SESSION['Staff_ID'];
			$this->reviewed_by->EditValue = $this->reviewed_by->CurrentValue;
		}
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "list") {
			...
			if ($this->status->CurrentValue == 0) {
				...
				$this->description->CellCssStyle = "color: teal; text-align: left;";
			}
