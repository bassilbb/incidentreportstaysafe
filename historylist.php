...
class chistory_list extends chistory {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->responsible_departments->AdvancedSearch->ToJson(), ","); // Field responsible_departments
	...
	function RestoreFilterList() {
		...
		// Field responsible_departments
		$this->responsible_departments->AdvancedSearch->SearchValue = @$filter["x_responsible_departments"];
		$this->responsible_departments->AdvancedSearch->SearchOperator = @$filter["z_responsible_departments"];
		$this->responsible_departments->AdvancedSearch->SearchCondition = @$filter["v_responsible_departments"];
		$this->responsible_departments->AdvancedSearch->SearchValue2 = @$filter["y_responsible_departments"];
		$this->responsible_departments->AdvancedSearch->SearchOperator2 = @$filter["w_responsible_departments"];
		$this->responsible_departments->AdvancedSearch->Save();
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->responsible_departments, $Default, FALSE); // responsible_departments
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->responsible_departments->AdvancedSearch->Save(); // responsible_departments
	...
	function CheckSearchParms() {
		...
		if ($this->branch->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->responsible_departments->AdvancedSearch->IssetSession())
			return TRUE;
	...
	function ResetAdvancedSearchParms() {
		...
		$this->responsible_departments->AdvancedSearch->UnsetSession();
	...
	function RestoreSearchParms() {
		...
		$this->responsible_departments->AdvancedSearch->Load();
	...
	function LoadSearchValues() {
		...
		$this->responsible_departments->AdvancedSearch->SearchValue = @$_GET["x_responsible_departments"];
		if ($this->responsible_departments->AdvancedSearch->SearchValue <> "" && $this->Command == "") $this->Command = "search";
		$this->responsible_departments->AdvancedSearch->SearchOperator = @$_GET["z_responsible_departments"];
	...
	function LoadRowValues($rs = NULL) {
		...
		$this->responsible_departments->setDbValue($row['responsible_departments']);
	...
	function NewRow() {
		...
		$row['department'] = NULL;
		$row['branch'] = NULL;
		$row['responsible_departments'] = NULL;
		$row['category'] = NULL;
	...
	function LoadDbValues(&$rs) {
		...
		$this->responsible_departments->DbValue = $row['responsible_departments'];
	...
	function SetupLookupFilters($fld, $pageId = null) {
		...
		case "x_staff_id":
			...
			break;
		case "x_responsible_departments":
			$sSqlWrk = "";
...
fhistorylist.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $history_list->staff_id->LookupFilterQuery(TRUE, "list"))) ?>;
...
fhistorylist.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":[],"ChildFields":["x_sub_sub_category[]"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_category"};
fhistorylist.Lists["x_sub_category"].Data = "<?php echo $history_list->sub_category->LookupFilterQuery(FALSE, "list") ?>";
fhistorylist.Lists["x_incident_location"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_incident_sub_location"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
fhistorylist.Lists["x_incident_location"].Data = "<?php echo $history_list->incident_location->LookupFilterQuery(FALSE, "list") ?>";
fhistorylist.Lists["x_incident_sub_location"] = {"LinkField":"x_code_sub","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_incident_venue"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_sub_location"};
fhistorylist.Lists["x_incident_sub_location"].Data = "<?php echo $history_list->incident_sub_location->LookupFilterQuery(FALSE, "list") ?>";
...
fhistorylist.Lists["x_assign_task"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fhistorylist.Lists["x_assign_task"].Data = "<?php echo $history_list->assign_task->LookupFilterQuery(FALSE, "list") ?>";
fhistorylist.Lists["x_last_updated_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","x_staffno",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
...
fhistorylist.Lists["x_job_assessment"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fhistorylist.Lists["x_job_assessment"].Options = <?php echo json_encode($history_list->job_assessment->Options()) ?>;
...
fhistorylistsrch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($history->staff_id->FldErrMsg()) ?>");
...
fhistorylistsrch.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $history_list->staff_id->LookupFilterQuery(TRUE, "extbs"))) ?>;
...
<input type="text" data-table="history" data-field="x_datetime_initiated" data-format="11" name="x_datetime_initiated" id="x_datetime_initiated" size="18" placeholder="<?php echo ew_HtmlEncode($history->datetime_initiated->getPlaceHolder()) ?>" value="<?php echo $history->datetime_initiated->EditValue ?>"<?php echo $history->datetime_initiated->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fhistorylistsrch", "x_datetime_initiated", {"ignoreReadonly":true,"useCurrent":false,"format":11});
</script>
<?php } ?>
</span>
	</div>
...
<?php if ($history->staff_id->Visible) { // staff_id ?>
	<div id="xsc_staff_id" class="ewCell form-group">
		<label class="ewSearchCaption ewLabel"><?php echo $history->staff_id->FldCaption() ?></label>
		<span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_staff_id" id="z_staff_id" value="="></span>
		<span class="ewSearchField">
<?php
$wrkonchange = trim(" " . @$history->staff_id->EditAttrs["onchange"]);
if ($wrkonchange <> "") $wrkonchange = " onchange=\"" . ew_JsEncode2($wrkonchange) . "\"";
$history->staff_id->EditAttrs["onchange"] = "";
?>
<span id="as_x_staff_id" style="white-space: nowrap; z-index: 8950">
	<input type="text" name="sv_x_staff_id" id="sv_x_staff_id" value="<?php echo $history->staff_id->EditValue ?>" size="18" placeholder="<?php echo ew_HtmlEncode($history->staff_id->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($history->staff_id->getPlaceHolder()) ?>"<?php echo $history->staff_id->EditAttributes() ?>>
</span>
<input type="hidden" data-table="history" data-field="x_staff_id" data-multiple="0" data-lookup="1" data-value-separator="<?php echo $history->staff_id->DisplayValueSeparatorAttribute() ?>" name="x_staff_id" id="x_staff_id" value="<?php echo ew_HtmlEncode($history->staff_id->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fhistorylistsrch.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
<button type="button" title="<?php echo ew_HtmlEncode(str_replace("%s", ew_RemoveHtml($history->staff_id->FldCaption()), $Language->Phrase("LookupLink", TRUE))) ?>" onclick="ew_ModalLookupShow({lnk:this,el:'x_staff_id',m:0,n:10,srch:true});" class="ewLookupBtn btn btn-default btn-sm"<?php echo (($history->staff_id->ReadOnly || $history->staff_id->Disabled) ? " disabled" : "")?>><span class="glyphicon glyphicon-search ewIcon"></span></button>
</span>
	</div>
<?php } ?>
</div>
...
<?php if ($history->incident_location->Visible) { // incident_location ?>
	<?php if ($history->SortUrl($history->incident_location) == "") { ?>
		<th data-name="incident_location" class="<?php echo $history->incident_location->HeaderCellClass() ?>"><div id="elh_history_incident_location" class="history_incident_location"><div class="ewTableHeaderCaption"><?php echo $history->incident_location->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="incident_location" class="<?php echo $history->incident_location->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $history->SortUrl($history->incident_location) ?>',1);"><div id="elh_history_incident_location" class="history_incident_location">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $history->incident_location->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($history->incident_location->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($history->incident_location->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($history->incident_sub_location->Visible) { // incident_sub_location ?>
	<?php if ($history->SortUrl($history->incident_sub_location) == "") { ?>
		<th data-name="incident_sub_location" class="<?php echo $history->incident_sub_location->HeaderCellClass() ?>"><div id="elh_history_incident_sub_location" class="history_incident_sub_location"><div class="ewTableHeaderCaption"><?php echo $history->incident_sub_location->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="incident_sub_location" class="<?php echo $history->incident_sub_location->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $history->SortUrl($history->incident_sub_location) ?>',1);"><div id="elh_history_incident_sub_location" class="history_incident_sub_location">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $history->incident_sub_location->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($history->incident_sub_location->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($history->incident_sub_location->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($history->status->Visible) { // status ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($history->assign_task->Visible) { // assign_task ?>
	<?php if ($history->SortUrl($history->assign_task) == "") { ?>
		<th data-name="assign_task" class="<?php echo $history->assign_task->HeaderCellClass() ?>"><div id="elh_history_assign_task" class="history_assign_task"><div class="ewTableHeaderCaption"><?php echo $history->assign_task->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="assign_task" class="<?php echo $history->assign_task->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $history->SortUrl($history->assign_task) ?>',1);"><div id="elh_history_assign_task" class="history_assign_task">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $history->assign_task->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($history->assign_task->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($history->assign_task->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($history->last_updated_by->Visible) { // last_updated_by ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($history->job_assessment->Visible) { // job_assessment ?>
	<?php if ($history->SortUrl($history->job_assessment) == "") { ?>
		<th data-name="job_assessment" class="<?php echo $history->job_assessment->HeaderCellClass() ?>"><div id="elh_history_job_assessment" class="history_job_assessment"><div class="ewTableHeaderCaption"><?php echo $history->job_assessment->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="job_assessment" class="<?php echo $history->job_assessment->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $history->SortUrl($history->job_assessment) ?>',1);"><div id="elh_history_job_assessment" class="history_job_assessment">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $history->job_assessment->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($history->job_assessment->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($history->job_assessment->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $history_list->RowCnt ?>_history_incident_location" class="history_incident_location">
<span<?php echo $history->incident_location->ViewAttributes() ?>>
<?php echo $history->incident_location->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($history->incident_sub_location->Visible) { // incident_sub_location ?>
		<td data-name="incident_sub_location"<?php echo $history->incident_sub_location->CellAttributes() ?>>
<span id="el<?php echo $history_list->RowCnt ?>_history_incident_sub_location" class="history_incident_sub_location">
<span<?php echo $history->incident_sub_location->ViewAttributes() ?>>
<?php echo $history->incident_sub_location->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($history->incident_description->Visible) { // incident_description ?>
...
<?php echo $history->status->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($history->assign_task->Visible) { // assign_task ?>
		<td data-name="assign_task"<?php echo $history->assign_task->CellAttributes() ?>>
<span id="el<?php echo $history_list->RowCnt ?>_history_assign_task" class="history_assign_task">
<span<?php echo $history->assign_task->ViewAttributes() ?>>
<?php echo $history->assign_task->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($history->last_updated_date->Visible) { // last_updated_date ?>
...
<?php echo $history->last_updated_by->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($history->job_assessment->Visible) { // job_assessment ?>
		<td data-name="job_assessment"<?php echo $history->job_assessment->CellAttributes() ?>>
<span id="el<?php echo $history_list->RowCnt ?>_history_job_assessment" class="history_job_assessment">
<span<?php echo $history->job_assessment->ViewAttributes() ?>>
<?php echo $history->job_assessment->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
