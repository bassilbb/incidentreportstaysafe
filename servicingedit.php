...
$servicing_edit = NULL; // Initialize page object first

class cservicing_edit extends cservicing {
	...
	// Page object name
	var $PageObjName = 'servicing_edit';
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// reviewed_date
			$this->reviewed_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->reviewed_date->CurrentValue, 17), NULL, $this->reviewed_date->ReadOnly);

			// reviewed_action
			$this->reviewed_action->SetDbValueDef($rsnew, $this->reviewed_action->CurrentValue, NULL, $this->reviewed_action->ReadOnly);
			...
			// staff_no
			$this->staff_no->SetDbValueDef($rsnew, $this->staff_no->CurrentValue, NULL, $this->staff_no->ReadOnly);
...
// Create page object
if (!isset($servicing_edit)) $servicing_edit = new cservicing_edit();

// Page init
$servicing_edit->Page_Init();

// Page main
$servicing_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$servicing_edit->Page_Render();
?>
...
var CurrentForm = fservicingedit = new ew_Form("fservicingedit", "edit");

// Validate form
fservicingedit.Validate = function() {
...
fservicingedit.Form_CustomValidate = 
...
fservicingedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fservicingedit.MultiPage = new ew_MultiPage("fservicingedit");

// Dynamic selection lists
fservicingedit.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fservicingedit.Lists["x_staff_id"].Data = "<?php echo $servicing_edit->staff_id->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $servicing_edit->staff_id->LookupFilterQuery(TRUE, "edit"))) ?>;
fservicingedit.Lists["x_staff_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fservicingedit.Lists["x_staff_name"].Data = "<?php echo $servicing_edit->staff_name->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.AutoSuggests["x_staff_name"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $servicing_edit->staff_name->LookupFilterQuery(TRUE, "edit"))) ?>;
fservicingedit.Lists["x_department"] = {"LinkField":"x_department_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_department_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"depertment"};
fservicingedit.Lists["x_department"].Data = "<?php echo $servicing_edit->department->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.AutoSuggests["x_department"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $servicing_edit->department->LookupFilterQuery(TRUE, "edit"))) ?>;
fservicingedit.Lists["x_branch"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_branch_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"branch"};
fservicingedit.Lists["x_branch"].Data = "<?php echo $servicing_edit->branch->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.AutoSuggests["x_branch"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $servicing_edit->branch->LookupFilterQuery(TRUE, "edit"))) ?>;
fservicingedit.Lists["x_buildings"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"buildings"};
fservicingedit.Lists["x_buildings"].Data = "<?php echo $servicing_edit->buildings->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.Lists["x_floors"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"floors"};
fservicingedit.Lists["x_floors"].Data = "<?php echo $servicing_edit->floors->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.Lists["x_items"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"items"};
fservicingedit.Lists["x_items"].Data = "<?php echo $servicing_edit->items->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.Lists["x_priority"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_category"};
fservicingedit.Lists["x_priority"].Data = "<?php echo $servicing_edit->priority->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.Lists["x_status"] = {"LinkField":"x_code","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"service_status"};
fservicingedit.Lists["x_status"].Data = "<?php echo $servicing_edit->status->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicingedit.Lists["x_initiator_action"].Options = <?php echo json_encode($servicing_edit->initiator_action->Options()) ?>;
fservicingedit.Lists["x_maintained_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fservicingedit.Lists["x_maintained_by"].Data = "<?php echo $servicing_edit->maintained_by->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.AutoSuggests["x_maintained_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $servicing_edit->maintained_by->LookupFilterQuery(TRUE, "edit"))) ?>;
fservicingedit.Lists["x_reviewed_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fservicingedit.Lists["x_reviewed_action"].Options = <?php echo json_encode($servicing_edit->reviewed_action->Options()) ?>;
fservicingedit.Lists["x_reviewed_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fservicingedit.Lists["x_reviewed_by"].Data = "<?php echo $servicing_edit->reviewed_by->LookupFilterQuery(FALSE, "edit") ?>";
fservicingedit.AutoSuggests["x_reviewed_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $servicing_edit->reviewed_by->LookupFilterQuery(TRUE, "edit"))) ?>;
...
<?php $servicing_edit->ShowPageHeader(); ?>
<?php
$servicing_edit->ShowMessage();
?>
<?php if (!$servicing_edit->IsModal) { ?>
<?php if ($servicing->CurrentAction <> "F") { // Confirm page ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($servicing_edit->Pager)) $servicing_edit->Pager = new cPrevNextPager($servicing_edit->StartRec, $servicing_edit->DisplayRecs, $servicing_edit->TotalRecs, $servicing_edit->AutoHidePager) ?>
<?php if ($servicing_edit->Pager->RecordCount > 0 && $servicing_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($servicing_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $servicing_edit->PageUrl() ?>start=<?php echo $servicing_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($servicing_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $servicing_edit->PageUrl() ?>start=<?php echo $servicing_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $servicing_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($servicing_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $servicing_edit->PageUrl() ?>start=<?php echo $servicing_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($servicing_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $servicing_edit->PageUrl() ?>start=<?php echo $servicing_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $servicing_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
...
<?php } ?>
<?php } ?>
<form name="fservicingedit" id="fservicingedit" class="<?php echo $servicing_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($servicing_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $servicing_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<input type="hidden" name="modal" value="<?php echo intval($servicing_edit->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="servicing_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $servicing_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $servicing_edit->MultiPages->TabStyle("1") ?>><a href="#tab_servicing1" data-toggle="tab"><?php echo $servicing->PageCaption(1) ?></a></li>
		<li<?php echo $servicing_edit->MultiPages->TabStyle("2") ?>><a href="#tab_servicing2" data-toggle="tab"><?php echo $servicing->PageCaption(2) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $servicing_edit->MultiPages->PageStyle("1") ?>" id="tab_servicing1"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($servicing->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_servicing_id" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->id->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->id->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
<span id="el_servicing_id">
<span<?php echo $servicing->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $servicing->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="servicing" data-field="x_id" data-page="1" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($servicing->id->CurrentValue) ?>">
<?php } else { ?>
<span id="el_servicing_id">
<span<?php echo $servicing->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $servicing->id->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="servicing" data-field="x_id" data-page="1" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($servicing->id->FormValue) ?>">
<?php } ?>
<?php echo $servicing->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($servicing->date_initiated->Visible) { // date_initiated ?>
	<div id="r_date_initiated" class="form-group">
		<label id="elh_servicing_date_initiated" for="x_date_initiated" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->date_initiated->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->date_initiated->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_servicing_reference_id" for="x_reference_id" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->reference_id->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->reference_id->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_servicing_staff_id" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->staff_id->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->staff_id->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fservicingedit.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_servicing_staff_id">
...
<?php if ($servicing->staff_name->Visible) { // staff_name ?>
	<div id="r_staff_name" class="form-group">
		<label id="elh_servicing_staff_name" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->staff_name->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->staff_name->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fservicingedit.CreateAutoSuggest({"id":"x_staff_name","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_servicing_staff_name">
...
<?php if ($servicing->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label id="elh_servicing_department" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->department->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->department->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fservicingedit.CreateAutoSuggest({"id":"x_department","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_servicing_department">
...
<?php if ($servicing->branch->Visible) { // branch ?>
	<div id="r_branch" class="form-group">
		<label id="elh_servicing_branch" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->branch->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->branch->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fservicingedit.CreateAutoSuggest({"id":"x_branch","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_servicing_branch">
...
<?php if ($servicing->buildings->Visible) { // buildings ?>
	<div id="r_buildings" class="form-group">
		<label id="elh_servicing_buildings" for="x_buildings" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->buildings->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->buildings->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->floors->Visible) { // floors ?>
	<div id="r_floors" class="form-group">
		<label id="elh_servicing_floors" for="x_floors" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->floors->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->floors->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->items->Visible) { // items ?>
	<div id="r_items" class="form-group">
		<label id="elh_servicing_items" for="x_items" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->items->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->items->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->priority->Visible) { // priority ?>
	<div id="r_priority" class="form-group">
		<label id="elh_servicing_priority" for="x_priority" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->priority->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->priority->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_servicing_description" for="x_description" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->description->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->description->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->staff_no->Visible) { // staff_no ?>
	<div id="r_staff_no" class="form-group">
		<label id="elh_servicing_staff_no" for="x_staff_no" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->staff_no->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->staff_no->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $servicing_edit->MultiPages->PageStyle("2") ?>" id="tab_servicing2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
<?php if ($servicing->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_servicing_status" for="x_status" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->status->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->status->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->date_maintained->Visible) { // date_maintained ?>
	<div id="r_date_maintained" class="form-group">
		<label id="elh_servicing_date_maintained" for="x_date_maintained" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->date_maintained->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->date_maintained->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_servicing_initiator_action" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->initiator_action->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->initiator_action->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_servicing_initiator_comment" for="x_initiator_comment" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->initiator_comment->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->initiator_comment->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->maintained_by->Visible) { // maintained_by ?>
	<div id="r_maintained_by" class="form-group">
		<label id="elh_servicing_maintained_by" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->maintained_by->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->maintained_by->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fservicingedit.CreateAutoSuggest({"id":"x_maintained_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_servicing_maintained_by">
...
<?php if ($servicing->reviewed_date->Visible) { // reviewed_date ?>
	<div id="r_reviewed_date" class="form-group">
		<label id="elh_servicing_reviewed_date" for="x_reviewed_date" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->reviewed_date->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->reviewed_date->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->reviewed_action->Visible) { // reviewed_action ?>
	<div id="r_reviewed_action" class="form-group">
		<label id="elh_servicing_reviewed_action" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->reviewed_action->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->reviewed_action->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->reviewed_comment->Visible) { // reviewed_comment ?>
	<div id="r_reviewed_comment" class="form-group">
		<label id="elh_servicing_reviewed_comment" for="x_reviewed_comment" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->reviewed_comment->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->reviewed_comment->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<?php if ($servicing->reviewed_by->Visible) { // reviewed_by ?>
	<div id="r_reviewed_by" class="form-group">
		<label id="elh_servicing_reviewed_by" class="<?php echo $servicing_edit->LeftColumnClass ?>"><?php echo $servicing->reviewed_by->FldCaption() ?></label>
		<div class="<?php echo $servicing_edit->RightColumnClass ?>"><div<?php echo $servicing->reviewed_by->CellAttributes() ?>>
<?php if ($servicing->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fservicingedit.CreateAutoSuggest({"id":"x_reviewed_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_servicing_reviewed_by">
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $servicing_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($servicing->CurrentAction <> "F") { // Confirm page ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $servicing_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
