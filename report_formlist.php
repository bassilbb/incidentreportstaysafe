...
freport_formlist.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $report_form_list->staff_id->LookupFilterQuery(TRUE, "list"))) ?>;
...
freport_formlist.Lists["x_sub_category"] = {"LinkField":"x_sub_category_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_sub_category_name","","",""],"ParentFields":[],"ChildFields":["x_sub_sub_category[]"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sub_category"};
freport_formlist.Lists["x_sub_category"].Data = "<?php echo $report_form_list->sub_category->LookupFilterQuery(FALSE, "list") ?>";
freport_formlist.Lists["x_incident_location"] = {"LinkField":"x_code_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_incident_sub_location"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_location"};
freport_formlist.Lists["x_incident_location"].Data = "<?php echo $report_form_list->incident_location->LookupFilterQuery(FALSE, "list") ?>";
freport_formlist.Lists["x_incident_sub_location"] = {"LinkField":"x_code_sub","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_incident_venue"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_sub_location"};
...
freport_formlist.Lists["x_job_assessment"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
freport_formlist.Lists["x_job_assessment"].Options = <?php echo json_encode($report_form_list->job_assessment->Options()) ?>;
...
<?php if ($report_form->incident_location->Visible) { // incident_location ?>
	<?php if ($report_form->SortUrl($report_form->incident_location) == "") { ?>
		<th data-name="incident_location" class="<?php echo $report_form->incident_location->HeaderCellClass() ?>"><div id="elh_report_form_incident_location" class="report_form_incident_location"><div class="ewTableHeaderCaption"><?php echo $report_form->incident_location->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="incident_location" class="<?php echo $report_form->incident_location->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_form->SortUrl($report_form->incident_location) ?>',1);"><div id="elh_report_form_incident_location" class="report_form_incident_location">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_form->incident_location->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_form->incident_location->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_form->incident_location->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($report_form->incident_sub_location->Visible) { // incident_sub_location ?>
	<?php if ($report_form->SortUrl($report_form->incident_sub_location) == "") { ?>
		<th data-name="incident_sub_location" class="<?php echo $report_form->incident_sub_location->HeaderCellClass() ?>"><div id="elh_report_form_incident_sub_location" class="report_form_incident_sub_location"><div class="ewTableHeaderCaption"><?php echo $report_form->incident_sub_location->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="incident_sub_location" class="<?php echo $report_form->incident_sub_location->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_form->SortUrl($report_form->incident_sub_location) ?>',1);"><div id="elh_report_form_incident_sub_location" class="report_form_incident_sub_location">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_form->incident_sub_location->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_form->incident_sub_location->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_form->incident_sub_location->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($report_form->reason->Visible) { // reason ?>
	...
	<?php } else { ?>
		<th data-name="reason" class="<?php echo $report_form->reason->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_form->SortUrl($report_form->reason) ?>',1);"><div id="elh_report_form_reason" class="report_form_reason">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_form->reason->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_form->reason->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_form->reason->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($report_form->job_assessment->Visible) { // job_assessment ?>
	<?php if ($report_form->SortUrl($report_form->job_assessment) == "") { ?>
		<th data-name="job_assessment" class="<?php echo $report_form->job_assessment->HeaderCellClass() ?>"><div id="elh_report_form_job_assessment" class="report_form_job_assessment"><div class="ewTableHeaderCaption"><?php echo $report_form->job_assessment->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="job_assessment" class="<?php echo $report_form->job_assessment->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $report_form->SortUrl($report_form->job_assessment) ?>',1);"><div id="elh_report_form_job_assessment" class="report_form_job_assessment">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $report_form->job_assessment->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($report_form->job_assessment->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($report_form->job_assessment->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span id="el<?php echo $report_form_list->RowCnt ?>_report_form_incident_location" class="report_form_incident_location">
...
<span id="el<?php echo $report_form_list->RowCnt ?>_report_form_incident_sub_location" class="report_form_incident_sub_location">
...
<span id="el<?php echo $report_form_list->RowCnt ?>_report_form_reason" class="report_form_reason">
