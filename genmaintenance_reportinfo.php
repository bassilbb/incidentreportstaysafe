...
$genmaintenance_report = NULL;

//
// Table class for genmaintenance_report
//
class cgenmaintenance_report extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'genmaintenance_report';
		$this->TableName = 'genmaintenance_report';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`genmaintenance_report`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('genmaintenance_report', 'genmaintenance_report', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// datetime
		$this->datetime = new cField('genmaintenance_report', 'genmaintenance_report', 'x_datetime', 'datetime', '`datetime`', ew_CastDateFieldForLike('`datetime`', 0, "DB"), 133, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// gen_name
		$this->gen_name = new cField('genmaintenance_report', 'genmaintenance_report', 'x_gen_name', 'gen_name', '`gen_name`', '`gen_name`', 3, -1, FALSE, '`gen_name`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// maintenance_type
		$this->maintenance_type = new cField('genmaintenance_report', 'genmaintenance_report', 'x_maintenance_type', 'maintenance_type', '`maintenance_type`', '`maintenance_type`', 16, -1, FALSE, '`maintenance_type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// running_hours
		$this->running_hours = new cField('genmaintenance_report', 'genmaintenance_report', 'x_running_hours', 'running_hours', '`running_hours`', '`running_hours`', 200, -1, FALSE, '`running_hours`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->running_hours->Sortable = TRUE; // Allow sort
		$this->fields['running_hours'] = &$this->running_hours;

		// cost
		$this->cost = new cField('genmaintenance_report', 'genmaintenance_report', 'x_cost', 'cost', '`cost`', '`cost`', 131, -1, FALSE, '`cost`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->cost->Sortable = TRUE; // Allow sort
		$this->cost->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['cost'] = &$this->cost;

		// labour_fee
		$this->labour_fee = new cField('genmaintenance_report', 'genmaintenance_report', 'x_labour_fee', 'labour_fee', '`labour_fee`', '`labour_fee`', 131, -1, FALSE, '`labour_fee`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new cField('genmaintenance_report', 'genmaintenance_report', 'x_total', 'total', '`total`', '`total`', 131, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->total->Sortable = TRUE; // Allow sort
		$this->total->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['total'] = &$this->total;

		// staff_id
		$this->staff_id = new cField('genmaintenance_report', 'genmaintenance_report', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 3, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status
		$this->status = new cField('genmaintenance_report', 'genmaintenance_report', 'x_status', 'status', '`status`', '`status`', 3, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// initiator_action
		$this->initiator_action = new cField('genmaintenance_report', 'genmaintenance_report', 'x_initiator_action', 'initiator_action', '`initiator_action`', '`initiator_action`', 3, -1, FALSE, '`initiator_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// initiator_comment
		$this->initiator_comment = new cField('genmaintenance_report', 'genmaintenance_report', 'x_initiator_comment', 'initiator_comment', '`initiator_comment`', '`initiator_comment`', 200, -1, FALSE, '`initiator_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->initiator_comment->Sortable = TRUE; // Allow sort
		$this->fields['initiator_comment'] = &$this->initiator_comment;

		// approver_date
		$this->approver_date = new cField('genmaintenance_report', 'genmaintenance_report', 'x_approver_date', 'approver_date', '`approver_date`', ew_CastDateFieldForLike('`approver_date`', 0, "DB"), 135, 0, FALSE, '`approver_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// approver_action
		$this->approver_action = new cField('genmaintenance_report', 'genmaintenance_report', 'x_approver_action', 'approver_action', '`approver_action`', '`approver_action`', 3, -1, FALSE, '`approver_action`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// approver_comment
		$this->approver_comment = new cField('genmaintenance_report', 'genmaintenance_report', 'x_approver_comment', 'approver_comment', '`approver_comment`', '`approver_comment`', 200, -1, FALSE, '`approver_comment`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->approver_comment->Sortable = TRUE; // Allow sort
		$this->fields['approver_comment'] = &$this->approver_comment;

		// approved_by
		$this->approved_by = new cField('genmaintenance_report', 'genmaintenance_report', 'x_approved_by', 'approved_by', '`approved_by`', '`approved_by`', 3, -1, FALSE, '`approved_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`genmaintenance_report`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "genmaintenance_reportlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "genmaintenance_reportedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "genmaintenance_reportadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("genmaintenance_reportview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("genmaintenance_reportview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "genmaintenance_reportadd.php?" . $this->UrlParm($parm);
		else
			$url = "genmaintenance_reportadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("genmaintenance_reportedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("genmaintenance_reportadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("genmaintenance_reportdelete.php", $this->UrlParm());
	}
