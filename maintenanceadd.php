...
$maintenance_add = NULL; // Initialize page object first

class cmaintenance_add extends cmaintenance {
	...
	// Page object name
	var $PageObjName = 'maintenance_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("maintenancelist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "maintenanceview.php")
	...
	function LoadDefaultValues() {
		...
		$this->maintenance_action->CurrentValue = NULL;
		$this->maintenance_action->OldValue = $this->maintenance_action->CurrentValue;
		$this->maintenance_comment->CurrentValue = NULL;
		$this->maintenance_comment->OldValue = $this->maintenance_comment->CurrentValue;
	...
	function NewRow() {
		...
		$row['maintenance_action'] = $this->maintenance_action->CurrentValue;
		$row['maintenance_comment'] = $this->maintenance_comment->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// maintenance_action
		$this->maintenance_action->SetDbValueDef($rsnew, $this->maintenance_action->CurrentValue, NULL, FALSE);

		// maintenance_comment
		$this->maintenance_comment->SetDbValueDef($rsnew, $this->maintenance_comment->CurrentValue, NULL, FALSE);

		// maintained_by
		$this->maintained_by->SetDbValueDef($rsnew, $this->maintained_by->CurrentValue, NULL, FALSE);

		// reviewed_date
		$this->reviewed_date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->reviewed_date->CurrentValue, 11), NULL, FALSE);

		// reviewed_action
		$this->reviewed_action->SetDbValueDef($rsnew, $this->reviewed_action->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($maintenance_add)) $maintenance_add = new cmaintenance_add();

// Page init
$maintenance_add->Page_Init();

// Page main
$maintenance_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$maintenance_add->Page_Render();
?>
...
var CurrentForm = fmaintenanceadd = new ew_Form("fmaintenanceadd", "add");

// Validate form
fmaintenanceadd.Validate = function() {
...
fmaintenanceadd.Form_CustomValidate = 
...
fmaintenanceadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Multi-Page
fmaintenanceadd.MultiPage = new ew_MultiPage("fmaintenanceadd");

// Dynamic selection lists
fmaintenanceadd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_staffno","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fmaintenanceadd.Lists["x_staff_id"].Data = "<?php echo $maintenance_add->staff_id->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.AutoSuggests["x_staff_id"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $maintenance_add->staff_id->LookupFilterQuery(TRUE, "add"))) ?>;
fmaintenanceadd.Lists["x_staff_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fmaintenanceadd.Lists["x_staff_name"].Data = "<?php echo $maintenance_add->staff_name->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.AutoSuggests["x_staff_name"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $maintenance_add->staff_name->LookupFilterQuery(TRUE, "add"))) ?>;
fmaintenanceadd.Lists["x_department"] = {"LinkField":"x_department_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_department_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"depertment"};
fmaintenanceadd.Lists["x_department"].Data = "<?php echo $maintenance_add->department->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.AutoSuggests["x_department"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $maintenance_add->department->LookupFilterQuery(TRUE, "add"))) ?>;
fmaintenanceadd.Lists["x_branch"] = {"LinkField":"x_branch_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_branch_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"branch"};
fmaintenanceadd.Lists["x_branch"].Data = "<?php echo $maintenance_add->branch->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.AutoSuggests["x_branch"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $maintenance_add->branch->LookupFilterQuery(TRUE, "add"))) ?>;
fmaintenanceadd.Lists["x_buildings"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":["x_floors"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"buildings"};
fmaintenanceadd.Lists["x_buildings"].Data = "<?php echo $maintenance_add->buildings->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.Lists["x_floors"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_buildings"],"ChildFields":["x_items[]"],"FilterFields":["x_buildings_id"],"Options":[],"Template":"","LinkTable":"floors"};
fmaintenanceadd.Lists["x_floors"].Data = "<?php echo $maintenance_add->floors->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.Lists["x_items[]"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":["x_floors"],"ChildFields":[],"FilterFields":["x_floor_id"],"Options":[],"Template":"","LinkTable":"items"};
fmaintenanceadd.Lists["x_items[]"].Data = "<?php echo $maintenance_add->items->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.Lists["x_priority"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"incident_category"};
fmaintenanceadd.Lists["x_priority"].Data = "<?php echo $maintenance_add->priority->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"maintained_status"};
fmaintenanceadd.Lists["x_status"].Data = "<?php echo $maintenance_add->status->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.Lists["x_maintenance_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaintenanceadd.Lists["x_maintenance_action"].Options = <?php echo json_encode($maintenance_add->maintenance_action->Options()) ?>;
fmaintenanceadd.Lists["x_maintained_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fmaintenanceadd.Lists["x_maintained_by"].Data = "<?php echo $maintenance_add->maintained_by->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.AutoSuggests["x_maintained_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $maintenance_add->maintained_by->LookupFilterQuery(TRUE, "add"))) ?>;
fmaintenanceadd.Lists["x_reviewed_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fmaintenanceadd.Lists["x_reviewed_action"].Options = <?php echo json_encode($maintenance_add->reviewed_action->Options()) ?>;
fmaintenanceadd.Lists["x_reviewed_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fmaintenanceadd.Lists["x_reviewed_by"].Data = "<?php echo $maintenance_add->reviewed_by->LookupFilterQuery(FALSE, "add") ?>";
fmaintenanceadd.AutoSuggests["x_reviewed_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $maintenance_add->reviewed_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $maintenance_add->ShowPageHeader(); ?>
<?php
$maintenance_add->ShowMessage();
?>
<form name="fmaintenanceadd" id="fmaintenanceadd" class="<?php echo $maintenance_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($maintenance_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $maintenance_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="maintenance">
<?php if ($maintenance->CurrentAction == "F") { // Confirm page ?>
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="a_confirm" id="a_confirm" value="F">
<?php } else { ?>
<input type="hidden" name="a_add" id="a_add" value="F">
<?php } ?>
<input type="hidden" name="modal" value="<?php echo intval($maintenance_add->IsModal) ?>">
<div class="ewMultiPage"><!-- multi-page -->
<div class="nav-tabs-custom" id="maintenance_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $maintenance_add->MultiPages->NavStyle() ?>">
		<li<?php echo $maintenance_add->MultiPages->TabStyle("1") ?>><a href="#tab_maintenance1" data-toggle="tab"><?php echo $maintenance->PageCaption(1) ?></a></li>
		<li<?php echo $maintenance_add->MultiPages->TabStyle("2") ?>><a href="#tab_maintenance2" data-toggle="tab"><?php echo $maintenance->PageCaption(2) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $maintenance_add->MultiPages->PageStyle("1") ?>" id="tab_maintenance1"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($maintenance->date_initiated->Visible) { // date_initiated ?>
	<div id="r_date_initiated" class="form-group">
		<label id="elh_maintenance_date_initiated" for="x_date_initiated" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->date_initiated->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->date_initiated->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->date_initiated->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_date_initiated" data-page="1" name="x_date_initiated" id="x_date_initiated" value="<?php echo ew_HtmlEncode($maintenance->date_initiated->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->reference_id->Visible) { // reference_id ?>
	<div id="r_reference_id" class="form-group">
		<label id="elh_maintenance_reference_id" for="x_reference_id" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->reference_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->reference_id->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->reference_id->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_reference_id" data-page="1" name="x_reference_id" id="x_reference_id" value="<?php echo ew_HtmlEncode($maintenance->reference_id->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_maintenance_staff_id" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->staff_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->staff_id->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fmaintenanceadd.CreateAutoSuggest({"id":"x_staff_id","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_maintenance_staff_id">
<span<?php echo $maintenance->staff_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->staff_id->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_staff_id" data-page="1" name="x_staff_id" id="x_staff_id" value="<?php echo ew_HtmlEncode($maintenance->staff_id->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->staff_name->Visible) { // staff_name ?>
	<div id="r_staff_name" class="form-group">
		<label id="elh_maintenance_staff_name" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->staff_name->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->staff_name->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fmaintenanceadd.CreateAutoSuggest({"id":"x_staff_name","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_maintenance_staff_name">
<span<?php echo $maintenance->staff_name->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->staff_name->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_staff_name" data-page="1" name="x_staff_name" id="x_staff_name" value="<?php echo ew_HtmlEncode($maintenance->staff_name->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label id="elh_maintenance_department" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->department->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->department->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fmaintenanceadd.CreateAutoSuggest({"id":"x_department","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_maintenance_department">
<span<?php echo $maintenance->department->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->department->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_department" data-page="1" name="x_department" id="x_department" value="<?php echo ew_HtmlEncode($maintenance->department->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->branch->Visible) { // branch ?>
	<div id="r_branch" class="form-group">
		<label id="elh_maintenance_branch" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->branch->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->branch->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fmaintenanceadd.CreateAutoSuggest({"id":"x_branch","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_maintenance_branch">
<span<?php echo $maintenance->branch->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->branch->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_branch" data-page="1" name="x_branch" id="x_branch" value="<?php echo ew_HtmlEncode($maintenance->branch->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->buildings->Visible) { // buildings ?>
	<div id="r_buildings" class="form-group">
		<label id="elh_maintenance_buildings" for="x_buildings" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->buildings->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->buildings->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->buildings->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_buildings" data-page="1" name="x_buildings" id="x_buildings" value="<?php echo ew_HtmlEncode($maintenance->buildings->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->floors->Visible) { // floors ?>
	<div id="r_floors" class="form-group">
		<label id="elh_maintenance_floors" for="x_floors" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->floors->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->floors->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->floors->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_floors" data-page="1" name="x_floors" id="x_floors" value="<?php echo ew_HtmlEncode($maintenance->floors->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->items->Visible) { // items ?>
	<div id="r_items" class="form-group">
		<label id="elh_maintenance_items" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->items->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->items->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->items->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_items" data-page="1" name="x_items" id="x_items" value="<?php echo ew_HtmlEncode($maintenance->items->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->priority->Visible) { // priority ?>
	<div id="r_priority" class="form-group">
		<label id="elh_maintenance_priority" for="x_priority" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->priority->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->priority->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->priority->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_priority" data-page="1" name="x_priority" id="x_priority" value="<?php echo ew_HtmlEncode($maintenance->priority->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_maintenance_description" for="x_description" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->description->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->description->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_description" data-page="1" name="x_description" id="x_description" value="<?php echo ew_HtmlEncode($maintenance->description->FormValue) ?>">
<?php } ?>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $maintenance_add->MultiPages->PageStyle("2") ?>" id="tab_maintenance2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
<?php if ($maintenance->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_maintenance_status" for="x_status" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->status->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<p class="form-control-static"><?php echo $maintenance->status->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_status" data-page="2" name="x_status" id="x_status" value="<?php echo ew_HtmlEncode($maintenance->status->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->date_maintained->Visible) { // date_maintained ?>
	<div id="r_date_maintained" class="form-group">
		<label id="elh_maintenance_date_maintained" for="x_date_maintained" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->date_maintained->FldCaption() ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->date_maintained->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fmaintenanceadd", "x_date_maintained", {"ignoreReadonly":true,"useCurrent":false,"format":17});
</script>
<?php } ?>
</span>
<?php } else { ?>
<span id="el_maintenance_date_maintained">
<span<?php echo $maintenance->date_maintained->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->date_maintained->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_date_maintained" data-page="2" name="x_date_maintained" id="x_date_maintained" value="<?php echo ew_HtmlEncode($maintenance->date_maintained->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->maintenance_action->Visible) { // maintenance_action ?>
	<div id="r_maintenance_action" class="form-group">
		<label id="elh_maintenance_maintenance_action" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->maintenance_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->maintenance_action->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<?php } else { ?>
<span id="el_maintenance_maintenance_action">
<span<?php echo $maintenance->maintenance_action->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->maintenance_action->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_maintenance_action" data-page="2" name="x_maintenance_action" id="x_maintenance_action" value="<?php echo ew_HtmlEncode($maintenance->maintenance_action->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->maintenance_comment->Visible) { // maintenance_comment ?>
	<div id="r_maintenance_comment" class="form-group">
		<label id="elh_maintenance_maintenance_comment" for="x_maintenance_comment" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->maintenance_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->maintenance_comment->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<?php } else { ?>
<span id="el_maintenance_maintenance_comment">
<span<?php echo $maintenance->maintenance_comment->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->maintenance_comment->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_maintenance_comment" data-page="2" name="x_maintenance_comment" id="x_maintenance_comment" value="<?php echo ew_HtmlEncode($maintenance->maintenance_comment->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->maintained_by->Visible) { // maintained_by ?>
	<div id="r_maintained_by" class="form-group">
		<label id="elh_maintenance_maintained_by" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->maintained_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->maintained_by->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fmaintenanceadd.CreateAutoSuggest({"id":"x_maintained_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_maintenance_maintained_by">
<span<?php echo $maintenance->maintained_by->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->maintained_by->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_maintained_by" data-page="2" name="x_maintained_by" id="x_maintained_by" value="<?php echo ew_HtmlEncode($maintenance->maintained_by->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->reviewed_date->Visible) { // reviewed_date ?>
	<div id="r_reviewed_date" class="form-group">
		<label id="elh_maintenance_reviewed_date" for="x_reviewed_date" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->reviewed_date->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->reviewed_date->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<?php } else { ?>
<span id="el_maintenance_reviewed_date">
<span<?php echo $maintenance->reviewed_date->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->reviewed_date->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_reviewed_date" data-page="2" name="x_reviewed_date" id="x_reviewed_date" value="<?php echo ew_HtmlEncode($maintenance->reviewed_date->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->reviewed_action->Visible) { // reviewed_action ?>
	<div id="r_reviewed_action" class="form-group">
		<label id="elh_maintenance_reviewed_action" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->reviewed_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->reviewed_action->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<?php } else { ?>
<span id="el_maintenance_reviewed_action">
<span<?php echo $maintenance->reviewed_action->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->reviewed_action->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_reviewed_action" data-page="2" name="x_reviewed_action" id="x_reviewed_action" value="<?php echo ew_HtmlEncode($maintenance->reviewed_action->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->reviewed_comment->Visible) { // reviewed_comment ?>
	<div id="r_reviewed_comment" class="form-group">
		<label id="elh_maintenance_reviewed_comment" for="x_reviewed_comment" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->reviewed_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->reviewed_comment->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<?php } else { ?>
<span id="el_maintenance_reviewed_comment">
<span<?php echo $maintenance->reviewed_comment->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->reviewed_comment->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_reviewed_comment" data-page="2" name="x_reviewed_comment" id="x_reviewed_comment" value="<?php echo ew_HtmlEncode($maintenance->reviewed_comment->FormValue) ?>">
<?php } ?>
...
<?php if ($maintenance->reviewed_by->Visible) { // reviewed_by ?>
	<div id="r_reviewed_by" class="form-group">
		<label id="elh_maintenance_reviewed_by" class="<?php echo $maintenance_add->LeftColumnClass ?>"><?php echo $maintenance->reviewed_by->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $maintenance_add->RightColumnClass ?>"><div<?php echo $maintenance->reviewed_by->CellAttributes() ?>>
<?php if ($maintenance->CurrentAction <> "F") { ?>
...
<script type="text/javascript">
fmaintenanceadd.CreateAutoSuggest({"id":"x_reviewed_by","forceSelect":false});
</script>
</span>
<?php } else { ?>
<span id="el_maintenance_reviewed_by">
<span<?php echo $maintenance->reviewed_by->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $maintenance->reviewed_by->ViewValue ?></p></span>
</span>
<input type="hidden" data-table="maintenance" data-field="x_reviewed_by" data-page="2" name="x_reviewed_by" id="x_reviewed_by" value="<?php echo ew_HtmlEncode($maintenance->reviewed_by->FormValue) ?>">
<?php } ?>
...
<?php if (!$maintenance_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $maintenance_add->OffsetColumnClass ?>"><!-- buttons offset -->
<?php if ($maintenance->CurrentAction <> "F") { // Confirm page ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $maintenance_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
<?php } else { ?>
...
<script type="text/javascript">
fmaintenanceadd.Init();
</script>
<?php
$maintenance_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$maintenance_add->Page_Terminate();
?>
