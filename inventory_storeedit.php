...
finventory_storeedit.Lists["x_statuss"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"statuss"};
finventory_storeedit.Lists["x_statuss"].Data = "<?php echo $inventory_store_edit->statuss->LookupFilterQuery(FALSE, "edit") ?>";
...
<?php if ($inventory_store->quantity_type->Visible) { // quantity_type ?>
	<div id="r_quantity_type" class="form-group">
		<label id="elh_inventory_store_quantity_type" for="x_quantity_type" class="<?php echo $inventory_store_edit->LeftColumnClass ?>"><?php echo $inventory_store->quantity_type->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($inventory_store->quantity_out->Visible) { // quantity_out ?>
	<div id="r_quantity_out" class="form-group">
		<label id="elh_inventory_store_quantity_out" for="x_quantity_out" class="<?php echo $inventory_store_edit->LeftColumnClass ?>"><?php echo $inventory_store->quantity_out->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($inventory_store->total_quantity->Visible) { // total_quantity ?>
	<div id="r_total_quantity" class="form-group">
		<label id="elh_inventory_store_total_quantity" for="x_total_quantity" class="<?php echo $inventory_store_edit->LeftColumnClass ?>"><?php echo $inventory_store->total_quantity->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($inventory_store->issued_action->Visible) { // issued_action ?>
	<div id="r_issued_action" class="form-group">
		<label id="elh_inventory_store_issued_action" class="<?php echo $inventory_store_edit->LeftColumnClass ?>"><?php echo $inventory_store->issued_action->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($inventory_store->issued_comment->Visible) { // issued_comment ?>
	<div id="r_issued_comment" class="form-group">
		<label id="elh_inventory_store_issued_comment" for="x_issued_comment" class="<?php echo $inventory_store_edit->LeftColumnClass ?>"><?php echo $inventory_store->issued_comment->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($inventory_store->statuss->Visible) { // statuss ?>
	<div id="r_statuss" class="form-group">
		<label id="elh_inventory_store_statuss" for="x_statuss" class="<?php echo $inventory_store_edit->LeftColumnClass ?>"><?php echo $inventory_store->statuss->FldCaption() ?></label>
		<div class="<?php echo $inventory_store_edit->RightColumnClass ?>"><div<?php echo $inventory_store->statuss->CellAttributes() ?>>
<?php if ($inventory_store->CurrentAction <> "F") { ?>
