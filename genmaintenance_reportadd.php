...
$genmaintenance_report_add = NULL; // Initialize page object first

class cgenmaintenance_report_add extends cgenmaintenance_report {
	...
	// Page object name
	var $PageObjName = 'genmaintenance_report_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("genmaintenance_reportlist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "genmaintenance_reportview.php")
...
// Create page object
if (!isset($genmaintenance_report_add)) $genmaintenance_report_add = new cgenmaintenance_report_add();

// Page init
$genmaintenance_report_add->Page_Init();

// Page main
$genmaintenance_report_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$genmaintenance_report_add->Page_Render();
?>
...
var CurrentForm = fgenmaintenance_reportadd = new ew_Form("fgenmaintenance_reportadd", "add");

// Validate form
fgenmaintenance_reportadd.Validate = function() {
...
fgenmaintenance_reportadd.Form_CustomValidate = 
...
fgenmaintenance_reportadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fgenmaintenance_reportadd.Lists["x_gen_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","x_kva",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fgenmaintenance_reportadd.Lists["x_gen_name"].Data = "<?php echo $genmaintenance_report_add->gen_name->LookupFilterQuery(FALSE, "add") ?>";
fgenmaintenance_reportadd.Lists["x_maintenance_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"maintenance_type"};
fgenmaintenance_reportadd.Lists["x_maintenance_type"].Data = "<?php echo $genmaintenance_report_add->maintenance_type->LookupFilterQuery(FALSE, "add") ?>";
fgenmaintenance_reportadd.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgenmaintenance_reportadd.Lists["x_staff_id"].Data = "<?php echo $genmaintenance_report_add->staff_id->LookupFilterQuery(FALSE, "add") ?>";
fgenmaintenance_reportadd.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_status"};
fgenmaintenance_reportadd.Lists["x_status"].Data = "<?php echo $genmaintenance_report_add->status->LookupFilterQuery(FALSE, "add") ?>";
fgenmaintenance_reportadd.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgenmaintenance_reportadd.Lists["x_initiator_action"].Options = <?php echo json_encode($genmaintenance_report_add->initiator_action->Options()) ?>;
fgenmaintenance_reportadd.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgenmaintenance_reportadd.Lists["x_approver_action"].Options = <?php echo json_encode($genmaintenance_report_add->approver_action->Options()) ?>;
fgenmaintenance_reportadd.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgenmaintenance_reportadd.Lists["x_approved_by"].Data = "<?php echo $genmaintenance_report_add->approved_by->LookupFilterQuery(FALSE, "add") ?>";
fgenmaintenance_reportadd.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $genmaintenance_report_add->approved_by->LookupFilterQuery(TRUE, "add"))) ?>;
...
<?php $genmaintenance_report_add->ShowPageHeader(); ?>
<?php
$genmaintenance_report_add->ShowMessage();
?>
<form name="fgenmaintenance_reportadd" id="fgenmaintenance_reportadd" class="<?php echo $genmaintenance_report_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($genmaintenance_report_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $genmaintenance_report_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="genmaintenance_report">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($genmaintenance_report_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($genmaintenance_report->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label id="elh_genmaintenance_report_datetime" for="x_datetime" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->datetime->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->datetime->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fgenmaintenance_reportadd", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($genmaintenance_report->gen_name->Visible) { // gen_name ?>
	<div id="r_gen_name" class="form-group">
		<label id="elh_genmaintenance_report_gen_name" for="x_gen_name" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->gen_name->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->gen_name->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->maintenance_type->Visible) { // maintenance_type ?>
	<div id="r_maintenance_type" class="form-group">
		<label id="elh_genmaintenance_report_maintenance_type" for="x_maintenance_type" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->maintenance_type->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->maintenance_type->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->running_hours->Visible) { // running_hours ?>
	<div id="r_running_hours" class="form-group">
		<label id="elh_genmaintenance_report_running_hours" for="x_running_hours" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->running_hours->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->running_hours->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->cost->Visible) { // cost ?>
	<div id="r_cost" class="form-group">
		<label id="elh_genmaintenance_report_cost" for="x_cost" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->cost->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->cost->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->labour_fee->Visible) { // labour_fee ?>
	<div id="r_labour_fee" class="form-group">
		<label id="elh_genmaintenance_report_labour_fee" for="x_labour_fee" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->labour_fee->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->labour_fee->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->total->Visible) { // total ?>
	<div id="r_total" class="form-group">
		<label id="elh_genmaintenance_report_total" for="x_total" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->total->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->total->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_genmaintenance_report_staff_id" for="x_staff_id" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->staff_id->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->staff_id->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_genmaintenance_report_status" for="x_status" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->status->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->status->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label id="elh_genmaintenance_report_initiator_action" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->initiator_action->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->initiator_action->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label id="elh_genmaintenance_report_initiator_comment" for="x_initiator_comment" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->initiator_comment->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->initiator_comment->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label id="elh_genmaintenance_report_approver_date" for="x_approver_date" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->approver_date->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approver_date->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label id="elh_genmaintenance_report_approver_action" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->approver_action->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approver_action->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label id="elh_genmaintenance_report_approver_comment" for="x_approver_comment" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->approver_comment->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approver_comment->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label id="elh_genmaintenance_report_approved_by" class="<?php echo $genmaintenance_report_add->LeftColumnClass ?>"><?php echo $genmaintenance_report->approved_by->FldCaption() ?></label>
		<div class="<?php echo $genmaintenance_report_add->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approved_by->CellAttributes() ?>>
...
<script type="text/javascript">
fgenmaintenance_reportadd.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
...
<?php if (!$genmaintenance_report_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $genmaintenance_report_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $genmaintenance_report_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fgenmaintenance_reportadd.Init();
</script>
<?php
$genmaintenance_report_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$genmaintenance_report_add->Page_Terminate();
?>
