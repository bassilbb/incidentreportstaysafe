...
class csparepart_report_list extends csparepart_report {
	...
	function RenderListOptions() {
		...
		if ($Security->CanView()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewView\" title=\"" . $viewcaption . "\" data-table=\"sparepart_report\" data-caption=\"" . $viewcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,url:'" . ew_HtmlEncode($this->ViewUrl) . "',btn:null});\">" . $Language->Phrase("ViewLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<a class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" href=\"sparepart_reportsrch.php\">" . $Language->Phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;

		// Search highlight button
		$item = &$this->SearchOptions->Add("searchhighlight");
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewHighlight active\" title=\"" . $Language->Phrase("Highlight") . "\" data-caption=\"" . $Language->Phrase("Highlight") . "\" data-toggle=\"button\" data-form=\"fsparepart_reportlistsrch\" data-name=\"" . $this->HighlightName() . "\">" . $Language->Phrase("HighlightBtn") . "</button>";
	...
	function RenderRow() {
		...
		$this->maintenance_total_cost->ViewCustomAttributes = "";
			...
			if ($this->Export == "")
				$this->quantity_used->ViewValue = $this->HighlightValue($this->quantity_used);
			...
			if ($this->Export == "")
				$this->maintenance_total_cost->ViewValue = $this->HighlightValue($this->maintenance_total_cost);
...
fsparepart_reportlist.Lists["x_part_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_part_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_module"};
fsparepart_reportlist.Lists["x_part_name"].Data = "<?php echo $sparepart_report_list->part_name->LookupFilterQuery(FALSE, "list") ?>";
fsparepart_reportlist.Lists["x_maintenance_id"] = {"LinkField":"x_maintenance_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_generator_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_view"};
fsparepart_reportlist.Lists["x_maintenance_id"].Data = "<?php echo $sparepart_report_list->maintenance_id->LookupFilterQuery(FALSE, "list") ?>";

// Form object for search
var CurrentSearchForm = fsparepart_reportlistsrch = new ew_Form("fsparepart_reportlistsrch");

// Validate function for search
fsparepart_reportlistsrch.Validate = function(fobj) {
...
// Form_CustomValidate event
fsparepart_reportlistsrch.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!
...
// Use JavaScript validation or not
fsparepart_reportlistsrch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fsparepart_reportlistsrch.Lists["x_part_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_part_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_module"};
fsparepart_reportlistsrch.Lists["x_part_name"].Data = "<?php echo $sparepart_report_list->part_name->LookupFilterQuery(FALSE, "extbs") ?>";
fsparepart_reportlistsrch.Lists["x_maintenance_id"] = {"LinkField":"x_maintenance_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_generator_name","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"sparepart_view"};
fsparepart_reportlistsrch.Lists["x_maintenance_id"].Data = "<?php echo $sparepart_report_list->maintenance_id->LookupFilterQuery(FALSE, "extbs") ?>";
</script>
<script type="text/javascript">
...
<?php
	...
	if ($sparepart_report_list->AuditTrailOnSearch && $sparepart_report_list->Command == "search" && !$sparepart_report_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $sparepart_report_list->getSessionWhere();
		$sparepart_report_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
...
<?php
if ($gsSearchError == "")
	$sparepart_report_list->LoadAdvancedSearch(); // Load advanced search

// Render for search
$sparepart_report->RowType = EW_ROWTYPE_SEARCH;
...
<?php if ($sparepart_report->date->Visible) { // date ?>
	<div id="xsc_date" class="ewCell form-group">
		<label for="x_date" class="ewSearchCaption ewLabel"><?php echo $sparepart_report->date->FldCaption() ?></label>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fsparepart_reportlistsrch", "x_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if (!$sparepart_report->date->ReadOnly && !$sparepart_report->date->Disabled && !isset($sparepart_report->date->EditAttrs["readonly"]) && !isset($sparepart_report->date->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("fsparepart_reportlistsrch", "y_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
	</div>
...
<?php if ($sparepart_report->part_name->Visible) { // part_name ?>
	<div id="xsc_part_name" class="ewCell form-group">
		<label for="x_part_name" class="ewSearchCaption ewLabel"><?php echo $sparepart_report->part_name->FldCaption() ?></label>
...
<?php if ($sparepart_report->maintenance_id->Visible) { // maintenance_id ?>
	<div id="xsc_maintenance_id" class="ewCell form-group">
		<label for="x_maintenance_id" class="ewSearchCaption ewLabel"><?php echo $sparepart_report->maintenance_id->FldCaption() ?></label>
		<span class="ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_maintenance_id" id="z_maintenance_id" value="="></span>
		<span class="ewSearchField">
<span class="ewLookupList">
...
$sparepart_report->RowType = EW_ROWTYPE_AGGREGATE;
$sparepart_report->ResetAttrs();
$sparepart_report_list->RenderRow();
?>
<?php if ($sparepart_report_list->TotalRecs > 0 && ($sparepart_report->CurrentAction <> "gridadd" && $sparepart_report->CurrentAction <> "gridedit")) { ?>
<tfoot><!-- Table footer -->
...
$sparepart_report_list->ListOptions->Render("footer", "left");
?>
	<?php if ($sparepart_report->id->Visible) { // id ?>
		<td data-name="id" class="<?php echo $sparepart_report->id->FooterCellClass() ?>"><span id="elf_sparepart_report_id" class="sparepart_report_id">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->date->Visible) { // date ?>
		<td data-name="date" class="<?php echo $sparepart_report->date->FooterCellClass() ?>"><span id="elf_sparepart_report_date" class="sparepart_report_date">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->part_name->Visible) { // part_name ?>
		<td data-name="part_name" class="<?php echo $sparepart_report->part_name->FooterCellClass() ?>"><span id="elf_sparepart_report_part_name" class="sparepart_report_part_name">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->maintenance_id->Visible) { // maintenance_id ?>
		<td data-name="maintenance_id" class="<?php echo $sparepart_report->maintenance_id->FooterCellClass() ?>"><span id="elf_sparepart_report_maintenance_id" class="sparepart_report_maintenance_id">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->quantity_in->Visible) { // quantity_in ?>
		<td data-name="quantity_in" class="<?php echo $sparepart_report->quantity_in->FooterCellClass() ?>"><span id="elf_sparepart_report_quantity_in" class="sparepart_report_quantity_in">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->quantity_used->Visible) { // quantity_used ?>
		<td data-name="quantity_used" class="<?php echo $sparepart_report->quantity_used->FooterCellClass() ?>"><span id="elf_sparepart_report_quantity_used" class="sparepart_report_quantity_used">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->cost->Visible) { // cost ?>
		<td data-name="cost" class="<?php echo $sparepart_report->cost->FooterCellClass() ?>"><span id="elf_sparepart_report_cost" class="sparepart_report_cost">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->total_quantity->Visible) { // total_quantity ?>
		<td data-name="total_quantity" class="<?php echo $sparepart_report->total_quantity->FooterCellClass() ?>"><span id="elf_sparepart_report_total_quantity" class="sparepart_report_total_quantity">
		&nbsp;
		</span></td>
	<?php } ?>
	<?php if ($sparepart_report->total_cost->Visible) { // total_cost ?>
		<td data-name="total_cost" class="<?php echo $sparepart_report->total_cost->FooterCellClass() ?>"><span id="elf_sparepart_report_total_cost" class="sparepart_report_total_cost">
...
<?php echo $sparepart_report->total_cost->ViewValue ?></span>
	...
	<?php } ?>
	<?php if ($sparepart_report->maintenance_total_cost->Visible) { // maintenance_total_cost ?>
		<td data-name="maintenance_total_cost" class="<?php echo $sparepart_report->maintenance_total_cost->FooterCellClass() ?>"><span id="elf_sparepart_report_maintenance_total_cost" class="sparepart_report_maintenance_total_cost">
		&nbsp;
		</span></td>
	<?php } ?>
<?php
...
$sparepart_report_list->ListOptions->Render("footer", "right");
?>
	</tr>
</tfoot>
<?php } ?>
