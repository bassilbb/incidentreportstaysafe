...
//
// Table class for type_of_incident
//
class ctype_of_incident extends cTable {
	var $code;
	var $description;
	...
	function __construct() {
		...
		$this->TableVar = 'type_of_incident';
		$this->TableName = 'type_of_incident';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`type_of_incident`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// code
		$this->code = new cField('type_of_incident', 'type_of_incident', 'x_code', 'code', '`code`', '`code`', 3, -1, FALSE, '`code`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->code->Sortable = TRUE; // Allow sort
		$this->code->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['code'] = &$this->code;

		// description
		$this->description = new cField('type_of_incident', 'type_of_incident', 'x_description', 'description', '`description`', '`description`', 200, -1, FALSE, '`description`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`type_of_incident`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "type_of_incidentlist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "type_of_incidentedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "type_of_incidentadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("type_of_incidentview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("type_of_incidentview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "type_of_incidentadd.php?" . $this->UrlParm($parm);
		else
			$url = "type_of_incidentadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("type_of_incidentedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("type_of_incidentadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("type_of_incidentdelete.php", $this->UrlParm());
	}
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "add") {
			if (CurrentUserLevel() == 1) {
				...
				$this->time_initiated->ReadOnly = TRUE;
				...
				$this->no_of_people->Visible = TRUE;
				$this->individual_involveds->Visible = TRUE;
				...
				$this->date_resolved->Visible = FALSE;
				$this->time_resolved->Visible = FALSE;
				...
				$this->time_approved->Visible = FALSE;
			...
			if (CurrentUserLevel() == 2 && $this->staff_id->CurrentValue == $_SESSION['Staff_ID']) {
				...
				$this->branch->ReadOnly = TRUE;
				$this->staff_details->ReadOnly = TRUE;
				$this->individual_involveds->Visible = TRUE;
				$this->status->Visible = FALSE;
				$this->no_of_people->Visible = TRUE;
				$this->category->Visible = TRUE;
			...
			if (CurrentUserLevel() == 3 && $this->staff_id->CurrentValue == $_SESSION['Staff_ID']) {
				$this->date_initiated->ReadOnly = FALSE;
				$this->time_initiated->ReadOnly = FALSE;
				$this->staffid->ReadOnly = FALSE;
				$this->staff_id->ReadOnly = TRUE;
				$this->report_by->ReadOnly = FALSE;
				$this->department->ReadOnly = FALSE;
				$this->branch->ReadOnly = FALSE;
				$this->individual_involveds->Visible = TRUE;
				$this->status->Visible = FALSE;
				$this->no_of_people->Visible = TRUE;
				...
				$this->time_approved->ReadOnly = TRUE;
				$this->approval_action->Visible = FALSE;
				$this->approval_comment->Visible = FALSE;
				$this->approved_by->Visible = FALSE;
			}
		...
		if (CurrentPageID() == "edit") {
			...
			if (CurrentUserLevel() == 2 && $this->staff_id->CurrentValue == $_SESSION['Staff_ID']) {
				...
				$this->branch->ReadOnly = FALSE;
				$this->status->ReadOnly = TRUE;
				$this->no_of_people->ReadOnly = TRUE;
				$this->individual_involveds->ReadOnly = TRUE;
				...
				$this->date_resolved->Visible = TRUE;
				$this->time_resolved->Visible = TRUE;
			...
			if (CurrentUserLevel() == 2 && $this->staff_id->CurrentValue != $_SESSION['Staff_ID']) {
				...
				$this->initiator_comment->ReadOnly = TRUE;
				$this->date_resolved->ReadOnly = TRUE;
				$this->time_resolved->ReadOnly = TRUE;
				$this->resolved_action->Visible = TRUE;
				$this->resolved_comment->Visible = TRUE;
				$this->resolved_by->ReadOnly = TRUE;
				$this->date_approved->Visible = FALSE;
			...
			if (CurrentUserLevel() == 3) {
				...
				$this->initiator_action->Visible = TRUE;
				$this->initiator_comment->ReadOnly = TRUE;
				if ($this->department->CurrentValue == 3) {
					$this->resolved_action->Visible = FALSE;
					$this->resolved_comment->Visible = FALSE;			
				} else {
		...
		if (CurrentPageID() == "list") {
			...
			if ($this->status->CurrentValue == 1) {
				...
				$this->time_initiated->CellCssStyle = "color: orange; text-align: left;";
				...
				$this->no_of_people->CellCssStyle = "color: orange; text-align: left;";
			...
			if ($this->status->CurrentValue == 2) {
				...
				$this->time_initiated->CellCssStyle = "color: red; text-align: left;";
				...
				$this->no_of_people->CellCssStyle = "color: red; text-align: left;";
			...
			if ($this->status->CurrentValue == 3) {
				...
				$this->time_initiated->CellCssStyle = "color: blue; text-align: left;";
				...
				$this->no_of_people->CellCssStyle = "color: blue; text-align: left;";
			...
			if ($this->status->CurrentValue == 0) {
				...
				$this->time_initiated->CellCssStyle = "color: teal; text-align: left;";
				...
				$this->no_of_people->CellCssStyle = "color: teal; text-align: left;";
			...
			if ($this->status->CurrentValue == 4) {
				$this->id->CellCssStyle = "color: deeppink; text-align: left;";
				$this->date_initiated->CellCssStyle = "color: deeppink; text-align: left;";
				$this->time_initiated->CellCssStyle = "color: deeppink; text-align: left;";
				$this->staff_id->CellCssStyle = "color: deeppink; text-align: left;";
				$this->report_by->CellCssStyle = "color: deeppink; text-align: left;";
				$this->department->CellCssStyle = "color: deeppink; text-align: left;";
				$this->branch->CellCssStyle = "color: deeppink; text-align: left;";
				$this->incident_id->CellCssStyle = "color: deeppink; text-align: left;";
				$this->incident_type->CellCssStyle = "color: deeppink; text-align: left;";
				$this->incident_location->CellCssStyle = "color: deeppink; text-align: left;";
				$this->no_of_people->CellCssStyle = "color: deeppink; text-align: left;";
				$this->category->CellCssStyle = "color: deeppink; text-align: left;";
				$this->incident_description->CellCssStyle = "color: deeppink; text-align: left;";
				$this->incident_category->CellCssStyle = "color: deeppink; text-align: left;";
				$this->sub_category->CellCssStyle = "color: deeppink; text-align: left;";
				$this->status->CellCssStyle = "color: deeppink; text-align: left;";				
			}
			if ($this->status->CurrentValue == 5) {
				...
				$this->time_initiated->CellCssStyle = "color: green; text-align: left;";
				...
				$this->no_of_people->CellCssStyle = "color: green; text-align: left;";
