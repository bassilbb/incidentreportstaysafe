...
$genmaintenance_report_search = NULL; // Initialize page object first

class cgenmaintenance_report_search extends cgenmaintenance_report {
	...
	// Page object name
	var $PageObjName = 'genmaintenance_report_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "genmaintenance_reportlist.php" . "?" . $sSrchStr;
	...
	function LoadSearchValues() {
		...
		$this->datetime->AdvancedSearch->SearchCondition = $objForm->GetValue("v_datetime");
		$this->datetime->AdvancedSearch->SearchValue2 = $objForm->GetValue("y_datetime");
		$this->datetime->AdvancedSearch->SearchOperator2 = $objForm->GetValue("w_datetime");
...
// Create page object
if (!isset($genmaintenance_report_search)) $genmaintenance_report_search = new cgenmaintenance_report_search();

// Page init
$genmaintenance_report_search->Page_Init();

// Page main
$genmaintenance_report_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$genmaintenance_report_search->Page_Render();
?>
...
<?php if ($genmaintenance_report_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fgenmaintenance_reportsearch = new ew_Form("fgenmaintenance_reportsearch", "search");
<?php } else { ?>
var CurrentForm = fgenmaintenance_reportsearch = new ew_Form("fgenmaintenance_reportsearch", "search");
<?php } ?>

// Form_CustomValidate event
fgenmaintenance_reportsearch.Form_CustomValidate = 
...
fgenmaintenance_reportsearch.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fgenmaintenance_reportsearch.Lists["x_gen_name"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_gen_name","x_location","x_kva",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"generator_registration"};
fgenmaintenance_reportsearch.Lists["x_gen_name"].Data = "<?php echo $genmaintenance_report_search->gen_name->LookupFilterQuery(FALSE, "search") ?>";
fgenmaintenance_reportsearch.Lists["x_maintenance_type"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"maintenance_type"};
fgenmaintenance_reportsearch.Lists["x_maintenance_type"].Data = "<?php echo $genmaintenance_report_search->maintenance_type->LookupFilterQuery(FALSE, "search") ?>";
fgenmaintenance_reportsearch.Lists["x_staff_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgenmaintenance_reportsearch.Lists["x_staff_id"].Data = "<?php echo $genmaintenance_report_search->staff_id->LookupFilterQuery(FALSE, "search") ?>";
fgenmaintenance_reportsearch.Lists["x_status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_description","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"gen_status"};
fgenmaintenance_reportsearch.Lists["x_status"].Data = "<?php echo $genmaintenance_report_search->status->LookupFilterQuery(FALSE, "search") ?>";
fgenmaintenance_reportsearch.Lists["x_initiator_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgenmaintenance_reportsearch.Lists["x_initiator_action"].Options = <?php echo json_encode($genmaintenance_report_search->initiator_action->Options()) ?>;
fgenmaintenance_reportsearch.Lists["x_approver_action"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fgenmaintenance_reportsearch.Lists["x_approver_action"].Options = <?php echo json_encode($genmaintenance_report_search->approver_action->Options()) ?>;
fgenmaintenance_reportsearch.Lists["x_approved_by"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_firstname","x_lastname","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"users"};
fgenmaintenance_reportsearch.Lists["x_approved_by"].Data = "<?php echo $genmaintenance_report_search->approved_by->LookupFilterQuery(FALSE, "search") ?>";
fgenmaintenance_reportsearch.AutoSuggests["x_approved_by"] = <?php echo json_encode(array("data" => "ajax=autosuggest&" . $genmaintenance_report_search->approved_by->LookupFilterQuery(TRUE, "search"))) ?>;

// Form object for search
// Validate function for search

fgenmaintenance_reportsearch.Validate = function(fobj) {
	...
	if (elm && !ew_CheckInteger(elm.value))
		return this.OnError(elm, "<?php echo ew_JsEncode2($genmaintenance_report->id->FldErrMsg()) ?>");
...
<?php $genmaintenance_report_search->ShowPageHeader(); ?>
<?php
$genmaintenance_report_search->ShowMessage();
?>
<form name="fgenmaintenance_reportsearch" id="fgenmaintenance_reportsearch" class="<?php echo $genmaintenance_report_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($genmaintenance_report_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $genmaintenance_report_search->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="genmaintenance_report">
<input type="hidden" name="a_search" id="a_search" value="S">
<input type="hidden" name="modal" value="<?php echo intval($genmaintenance_report_search->IsModal) ?>">
<div class="ewSearchDiv"><!-- page* -->
<?php if ($genmaintenance_report->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label for="x_id" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_id"><?php echo $genmaintenance_report->id->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_id" id="z_id" value="="></p>
		</label>
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->id->CellAttributes() ?>>
			<span id="el_genmaintenance_report_id">
<input type="text" data-table="genmaintenance_report" data-field="x_id" data-page="1" name="x_id" id="x_id" placeholder="<?php echo ew_HtmlEncode($genmaintenance_report->id->getPlaceHolder()) ?>" value="<?php echo $genmaintenance_report->id->EditValue ?>"<?php echo $genmaintenance_report->id->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($genmaintenance_report->datetime->Visible) { // datetime ?>
	<div id="r_datetime" class="form-group">
		<label for="x_datetime" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_datetime"><?php echo $genmaintenance_report->datetime->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("BETWEEN") ?><input type="hidden" name="z_datetime" id="z_datetime" value="BETWEEN"></p>
		</label>
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->datetime->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fgenmaintenance_reportsearch", "x_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
			<span class="ewSearchCond btw1_datetime">&nbsp;<?php echo $Language->Phrase("AND") ?>&nbsp;</span>
			<span id="e2_genmaintenance_report_datetime" class="btw1_datetime">
<input type="text" data-table="genmaintenance_report" data-field="x_datetime" data-page="1" name="y_datetime" id="y_datetime" size="30" placeholder="<?php echo ew_HtmlEncode($genmaintenance_report->datetime->getPlaceHolder()) ?>" value="<?php echo $genmaintenance_report->datetime->EditValue2 ?>"<?php echo $genmaintenance_report->datetime->EditAttributes() ?>>
<?php if (!$genmaintenance_report->datetime->ReadOnly && !$genmaintenance_report->datetime->Disabled && !isset($genmaintenance_report->datetime->EditAttrs["readonly"]) && !isset($genmaintenance_report->datetime->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("fgenmaintenance_reportsearch", "y_datetime", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
		</div></div>
...
<?php if ($genmaintenance_report->gen_name->Visible) { // gen_name ?>
	<div id="r_gen_name" class="form-group">
		<label for="x_gen_name" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_gen_name"><?php echo $genmaintenance_report->gen_name->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->gen_name->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->maintenance_type->Visible) { // maintenance_type ?>
	<div id="r_maintenance_type" class="form-group">
		<label for="x_maintenance_type" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_maintenance_type"><?php echo $genmaintenance_report->maintenance_type->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->maintenance_type->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->running_hours->Visible) { // running_hours ?>
	<div id="r_running_hours" class="form-group">
		<label for="x_running_hours" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_running_hours"><?php echo $genmaintenance_report->running_hours->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->running_hours->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->cost->Visible) { // cost ?>
	<div id="r_cost" class="form-group">
		<label for="x_cost" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_cost"><?php echo $genmaintenance_report->cost->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_cost" id="z_cost" value="="></p>
		</label>
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->cost->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->labour_fee->Visible) { // labour_fee ?>
	<div id="r_labour_fee" class="form-group">
		<label for="x_labour_fee" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_labour_fee"><?php echo $genmaintenance_report->labour_fee->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->labour_fee->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->total->Visible) { // total ?>
	<div id="r_total" class="form-group">
		<label for="x_total" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_total"><?php echo $genmaintenance_report->total->FldCaption() ?></span>
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("=") ?><input type="hidden" name="z_total" id="z_total" value="="></p>
		</label>
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->total->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label for="x_staff_id" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_staff_id"><?php echo $genmaintenance_report->staff_id->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->staff_id->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label for="x_status" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_status"><?php echo $genmaintenance_report->status->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->status->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->initiator_action->Visible) { // initiator_action ?>
	<div id="r_initiator_action" class="form-group">
		<label class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_initiator_action"><?php echo $genmaintenance_report->initiator_action->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->initiator_action->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->initiator_comment->Visible) { // initiator_comment ?>
	<div id="r_initiator_comment" class="form-group">
		<label for="x_initiator_comment" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_initiator_comment"><?php echo $genmaintenance_report->initiator_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->initiator_comment->CellAttributes() ?>>
			<span id="el_genmaintenance_report_initiator_comment">
<input type="text" data-table="genmaintenance_report" data-field="x_initiator_comment" data-page="1" name="x_initiator_comment" id="x_initiator_comment" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($genmaintenance_report->initiator_comment->getPlaceHolder()) ?>" value="<?php echo $genmaintenance_report->initiator_comment->EditValue ?>"<?php echo $genmaintenance_report->initiator_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($genmaintenance_report->approver_date->Visible) { // approver_date ?>
	<div id="r_approver_date" class="form-group">
		<label for="x_approver_date" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_approver_date"><?php echo $genmaintenance_report->approver_date->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approver_date->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->approver_action->Visible) { // approver_action ?>
	<div id="r_approver_action" class="form-group">
		<label class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_approver_action"><?php echo $genmaintenance_report->approver_action->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approver_action->CellAttributes() ?>>
...
<?php if ($genmaintenance_report->approver_comment->Visible) { // approver_comment ?>
	<div id="r_approver_comment" class="form-group">
		<label for="x_approver_comment" class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_approver_comment"><?php echo $genmaintenance_report->approver_comment->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approver_comment->CellAttributes() ?>>
			<span id="el_genmaintenance_report_approver_comment">
<input type="text" data-table="genmaintenance_report" data-field="x_approver_comment" data-page="1" name="x_approver_comment" id="x_approver_comment" size="30" maxlength="100" placeholder="<?php echo ew_HtmlEncode($genmaintenance_report->approver_comment->getPlaceHolder()) ?>" value="<?php echo $genmaintenance_report->approver_comment->EditValue ?>"<?php echo $genmaintenance_report->approver_comment->EditAttributes() ?>>
</span>
		</div></div>
	</div>
<?php } ?>
<?php if ($genmaintenance_report->approved_by->Visible) { // approved_by ?>
	<div id="r_approved_by" class="form-group">
		<label class="<?php echo $genmaintenance_report_search->LeftColumnClass ?>"><span id="elh_genmaintenance_report_approved_by"><?php echo $genmaintenance_report->approved_by->FldCaption() ?></span>
		...
		<div class="<?php echo $genmaintenance_report_search->RightColumnClass ?>"><div<?php echo $genmaintenance_report->approved_by->CellAttributes() ?>>
...
<input type="hidden" data-table="genmaintenance_report" data-field="x_approved_by" data-page="1" data-value-separator="<?php echo $genmaintenance_report->approved_by->DisplayValueSeparatorAttribute() ?>" name="x_approved_by" id="x_approved_by" value="<?php echo ew_HtmlEncode($genmaintenance_report->approved_by->AdvancedSearch->SearchValue) ?>"<?php echo $wrkonchange ?>>
<script type="text/javascript">
fgenmaintenance_reportsearch.CreateAutoSuggest({"id":"x_approved_by","forceSelect":false});
</script>
</span>
		</div></div>
	</div>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $genmaintenance_report_search->OffsetColumnClass ?>"><!-- buttons offset -->
...
<script type="text/javascript">
fgenmaintenance_reportsearch.Init();
</script>
<?php
$genmaintenance_report_search->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$genmaintenance_report_search->Page_Terminate();
?>
