...
$systems_edit = NULL; // Initialize page object first

class csystems_edit extends csystems {
...
// Create page object
if (!isset($systems_edit)) $systems_edit = new csystems_edit();

// Page init
$systems_edit->Page_Init();

// Page main
$systems_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$systems_edit->Page_Render();
?>
...
var CurrentForm = fsystemsedit = new ew_Form("fsystemsedit", "edit");

// Validate form
fsystemsedit.Validate = function() {
...
fsystemsedit.Form_CustomValidate = 
...
fsystemsedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $systems_edit->ShowPageHeader(); ?>
<?php
$systems_edit->ShowMessage();
?>
<?php if (!$systems_edit->IsModal) { ?>
<form name="ewPagerForm" class="form-horizontal ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($systems_edit->Pager)) $systems_edit->Pager = new cPrevNextPager($systems_edit->StartRec, $systems_edit->DisplayRecs, $systems_edit->TotalRecs, $systems_edit->AutoHidePager) ?>
<?php if ($systems_edit->Pager->RecordCount > 0 && $systems_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($systems_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $systems_edit->PageUrl() ?>start=<?php echo $systems_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($systems_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $systems_edit->PageUrl() ?>start=<?php echo $systems_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $systems_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($systems_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $systems_edit->PageUrl() ?>start=<?php echo $systems_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($systems_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $systems_edit->PageUrl() ?>start=<?php echo $systems_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $systems_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<form name="fsystemsedit" id="fsystemsedit" class="<?php echo $systems_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($systems_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $systems_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="systems">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($systems_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($systems->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_systems_id" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->id->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->id->CellAttributes() ?>>
<span id="el_systems_id">
<span<?php echo $systems->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $systems->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="systems" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($systems->id->CurrentValue) ?>">
<?php echo $systems->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($systems->asset_tag->Visible) { // asset_tag ?>
	<div id="r_asset_tag" class="form-group">
		<label id="elh_systems_asset_tag" for="x_asset_tag" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->asset_tag->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->asset_tag->CellAttributes() ?>>
...
<?php if ($systems->start_sate->Visible) { // start_sate ?>
	<div id="r_start_sate" class="form-group">
		<label id="elh_systems_start_sate" for="x_start_sate" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->start_sate->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->start_sate->CellAttributes() ?>>
...
<?php if ($systems->end_date->Visible) { // end_date ?>
	<div id="r_end_date" class="form-group">
		<label id="elh_systems_end_date" for="x_end_date" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->end_date->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->end_date->CellAttributes() ?>>
...
<?php if ($systems->cost_for_repair->Visible) { // cost_for_repair ?>
	<div id="r_cost_for_repair" class="form-group">
		<label id="elh_systems_cost_for_repair" for="x_cost_for_repair" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->cost_for_repair->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->cost_for_repair->CellAttributes() ?>>
...
<?php if ($systems->service_provider->Visible) { // service_provider ?>
	<div id="r_service_provider" class="form-group">
		<label id="elh_systems_service_provider" for="x_service_provider" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->service_provider->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->service_provider->CellAttributes() ?>>
...
<?php if ($systems->address->Visible) { // address ?>
	<div id="r_address" class="form-group">
		<label id="elh_systems_address" for="x_address" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->address->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->address->CellAttributes() ?>>
...
<?php if ($systems->type_of_repair->Visible) { // type_of_repair ?>
	<div id="r_type_of_repair" class="form-group">
		<label id="elh_systems_type_of_repair" for="x_type_of_repair" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->type_of_repair->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->type_of_repair->CellAttributes() ?>>
...
<?php if ($systems->note->Visible) { // note ?>
	<div id="r_note" class="form-group">
		<label id="elh_systems_note" for="x_note" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->note->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->note->CellAttributes() ?>>
...
<?php if ($systems->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_systems_status" for="x_status" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->status->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->status->CellAttributes() ?>>
...
<?php if ($systems->asset_category->Visible) { // asset_category ?>
	<div id="r_asset_category" class="form-group">
		<label id="elh_systems_asset_category" for="x_asset_category" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->asset_category->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->asset_category->CellAttributes() ?>>
...
<?php if ($systems->asset_sub_category->Visible) { // asset_sub_category ?>
	<div id="r_asset_sub_category" class="form-group">
		<label id="elh_systems_asset_sub_category" for="x_asset_sub_category" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->asset_sub_category->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->asset_sub_category->CellAttributes() ?>>
...
<?php if ($systems->serial_number->Visible) { // serial_number ?>
	<div id="r_serial_number" class="form-group">
		<label id="elh_systems_serial_number" for="x_serial_number" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->serial_number->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->serial_number->CellAttributes() ?>>
...
<?php if ($systems->programe_area->Visible) { // programe_area ?>
	<div id="r_programe_area" class="form-group">
		<label id="elh_systems_programe_area" for="x_programe_area" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->programe_area->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->programe_area->CellAttributes() ?>>
...
<?php if ($systems->division->Visible) { // division ?>
	<div id="r_division" class="form-group">
		<label id="elh_systems_division" for="x_division" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->division->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->division->CellAttributes() ?>>
...
<?php if ($systems->branch->Visible) { // branch ?>
	<div id="r_branch" class="form-group">
		<label id="elh_systems_branch" for="x_branch" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->branch->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->branch->CellAttributes() ?>>
...
<?php if ($systems->department->Visible) { // department ?>
	<div id="r_department" class="form-group">
		<label id="elh_systems_department" for="x_department" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->department->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->department->CellAttributes() ?>>
...
<?php if ($systems->staff_id->Visible) { // staff_id ?>
	<div id="r_staff_id" class="form-group">
		<label id="elh_systems_staff_id" for="x_staff_id" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->staff_id->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->staff_id->CellAttributes() ?>>
...
<?php if ($systems->created_by->Visible) { // created_by ?>
	<div id="r_created_by" class="form-group">
		<label id="elh_systems_created_by" for="x_created_by" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->created_by->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->created_by->CellAttributes() ?>>
...
<?php if ($systems->created_date->Visible) { // created_date ?>
	<div id="r_created_date" class="form-group">
		<label id="elh_systems_created_date" for="x_created_date" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->created_date->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->created_date->CellAttributes() ?>>
...
<?php if ($systems->device_number->Visible) { // device_number ?>
	<div id="r_device_number" class="form-group">
		<label id="elh_systems_device_number" for="x_device_number" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->device_number->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->device_number->CellAttributes() ?>>
...
<?php if ($systems->tablet_imie_number->Visible) { // tablet_imie_number ?>
	<div id="r_tablet_imie_number" class="form-group">
		<label id="elh_systems_tablet_imie_number" for="x_tablet_imie_number" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->tablet_imie_number->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->tablet_imie_number->CellAttributes() ?>>
...
<?php if ($systems->model->Visible) { // model ?>
	<div id="r_model" class="form-group">
		<label id="elh_systems_model" for="x_model" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->model->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->model->CellAttributes() ?>>
...
<?php if ($systems->flag->Visible) { // flag ?>
	<div id="r_flag" class="form-group">
		<label id="elh_systems_flag" for="x_flag" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->flag->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->flag->CellAttributes() ?>>
...
<?php if ($systems->area->Visible) { // area ?>
	<div id="r_area" class="form-group">
		<label id="elh_systems_area" for="x_area" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->area->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->area->CellAttributes() ?>>
...
<?php if ($systems->updated_date->Visible) { // updated_date ?>
	<div id="r_updated_date" class="form-group">
		<label id="elh_systems_updated_date" for="x_updated_date" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->updated_date->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->updated_date->CellAttributes() ?>>
...
<?php if ($systems->updated_by->Visible) { // updated_by ?>
	<div id="r_updated_by" class="form-group">
		<label id="elh_systems_updated_by" for="x_updated_by" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->updated_by->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->updated_by->CellAttributes() ?>>
...
<?php if ($systems->received_date->Visible) { // received_date ?>
	<div id="r_received_date" class="form-group">
		<label id="elh_systems_received_date" for="x_received_date" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->received_date->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->received_date->CellAttributes() ?>>
...
<?php if ($systems->received_by->Visible) { // received_by ?>
	<div id="r_received_by" class="form-group">
		<label id="elh_systems_received_by" for="x_received_by" class="<?php echo $systems_edit->LeftColumnClass ?>"><?php echo $systems->received_by->FldCaption() ?></label>
		<div class="<?php echo $systems_edit->RightColumnClass ?>"><div<?php echo $systems->received_by->CellAttributes() ?>>
...
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $systems_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $systems_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
