...
//
// Table class for laptop_tablet
//
class claptop_tablet extends cTable {
	var $id;
	var $asset_tag;
	var $start_sate;
	var $end_date;
	...
	function __construct() {
		...
		$this->TableVar = 'laptop_tablet';
		$this->TableName = 'laptop_tablet';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`laptop_tablet`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('laptop_tablet', 'laptop_tablet', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// asset_tag
		$this->asset_tag = new cField('laptop_tablet', 'laptop_tablet', 'x_asset_tag', 'asset_tag', '`asset_tag`', '`asset_tag`', 200, -1, FALSE, '`asset_tag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->asset_tag->Sortable = TRUE; // Allow sort
		$this->fields['asset_tag'] = &$this->asset_tag;

		// start_sate
		$this->start_sate = new cField('laptop_tablet', 'laptop_tablet', 'x_start_sate', 'start_sate', '`start_sate`', ew_CastDateFieldForLike('`start_sate`', 0, "DB"), 135, 0, FALSE, '`start_sate`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// end_date
		$this->end_date = new cField('laptop_tablet', 'laptop_tablet', 'x_end_date', 'end_date', '`end_date`', ew_CastDateFieldForLike('`end_date`', 0, "DB"), 135, 0, FALSE, '`end_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// cost_for_repair
		$this->cost_for_repair = new cField('laptop_tablet', 'laptop_tablet', 'x_cost_for_repair', 'cost_for_repair', '`cost_for_repair`', '`cost_for_repair`', 3, -1, FALSE, '`cost_for_repair`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// service_provider
		$this->service_provider = new cField('laptop_tablet', 'laptop_tablet', 'x_service_provider', 'service_provider', '`service_provider`', '`service_provider`', 200, -1, FALSE, '`service_provider`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->service_provider->Sortable = TRUE; // Allow sort
		$this->fields['service_provider'] = &$this->service_provider;

		// address
		$this->address = new cField('laptop_tablet', 'laptop_tablet', 'x_address', 'address', '`address`', '`address`', 200, -1, FALSE, '`address`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->address->Sortable = TRUE; // Allow sort
		$this->fields['address'] = &$this->address;

		// type_of_repair
		$this->type_of_repair = new cField('laptop_tablet', 'laptop_tablet', 'x_type_of_repair', 'type_of_repair', '`type_of_repair`', '`type_of_repair`', 200, -1, FALSE, '`type_of_repair`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->type_of_repair->Sortable = TRUE; // Allow sort
		$this->fields['type_of_repair'] = &$this->type_of_repair;

		// note
		$this->note = new cField('laptop_tablet', 'laptop_tablet', 'x_note', 'note', '`note`', '`note`', 200, -1, FALSE, '`note`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->note->Sortable = TRUE; // Allow sort
		$this->fields['note'] = &$this->note;

		// status
		$this->status = new cField('laptop_tablet', 'laptop_tablet', 'x_status', 'status', '`status`', '`status`', 200, -1, FALSE, '`status`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->status->Sortable = TRUE; // Allow sort
		$this->fields['status'] = &$this->status;

		// asset_category
		$this->asset_category = new cField('laptop_tablet', 'laptop_tablet', 'x_asset_category', 'asset_category', '`asset_category`', '`asset_category`', 200, -1, FALSE, '`asset_category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->asset_category->Sortable = TRUE; // Allow sort
		$this->fields['asset_category'] = &$this->asset_category;

		// asset_sub_category
		$this->asset_sub_category = new cField('laptop_tablet', 'laptop_tablet', 'x_asset_sub_category', 'asset_sub_category', '`asset_sub_category`', '`asset_sub_category`', 200, -1, FALSE, '`asset_sub_category`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->asset_sub_category->Sortable = TRUE; // Allow sort
		$this->fields['asset_sub_category'] = &$this->asset_sub_category;

		// serial_number
		$this->serial_number = new cField('laptop_tablet', 'laptop_tablet', 'x_serial_number', 'serial_number', '`serial_number`', '`serial_number`', 200, -1, FALSE, '`serial_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->serial_number->Sortable = TRUE; // Allow sort
		$this->fields['serial_number'] = &$this->serial_number;

		// programe_area
		$this->programe_area = new cField('laptop_tablet', 'laptop_tablet', 'x_programe_area', 'programe_area', '`programe_area`', '`programe_area`', 200, -1, FALSE, '`programe_area`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->programe_area->Sortable = TRUE; // Allow sort
		$this->fields['programe_area'] = &$this->programe_area;

		// division
		$this->division = new cField('laptop_tablet', 'laptop_tablet', 'x_division', 'division', '`division`', '`division`', 200, -1, FALSE, '`division`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->division->Sortable = TRUE; // Allow sort
		$this->fields['division'] = &$this->division;

		// branch
		$this->branch = new cField('laptop_tablet', 'laptop_tablet', 'x_branch', 'branch', '`branch`', '`branch`', 200, -1, FALSE, '`branch`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->branch->Sortable = TRUE; // Allow sort
		$this->fields['branch'] = &$this->branch;

		// department
		$this->department = new cField('laptop_tablet', 'laptop_tablet', 'x_department', 'department', '`department`', '`department`', 200, -1, FALSE, '`department`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->department->Sortable = TRUE; // Allow sort
		$this->fields['department'] = &$this->department;

		// staff_id
		$this->staff_id = new cField('laptop_tablet', 'laptop_tablet', 'x_staff_id', 'staff_id', '`staff_id`', '`staff_id`', 200, -1, FALSE, '`staff_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->staff_id->Sortable = TRUE; // Allow sort
		$this->fields['staff_id'] = &$this->staff_id;

		// created_by
		$this->created_by = new cField('laptop_tablet', 'laptop_tablet', 'x_created_by', 'created_by', '`created_by`', '`created_by`', 200, -1, FALSE, '`created_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->created_by->Sortable = TRUE; // Allow sort
		$this->fields['created_by'] = &$this->created_by;

		// created_date
		$this->created_date = new cField('laptop_tablet', 'laptop_tablet', 'x_created_date', 'created_date', '`created_date`', ew_CastDateFieldForLike('`created_date`', 0, "DB"), 135, 0, FALSE, '`created_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// device_number
		$this->device_number = new cField('laptop_tablet', 'laptop_tablet', 'x_device_number', 'device_number', '`device_number`', '`device_number`', 200, -1, FALSE, '`device_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->device_number->Sortable = TRUE; // Allow sort
		$this->fields['device_number'] = &$this->device_number;

		// tablet_imie_number
		$this->tablet_imie_number = new cField('laptop_tablet', 'laptop_tablet', 'x_tablet_imie_number', 'tablet_imie_number', '`tablet_imie_number`', '`tablet_imie_number`', 200, -1, FALSE, '`tablet_imie_number`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tablet_imie_number->Sortable = TRUE; // Allow sort
		$this->fields['tablet_imie_number'] = &$this->tablet_imie_number;

		// model
		$this->model = new cField('laptop_tablet', 'laptop_tablet', 'x_model', 'model', '`model`', '`model`', 200, -1, FALSE, '`model`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->model->Sortable = TRUE; // Allow sort
		$this->fields['model'] = &$this->model;

		// flag
		$this->flag = new cField('laptop_tablet', 'laptop_tablet', 'x_flag', 'flag', '`flag`', '`flag`', 16, -1, FALSE, '`flag`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->flag->Sortable = TRUE; // Allow sort
		$this->flag->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['flag'] = &$this->flag;

		// area
		$this->area = new cField('laptop_tablet', 'laptop_tablet', 'x_area', 'area', '`area`', '`area`', 200, -1, FALSE, '`area`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->area->Sortable = TRUE; // Allow sort
		$this->fields['area'] = &$this->area;

		// updated_date
		$this->updated_date = new cField('laptop_tablet', 'laptop_tablet', 'x_updated_date', 'updated_date', '`updated_date`', ew_CastDateFieldForLike('`updated_date`', 0, "DB"), 135, 0, FALSE, '`updated_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// updated_by
		$this->updated_by = new cField('laptop_tablet', 'laptop_tablet', 'x_updated_by', 'updated_by', '`updated_by`', '`updated_by`', 3, -1, FALSE, '`updated_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// received_date
		$this->received_date = new cField('laptop_tablet', 'laptop_tablet', 'x_received_date', 'received_date', '`received_date`', ew_CastDateFieldForLike('`received_date`', 0, "DB"), 135, 0, FALSE, '`received_date`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// received_by
		$this->received_by = new cField('laptop_tablet', 'laptop_tablet', 'x_received_by', 'received_by', '`received_by`', '`received_by`', 3, -1, FALSE, '`received_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`laptop_tablet`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "laptop_tabletedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "laptop_tabletadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("laptop_tabletview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("laptop_tabletview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "laptop_tabletadd.php?" . $this->UrlParm($parm);
		else
			$url = "laptop_tabletadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("laptop_tabletedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("laptop_tabletadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("laptop_tabletdelete.php", $this->UrlParm());
	}
